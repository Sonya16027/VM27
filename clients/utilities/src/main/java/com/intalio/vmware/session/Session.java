...
public class Session {
	...
	private void collectArguments(NodeList arguments, HashMap<String, String> argumentMap) {
		argumentMap.clear();
		if (arguments == null) {
			return;
		}
	...
	private HashMap<String, String> mergeArguments(HashMap<String, String> leftArgs, HashMap<String, String> rightArgs) {
