 ...
 * un.bat com.intalio.vmware.host.RemoveVirtualSwitch --url [webserviceurl] --username [username] --password  *[password]  --vsiwtchid [mySwitch] --datacenter [mydatacenter]  --host[hostname]
 * 
 * b&gt;Command Line:to remove a Virtual Switch from a virtual center without specifying the host&lt;/b&gt;
 * un.bat com.intalio.vmware.host.RemoveVirtualSwitch --url [webserviceurl] --username [username] --password  *[password]  --vsiwtchid [mySwitch] --datacenter [mydatacenter] 
 * 
 * b&gt; Command Line:to remove a Virtual Switch from a virtual center without specifying the datacenter&lt;/b&gt;
 * un.bat com.intalio.vmware.host.RemoveVirtualSwitch --url [webserviceurl] --username [username] --password  [password]  --vsiwtchid [mySwitch] --host [host]
 * 
 *</pre>
 */
