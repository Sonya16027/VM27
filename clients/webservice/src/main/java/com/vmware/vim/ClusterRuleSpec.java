...
public class ClusterRuleSpec  extends com.vmware.vim.ArrayUpdateSpec  implements java.io.Serializable {
    ...
    public ClusterRuleSpec(
           ...
           com.vmware.vim.ClusterRuleInfo info) {
        super(
            dynamicType,
            dynamicProperty,
            operation,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterRuleSpec"));
