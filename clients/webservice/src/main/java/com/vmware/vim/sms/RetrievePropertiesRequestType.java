...
public class RetrievePropertiesRequestType  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "RetrievePropertiesRequestType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "specSet"));
