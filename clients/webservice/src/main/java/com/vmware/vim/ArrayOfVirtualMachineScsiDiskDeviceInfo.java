...
public class ArrayOfVirtualMachineScsiDiskDeviceInfo  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineScsiDiskDeviceInfo(com.vmware.vim.VirtualMachineScsiDiskDeviceInfo[] virtualMachineScsiDiskDeviceInfo) {
        this.virtualMachineScsiDiskDeviceInfo = virtualMachineScsiDiskDeviceInfo;
    }

    public com.vmware.vim.VirtualMachineScsiDiskDeviceInfo getVirtualMachineScsiDiskDeviceInfo(int i) {
        return this.virtualMachineScsiDiskDeviceInfo[i];
    }

    public void setVirtualMachineScsiDiskDeviceInfo(int i, com.vmware.vim.VirtualMachineScsiDiskDeviceInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineScsiDiskDeviceInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineScsiDiskDeviceInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineScsiDiskDeviceInfo"));
