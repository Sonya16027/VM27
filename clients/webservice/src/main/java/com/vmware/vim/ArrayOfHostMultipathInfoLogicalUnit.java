...
public class ArrayOfHostMultipathInfoLogicalUnit  implements java.io.Serializable {
     ...
     */
    public void setHostMultipathInfoLogicalUnit(com.vmware.vim.HostMultipathInfoLogicalUnit[] hostMultipathInfoLogicalUnit) {
        this.hostMultipathInfoLogicalUnit = hostMultipathInfoLogicalUnit;
    }

    public com.vmware.vim.HostMultipathInfoLogicalUnit getHostMultipathInfoLogicalUnit(int i) {
        return this.hostMultipathInfoLogicalUnit[i];
    }

    public void setHostMultipathInfoLogicalUnit(int i, com.vmware.vim.HostMultipathInfoLogicalUnit _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostMultipathInfoLogicalUnit"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostMultipathInfoLogicalUnit");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostMultipathInfoLogicalUnit"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostMultipathInfoLogicalUnit"));
