...
public class ArrayOfVirtualMachineCdromInfo  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineCdromInfo(com.vmware.vim.VirtualMachineCdromInfo[] virtualMachineCdromInfo) {
        this.virtualMachineCdromInfo = virtualMachineCdromInfo;
    }

    public com.vmware.vim.VirtualMachineCdromInfo getVirtualMachineCdromInfo(int i) {
        return this.virtualMachineCdromInfo[i];
    }

    public void setVirtualMachineCdromInfo(int i, com.vmware.vim.VirtualMachineCdromInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineCdromInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineCdromInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineCdromInfo"));
