...
public class HostScsiTopology  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public void setAdapter(int i, com.vmware.vim.HostScsiTopologyInterface _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostScsiTopology"));
