...
public class HostVMotionNetConfig  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.HostVirtualNic[] candidateVnic;
    ...
    public HostVMotionNetConfig(
           ...
           com.vmware.vim.HostVirtualNic[] candidateVnic,
     ...
     */
    public com.vmware.vim.HostVirtualNic[] getCandidateVnic() {
        return candidateVnic;
    }
     ...
     * @param candidateVnic
     */
    public void setCandidateVnic(com.vmware.vim.HostVirtualNic[] candidateVnic) {
        this.candidateVnic = candidateVnic;
    }

    public com.vmware.vim.HostVirtualNic getCandidateVnic(int i) {
        return this.candidateVnic[i];
    }

    public void setCandidateVnic(int i, com.vmware.vim.HostVirtualNic _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostVMotionNetConfig"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("candidateVnic");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "candidateVnic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "selectedVnic"));
