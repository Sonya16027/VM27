...
public class ArrayOfPropertyFilterSpec  implements java.io.Serializable {
     ...
     */
    public void setPropertyFilterSpec(com.vmware.vim.PropertyFilterSpec[] propertyFilterSpec) {
        this.propertyFilterSpec = propertyFilterSpec;
    }
    ...
    public void setPropertyFilterSpec(int i, com.vmware.vim.PropertyFilterSpec _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPropertyFilterSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertyFilterSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PropertyFilterSpec"));
