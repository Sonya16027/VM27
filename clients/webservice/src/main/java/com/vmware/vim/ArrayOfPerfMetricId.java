...
public class ArrayOfPerfMetricId  implements java.io.Serializable {
    ...
    public ArrayOfPerfMetricId(
           com.vmware.vim.PerfMetricId[] perfMetricId) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPerfMetricId"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("perfMetricId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PerfMetricId"));
