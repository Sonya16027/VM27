...
public class PropertyChange  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    ...
    public PropertyChange(
           ...
           com.vmware.vim.sms.PropertyChangeOp op,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "PropertyChange"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sm1", "PropertyChangeOp"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
