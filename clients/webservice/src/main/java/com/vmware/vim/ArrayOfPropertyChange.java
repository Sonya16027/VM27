...
public class ArrayOfPropertyChange  implements java.io.Serializable {
    ...
    public ArrayOfPropertyChange(
           com.vmware.vim.PropertyChange[] propertyChange) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPropertyChange"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertyChange");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PropertyChange"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PropertyChange"));
