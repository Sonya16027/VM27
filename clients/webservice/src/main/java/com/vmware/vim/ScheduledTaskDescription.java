...
public class ScheduledTaskDescription  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     * @param schedulerInfo
     */
    public void setSchedulerInfo(com.vmware.vim.ScheduledTaskDetail[] schedulerInfo) {
        this.schedulerInfo = schedulerInfo;
    }
    ...
    public void setSchedulerInfo(int i, com.vmware.vim.ScheduledTaskDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskDescription"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "schedulerInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "dayOfWeek"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "weekOfMonth"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
