...
public class UpdateVcDbConnectionInfoRequestType implements
	...
	/**
	 * Gets the dbConnectionSpec value for this
	...
	/**
	 * Sets the dbConnectionSpec value for this
	 * UpdateVcDbConnectionInfoRequestType.
	 * 
	 * @param dbConnectionSpec
	 */
	public void setDbConnectionSpec(
			com.vmware.vim.sms.DbConnectionSpec dbConnectionSpec) {
		this.dbConnectionSpec = dbConnectionSpec;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof UpdateVcDbConnectionInfoRequestType)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.dbConnectionSpec == null && other
						.getDbConnectionSpec() == null) || (this.dbConnectionSpec != null && this.dbConnectionSpec
						.equals(other.getDbConnectionSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			UpdateVcDbConnectionInfoRequestType.class, true);
