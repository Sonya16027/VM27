...
public class VirtualDiskRawDiskVer2BackingOption  extends com.vmware.vim.VirtualDeviceDeviceBackingOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDiskRawDiskVer2BackingOption"));
