...
public class ArrayOfElementDescription  implements java.io.Serializable {
     ...
     */
    public void setElementDescription(com.vmware.vim.ElementDescription[] elementDescription) {
        this.elementDescription = elementDescription;
    }
    ...
    public void setElementDescription(int i, com.vmware.vim.ElementDescription _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfElementDescription"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("elementDescription");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
