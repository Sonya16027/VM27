...
public class VirtualMachineFileLayout  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public void setDisk(int i, com.vmware.vim.VirtualMachineFileLayoutDiskLayout _value) {
        this.disk[i] = _value;
    }
     ...
     * @param snapshot
     */
    public void setSnapshot(com.vmware.vim.VirtualMachineFileLayoutSnapshotLayout[] snapshot) {
        this.snapshot = snapshot;
    }

    public com.vmware.vim.VirtualMachineFileLayoutSnapshotLayout getSnapshot(int i) {
        return this.snapshot[i];
    }

    public void setSnapshot(int i, com.vmware.vim.VirtualMachineFileLayoutSnapshotLayout _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineFileLayout"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "logFile"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineFileLayoutSnapshotLayout"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "swapFile"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
