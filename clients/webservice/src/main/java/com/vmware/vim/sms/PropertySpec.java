...
public class PropertySpec  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "PropertySpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "all"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "pathSet"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
