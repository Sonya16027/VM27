...
public class HostDatastoreExistsConnectInfo  extends com.vmware.vim.HostDatastoreConnectInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDatastoreExistsConnectInfo"));
