...
public class VmfsDatastoreMultipleExtentOption  extends com.vmware.vim.VmfsDatastoreBaseOption  implements java.io.Serializable {
    ...
    public com.vmware.vim.HostDiskPartitionBlockRange getVmfsExtent(int i) {
        return this.vmfsExtent[i];
    }

    public void setVmfsExtent(int i, com.vmware.vim.HostDiskPartitionBlockRange _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmfsDatastoreMultipleExtentOption"));
