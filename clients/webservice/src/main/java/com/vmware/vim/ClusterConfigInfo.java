...
public class ClusterConfigInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     * @param dasVmConfig
     */
    public void setDasVmConfig(com.vmware.vim.ClusterDasVmConfigInfo[] dasVmConfig) {
        this.dasVmConfig = dasVmConfig;
    }
    ...
    public void setDasVmConfig(int i, com.vmware.vim.ClusterDasVmConfigInfo _value) {
     ...
     * @param drsVmConfig
     */
    public void setDrsVmConfig(com.vmware.vim.ClusterDrsVmConfigInfo[] drsVmConfig) {
        this.drsVmConfig = drsVmConfig;
    }
    ...
    public void setDrsVmConfig(int i, com.vmware.vim.ClusterDrsVmConfigInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterConfigInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "dasVmConfig"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "drsVmConfig"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDrsVmConfigInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterRuleInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
