...
public class ManagedObjectNotFound  extends com.vmware.vim.sms.RuntimeFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ManagedObjectNotFound"));
