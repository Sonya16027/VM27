...
public class ArrayOfVirtualMachineConfigInfoDatastoreUrlPair  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineConfigInfoDatastoreUrlPair(com.vmware.vim.VirtualMachineConfigInfoDatastoreUrlPair[] virtualMachineConfigInfoDatastoreUrlPair) {
        this.virtualMachineConfigInfoDatastoreUrlPair = virtualMachineConfigInfoDatastoreUrlPair;
    }

    public com.vmware.vim.VirtualMachineConfigInfoDatastoreUrlPair getVirtualMachineConfigInfoDatastoreUrlPair(int i) {
        return this.virtualMachineConfigInfoDatastoreUrlPair[i];
    }

    public void setVirtualMachineConfigInfoDatastoreUrlPair(int i, com.vmware.vim.VirtualMachineConfigInfoDatastoreUrlPair _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineConfigInfoDatastoreUrlPair"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineConfigInfoDatastoreUrlPair");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineConfigInfoDatastoreUrlPair"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineConfigInfoDatastoreUrlPair"));
