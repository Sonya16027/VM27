...
public class QueryResult  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "QueryResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "metadata"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sm1", "Metadata"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
