...
public class VMotionLinkDown  extends com.vmware.vim.VMotionInterfaceIssue  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VMotionLinkDown"));
