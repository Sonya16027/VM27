...
public class ArrayOfUserSession  implements java.io.Serializable {
    ...
    public ArrayOfUserSession(
           com.vmware.vim.UserSession[] userSession) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfUserSession"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userSession");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "UserSession"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "UserSession"));
