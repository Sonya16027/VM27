...
public class ArrayOfVirtualMachineParallelInfo  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineParallelInfo(com.vmware.vim.VirtualMachineParallelInfo[] virtualMachineParallelInfo) {
        this.virtualMachineParallelInfo = virtualMachineParallelInfo;
    }

    public com.vmware.vim.VirtualMachineParallelInfo getVirtualMachineParallelInfo(int i) {
        return this.virtualMachineParallelInfo[i];
    }

    public void setVirtualMachineParallelInfo(int i, com.vmware.vim.VirtualMachineParallelInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineParallelInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineParallelInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineParallelInfo"));
