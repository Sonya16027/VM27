...
public class VmfsDatastoreExtendSpec  extends com.vmware.vim.VmfsDatastoreSpec  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmfsDatastoreExtendSpec"));
