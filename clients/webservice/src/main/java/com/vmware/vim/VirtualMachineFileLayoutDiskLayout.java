...
public class VirtualMachineFileLayoutDiskLayout  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int key;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineFileLayoutDiskLayout"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "diskFile"));
