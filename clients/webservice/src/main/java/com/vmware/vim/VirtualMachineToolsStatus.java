...
public class VirtualMachineToolsStatus implements java.io.Serializable {
	...
	public static final VirtualMachineToolsStatus toolsNotInstalled = new VirtualMachineToolsStatus(
			_toolsNotInstalled);
	public static final VirtualMachineToolsStatus toolsNotRunning = new VirtualMachineToolsStatus(
			_toolsNotRunning);
	public static final VirtualMachineToolsStatus toolsOld = new VirtualMachineToolsStatus(
			_toolsOld);
	public static final VirtualMachineToolsStatus toolsOk = new VirtualMachineToolsStatus(
			_toolsOk);
	...
	public static VirtualMachineToolsStatus fromValue(java.lang.String value)
		...
		VirtualMachineToolsStatus enumeration = (VirtualMachineToolsStatus) _table_
				.get(value);
		if (enumeration == null) {
