...
public class PosixUserSearchResult  extends com.vmware.vim.UserSearchResult  implements java.io.Serializable {
    private int id;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PosixUserSearchResult"));
