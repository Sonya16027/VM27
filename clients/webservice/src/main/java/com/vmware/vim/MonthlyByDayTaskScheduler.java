...
public class MonthlyByDayTaskScheduler  extends com.vmware.vim.MonthlyTaskScheduler  implements java.io.Serializable {
    private int day;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "MonthlyByDayTaskScheduler"));
