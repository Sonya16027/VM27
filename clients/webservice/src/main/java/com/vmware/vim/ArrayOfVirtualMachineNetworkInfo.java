...
public class ArrayOfVirtualMachineNetworkInfo  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineNetworkInfo(com.vmware.vim.VirtualMachineNetworkInfo[] virtualMachineNetworkInfo) {
        this.virtualMachineNetworkInfo = virtualMachineNetworkInfo;
    }

    public com.vmware.vim.VirtualMachineNetworkInfo getVirtualMachineNetworkInfo(int i) {
        return this.virtualMachineNetworkInfo[i];
    }

    public void setVirtualMachineNetworkInfo(int i, com.vmware.vim.VirtualMachineNetworkInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineNetworkInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineNetworkInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineNetworkInfo"));
