...
public class ArrayOfHostService  implements java.io.Serializable {
    ...
    public ArrayOfHostService(
           com.vmware.vim.HostService[] hostService) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostService"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostService");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostService"));
