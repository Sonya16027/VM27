...
public class VirtualDiskPartitionedRawDiskVer2BackingOption  extends com.vmware.vim.VirtualDiskRawDiskVer2BackingOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDiskPartitionedRawDiskVer2BackingOption"));
    }
