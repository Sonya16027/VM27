...
public class ArrayOfPropertySpec  implements java.io.Serializable {
    ...
    public ArrayOfPropertySpec(
           com.vmware.vim.sms.PropertySpec[] propertySpec) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ArrayOfPropertySpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertySpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "PropertySpec"));
