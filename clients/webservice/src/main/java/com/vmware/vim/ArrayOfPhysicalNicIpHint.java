...
public class ArrayOfPhysicalNicIpHint  implements java.io.Serializable {
     ...
     */
    public void setPhysicalNicIpHint(com.vmware.vim.PhysicalNicIpHint[] physicalNicIpHint) {
        this.physicalNicIpHint = physicalNicIpHint;
    }
    ...
    public void setPhysicalNicIpHint(int i, com.vmware.vim.PhysicalNicIpHint _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPhysicalNicIpHint"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("physicalNicIpHint");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PhysicalNicIpHint"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PhysicalNicIpHint"));
