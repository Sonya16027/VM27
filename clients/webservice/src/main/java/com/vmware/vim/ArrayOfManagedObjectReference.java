...
public class ArrayOfManagedObjectReference  implements java.io.Serializable {
     ...
     */
    public void setManagedObjectReference(com.vmware.vim.ManagedObjectReference[] managedObjectReference) {
        this.managedObjectReference = managedObjectReference;
    }
    ...
    public void setManagedObjectReference(int i, com.vmware.vim.ManagedObjectReference _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfManagedObjectReference"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("managedObjectReference");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ManagedObjectReference"));
