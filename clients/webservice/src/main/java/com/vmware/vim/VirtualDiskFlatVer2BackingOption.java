...
public class VirtualDiskFlatVer2BackingOption  extends com.vmware.vim.VirtualDeviceFileBackingOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDiskFlatVer2BackingOption"));
