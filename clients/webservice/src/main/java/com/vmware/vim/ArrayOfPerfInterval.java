...
public class ArrayOfPerfInterval  implements java.io.Serializable {
    ...
    public ArrayOfPerfInterval(
           com.vmware.vim.PerfInterval[] perfInterval) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPerfInterval"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("perfInterval");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PerfInterval"));
