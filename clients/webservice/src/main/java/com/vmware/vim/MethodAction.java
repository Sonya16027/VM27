...
public class MethodAction  extends com.vmware.vim.Action  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "MethodAction"));
