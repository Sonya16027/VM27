...
public class ArrayOfHostDiagnosticPartition  implements java.io.Serializable {
     ...
     */
    public void setHostDiagnosticPartition(com.vmware.vim.HostDiagnosticPartition[] hostDiagnosticPartition) {
        this.hostDiagnosticPartition = hostDiagnosticPartition;
    }

    public com.vmware.vim.HostDiagnosticPartition getHostDiagnosticPartition(int i) {
        return this.hostDiagnosticPartition[i];
    }

    public void setHostDiagnosticPartition(int i, com.vmware.vim.HostDiagnosticPartition _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostDiagnosticPartition"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostDiagnosticPartition");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostDiagnosticPartition"));
