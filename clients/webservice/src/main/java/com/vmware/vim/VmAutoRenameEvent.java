...
public class VmAutoRenameEvent  extends com.vmware.vim.VmEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmAutoRenameEvent"));
