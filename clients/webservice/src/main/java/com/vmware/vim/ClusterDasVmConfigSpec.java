...
public class ClusterDasVmConfigSpec  extends com.vmware.vim.ArrayUpdateSpec  implements java.io.Serializable {
    private com.vmware.vim.ClusterDasVmConfigInfo info;
    ...
    public ClusterDasVmConfigSpec(
           ...
           com.vmware.vim.ClusterDasVmConfigInfo info) {
        super(
            dynamicType,
            dynamicProperty,
            operation,
     ...
     * @return info
     */
    public com.vmware.vim.ClusterDasVmConfigInfo getInfo() {
        return info;
    }
     ...
     * @param info
     */
    public void setInfo(com.vmware.vim.ClusterDasVmConfigInfo info) {
        this.info = info;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDasVmConfigSpec"));
