/**
 * MigrationResourceWarningEvent.java
 *
...
public class MigrationResourceWarningEvent  extends com.vmware.vim.MigrationEvent  implements java.io.Serializable {
    private com.vmware.vim.ResourcePoolEventArgument dstPool;

    private com.vmware.vim.HostEventArgument dstHost;

    public MigrationResourceWarningEvent() {
    }
    ...
    /**
     * Gets the dstPool value for this MigrationResourceWarningEvent.
     * 
     * @return dstPool
     */
    ...
    /**
     * Sets the dstPool value for this MigrationResourceWarningEvent.
     * 
     * @param dstPool
     */
    ...
    /**
     * Gets the dstHost value for this MigrationResourceWarningEvent.
     * 
     * @return dstHost
     */
    ...
    /**
     * Sets the dstHost value for this MigrationResourceWarningEvent.
     * 
     * @param dstHost
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MigrationResourceWarningEvent)) return false;
        MigrationResourceWarningEvent other = (MigrationResourceWarningEvent) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MigrationResourceWarningEvent.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "MigrationResourceWarningEvent"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dstPool");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "dstPool"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ResourcePoolEventArgument"));
