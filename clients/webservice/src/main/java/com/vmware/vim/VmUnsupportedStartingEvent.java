...
public class VmUnsupportedStartingEvent  extends com.vmware.vim.VmStartingEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmUnsupportedStartingEvent"));
