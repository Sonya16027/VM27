...
public class VirtualDeviceRemoteDeviceBackingInfo  extends com.vmware.vim.VirtualDeviceBackingInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceRemoteDeviceBackingInfo"));
