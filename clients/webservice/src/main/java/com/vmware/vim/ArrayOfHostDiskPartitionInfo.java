...
public class ArrayOfHostDiskPartitionInfo  implements java.io.Serializable {
     ...
     */
    public void setHostDiskPartitionInfo(com.vmware.vim.HostDiskPartitionInfo[] hostDiskPartitionInfo) {
        this.hostDiskPartitionInfo = hostDiskPartitionInfo;
    }
    ...
    public void setHostDiskPartitionInfo(int i, com.vmware.vim.HostDiskPartitionInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostDiskPartitionInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostDiskPartitionInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostDiskPartitionInfo"));
