...
public class ScheduledTaskEmailFailedEvent  extends com.vmware.vim.ScheduledTaskEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskEmailFailedEvent"));
