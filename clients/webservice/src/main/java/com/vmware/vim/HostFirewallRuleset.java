...
public class HostFirewallRuleset  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.vim.HostFirewallRule[] rule;
    ...
    public HostFirewallRuleset(
           ...
           boolean required,
           com.vmware.vim.HostFirewallRule[] rule,
     ...
     * @return rule
     */
    public com.vmware.vim.HostFirewallRule[] getRule() {
        return rule;
    }
     ...
     * @param rule
     */
    public void setRule(com.vmware.vim.HostFirewallRule[] rule) {
        this.rule = rule;
    }

    public com.vmware.vim.HostFirewallRule getRule(int i) {
        return this.rule[i];
    }

    public void setRule(int i, com.vmware.vim.HostFirewallRule _value) {
        this.rule[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostFirewallRuleset"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "label"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("required");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "required"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostFirewallRule"));
        elemField.setNillable(false);
