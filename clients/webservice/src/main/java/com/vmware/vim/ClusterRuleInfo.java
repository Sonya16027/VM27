...
public class ClusterRuleInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.Integer key;

    private com.vmware.vim.ManagedEntityStatus status;
    ...
    public ClusterRuleInfo(
           ...
           com.vmware.vim.ManagedEntityStatus status,
     ...
     * @return status
     */
    public com.vmware.vim.ManagedEntityStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.vmware.vim.ManagedEntityStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterRuleInfo"));
