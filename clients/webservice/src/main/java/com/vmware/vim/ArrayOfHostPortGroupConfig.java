/**
 * ArrayOfHostPortGroupConfig.java
 *
...
public class ArrayOfHostPortGroupConfig  implements java.io.Serializable {
    private com.vmware.vim.HostPortGroupConfig[] hostPortGroupConfig;

    public ArrayOfHostPortGroupConfig() {
    }

    public ArrayOfHostPortGroupConfig(
           com.vmware.vim.HostPortGroupConfig[] hostPortGroupConfig) {
     ...
     */
    public com.vmware.vim.HostPortGroupConfig[] getHostPortGroupConfig() {
        return hostPortGroupConfig;
    }
     ...
     */
    public void setHostPortGroupConfig(com.vmware.vim.HostPortGroupConfig[] hostPortGroupConfig) {
        this.hostPortGroupConfig = hostPortGroupConfig;
    }

    public com.vmware.vim.HostPortGroupConfig getHostPortGroupConfig(int i) {
        return this.hostPortGroupConfig[i];
    }

    public void setHostPortGroupConfig(int i, com.vmware.vim.HostPortGroupConfig _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostPortGroupConfig"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostPortGroupConfig");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostPortGroupConfig"));
