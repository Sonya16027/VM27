...
public class PerfCounterInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int key;

    private com.vmware.vim.ElementDescription nameInfo;

    private com.vmware.vim.ElementDescription groupInfo;

    private com.vmware.vim.ElementDescription unitInfo;

    private com.vmware.vim.PerfSummaryType rollupType;

    private com.vmware.vim.PerfStatsType statsType;
    ...
    public PerfCounterInfo(
           ...
           int key,
           com.vmware.vim.ElementDescription nameInfo,
           com.vmware.vim.ElementDescription groupInfo,
           com.vmware.vim.ElementDescription unitInfo,
           com.vmware.vim.PerfSummaryType rollupType,
           com.vmware.vim.PerfStatsType statsType,
     ...
     * @return nameInfo
     */
    public com.vmware.vim.ElementDescription getNameInfo() {
        return nameInfo;
    }
     ...
     * @param nameInfo
     */
    public void setNameInfo(com.vmware.vim.ElementDescription nameInfo) {
        this.nameInfo = nameInfo;
    }
     ...
     * @return groupInfo
     */
    public com.vmware.vim.ElementDescription getGroupInfo() {
        return groupInfo;
    }
     ...
     * @param groupInfo
     */
    public void setGroupInfo(com.vmware.vim.ElementDescription groupInfo) {
        this.groupInfo = groupInfo;
    }
     ...
     * @return unitInfo
     */
    public com.vmware.vim.ElementDescription getUnitInfo() {
        return unitInfo;
    }
     ...
     * @param unitInfo
     */
    public void setUnitInfo(com.vmware.vim.ElementDescription unitInfo) {
        this.unitInfo = unitInfo;
    }
     ...
     * @return rollupType
     */
    public com.vmware.vim.PerfSummaryType getRollupType() {
        return rollupType;
    }
     ...
     * @param rollupType
     */
    public void setRollupType(com.vmware.vim.PerfSummaryType rollupType) {
        this.rollupType = rollupType;
    }
     ...
     * @return statsType
     */
    public com.vmware.vim.PerfStatsType getStatsType() {
        return statsType;
    }
     ...
     * @param statsType
     */
    public void setStatsType(com.vmware.vim.PerfStatsType statsType) {
        this.statsType = statsType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfCounterInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "nameInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("groupInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "groupInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("unitInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "unitInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("rollupType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "rollupType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfSummaryType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statsType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "statsType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfStatsType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("associatedCounterId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "associatedCounterId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
