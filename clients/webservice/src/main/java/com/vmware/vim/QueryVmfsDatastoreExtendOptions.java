...
public class QueryVmfsDatastoreExtendOptions  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryVmfsDatastoreExtendOptions)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryVmfsDatastoreExtendOptions.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">QueryVmfsDatastoreExtendOptions"));
