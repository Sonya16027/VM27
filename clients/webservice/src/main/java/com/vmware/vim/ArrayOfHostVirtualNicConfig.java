...
public class ArrayOfHostVirtualNicConfig  implements java.io.Serializable {
     ...
     */
    public void setHostVirtualNicConfig(com.vmware.vim.HostVirtualNicConfig[] hostVirtualNicConfig) {
        this.hostVirtualNicConfig = hostVirtualNicConfig;
    }
    ...
    public void setHostVirtualNicConfig(int i, com.vmware.vim.HostVirtualNicConfig _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostVirtualNicConfig"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostVirtualNicConfig");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostVirtualNicConfig"));
