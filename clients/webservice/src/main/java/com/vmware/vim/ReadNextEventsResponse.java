...
public class ReadNextEventsResponse  implements java.io.Serializable {
    private com.vmware.vim.Event[] returnval;

    public ReadNextEventsResponse() {
    }

    public ReadNextEventsResponse(
           com.vmware.vim.Event[] returnval) {
           this.returnval = returnval;
    }


    /**
     * Gets the returnval value for this ReadNextEventsResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this ReadNextEventsResponse.
     * 
     * @param returnval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReadNextEventsResponse)) return false;
        ReadNextEventsResponse other = (ReadNextEventsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReadNextEventsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">ReadNextEventsResponse"));
