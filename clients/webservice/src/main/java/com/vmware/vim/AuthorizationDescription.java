...
public class AuthorizationDescription  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setPrivilegeGroup(com.vmware.vim.ElementDescription[] privilegeGroup) {
        this.privilegeGroup = privilegeGroup;
    }
    ...
    public void setPrivilegeGroup(int i, com.vmware.vim.ElementDescription _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AuthorizationDescription"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("privilege");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "privilege"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "privilegeGroup"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
