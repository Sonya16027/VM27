...
public class SendEmailAction extends com.vmware.vim.Action implements
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "toList"));
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ccList"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
