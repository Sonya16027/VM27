...
public class VirtualSerialPortPipeBackingOption  extends com.vmware.vim.VirtualDevicePipeBackingOption  implements java.io.Serializable {
    ...
    public VirtualSerialPortPipeBackingOption(
           ...
           com.vmware.vim.ChoiceOption endpoint,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualSerialPortPipeBackingOption"));
