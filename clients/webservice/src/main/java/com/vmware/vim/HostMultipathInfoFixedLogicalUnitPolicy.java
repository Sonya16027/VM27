...
public class HostMultipathInfoFixedLogicalUnitPolicy extends
		com.vmware.vim.HostMultipathInfoLogicalUnitPolicy implements
	...
	public HostMultipathInfoFixedLogicalUnitPolicy(
			...
			java.lang.String policy, java.lang.String prefer) {
		super(dynamicType, dynamicProperty, policy);
		this.prefer = prefer;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostMultipathInfoFixedLogicalUnitPolicy)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.prefer == null && other.getPrefer() == null) || (this.prefer != null && this.prefer
						.equals(other.getPrefer())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostMultipathInfoFixedLogicalUnitPolicy.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "prefer"));
