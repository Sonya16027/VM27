...
public class NoActiveHostInCluster  extends com.vmware.vim.InvalidState  implements java.io.Serializable {
     ...
     */
    public void setComputeResource(com.vmware.vim.ManagedObjectReference computeResource) {
        this.computeResource = computeResource;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "NoActiveHostInCluster"));
