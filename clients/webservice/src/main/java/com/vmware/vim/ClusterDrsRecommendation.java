...
public class ClusterDrsRecommendation  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     * @param migrationList
     */
    public void setMigrationList(com.vmware.vim.ClusterDrsMigration[] migrationList) {
        this.migrationList = migrationList;
    }
    ...
    public void setMigrationList(int i, com.vmware.vim.ClusterDrsMigration _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDrsRecommendation"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "reasonText"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("migrationList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "migrationList"));
