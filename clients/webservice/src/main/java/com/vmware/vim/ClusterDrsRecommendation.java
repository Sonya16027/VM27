...
public class ClusterDrsRecommendation extends com.vmware.vim.DynamicData
	...
	private com.vmware.vim.ClusterDrsMigration[] migrationList;

	public ClusterDrsRecommendation() {
	}

	public ClusterDrsRecommendation(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty,
			java.lang.String key, int rating, java.lang.String reason,
			java.lang.String reasonText,
			com.vmware.vim.ClusterDrsMigration[] migrationList) {
	 ...
	 */
	public com.vmware.vim.ClusterDrsMigration[] getMigrationList() {
		return migrationList;
	}
	 ...
	 * @param migrationList
	 */
	public void setMigrationList(
			com.vmware.vim.ClusterDrsMigration[] migrationList) {
		this.migrationList = migrationList;
	}

	public com.vmware.vim.ClusterDrsMigration getMigrationList(int i) {
		return this.migrationList[i];
	}

	public void setMigrationList(int i,
			com.vmware.vim.ClusterDrsMigration _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClusterDrsRecommendation)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.migrationList == null && other.getMigrationList() == null) || (this.migrationList != null && java.util.Arrays
						.equals(this.migrationList, other.getMigrationList())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClusterDrsRecommendation.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "rating"));
		elemField.setXmlType(new javax.xml.namespace.QName(
