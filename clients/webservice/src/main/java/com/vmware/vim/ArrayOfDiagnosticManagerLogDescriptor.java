...
public class ArrayOfDiagnosticManagerLogDescriptor  implements java.io.Serializable {
     ...
     */
    public void setDiagnosticManagerLogDescriptor(com.vmware.vim.DiagnosticManagerLogDescriptor[] diagnosticManagerLogDescriptor) {
        this.diagnosticManagerLogDescriptor = diagnosticManagerLogDescriptor;
    }

    public com.vmware.vim.DiagnosticManagerLogDescriptor getDiagnosticManagerLogDescriptor(int i) {
        return this.diagnosticManagerLogDescriptor[i];
    }

    public void setDiagnosticManagerLogDescriptor(int i, com.vmware.vim.DiagnosticManagerLogDescriptor _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfDiagnosticManagerLogDescriptor"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("diagnosticManagerLogDescriptor");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "DiagnosticManagerLogDescriptor"));
