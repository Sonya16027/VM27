...
public class ArrayOfUserSearchResult  implements java.io.Serializable {
     ...
     */
    public void setUserSearchResult(com.vmware.vim.UserSearchResult[] userSearchResult) {
        this.userSearchResult = userSearchResult;
    }
    ...
    public void setUserSearchResult(int i, com.vmware.vim.UserSearchResult _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfUserSearchResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userSearchResult");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "UserSearchResult"));
