...
public class VirtualDeviceRemoteDeviceBackingOption  extends com.vmware.vim.VirtualDeviceBackingOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceRemoteDeviceBackingOption"));
    }
