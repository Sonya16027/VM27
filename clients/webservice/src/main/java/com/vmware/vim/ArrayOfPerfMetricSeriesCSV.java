...
public class ArrayOfPerfMetricSeriesCSV  implements java.io.Serializable {
     ...
     */
    public void setPerfMetricSeriesCSV(com.vmware.vim.PerfMetricSeriesCSV[] perfMetricSeriesCSV) {
        this.perfMetricSeriesCSV = perfMetricSeriesCSV;
    }
    ...
    public void setPerfMetricSeriesCSV(int i, com.vmware.vim.PerfMetricSeriesCSV _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPerfMetricSeriesCSV"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("perfMetricSeriesCSV");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PerfMetricSeriesCSV"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfMetricSeriesCSV"));
