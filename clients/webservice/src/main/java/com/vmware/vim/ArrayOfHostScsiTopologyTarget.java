...
public class ArrayOfHostScsiTopologyTarget  implements java.io.Serializable {
     ...
     */
    public void setHostScsiTopologyTarget(com.vmware.vim.HostScsiTopologyTarget[] hostScsiTopologyTarget) {
        this.hostScsiTopologyTarget = hostScsiTopologyTarget;
    }
    ...
    public void setHostScsiTopologyTarget(int i, com.vmware.vim.HostScsiTopologyTarget _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostScsiTopologyTarget"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostScsiTopologyTarget");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostScsiTopologyTarget"));
