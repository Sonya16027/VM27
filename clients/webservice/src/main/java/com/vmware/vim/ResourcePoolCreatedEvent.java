...
public class ResourcePoolCreatedEvent  extends com.vmware.vim.ResourcePoolEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ResourcePoolCreatedEvent"));
