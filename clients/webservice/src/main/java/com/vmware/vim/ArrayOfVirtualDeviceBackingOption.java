...
public class ArrayOfVirtualDeviceBackingOption  implements java.io.Serializable {
     ...
     */
    public void setVirtualDeviceBackingOption(com.vmware.vim.VirtualDeviceBackingOption[] virtualDeviceBackingOption) {
        this.virtualDeviceBackingOption = virtualDeviceBackingOption;
    }

    public com.vmware.vim.VirtualDeviceBackingOption getVirtualDeviceBackingOption(int i) {
        return this.virtualDeviceBackingOption[i];
    }

    public void setVirtualDeviceBackingOption(int i, com.vmware.vim.VirtualDeviceBackingOption _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualDeviceBackingOption"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualDeviceBackingOption");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceBackingOption"));
