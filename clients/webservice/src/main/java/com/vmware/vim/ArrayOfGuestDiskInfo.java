...
public class ArrayOfGuestDiskInfo  implements java.io.Serializable {
    ...
    public ArrayOfGuestDiskInfo(
           com.vmware.vim.GuestDiskInfo[] guestDiskInfo) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfGuestDiskInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("guestDiskInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "GuestDiskInfo"));
