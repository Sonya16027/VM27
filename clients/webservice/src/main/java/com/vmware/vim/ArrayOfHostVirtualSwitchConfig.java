...
public class ArrayOfHostVirtualSwitchConfig  implements java.io.Serializable {
     ...
     */
    public void setHostVirtualSwitchConfig(com.vmware.vim.HostVirtualSwitchConfig[] hostVirtualSwitchConfig) {
        this.hostVirtualSwitchConfig = hostVirtualSwitchConfig;
    }

    public com.vmware.vim.HostVirtualSwitchConfig getHostVirtualSwitchConfig(int i) {
        return this.hostVirtualSwitchConfig[i];
    }

    public void setHostVirtualSwitchConfig(int i, com.vmware.vim.HostVirtualSwitchConfig _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostVirtualSwitchConfig"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostVirtualSwitchConfig");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostVirtualSwitchConfig"));
