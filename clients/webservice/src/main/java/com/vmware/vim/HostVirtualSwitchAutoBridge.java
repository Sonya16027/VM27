...
public class HostVirtualSwitchAutoBridge  extends com.vmware.vim.HostVirtualSwitchBridge  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostVirtualSwitchAutoBridge"));
    }
