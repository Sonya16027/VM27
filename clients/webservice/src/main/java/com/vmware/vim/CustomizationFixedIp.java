...
public class CustomizationFixedIp  extends com.vmware.vim.CustomizationIpGenerator  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomizationFixedIp"));
