...
public class GroupAlarmAction  extends com.vmware.vim.AlarmAction  implements java.io.Serializable {
    ...
    public com.vmware.vim.AlarmAction getAction(int i) {
        return this.action[i];
    }

    public void setAction(int i, com.vmware.vim.AlarmAction _value) {
        this.action[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GroupAlarmAction)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GroupAlarmAction.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "GroupAlarmAction"));
