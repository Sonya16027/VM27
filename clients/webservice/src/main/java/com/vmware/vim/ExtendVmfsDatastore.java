...
public class ExtendVmfsDatastore  implements java.io.Serializable {
    private com.vmware.vim.ManagedObjectReference _this;

    private com.vmware.vim.ManagedObjectReference datastore;

    private com.vmware.vim.VmfsDatastoreExtendSpec spec;

    public ExtendVmfsDatastore() {
    }
    ...
    /**
     * Gets the _this value for this ExtendVmfsDatastore.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this ExtendVmfsDatastore.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the datastore value for this ExtendVmfsDatastore.
     * 
     * @return datastore
     */
    ...
    /**
     * Sets the datastore value for this ExtendVmfsDatastore.
     * 
     * @param datastore
     */
    ...
    /**
     * Gets the spec value for this ExtendVmfsDatastore.
     * 
     * @return spec
     */
    public com.vmware.vim.VmfsDatastoreExtendSpec getSpec() {
        return spec;
    }


    /**
     * Sets the spec value for this ExtendVmfsDatastore.
     * 
     * @param spec
     */
    public void setSpec(com.vmware.vim.VmfsDatastoreExtendSpec spec) {
        this.spec = spec;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExtendVmfsDatastore)) return false;
        ExtendVmfsDatastore other = (ExtendVmfsDatastore) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExtendVmfsDatastore.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">ExtendVmfsDatastore"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmfsDatastoreExtendSpec"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
