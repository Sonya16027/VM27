...
public class InvalidTopologyQuery  extends com.vmware.vim.sms.InvalidArgument  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidTopologyQuery)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InvalidTopologyQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "InvalidTopologyQuery"));
