...
public class AccountCreatedEvent  extends com.vmware.vim.HostEvent  implements java.io.Serializable {
    ...
    public AccountCreatedEvent(
           ...
           com.vmware.vim.HostAccountSpec spec,
           boolean group) {
        super(
            dynamicType,
            dynamicProperty,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AccountCreatedEvent"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("spec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "spec"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostAccountSpec"));
