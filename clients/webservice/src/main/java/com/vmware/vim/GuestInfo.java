...
public class GuestInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.vim.GuestNicInfo[] net;

    private com.vmware.vim.GuestDiskInfo[] disk;

    private com.vmware.vim.GuestScreenInfo screen;
    ...
    public GuestInfo(
           ...
           com.vmware.vim.GuestNicInfo[] net,
           com.vmware.vim.GuestDiskInfo[] disk,
           com.vmware.vim.GuestScreenInfo screen,
     ...
     * @param toolsStatus
     */
    public void setToolsStatus(com.vmware.vim.VirtualMachineToolsStatus toolsStatus) {
        this.toolsStatus = toolsStatus;
    }
     ...
     * @return net
     */
    public com.vmware.vim.GuestNicInfo[] getNet() {
        return net;
    }
     ...
     * @param net
     */
    public void setNet(com.vmware.vim.GuestNicInfo[] net) {
        this.net = net;
    }

    public com.vmware.vim.GuestNicInfo getNet(int i) {
        return this.net[i];
    }

    public void setNet(int i, com.vmware.vim.GuestNicInfo _value) {
        this.net[i] = _value;
    }
     ...
     * @return disk
     */
    public com.vmware.vim.GuestDiskInfo[] getDisk() {
        return disk;
    }
     ...
     * @param disk
     */
    public void setDisk(com.vmware.vim.GuestDiskInfo[] disk) {
        this.disk = disk;
    }

    public com.vmware.vim.GuestDiskInfo getDisk(int i) {
        return this.disk[i];
    }

    public void setDisk(int i, com.vmware.vim.GuestDiskInfo _value) {
        this.disk[i] = _value;
    }
     ...
     * @return screen
     */
    public com.vmware.vim.GuestScreenInfo getScreen() {
        return screen;
    }
     ...
     * @param screen
     */
    public void setScreen(com.vmware.vim.GuestScreenInfo screen) {
        this.screen = screen;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "GuestInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("toolsStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "toolsStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineToolsStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("toolsVersion");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "toolsVersion"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "guestFamily"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ipAddress"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "net"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "GuestNicInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "GuestDiskInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "screen"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "GuestScreenInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("guestState");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "guestState"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
