...
public class VirtualDeviceOption  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.String type;

    private com.vmware.vim.VirtualDeviceConnectOption connectOption;

    private java.lang.String controllerType;

    private com.vmware.vim.BoolOption autoAssignController;

    private com.vmware.vim.VirtualDeviceBackingOption[] backingOption;
     ...
     */
    public com.vmware.vim.VirtualDeviceConnectOption getConnectOption() {
        return connectOption;
    }
     ...
     * @param connectOption
     */
    public void setConnectOption(com.vmware.vim.VirtualDeviceConnectOption connectOption) {
        this.connectOption = connectOption;
    }
     ...
     */
    public com.vmware.vim.BoolOption getAutoAssignController() {
        return autoAssignController;
    }
     ...
     */
    public void setAutoAssignController(com.vmware.vim.BoolOption autoAssignController) {
        this.autoAssignController = autoAssignController;
    }
     ...
     */
    public com.vmware.vim.VirtualDeviceBackingOption[] getBackingOption() {
        return backingOption;
    }
     ...
     * @param backingOption
     */
    public void setBackingOption(com.vmware.vim.VirtualDeviceBackingOption[] backingOption) {
        this.backingOption = backingOption;
    }

    public com.vmware.vim.VirtualDeviceBackingOption getBackingOption(int i) {
        return this.backingOption[i];
    }

    public void setBackingOption(int i, com.vmware.vim.VirtualDeviceBackingOption _value) {
     ...
     */
    public void setDefaultBackingOptionIndex(java.lang.Integer defaultBackingOptionIndex) {
        this.defaultBackingOptionIndex = defaultBackingOptionIndex;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualDeviceOption)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.connectOption==null && other.getConnectOption()==null) || 
             (this.connectOption!=null &&
              this.connectOption.equals(other.getConnectOption()))) &&
            ((this.controllerType==null && other.getControllerType()==null) || 
             (this.controllerType!=null &&
              this.controllerType.equals(other.getControllerType()))) &&
            ((this.autoAssignController==null && other.getAutoAssignController()==null) || 
             (this.autoAssignController!=null &&
              this.autoAssignController.equals(other.getAutoAssignController()))) &&
            ((this.backingOption==null && other.getBackingOption()==null) || 
             (this.backingOption!=null &&
              java.util.Arrays.equals(this.backingOption, other.getBackingOption()))) &&
            ((this.defaultBackingOptionIndex==null && other.getDefaultBackingOptionIndex()==null) || 
             (this.defaultBackingOptionIndex!=null &&
              this.defaultBackingOptionIndex.equals(other.getDefaultBackingOptionIndex()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getBackingOption() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBackingOption());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getBackingOption(), i);
                if (obj != null &&
        ...
        _hashCode += (isPlugAndPlay() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualDeviceOption.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceOption"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "connectOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceConnectOption"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("controllerType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "controllerType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "autoAssignController"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "backingOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceBackingOption"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "defaultBackingOptionIndex"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "licensingLimit"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "deprecated"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("plugAndPlay");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "plugAndPlay"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
