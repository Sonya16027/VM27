...
public class ArrayOfHostFileSystemMountInfo  implements java.io.Serializable {
     ...
     */
    public void setHostFileSystemMountInfo(com.vmware.vim.HostFileSystemMountInfo[] hostFileSystemMountInfo) {
        this.hostFileSystemMountInfo = hostFileSystemMountInfo;
    }

    public com.vmware.vim.HostFileSystemMountInfo getHostFileSystemMountInfo(int i) {
        return this.hostFileSystemMountInfo[i];
    }

    public void setHostFileSystemMountInfo(int i, com.vmware.vim.HostFileSystemMountInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostFileSystemMountInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostFileSystemMountInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostFileSystemMountInfo"));
