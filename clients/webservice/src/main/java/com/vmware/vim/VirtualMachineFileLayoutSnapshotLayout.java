...
public class VirtualMachineFileLayoutSnapshotLayout  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineFileLayoutSnapshotLayout"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "snapshotFile"));
