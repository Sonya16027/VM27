...
public class HostDiskDimensionsChs extends com.vmware.vim.DynamicData implements
	...
	public HostDiskDimensionsChs(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty, long cylinder,
			int head, int sector) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "sector"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "int"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
