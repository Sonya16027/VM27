...
public class FilterSpecConstraint  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setComparisonOperator(com.vmware.vim.sms.FilterSpecComparisonOperator comparisonOperator) {
        this.comparisonOperator = comparisonOperator;
    }
     ...
     */
    public void setChildConstraint(com.vmware.vim.sms.FilterSpecConstraint[] childConstraint) {
        this.childConstraint = childConstraint;
    }
    ...
    public void setChildConstraint(int i, com.vmware.vim.sms.FilterSpecConstraint _value) {
        this.childConstraint[i] = _value;
    }


    /**
     * Gets the childConstraintLogicalOperator value for this FilterSpecConstraint.
     * 
    ...
    /**
     * Sets the childConstraintLogicalOperator value for this FilterSpecConstraint.
     * 
     * @param childConstraintLogicalOperator
     */
    public void setChildConstraintLogicalOperator(com.vmware.vim.sms.FilterSpecLogicalOperator childConstraintLogicalOperator) {
        this.childConstraintLogicalOperator = childConstraintLogicalOperator;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FilterSpecConstraint)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.comparisonOperator==null && other.getComparisonOperator()==null) || 
             (this.comparisonOperator!=null &&
              this.comparisonOperator.equals(other.getComparisonOperator()))) &&
            ((this.childConstraint==null && other.getChildConstraint()==null) || 
             (this.childConstraint!=null &&
              java.util.Arrays.equals(this.childConstraint, other.getChildConstraint()))) &&
            ((this.childConstraintLogicalOperator==null && other.getChildConstraintLogicalOperator()==null) || 
             (this.childConstraintLogicalOperator!=null &&
              this.childConstraintLogicalOperator.equals(other.getChildConstraintLogicalOperator())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getChildConstraint() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getChildConstraint());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getChildConstraint(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FilterSpecConstraint.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "FilterSpecConstraint"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "propertyValue"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "comparisonOperator"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sm1", "FilterSpecComparisonOperator"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("childConstraint");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "childConstraint"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sm1", "FilterSpecConstraint"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "childConstraintLogicalOperator"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sm1", "FilterSpecLogicalOperator"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
