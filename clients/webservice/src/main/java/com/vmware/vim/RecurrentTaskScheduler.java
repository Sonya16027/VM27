...
public class RecurrentTaskScheduler  extends com.vmware.vim.TaskScheduler  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "RecurrentTaskScheduler"));
