...
public class VirtualSerialPort  extends com.vmware.vim.VirtualDevice  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualSerialPort"));
