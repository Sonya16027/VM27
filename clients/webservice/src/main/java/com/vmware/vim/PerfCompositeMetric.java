...
public class PerfCompositeMetric  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfCompositeMetric"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "childEntity"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfEntityMetricBase"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
