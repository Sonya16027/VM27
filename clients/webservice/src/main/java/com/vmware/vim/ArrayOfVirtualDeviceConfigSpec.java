...
public class ArrayOfVirtualDeviceConfigSpec  implements java.io.Serializable {
     ...
     */
    public void setVirtualDeviceConfigSpec(com.vmware.vim.VirtualDeviceConfigSpec[] virtualDeviceConfigSpec) {
        this.virtualDeviceConfigSpec = virtualDeviceConfigSpec;
    }

    public com.vmware.vim.VirtualDeviceConfigSpec getVirtualDeviceConfigSpec(int i) {
        return this.virtualDeviceConfigSpec[i];
    }

    public void setVirtualDeviceConfigSpec(int i, com.vmware.vim.VirtualDeviceConfigSpec _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualDeviceConfigSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualDeviceConfigSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceConfigSpec"));
