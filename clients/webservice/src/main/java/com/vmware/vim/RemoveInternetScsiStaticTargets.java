/**
 * RemoveInternetScsiStaticTargets.java
 *
...
public class RemoveInternetScsiStaticTargets  implements java.io.Serializable {
    ...
    public RemoveInternetScsiStaticTargets() {
    }
    ...
    /**
     * Gets the _this value for this RemoveInternetScsiStaticTargets.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this RemoveInternetScsiStaticTargets.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the iScsiHbaDevice value for this RemoveInternetScsiStaticTargets.
     * 
    ...
    /**
     * Sets the iScsiHbaDevice value for this RemoveInternetScsiStaticTargets.
     * 
    ...
    /**
     * Gets the targets value for this RemoveInternetScsiStaticTargets.
     * 
     * @return targets
     */
    ...
    /**
     * Sets the targets value for this RemoveInternetScsiStaticTargets.
     * 
     * @param targets
     */
    public void setTargets(com.vmware.vim.HostInternetScsiHbaStaticTarget[] targets) {
        this.targets = targets;
    }
    ...
    public void setTargets(int i, com.vmware.vim.HostInternetScsiHbaStaticTarget _value) {
        this.targets[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RemoveInternetScsiStaticTargets)) return false;
        RemoveInternetScsiStaticTargets other = (RemoveInternetScsiStaticTargets) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RemoveInternetScsiStaticTargets.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">RemoveInternetScsiStaticTargets"));
