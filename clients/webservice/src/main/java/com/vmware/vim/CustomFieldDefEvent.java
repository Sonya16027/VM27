...
public class CustomFieldDefEvent  extends com.vmware.vim.CustomFieldEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomFieldDefEvent"));
