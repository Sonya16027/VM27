...
public class InsufficientHostCapacityFault  extends com.vmware.vim.InsufficientResourcesFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "InsufficientHostCapacityFault"));
    }
