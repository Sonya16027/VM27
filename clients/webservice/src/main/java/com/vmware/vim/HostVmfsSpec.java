...
public class HostVmfsSpec  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostVmfsSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "volumeName"));
