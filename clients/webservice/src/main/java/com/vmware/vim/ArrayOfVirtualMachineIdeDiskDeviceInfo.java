/**
 * ArrayOfVirtualMachineIdeDiskDeviceInfo.java
 *
...
public class ArrayOfVirtualMachineIdeDiskDeviceInfo  implements java.io.Serializable {
    private com.vmware.vim.VirtualMachineIdeDiskDeviceInfo[] virtualMachineIdeDiskDeviceInfo;

    public ArrayOfVirtualMachineIdeDiskDeviceInfo() {
    }

    public ArrayOfVirtualMachineIdeDiskDeviceInfo(
           com.vmware.vim.VirtualMachineIdeDiskDeviceInfo[] virtualMachineIdeDiskDeviceInfo) {
     ...
     */
    public com.vmware.vim.VirtualMachineIdeDiskDeviceInfo[] getVirtualMachineIdeDiskDeviceInfo() {
        return virtualMachineIdeDiskDeviceInfo;
    }
     ...
     */
    public void setVirtualMachineIdeDiskDeviceInfo(com.vmware.vim.VirtualMachineIdeDiskDeviceInfo[] virtualMachineIdeDiskDeviceInfo) {
        this.virtualMachineIdeDiskDeviceInfo = virtualMachineIdeDiskDeviceInfo;
    }

    public com.vmware.vim.VirtualMachineIdeDiskDeviceInfo getVirtualMachineIdeDiskDeviceInfo(int i) {
        return this.virtualMachineIdeDiskDeviceInfo[i];
    }

    public void setVirtualMachineIdeDiskDeviceInfo(int i, com.vmware.vim.VirtualMachineIdeDiskDeviceInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineIdeDiskDeviceInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineIdeDiskDeviceInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineIdeDiskDeviceInfo"));
