...
public class PermissionEvent  extends com.vmware.vim.AuthorizationEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PermissionEvent"));
