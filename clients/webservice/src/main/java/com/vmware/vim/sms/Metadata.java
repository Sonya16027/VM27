...
public class Metadata  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    private int numRows;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.propertyName==null && other.getPropertyName()==null) || 
             (this.propertyName!=null &&
              java.util.Arrays.equals(this.propertyName, other.getPropertyName())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPropertyName() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPropertyName());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPropertyName(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "Metadata"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("numRows");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "numRows"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("totalRows");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "totalRows"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
