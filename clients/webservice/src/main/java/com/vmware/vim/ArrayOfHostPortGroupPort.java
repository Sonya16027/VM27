...
public class ArrayOfHostPortGroupPort  implements java.io.Serializable {
     ...
     */
    public void setHostPortGroupPort(com.vmware.vim.HostPortGroupPort[] hostPortGroupPort) {
        this.hostPortGroupPort = hostPortGroupPort;
    }
    ...
    public void setHostPortGroupPort(int i, com.vmware.vim.HostPortGroupPort _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostPortGroupPort"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostPortGroupPort");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostPortGroupPort"));
