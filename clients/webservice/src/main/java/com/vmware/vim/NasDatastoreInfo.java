...
public class NasDatastoreInfo  extends com.vmware.vim.DatastoreInfo  implements java.io.Serializable {
    ...
    public NasDatastoreInfo(
           ...
           long freeSpace,
           long maxFileSize,
           com.vmware.vim.HostNasVolume nas) {
        super(
            dynamicType,
            dynamicProperty,
            name,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "NasDatastoreInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nas");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "nas"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostNasVolume"));
