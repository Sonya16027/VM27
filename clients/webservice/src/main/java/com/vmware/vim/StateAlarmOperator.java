...
public class StateAlarmOperator implements java.io.Serializable {
	...
	public static final StateAlarmOperator isEqual = new StateAlarmOperator(
			_isEqual);
	public static final StateAlarmOperator isUnequal = new StateAlarmOperator(
			_isUnequal);
	...
	public static StateAlarmOperator fromValue(java.lang.String value)
		...
		StateAlarmOperator enumeration = (StateAlarmOperator) _table_
				.get(value);
		if (enumeration == null) {
