...
public class CustomizationGlobalIPSettings  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public CustomizationGlobalIPSettings(
           ...
           java.lang.String[] dnsSuffixList,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomizationGlobalIPSettings)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.dnsSuffixList==null && other.getDnsSuffixList()==null) || 
             (this.dnsSuffixList!=null &&
              java.util.Arrays.equals(this.dnsSuffixList, other.getDnsSuffixList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getDnsSuffixList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDnsSuffixList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDnsSuffixList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomizationGlobalIPSettings.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomizationGlobalIPSettings"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnsSuffixList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "dnsSuffixList"));
