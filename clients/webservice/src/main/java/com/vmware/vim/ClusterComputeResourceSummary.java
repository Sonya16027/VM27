...
public class ClusterComputeResourceSummary extends
		com.vmware.vim.ComputeResourceSummary implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public ClusterComputeResourceSummary(java.lang.String dynamicType,
			...
			int currentFailoverLevel, int numVmotions) {
