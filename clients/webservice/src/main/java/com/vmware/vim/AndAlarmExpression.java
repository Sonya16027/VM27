...
public class AndAlarmExpression  extends com.vmware.vim.AlarmExpression  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AndAlarmExpression"));
