...
public class VirtualDiskFlatVer1BackingOption  extends com.vmware.vim.VirtualDeviceFileBackingOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDiskFlatVer1BackingOption"));
