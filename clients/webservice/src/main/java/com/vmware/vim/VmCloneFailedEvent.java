...
public class VmCloneFailedEvent  extends com.vmware.vim.VmCloneEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmCloneFailedEvent"));
