...
public class HostVirtualSwitchConfig  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostVirtualSwitchConfig"));
