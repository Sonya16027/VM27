...
public class TraversalSpec  extends com.vmware.vim.sms.SelectionSpec  implements java.io.Serializable {
    ...
    private com.vmware.vim.sms.SelectionSpec[] selectSet;
    ...
    public TraversalSpec(
           ...
           com.vmware.vim.sms.SelectionSpec[] selectSet) {
        super(
            dynamicType,
            dynamicProperty,
            name);
     ...
     * @return selectSet
     */
    public com.vmware.vim.sms.SelectionSpec[] getSelectSet() {
        return selectSet;
    }
     ...
     * @param selectSet
     */
    public void setSelectSet(com.vmware.vim.sms.SelectionSpec[] selectSet) {
        this.selectSet = selectSet;
    }

    public com.vmware.vim.sms.SelectionSpec getSelectSet(int i) {
        return this.selectSet[i];
    }

    public void setSelectSet(int i, com.vmware.vim.sms.SelectionSpec _value) {
        this.selectSet[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TraversalSpec)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TraversalSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "TraversalSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "skip"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "selectSet"));
