...
public class ArrayOfHostVirtualNic  implements java.io.Serializable {
    ...
    public ArrayOfHostVirtualNic(
           com.vmware.vim.HostVirtualNic[] hostVirtualNic) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostVirtualNic"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostVirtualNic");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostVirtualNic"));
