...
public class HostScsiTopologyTarget  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private int target;

    private com.vmware.vim.HostScsiTopologyLun[] lun;
    ...
    public HostScsiTopologyTarget(
           ...
           int target,
           com.vmware.vim.HostScsiTopologyLun[] lun,
     ...
     * @return lun
     */
    public com.vmware.vim.HostScsiTopologyLun[] getLun() {
        return lun;
    }
     ...
     * @param lun
     */
    public void setLun(com.vmware.vim.HostScsiTopologyLun[] lun) {
        this.lun = lun;
    }

    public com.vmware.vim.HostScsiTopologyLun getLun(int i) {
        return this.lun[i];
    }

    public void setLun(int i, com.vmware.vim.HostScsiTopologyLun _value) {
        this.lun[i] = _value;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostScsiTopologyTarget)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostScsiTopologyTarget.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostScsiTopologyTarget"));
