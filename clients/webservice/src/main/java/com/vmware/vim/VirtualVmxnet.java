...
public class VirtualVmxnet  extends com.vmware.vim.VirtualEthernetCard  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualVmxnet"));
    }
