...
public class CreateScheduledTask  implements java.io.Serializable {
    private com.vmware.vim.ManagedObjectReference _this;

    private com.vmware.vim.ManagedObjectReference entity;

    private com.vmware.vim.ScheduledTaskSpec spec;
    ...
    /**
     * Gets the _this value for this CreateScheduledTask.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this CreateScheduledTask.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the entity value for this CreateScheduledTask.
     * 
     * @return entity
     */
    ...
    /**
     * Sets the entity value for this CreateScheduledTask.
     * 
     * @param entity
     */
    ...
    /**
     * Gets the spec value for this CreateScheduledTask.
     * 
     * @return spec
     */
    public com.vmware.vim.ScheduledTaskSpec getSpec() {
        return spec;
    }


    /**
     * Sets the spec value for this CreateScheduledTask.
     * 
     * @param spec
     */
    public void setSpec(com.vmware.vim.ScheduledTaskSpec spec) {
        this.spec = spec;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateScheduledTask)) return false;
        CreateScheduledTask other = (CreateScheduledTask) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateScheduledTask.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">CreateScheduledTask"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskSpec"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
