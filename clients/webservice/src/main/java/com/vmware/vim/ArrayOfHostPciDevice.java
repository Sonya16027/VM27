...
public class ArrayOfHostPciDevice  implements java.io.Serializable {
    ...
    public ArrayOfHostPciDevice(
           com.vmware.vim.HostPciDevice[] hostPciDevice) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostPciDevice"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostPciDevice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostPciDevice"));
