...
public class ScheduledTaskEvent  extends com.vmware.vim.Event  implements java.io.Serializable {
     ...
     * @param scheduledTask
     */
    public void setScheduledTask(com.vmware.vim.ScheduledTaskEventArgument scheduledTask) {
        this.scheduledTask = scheduledTask;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskEvent"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskEventArgument"));
