...
public class HostNetworkConfigResult  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public HostNetworkConfigResult(
           ...
           java.lang.String[] consoleVnicDevice) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostNetworkConfigResult)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.vnicDevice==null && other.getVnicDevice()==null) || 
             (this.vnicDevice!=null &&
              java.util.Arrays.equals(this.vnicDevice, other.getVnicDevice()))) &&
            ((this.consoleVnicDevice==null && other.getConsoleVnicDevice()==null) || 
             (this.consoleVnicDevice!=null &&
              java.util.Arrays.equals(this.consoleVnicDevice, other.getConsoleVnicDevice())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getVnicDevice() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getVnicDevice());
                 i++) {
        ...
        if (getConsoleVnicDevice() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getConsoleVnicDevice());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostNetworkConfigResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostNetworkConfigResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("vnicDevice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "vnicDevice"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "consoleVnicDevice"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
