...
public class VirtualDiskSparseVer2BackingInfo  extends com.vmware.vim.VirtualDeviceFileBackingInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDiskSparseVer2BackingInfo"));
