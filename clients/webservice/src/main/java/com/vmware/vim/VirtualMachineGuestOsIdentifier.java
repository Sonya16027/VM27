...
public class VirtualMachineGuestOsIdentifier implements java.io.Serializable {
	...
	public static final VirtualMachineGuestOsIdentifier sjdsGuest = new VirtualMachineGuestOsIdentifier(
			_sjdsGuest);
	public static final VirtualMachineGuestOsIdentifier mandrakeGuest = new VirtualMachineGuestOsIdentifier(
			_mandrakeGuest);
	public static final VirtualMachineGuestOsIdentifier mandrake64Guest = new VirtualMachineGuestOsIdentifier(
			_mandrake64Guest);
