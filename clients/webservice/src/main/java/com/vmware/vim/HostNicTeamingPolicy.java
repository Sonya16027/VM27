...
public class HostNicTeamingPolicy  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.vim.HostNicFailureCriteria failureCriteria;

    private com.vmware.vim.HostNicOrderPolicy nicOrder;
    ...
    public HostNicTeamingPolicy(
           ...
           com.vmware.vim.HostNicFailureCriteria failureCriteria,
           com.vmware.vim.HostNicOrderPolicy nicOrder) {
        super(
            dynamicType,
            dynamicProperty);
        this.policy = policy;
     ...
     */
    public com.vmware.vim.HostNicFailureCriteria getFailureCriteria() {
        return failureCriteria;
    }
     ...
     */
    public void setFailureCriteria(com.vmware.vim.HostNicFailureCriteria failureCriteria) {
        this.failureCriteria = failureCriteria;
    }
     ...
     * @return nicOrder
     */
    public com.vmware.vim.HostNicOrderPolicy getNicOrder() {
        return nicOrder;
    }
     ...
     * @param nicOrder
     */
    public void setNicOrder(com.vmware.vim.HostNicOrderPolicy nicOrder) {
        this.nicOrder = nicOrder;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostNicTeamingPolicy"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "reversePolicy"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "notifySwitches"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "rollingOrder"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "failureCriteria"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostNicFailureCriteria"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nicOrder");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "nicOrder"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostNicOrderPolicy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
