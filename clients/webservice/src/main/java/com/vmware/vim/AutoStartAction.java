...
public class AutoStartAction implements java.io.Serializable {
	...
	public static final AutoStartAction systemDefault = new AutoStartAction(
			_systemDefault);
	public static final AutoStartAction powerOn = new AutoStartAction(_powerOn);
	public static final AutoStartAction powerOff = new AutoStartAction(
			_powerOff);
	public static final AutoStartAction guestShutdown = new AutoStartAction(
			_guestShutdown);
	...
	public static AutoStartAction fromValue(java.lang.String value)
		...
		AutoStartAction enumeration = (AutoStartAction) _table_.get(value);
		if (enumeration == null) {
