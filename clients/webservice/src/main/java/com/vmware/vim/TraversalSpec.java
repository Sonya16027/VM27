...
public class TraversalSpec  extends com.vmware.vim.SelectionSpec  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "TraversalSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "selectSet"));
