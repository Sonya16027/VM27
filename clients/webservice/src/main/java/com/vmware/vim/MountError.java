...
public class MountError  extends com.vmware.vim.CustomizationFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "MountError"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "diskIndex"));
