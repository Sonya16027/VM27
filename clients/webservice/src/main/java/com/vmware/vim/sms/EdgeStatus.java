...
public class EdgeStatus implements java.io.Serializable {
    ...
    public static EdgeStatus fromValue(java.lang.String value)
        ...
        EdgeStatus enumeration = (EdgeStatus)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EdgeStatus.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "EdgeStatus"));
    }
    /**
