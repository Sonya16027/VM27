...
public class NodeProperty  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this NodeProperty.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this NodeProperty.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "NodeProperty"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "value"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
