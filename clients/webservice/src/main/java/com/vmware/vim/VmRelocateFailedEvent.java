...
public class VmRelocateFailedEvent  extends com.vmware.vim.VmRelocateSpecEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmRelocateFailedEvent"));
