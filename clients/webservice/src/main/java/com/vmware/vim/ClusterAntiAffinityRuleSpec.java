...
public class ClusterAntiAffinityRuleSpec  extends com.vmware.vim.ClusterRuleInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterAntiAffinityRuleSpec"));
