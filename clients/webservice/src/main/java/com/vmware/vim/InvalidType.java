...
public class InvalidType  extends com.vmware.vim.InvalidRequest  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "InvalidType"));
