...
public class ArrayOfHostVirtualSwitch  implements java.io.Serializable {
     ...
     */
    public void setHostVirtualSwitch(com.vmware.vim.HostVirtualSwitch[] hostVirtualSwitch) {
        this.hostVirtualSwitch = hostVirtualSwitch;
    }
    ...
    public void setHostVirtualSwitch(int i, com.vmware.vim.HostVirtualSwitch _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostVirtualSwitch"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostVirtualSwitch");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostVirtualSwitch"));
