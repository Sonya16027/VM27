...
public class HostDiskPartitionSpec  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.HostDiskDimensionsChs chs;

    private java.lang.Long totalSectors;

    private com.vmware.vim.HostDiskPartitionAttributes[] partition;
    ...
    public HostDiskPartitionSpec(
           ...
           com.vmware.vim.HostDiskDimensionsChs chs,
           java.lang.Long totalSectors,
           com.vmware.vim.HostDiskPartitionAttributes[] partition) {
        super(
            dynamicType,
            dynamicProperty);
        this.chs = chs;
     ...
     * @return chs
     */
    public com.vmware.vim.HostDiskDimensionsChs getChs() {
        return chs;
    }
     ...
     * @param chs
     */
    public void setChs(com.vmware.vim.HostDiskDimensionsChs chs) {
        this.chs = chs;
    }
     ...
     * @return partition
     */
    public com.vmware.vim.HostDiskPartitionAttributes[] getPartition() {
        return partition;
    }
     ...
     * @param partition
     */
    public void setPartition(com.vmware.vim.HostDiskPartitionAttributes[] partition) {
        this.partition = partition;
    }

    public com.vmware.vim.HostDiskPartitionAttributes getPartition(int i) {
        return this.partition[i];
    }

    public void setPartition(int i, com.vmware.vim.HostDiskPartitionAttributes _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskPartitionSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("chs");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "chs"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskDimensionsChs"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("totalSectors");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "totalSectors"));
