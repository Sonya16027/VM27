...
public class VirtualHardwareOption extends com.vmware.vim.DynamicData implements
	...
	public VirtualHardwareOption(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty, int hwVersion,
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "numCPU"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "int"));
		elemField.setNillable(false);
		elemField.setMaxOccursUnbounded(true);
