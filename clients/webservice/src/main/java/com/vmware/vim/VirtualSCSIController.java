...
public class VirtualSCSIController  extends com.vmware.vim.VirtualController  implements java.io.Serializable {
    private java.lang.Boolean hotAddRemove;

    private com.vmware.vim.VirtualSCSISharing sharedBus;
    ...
    public VirtualSCSIController(
           ...
           int busNumber,
           int[] device,
           java.lang.Boolean hotAddRemove,
           com.vmware.vim.VirtualSCSISharing sharedBus,
     ...
     * @return sharedBus
     */
    public com.vmware.vim.VirtualSCSISharing getSharedBus() {
        return sharedBus;
    }
     ...
     * @param sharedBus
     */
    public void setSharedBus(com.vmware.vim.VirtualSCSISharing sharedBus) {
        this.sharedBus = sharedBus;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualSCSIController)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.sharedBus==null && other.getSharedBus()==null) || 
             (this.sharedBus!=null &&
              this.sharedBus.equals(other.getSharedBus()))) &&
            ((this.scsiCtlrUnitNumber==null && other.getScsiCtlrUnitNumber()==null) || 
             (this.scsiCtlrUnitNumber!=null &&
              this.scsiCtlrUnitNumber.equals(other.getScsiCtlrUnitNumber())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualSCSIController.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualSCSIController"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hotAddRemove");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "hotAddRemove"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "sharedBus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualSCSISharing"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("scsiCtlrUnitNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "scsiCtlrUnitNumber"));
