...
public class ScheduledTaskEventArgument  extends com.vmware.vim.EntityEventArgument  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskEventArgument"));
