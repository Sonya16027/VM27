...
public class HostAddFailedEvent  extends com.vmware.vim.HostEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostAddFailedEvent"));
