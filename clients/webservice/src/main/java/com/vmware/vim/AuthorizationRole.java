...
public class AuthorizationRole  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int roleId;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AuthorizationRole"));
