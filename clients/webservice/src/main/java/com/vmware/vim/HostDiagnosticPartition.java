...
public class HostDiagnosticPartition extends com.vmware.vim.DynamicData
	...
	public HostDiagnosticPartition(java.lang.String dynamicType,
			...
			int slots, com.vmware.vim.HostScsiDiskPartition id) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "slots"));
		elemField.setXmlType(new javax.xml.namespace.QName(
