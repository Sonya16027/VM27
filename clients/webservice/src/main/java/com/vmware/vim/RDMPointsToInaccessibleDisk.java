...
public class RDMPointsToInaccessibleDisk  extends com.vmware.vim.CannotAccessVmDisk  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "RDMPointsToInaccessibleDisk"));
    }
