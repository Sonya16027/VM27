...
public class ArrayOfPropertyChange  implements java.io.Serializable {
     ...
     */
    public void setPropertyChange(com.vmware.vim.sms.PropertyChange[] propertyChange) {
        this.propertyChange = propertyChange;
    }
    ...
    public void setPropertyChange(int i, com.vmware.vim.sms.PropertyChange _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ArrayOfPropertyChange"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertyChange");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "PropertyChange"));
