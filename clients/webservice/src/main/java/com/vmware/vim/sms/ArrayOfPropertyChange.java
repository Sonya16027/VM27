...
public class ArrayOfPropertyChange implements java.io.Serializable {
	...
	private com.vmware.vim.sms.PropertyChange[] propertyChange;

	public ArrayOfPropertyChange() {
	}

	public ArrayOfPropertyChange(
			com.vmware.vim.sms.PropertyChange[] propertyChange) {
	 ...
	 */
	public com.vmware.vim.sms.PropertyChange[] getPropertyChange() {
		return propertyChange;
	}
	...
	public com.vmware.vim.sms.PropertyChange getPropertyChange(int i) {
		return this.propertyChange[i];
	}

	public void setPropertyChange(int i,
			com.vmware.vim.sms.PropertyChange _value) {
