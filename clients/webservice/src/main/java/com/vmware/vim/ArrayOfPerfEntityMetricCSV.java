...
public class ArrayOfPerfEntityMetricCSV implements java.io.Serializable {
	 ...
	 */
	public void setPerfEntityMetricCSV(
			com.vmware.vim.PerfEntityMetricCSV[] perfEntityMetricCSV) {
		this.perfEntityMetricCSV = perfEntityMetricCSV;
	}
	...
	public void setPerfEntityMetricCSV(int i,
			com.vmware.vim.PerfEntityMetricCSV _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfPerfEntityMetricCSV)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.perfEntityMetricCSV == null && other
				.getPerfEntityMetricCSV() == null) || (this.perfEntityMetricCSV != null && java.util.Arrays
				.equals(this.perfEntityMetricCSV, other
						.getPerfEntityMetricCSV())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPerfEntityMetricCSV() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPerfEntityMetricCSV()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getPerfEntityMetricCSV(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfPerfEntityMetricCSV.class, true);
