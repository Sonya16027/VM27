...
public class VirtualMachineDiskDeviceInfo  extends com.vmware.vim.VirtualMachineTargetInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineDiskDeviceInfo"));
