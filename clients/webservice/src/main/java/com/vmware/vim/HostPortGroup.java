...
public class HostPortGroup  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private com.vmware.vim.HostPortGroupPort[] port;

    private java.lang.String vswitch;

    private com.vmware.vim.HostNetworkPolicy computedPolicy;
    ...
    public HostPortGroup(
           ...
           com.vmware.vim.HostPortGroupPort[] port,
           java.lang.String vswitch,
           com.vmware.vim.HostNetworkPolicy computedPolicy,
     ...
     * @return port
     */
    public com.vmware.vim.HostPortGroupPort[] getPort() {
        return port;
    }
     ...
     * @param port
     */
    public void setPort(com.vmware.vim.HostPortGroupPort[] port) {
        this.port = port;
    }

    public com.vmware.vim.HostPortGroupPort getPort(int i) {
        return this.port[i];
    }

    public void setPort(int i, com.vmware.vim.HostPortGroupPort _value) {
        this.port[i] = _value;
    }
     ...
     */
    public com.vmware.vim.HostNetworkPolicy getComputedPolicy() {
        return computedPolicy;
    }
     ...
     */
    public void setComputedPolicy(com.vmware.vim.HostNetworkPolicy computedPolicy) {
        this.computedPolicy = computedPolicy;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostPortGroup"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostPortGroupPort"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "computedPolicy"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostNetworkPolicy"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("spec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "spec"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostPortGroupSpec"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
