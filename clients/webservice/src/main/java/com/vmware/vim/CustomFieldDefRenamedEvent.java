...
public class CustomFieldDefRenamedEvent  extends com.vmware.vim.CustomFieldDefEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomFieldDefRenamedEvent"));
