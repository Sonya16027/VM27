...
public class DasConfigFault  extends com.vmware.vim.VimFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DasConfigFault"));
    }
