...
public class IntOption  extends com.vmware.vim.OptionType  implements java.io.Serializable {
    private int min;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "IntOption"));
