...
public class UpdateServicePolicy implements java.io.Serializable {
	...
	public UpdateServicePolicy(com.vmware.vim.ManagedObjectReference _this,
			java.lang.String id, java.lang.String policy) {
		this._this = _this;
		this.id = id;
		this.policy = policy;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof UpdateServicePolicy)) {
			return false;
		}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			UpdateServicePolicy.class, true);
