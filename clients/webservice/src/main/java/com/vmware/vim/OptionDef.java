...
public class OptionDef  extends com.vmware.vim.ElementDescription  implements java.io.Serializable {
    ...
    public OptionDef(
           ...
           com.vmware.vim.OptionType optionType) {
        super(
            dynamicType,
            dynamicProperty,
            label,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "OptionDef"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("optionType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "optionType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "OptionType"));
