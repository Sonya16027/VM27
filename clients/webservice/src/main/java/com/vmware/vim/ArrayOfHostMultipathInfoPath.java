...
public class ArrayOfHostMultipathInfoPath  implements java.io.Serializable {
     ...
     */
    public void setHostMultipathInfoPath(com.vmware.vim.HostMultipathInfoPath[] hostMultipathInfoPath) {
        this.hostMultipathInfoPath = hostMultipathInfoPath;
    }
    ...
    public void setHostMultipathInfoPath(int i, com.vmware.vim.HostMultipathInfoPath _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostMultipathInfoPath"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostMultipathInfoPath");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostMultipathInfoPath"));
