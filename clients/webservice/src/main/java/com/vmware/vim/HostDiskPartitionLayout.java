...
public class HostDiskPartitionLayout  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     * @param partition
     */
    public void setPartition(com.vmware.vim.HostDiskPartitionBlockRange[] partition) {
        this.partition = partition;
    }
    ...
    public void setPartition(int i, com.vmware.vim.HostDiskPartitionBlockRange _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskPartitionLayout"));
