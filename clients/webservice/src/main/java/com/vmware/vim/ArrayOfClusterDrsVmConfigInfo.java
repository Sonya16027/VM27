...
public class ArrayOfClusterDrsVmConfigInfo  implements java.io.Serializable {
     ...
     */
    public void setClusterDrsVmConfigInfo(com.vmware.vim.ClusterDrsVmConfigInfo[] clusterDrsVmConfigInfo) {
        this.clusterDrsVmConfigInfo = clusterDrsVmConfigInfo;
    }
    ...
    public void setClusterDrsVmConfigInfo(int i, com.vmware.vim.ClusterDrsVmConfigInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfClusterDrsVmConfigInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("clusterDrsVmConfigInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ClusterDrsVmConfigInfo"));
