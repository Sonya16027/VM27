...
public class HostCpuIdInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int level;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostCpuIdInfo"));
