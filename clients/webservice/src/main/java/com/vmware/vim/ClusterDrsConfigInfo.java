...
public class ClusterDrsConfigInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setDefaultVmBehavior(com.vmware.vim.DrsBehavior defaultVmBehavior) {
        this.defaultVmBehavior = defaultVmBehavior;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDrsConfigInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "defaultVmBehavior"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "vmotionRate"));
