...
public class ArrayOfHostCpuPackage  implements java.io.Serializable {
    ...
    public ArrayOfHostCpuPackage(
           com.vmware.vim.HostCpuPackage[] hostCpuPackage) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostCpuPackage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostCpuPackage");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostCpuPackage"));
