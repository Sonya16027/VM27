...
public class ArrayOfAnyType implements java.io.Serializable {
	...
	public ArrayOfAnyType(java.lang.Object[] anyType) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.anyType == null && other.getAnyType() == null) || (this.anyType != null && java.util.Arrays
				.equals(this.anyType, other.getAnyType())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (getAnyType() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getAnyType()); i++) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:sm1", "anyType"));
