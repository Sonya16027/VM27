...
public class ResourcePoolEvent  extends com.vmware.vim.Event  implements java.io.Serializable {
     ...
     * @param resourcePool
     */
    public void setResourcePool(com.vmware.vim.ResourcePoolEventArgument resourcePool) {
        this.resourcePool = resourcePool;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ResourcePoolEvent"));
