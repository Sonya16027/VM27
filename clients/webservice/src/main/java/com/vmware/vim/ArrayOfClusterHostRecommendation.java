...
public class ArrayOfClusterHostRecommendation  implements java.io.Serializable {
     ...
     */
    public void setClusterHostRecommendation(com.vmware.vim.ClusterHostRecommendation[] clusterHostRecommendation) {
        this.clusterHostRecommendation = clusterHostRecommendation;
    }

    public com.vmware.vim.ClusterHostRecommendation getClusterHostRecommendation(int i) {
        return this.clusterHostRecommendation[i];
    }

    public void setClusterHostRecommendation(int i, com.vmware.vim.ClusterHostRecommendation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfClusterHostRecommendation"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("clusterHostRecommendation");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ClusterHostRecommendation"));
