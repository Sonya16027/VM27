...
public class TaskEvent  extends com.vmware.vim.Event  implements java.io.Serializable {
    private com.vmware.vim.TaskInfo info;
     ...
     * @return info
     */
    public com.vmware.vim.TaskInfo getInfo() {
        return info;
    }
     ...
     * @param info
     */
    public void setInfo(com.vmware.vim.TaskInfo info) {
        this.info = info;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "TaskEvent"));
