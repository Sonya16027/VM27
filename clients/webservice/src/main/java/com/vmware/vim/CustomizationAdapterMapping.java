...
public class CustomizationAdapterMapping  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.String macAddress;

    private com.vmware.vim.CustomizationIPSettings adapter;
    ...
    public CustomizationAdapterMapping(
           ...
           com.vmware.vim.CustomizationIPSettings adapter) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return adapter
     */
    public com.vmware.vim.CustomizationIPSettings getAdapter() {
        return adapter;
    }
     ...
     * @param adapter
     */
    public void setAdapter(com.vmware.vim.CustomizationIPSettings adapter) {
        this.adapter = adapter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomizationAdapterMapping"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("macAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "macAddress"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomizationIPSettings"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
