...
public class VirtualMachineConfigInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setDefaultPowerOps(com.vmware.vim.VirtualMachineDefaultPowerOpInfo defaultPowerOps) {
        this.defaultPowerOps = defaultPowerOps;
    }
     ...
     * @param datastoreUrl
     */
    public void setDatastoreUrl(com.vmware.vim.VirtualMachineConfigInfoDatastoreUrlPair[] datastoreUrl) {
        this.datastoreUrl = datastoreUrl;
    }

    public com.vmware.vim.VirtualMachineConfigInfoDatastoreUrlPair getDatastoreUrl(int i) {
        return this.datastoreUrl[i];
    }

    public void setDatastoreUrl(int i, com.vmware.vim.VirtualMachineConfigInfoDatastoreUrlPair _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineConfigInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "modified"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "defaultPowerOps"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualHardware"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "datastoreUrl"));
