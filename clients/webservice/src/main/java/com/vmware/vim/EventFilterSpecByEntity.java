...
public class EventFilterSpecByEntity  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.ManagedObjectReference entity;

    private com.vmware.vim.EventFilterSpecRecursionOption recursion;
    ...
    public EventFilterSpecByEntity(
           ...
           com.vmware.vim.EventFilterSpecRecursionOption recursion) {
        super(
            dynamicType,
            dynamicProperty);
        this.entity = entity;
     ...
     * @return recursion
     */
    public com.vmware.vim.EventFilterSpecRecursionOption getRecursion() {
        return recursion;
    }
     ...
     * @param recursion
     */
    public void setRecursion(com.vmware.vim.EventFilterSpecRecursionOption recursion) {
        this.recursion = recursion;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EventFilterSpecByEntity)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EventFilterSpecByEntity.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "EventFilterSpecByEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "EventFilterSpecRecursionOption"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
