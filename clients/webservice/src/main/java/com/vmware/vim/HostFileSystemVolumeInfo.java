...
public class HostFileSystemVolumeInfo extends com.vmware.vim.DynamicData
	...
	private com.vmware.vim.HostFileSystemMountInfo[] mountInfo;

	public HostFileSystemVolumeInfo() {
	}

	public HostFileSystemVolumeInfo(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty,
			java.lang.String[] volumeTypeList,
			com.vmware.vim.HostFileSystemMountInfo[] mountInfo) {
	 ...
	 * @return mountInfo
	 */
	public com.vmware.vim.HostFileSystemMountInfo[] getMountInfo() {
		return mountInfo;
	}
	 ...
	 * @param mountInfo
	 */
	public void setMountInfo(com.vmware.vim.HostFileSystemMountInfo[] mountInfo) {
		this.mountInfo = mountInfo;
	}

	public com.vmware.vim.HostFileSystemMountInfo getMountInfo(int i) {
		return this.mountInfo[i];
	}

	public void setMountInfo(int i,
			com.vmware.vim.HostFileSystemMountInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.volumeTypeList == null && other.getVolumeTypeList() == null) || (this.volumeTypeList != null && java.util.Arrays
						.equals(this.volumeTypeList, other.getVolumeTypeList())))
				&& ((this.mountInfo == null && other.getMountInfo() == null) || (this.mountInfo != null && java.util.Arrays
						.equals(this.mountInfo, other.getMountInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostFileSystemVolumeInfo.class, true);
