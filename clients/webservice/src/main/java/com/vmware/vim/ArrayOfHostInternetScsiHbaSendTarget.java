...
public class ArrayOfHostInternetScsiHbaSendTarget  implements java.io.Serializable {
     ...
     */
    public void setHostInternetScsiHbaSendTarget(com.vmware.vim.HostInternetScsiHbaSendTarget[] hostInternetScsiHbaSendTarget) {
        this.hostInternetScsiHbaSendTarget = hostInternetScsiHbaSendTarget;
    }

    public com.vmware.vim.HostInternetScsiHbaSendTarget getHostInternetScsiHbaSendTarget(int i) {
        return this.hostInternetScsiHbaSendTarget[i];
    }

    public void setHostInternetScsiHbaSendTarget(int i, com.vmware.vim.HostInternetScsiHbaSendTarget _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostInternetScsiHbaSendTarget"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostInternetScsiHbaSendTarget");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostInternetScsiHbaSendTarget"));
