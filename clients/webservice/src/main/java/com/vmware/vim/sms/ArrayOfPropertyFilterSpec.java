...
public class ArrayOfPropertyFilterSpec implements java.io.Serializable {
	...
	private com.vmware.vim.sms.PropertyFilterSpec[] propertyFilterSpec;

	public ArrayOfPropertyFilterSpec() {
	}

	public ArrayOfPropertyFilterSpec(
			com.vmware.vim.sms.PropertyFilterSpec[] propertyFilterSpec) {
	 ...
	 */
	public com.vmware.vim.sms.PropertyFilterSpec[] getPropertyFilterSpec() {
		return propertyFilterSpec;
	}
	 ...
	 */
	public void setPropertyFilterSpec(
			com.vmware.vim.sms.PropertyFilterSpec[] propertyFilterSpec) {
		this.propertyFilterSpec = propertyFilterSpec;
	}

	public com.vmware.vim.sms.PropertyFilterSpec getPropertyFilterSpec(int i) {
		return this.propertyFilterSpec[i];
	}

	public void setPropertyFilterSpec(int i,
			com.vmware.vim.sms.PropertyFilterSpec _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfPropertyFilterSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.propertyFilterSpec == null && other
				.getPropertyFilterSpec() == null) || (this.propertyFilterSpec != null && java.util.Arrays
				.equals(this.propertyFilterSpec, other.getPropertyFilterSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPropertyFilterSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPropertyFilterSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getPropertyFilterSpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfPropertyFilterSpec.class, true);
