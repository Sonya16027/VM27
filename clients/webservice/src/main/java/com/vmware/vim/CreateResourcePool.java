...
public class CreateResourcePool implements java.io.Serializable {
	...
	public CreateResourcePool(com.vmware.vim.ManagedObjectReference _this,
			java.lang.String name, com.vmware.vim.ResourceConfigSpec spec) {
		this._this = _this;
		this.name = name;
		this.spec = spec;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CreateResourcePool)) {
			return false;
		}
