...
public class ArrayOfHostFirewallRule  implements java.io.Serializable {
    private com.vmware.vim.HostFirewallRule[] hostFirewallRule;

    public ArrayOfHostFirewallRule() {
    }

    public ArrayOfHostFirewallRule(
           com.vmware.vim.HostFirewallRule[] hostFirewallRule) {
     ...
     */
    public com.vmware.vim.HostFirewallRule[] getHostFirewallRule() {
        return hostFirewallRule;
    }
     ...
     */
    public void setHostFirewallRule(com.vmware.vim.HostFirewallRule[] hostFirewallRule) {
        this.hostFirewallRule = hostFirewallRule;
    }

    public com.vmware.vim.HostFirewallRule getHostFirewallRule(int i) {
        return this.hostFirewallRule[i];
    }

    public void setHostFirewallRule(int i, com.vmware.vim.HostFirewallRule _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostFirewallRule"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostFirewallRule");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostFirewallRule"));
