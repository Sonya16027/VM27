...
public class ArrayOfManagedObjectReference  implements java.io.Serializable {
     ...
     */
    public void setManagedObjectReference(com.vmware.vim.sms.ManagedObjectReference[] managedObjectReference) {
        this.managedObjectReference = managedObjectReference;
    }

    public com.vmware.vim.sms.ManagedObjectReference getManagedObjectReference(int i) {
        return this.managedObjectReference[i];
    }

    public void setManagedObjectReference(int i, com.vmware.vim.sms.ManagedObjectReference _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ArrayOfManagedObjectReference"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("managedObjectReference");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "ManagedObjectReference"));
