...
public class ArrayOfManagedObjectReference implements java.io.Serializable {
	...
	private com.vmware.vim.sms.ManagedObjectReference[] managedObjectReference;

	public ArrayOfManagedObjectReference() {
	}

	public ArrayOfManagedObjectReference(
			com.vmware.vim.sms.ManagedObjectReference[] managedObjectReference) {
	 ...
	 */
	public com.vmware.vim.sms.ManagedObjectReference[] getManagedObjectReference() {
		return managedObjectReference;
	}
	...
	public void setManagedObjectReference(int i,
			com.vmware.vim.sms.ManagedObjectReference _value) {
