...
public class ArrayOfVirtualMachineFileLayoutSnapshotLayout  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineFileLayoutSnapshotLayout(com.vmware.vim.VirtualMachineFileLayoutSnapshotLayout[] virtualMachineFileLayoutSnapshotLayout) {
        this.virtualMachineFileLayoutSnapshotLayout = virtualMachineFileLayoutSnapshotLayout;
    }

    public com.vmware.vim.VirtualMachineFileLayoutSnapshotLayout getVirtualMachineFileLayoutSnapshotLayout(int i) {
        return this.virtualMachineFileLayoutSnapshotLayout[i];
    }

    public void setVirtualMachineFileLayoutSnapshotLayout(int i, com.vmware.vim.VirtualMachineFileLayoutSnapshotLayout _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineFileLayoutSnapshotLayout"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineFileLayoutSnapshotLayout");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineFileLayoutSnapshotLayout"));
