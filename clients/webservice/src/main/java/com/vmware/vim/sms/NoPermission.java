...
public class NoPermission  extends com.vmware.vim.sms.AuthenticationFailed  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "NoPermission"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "privilegeId"));
