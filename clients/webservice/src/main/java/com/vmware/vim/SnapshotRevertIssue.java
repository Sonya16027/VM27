...
public class SnapshotRevertIssue extends com.vmware.vim.MigrationFault
	...
	public SnapshotRevertIssue(java.lang.String dynamicType,
			...
			java.lang.String snapshotName, com.vmware.vim.Event[] event,
			boolean errors) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "errors"));
		elemField.setXmlType(new javax.xml.namespace.QName(
