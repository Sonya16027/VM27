...
public class ArrayOfObjectUpdate  implements java.io.Serializable {
    ...
    public ArrayOfObjectUpdate(
           com.vmware.vim.ObjectUpdate[] objectUpdate) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfObjectUpdate"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("objectUpdate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ObjectUpdate"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ObjectUpdate"));
