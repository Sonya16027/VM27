...
public class VirtualDeviceConfigSpec  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     * @param operation
     */
    public void setOperation(com.vmware.vim.VirtualDeviceConfigSpecOperation operation) {
        this.operation = operation;
    }
     ...
     * @param fileOperation
     */
    public void setFileOperation(com.vmware.vim.VirtualDeviceConfigSpecFileOperation fileOperation) {
        this.fileOperation = fileOperation;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceConfigSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "fileOperation"));
