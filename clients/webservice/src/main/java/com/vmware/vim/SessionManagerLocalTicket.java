...
public class SessionManagerLocalTicket  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "SessionManagerLocalTicket"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "passwordFilePath"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
