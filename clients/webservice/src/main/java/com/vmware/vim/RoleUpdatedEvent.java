...
public class RoleUpdatedEvent  extends com.vmware.vim.RoleEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "RoleUpdatedEvent"));
