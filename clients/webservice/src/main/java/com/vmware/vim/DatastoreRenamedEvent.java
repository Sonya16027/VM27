...
public class DatastoreRenamedEvent  extends com.vmware.vim.DatastoreEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DatastoreRenamedEvent"));
