...
public class CurrentTime implements java.io.Serializable {
	...
	public CurrentTime(com.vmware.vim.ManagedObjectReference _this) {
		this._this = _this;
	}

	/**
	 * Gets the _this value for this CurrentTime.
	 * 
	 * @return _this
	 */
	...
	/**
	 * Sets the _this value for this CurrentTime.
	 * 
	 * @param _this
	 */
