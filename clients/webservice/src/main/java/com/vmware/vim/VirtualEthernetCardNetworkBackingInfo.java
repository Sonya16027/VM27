...
public class VirtualEthernetCardNetworkBackingInfo  extends com.vmware.vim.VirtualDeviceDeviceBackingInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualEthernetCardNetworkBackingInfo"));
