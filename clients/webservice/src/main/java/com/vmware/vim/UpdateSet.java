...
public class UpdateSet  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "UpdateSet"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "filterSet"));
