...
public class VirtualDeviceConnectInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualDeviceConnectInfo)) return false;
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isStartConnected() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        _hashCode += (isAllowGuestControl() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualDeviceConnectInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualDeviceConnectInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "connected"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
