...
public class VmConfigFileInfo  extends com.vmware.vim.FileInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VmConfigFileInfo"));
