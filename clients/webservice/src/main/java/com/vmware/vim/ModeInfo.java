...
public class ModeInfo extends com.vmware.vim.DynamicData implements
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "browse"));
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "admin"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
