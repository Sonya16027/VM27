...
public class HostDatastoreBrowserSearchResults  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.ManagedObjectReference datastore;

    private java.lang.String folderPath;

    private com.vmware.vim.FileInfo[] file;
     ...
     * @return file
     */
    public com.vmware.vim.FileInfo[] getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(com.vmware.vim.FileInfo[] file) {
        this.file = file;
    }

    public com.vmware.vim.FileInfo getFile(int i) {
        return this.file[i];
    }

    public void setFile(int i, com.vmware.vim.FileInfo _value) {
        this.file[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostDatastoreBrowserSearchResults)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostDatastoreBrowserSearchResults.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDatastoreBrowserSearchResults"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "folderPath"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "file"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "FileInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
