...
public class VimServiceLocator extends org.apache.axis.client.Service implements com.vmware.vim.VimService {
    ...
    public com.vmware.vim.VimPortType getVimPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vmware.vim.VimBindingStub _stub = new com.vmware.vim.VimBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vmware.vim.VimPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vmware.vim.VimBindingStub _stub = new com.vmware.vim.VimBindingStub(new java.net.URL(VimPort_address), this);
                _stub.setPortName(getVimPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:vim2Service", "VimService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:vim2Service", "VimPort"));
        }
