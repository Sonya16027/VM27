...
public class VimServiceLocator extends org.apache.axis.client.Service implements
	...
	public com.vmware.vim.VimPortType getVimPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			com.vmware.vim.VimBindingStub _stub = new com.vmware.vim.VimBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (com.vmware.vim.VimPortType.class
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("urn:vim2Service",
					"VimPort"));
		}
