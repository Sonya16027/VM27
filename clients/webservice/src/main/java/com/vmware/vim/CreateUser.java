...
public class CreateUser  implements java.io.Serializable {
    ...
    private com.vmware.vim.HostAccountSpec user;
    ...
    /**
     * Gets the _this value for this CreateUser.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this CreateUser.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the user value for this CreateUser.
     * 
     * @return user
     */
    public com.vmware.vim.HostAccountSpec getUser() {
        return user;
    }


    /**
     * Sets the user value for this CreateUser.
     * 
     * @param user
     */
    public void setUser(com.vmware.vim.HostAccountSpec user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">CreateUser"));
