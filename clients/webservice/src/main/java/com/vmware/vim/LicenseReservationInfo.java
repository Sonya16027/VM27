...
public class LicenseReservationInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private com.vmware.vim.LicenseReservationInfoState state;
    ...
    public LicenseReservationInfo(
           ...
           com.vmware.vim.LicenseReservationInfoState state,
           int required) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return state
     */
    public com.vmware.vim.LicenseReservationInfoState getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(com.vmware.vim.LicenseReservationInfoState state) {
        this.state = state;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "LicenseReservationInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "LicenseReservationInfoState"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
