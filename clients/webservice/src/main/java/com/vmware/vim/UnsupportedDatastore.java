...
public class UnsupportedDatastore  extends com.vmware.vim.VmConfigFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "UnsupportedDatastore"));
