...
public class TaskDescription  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.ElementDescription[] methodInfo;

    private com.vmware.vim.ElementDescription[] state;

    private com.vmware.vim.TypeDescription[] reason;
    ...
    public TaskDescription(
           ...
           com.vmware.vim.ElementDescription[] methodInfo,
           com.vmware.vim.ElementDescription[] state,
           com.vmware.vim.TypeDescription[] reason) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return methodInfo
     */
    public com.vmware.vim.ElementDescription[] getMethodInfo() {
        return methodInfo;
    }
     ...
     * @param methodInfo
     */
    public void setMethodInfo(com.vmware.vim.ElementDescription[] methodInfo) {
        this.methodInfo = methodInfo;
    }

    public com.vmware.vim.ElementDescription getMethodInfo(int i) {
        return this.methodInfo[i];
    }

    public void setMethodInfo(int i, com.vmware.vim.ElementDescription _value) {
     ...
     * @return reason
     */
    public com.vmware.vim.TypeDescription[] getReason() {
        return reason;
    }
     ...
     * @param reason
     */
    public void setReason(com.vmware.vim.TypeDescription[] reason) {
        this.reason = reason;
    }

    public com.vmware.vim.TypeDescription getReason(int i) {
        return this.reason[i];
    }

    public void setReason(int i, com.vmware.vim.TypeDescription _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "TaskDescription"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("methodInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "methodInfo"));
