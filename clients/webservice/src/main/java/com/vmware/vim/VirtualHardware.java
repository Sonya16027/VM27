...
public class VirtualHardware  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int numCPU;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualHardware"));
