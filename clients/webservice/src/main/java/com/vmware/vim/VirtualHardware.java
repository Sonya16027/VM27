...
public class VirtualHardware extends com.vmware.vim.DynamicData implements
	...
	public VirtualHardware(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty, int numCPU,
			int memoryMB, com.vmware.vim.VirtualDevice[] device) {
	...
	public com.vmware.vim.VirtualDevice getDevice(int i) {
		return this.device[i];
	}

	public void setDevice(int i, com.vmware.vim.VirtualDevice _value) {
