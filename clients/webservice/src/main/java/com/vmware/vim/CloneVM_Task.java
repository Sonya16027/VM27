...
public class CloneVM_Task  implements java.io.Serializable {
    ...
    public CloneVM_Task(
           ...
           com.vmware.vim.VirtualMachineCloneSpec spec) {
           this._this = _this;
           this.folder = folder;
           this.name = name;
           this.spec = spec;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CloneVM_Task)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CloneVM_Task.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">CloneVM_Task"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "folder"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ManagedObjectReference"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineCloneSpec"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
