...
public class ReadOnlyDisksWithLegacyDestination extends
	...
	public ReadOnlyDisksWithLegacyDestination(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty, int roDiskCount,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ReadOnlyDisksWithLegacyDestination)) {
			return false;
		}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isTimeoutDanger() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ReadOnlyDisksWithLegacyDestination.class, true);
