...
public class MismatchedNetworkPolicies  extends com.vmware.vim.MigrationFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "MismatchedNetworkPolicies"));
