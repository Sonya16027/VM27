...
public class ArrayOfVirtualMachineLegacyNetworkSwitchInfo  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineLegacyNetworkSwitchInfo(com.vmware.vim.VirtualMachineLegacyNetworkSwitchInfo[] virtualMachineLegacyNetworkSwitchInfo) {
        this.virtualMachineLegacyNetworkSwitchInfo = virtualMachineLegacyNetworkSwitchInfo;
    }

    public com.vmware.vim.VirtualMachineLegacyNetworkSwitchInfo getVirtualMachineLegacyNetworkSwitchInfo(int i) {
        return this.virtualMachineLegacyNetworkSwitchInfo[i];
    }

    public void setVirtualMachineLegacyNetworkSwitchInfo(int i, com.vmware.vim.VirtualMachineLegacyNetworkSwitchInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineLegacyNetworkSwitchInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineLegacyNetworkSwitchInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineLegacyNetworkSwitchInfo"));
