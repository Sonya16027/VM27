...
public class LicenseFeatureInfoState implements java.io.Serializable {
	...
	public static final LicenseFeatureInfoState enabled = new LicenseFeatureInfoState(
			_enabled);
	public static final LicenseFeatureInfoState disabled = new LicenseFeatureInfoState(
			_disabled);
	public static final LicenseFeatureInfoState optional = new LicenseFeatureInfoState(
			_optional);
	...
	public static LicenseFeatureInfoState fromValue(java.lang.String value)
		...
		LicenseFeatureInfoState enumeration = (LicenseFeatureInfoState) _table_
				.get(value);
		if (enumeration == null) {
