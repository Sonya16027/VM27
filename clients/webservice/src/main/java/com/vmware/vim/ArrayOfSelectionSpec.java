...
public class ArrayOfSelectionSpec  implements java.io.Serializable {
    ...
    public ArrayOfSelectionSpec(
           com.vmware.vim.SelectionSpec[] selectionSpec) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfSelectionSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("selectionSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "SelectionSpec"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "SelectionSpec"));
