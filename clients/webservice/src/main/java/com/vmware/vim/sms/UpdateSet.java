...
public class UpdateSet  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    private java.lang.String version;

    private com.vmware.vim.sms.PropertyFilterUpdate[] filterSet;
    ...
    public UpdateSet(
           ...
           com.vmware.vim.sms.PropertyFilterUpdate[] filterSet) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return filterSet
     */
    public com.vmware.vim.sms.PropertyFilterUpdate[] getFilterSet() {
        return filterSet;
    }
     ...
     * @param filterSet
     */
    public void setFilterSet(com.vmware.vim.sms.PropertyFilterUpdate[] filterSet) {
        this.filterSet = filterSet;
    }

    public com.vmware.vim.sms.PropertyFilterUpdate getFilterSet(int i) {
        return this.filterSet[i];
    }

    public void setFilterSet(int i, com.vmware.vim.sms.PropertyFilterUpdate _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "UpdateSet"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "filterSet"));
