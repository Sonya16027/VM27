...
public class AgentInstallFailed  extends com.vmware.vim.HostConnectFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AgentInstallFailed"));
    }
