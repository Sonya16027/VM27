...
public class MergePermissions implements java.io.Serializable {
	...
	public MergePermissions(com.vmware.vim.ManagedObjectReference _this,
			int srcRoleId, int dstRoleId) {
		this._this = _this;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MergePermissions)) {
			return false;
		}
