...
public class ArrayOfPropertyFilterUpdate  implements java.io.Serializable {
     ...
     */
    public void setPropertyFilterUpdate(com.vmware.vim.PropertyFilterUpdate[] propertyFilterUpdate) {
        this.propertyFilterUpdate = propertyFilterUpdate;
    }
    ...
    public void setPropertyFilterUpdate(int i, com.vmware.vim.PropertyFilterUpdate _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPropertyFilterUpdate"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertyFilterUpdate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PropertyFilterUpdate"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PropertyFilterUpdate"));
