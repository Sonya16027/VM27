...
public class PerfMetricId  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfMetricId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "instance"));
