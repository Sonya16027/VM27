...
public class PermissionUpdatedEvent  extends com.vmware.vim.PermissionEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PermissionUpdatedEvent"));
