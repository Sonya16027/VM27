...
public class InvalidDatastorePath  extends com.vmware.vim.InvalidDatastore  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "InvalidDatastorePath"));
