...
public class ClusterConfigSpec  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setDasVmConfigSpec(com.vmware.vim.ClusterDasVmConfigSpec[] dasVmConfigSpec) {
        this.dasVmConfigSpec = dasVmConfigSpec;
    }
    ...
    public void setDasVmConfigSpec(int i, com.vmware.vim.ClusterDasVmConfigSpec _value) {
     ...
     */
    public void setDrsVmConfigSpec(com.vmware.vim.ClusterDrsVmConfigSpec[] drsVmConfigSpec) {
        this.drsVmConfigSpec = drsVmConfigSpec;
    }
    ...
    public void setDrsVmConfigSpec(int i, com.vmware.vim.ClusterDrsVmConfigSpec _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClusterConfigSpec)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClusterConfigSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterConfigSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dasConfig");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "dasConfig"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDasConfigInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dasVmConfigSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "dasVmConfigSpec"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDasVmConfigSpec"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "drsConfig"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDrsConfigInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("drsVmConfigSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "drsVmConfigSpec"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterDrsVmConfigSpec"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "rulesSpec"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ClusterRuleSpec"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
