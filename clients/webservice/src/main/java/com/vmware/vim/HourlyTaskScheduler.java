...
public class HourlyTaskScheduler  extends com.vmware.vim.RecurrentTaskScheduler  implements java.io.Serializable {
    private int minute;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HourlyTaskScheduler"));
