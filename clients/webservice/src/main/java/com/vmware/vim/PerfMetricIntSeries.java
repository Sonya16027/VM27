...
public class PerfMetricIntSeries  extends com.vmware.vim.PerfMetricSeries  implements java.io.Serializable {
    private long[] value;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PerfMetricIntSeries"));
