...
public class ArrayOfHostScsiDisk  implements java.io.Serializable {
    ...
    public ArrayOfHostScsiDisk(
           com.vmware.vim.HostScsiDisk[] hostScsiDisk) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfHostScsiDisk"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostScsiDisk");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "HostScsiDisk"));
