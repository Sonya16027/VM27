...
public class VirtualUSB  extends com.vmware.vim.VirtualDevice  implements java.io.Serializable {
    public VirtualUSB() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualUSB"));
    }
