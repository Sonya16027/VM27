...
public class RoleEventArgument  extends com.vmware.vim.EventArgument  implements java.io.Serializable {
    private int roleId;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "RoleEventArgument"));
