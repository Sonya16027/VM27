...
public class ResourcePoolRuntimeInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.ResourcePoolResourceUsage memory;

    private com.vmware.vim.ResourcePoolResourceUsage cpu;
    ...
    public ResourcePoolRuntimeInfo(
           ...
           com.vmware.vim.ResourcePoolResourceUsage memory,
           com.vmware.vim.ResourcePoolResourceUsage cpu,
     ...
     * @return memory
     */
    public com.vmware.vim.ResourcePoolResourceUsage getMemory() {
        return memory;
    }
     ...
     * @param memory
     */
    public void setMemory(com.vmware.vim.ResourcePoolResourceUsage memory) {
        this.memory = memory;
    }
     ...
     * @return cpu
     */
    public com.vmware.vim.ResourcePoolResourceUsage getCpu() {
        return cpu;
    }
     ...
     * @param cpu
     */
    public void setCpu(com.vmware.vim.ResourcePoolResourceUsage cpu) {
        this.cpu = cpu;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResourcePoolRuntimeInfo)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResourcePoolRuntimeInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ResourcePoolRuntimeInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("memory");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "memory"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ResourcePoolResourceUsage"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cpu");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "cpu"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ResourcePoolResourceUsage"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
