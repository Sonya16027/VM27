...
public class VirtualMachineIdeDiskDevicePartitionInfo extends
	...
	public VirtualMachineIdeDiskDevicePartitionInfo(
			...
			com.vmware.vim.DynamicProperty[] dynamicProperty, int id,
			int capacity) {
	...
	/**
	 * Gets the capacity value for this
	...
	/**
	 * Sets the capacity value for this
	 * VirtualMachineIdeDiskDevicePartitionInfo.
	 * 
	 * @param capacity
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VirtualMachineIdeDiskDevicePartitionInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = super.equals(obj) && this.id == other.getId()
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualMachineIdeDiskDevicePartitionInfo.class, true);
