...
public class VirtualMachineIdeDiskDevicePartitionInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int id;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineIdeDiskDevicePartitionInfo"));
