...
public class UpdateUser  implements java.io.Serializable {
    ...
    /**
     * Gets the _this value for this UpdateUser.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this UpdateUser.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the user value for this UpdateUser.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this UpdateUser.
     * 
     * @param user
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">UpdateUser"));
