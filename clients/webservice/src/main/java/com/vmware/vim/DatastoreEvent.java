...
public class DatastoreEvent  extends com.vmware.vim.Event  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DatastoreEvent"));
