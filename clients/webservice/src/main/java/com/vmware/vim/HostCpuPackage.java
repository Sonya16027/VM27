...
public class HostCpuPackage extends com.vmware.vim.DynamicData implements
	...
	public HostCpuPackage(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty, short index,
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "index"));
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "busHz"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "long"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
