...
public class ArrayOfScheduledTaskDetail  implements java.io.Serializable {
    private com.vmware.vim.ScheduledTaskDetail[] scheduledTaskDetail;

    public ArrayOfScheduledTaskDetail() {
    }

    public ArrayOfScheduledTaskDetail(
           com.vmware.vim.ScheduledTaskDetail[] scheduledTaskDetail) {
     ...
     */
    public com.vmware.vim.ScheduledTaskDetail[] getScheduledTaskDetail() {
        return scheduledTaskDetail;
    }
     ...
     */
    public void setScheduledTaskDetail(com.vmware.vim.ScheduledTaskDetail[] scheduledTaskDetail) {
        this.scheduledTaskDetail = scheduledTaskDetail;
    }

    public com.vmware.vim.ScheduledTaskDetail getScheduledTaskDetail(int i) {
        return this.scheduledTaskDetail[i];
    }

    public void setScheduledTaskDetail(int i, com.vmware.vim.ScheduledTaskDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfScheduledTaskDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("scheduledTaskDetail");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ScheduledTaskDetail"));
