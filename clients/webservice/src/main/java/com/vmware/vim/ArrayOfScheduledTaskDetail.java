...
public class ArrayOfScheduledTaskDetail implements java.io.Serializable {
	 ...
	 */
	public void setScheduledTaskDetail(
			com.vmware.vim.ScheduledTaskDetail[] scheduledTaskDetail) {
		this.scheduledTaskDetail = scheduledTaskDetail;
	}
	...
	public void setScheduledTaskDetail(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfScheduledTaskDetail)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.scheduledTaskDetail == null && other
				.getScheduledTaskDetail() == null) || (this.scheduledTaskDetail != null && java.util.Arrays
				.equals(this.scheduledTaskDetail, other
	...
	public synchronized int hashCode() {
		...
		if (getScheduledTaskDetail() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getScheduledTaskDetail()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getScheduledTaskDetail(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfScheduledTaskDetail.class, true);
