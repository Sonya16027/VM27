...
public class DeviceNotSupported  extends com.vmware.vim.VirtualHardwareCompatibilityIssue  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DeviceNotSupported"));
