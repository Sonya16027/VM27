...
public class AlarmActionTriggeredEvent  extends com.vmware.vim.AlarmEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AlarmActionTriggeredEvent"));
