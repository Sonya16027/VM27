...
public class ArrayOfMissingProperty  implements java.io.Serializable {
     ...
     */
    public void setMissingProperty(com.vmware.vim.sms.MissingProperty[] missingProperty) {
        this.missingProperty = missingProperty;
    }
    ...
    public void setMissingProperty(int i, com.vmware.vim.sms.MissingProperty _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ArrayOfMissingProperty"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("missingProperty");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "MissingProperty"));
