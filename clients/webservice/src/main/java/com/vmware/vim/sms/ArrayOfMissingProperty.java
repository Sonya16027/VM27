...
public class ArrayOfMissingProperty implements java.io.Serializable {
	...
	private com.vmware.vim.sms.MissingProperty[] missingProperty;

	public ArrayOfMissingProperty() {
	}

	public ArrayOfMissingProperty(
			com.vmware.vim.sms.MissingProperty[] missingProperty) {
	 ...
	 */
	public com.vmware.vim.sms.MissingProperty[] getMissingProperty() {
		return missingProperty;
	}
	 ...
	 */
	public void setMissingProperty(
			com.vmware.vim.sms.MissingProperty[] missingProperty) {
		this.missingProperty = missingProperty;
	}

	public com.vmware.vim.sms.MissingProperty getMissingProperty(int i) {
		return this.missingProperty[i];
	}

	public void setMissingProperty(int i,
			com.vmware.vim.sms.MissingProperty _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfMissingProperty)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.missingProperty == null && other
				.getMissingProperty() == null) || (this.missingProperty != null && java.util.Arrays
				.equals(this.missingProperty, other.getMissingProperty())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getMissingProperty() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getMissingProperty()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getMissingProperty(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfMissingProperty.class, true);
