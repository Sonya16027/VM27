...
public class AffinityConfigured extends com.vmware.vim.MigrationFault implements
	...
	public AffinityConfigured(java.lang.String dynamicType,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof AffinityConfigured)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.configuredAffinity == null && other
						.getConfiguredAffinity() == null) || (this.configuredAffinity != null && java.util.Arrays
						.equals(this.configuredAffinity, other
								.getConfiguredAffinity())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getConfiguredAffinity() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getConfiguredAffinity()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getConfiguredAffinity(), i);
