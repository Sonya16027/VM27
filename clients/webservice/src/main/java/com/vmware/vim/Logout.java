...
public class Logout implements java.io.Serializable {
	...
	public Logout(com.vmware.vim.ManagedObjectReference _this) {
		this._this = _this;
	}

	/**
	 * Gets the _this value for this Logout.
	 * 
	 * @return _this
	 */
	...
	/**
	 * Sets the _this value for this Logout.
	 * 
	 * @param _this
	 */
	...
	static {
		typeDesc
				.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">Logout"));
