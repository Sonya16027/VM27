...
public class VirtualLsiLogicControllerOption extends
		com.vmware.vim.VirtualSCSIControllerOption implements
	...
	public VirtualLsiLogicControllerOption(java.lang.String dynamicType,
		...
		super(dynamicType, dynamicProperty, type, connectOption,
				...
				plugAndPlay, devices, supportedDevice, numSCSIDisks,
				numSCSICdroms, numSCSIPassthrough, sharing, defaultSharedIndex,
				hotAddRemove, scsiCtlrUnitNumber);
	}
