...
public class ObjectContent  extends com.vmware.vim.sms.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.sms.ManagedObjectReference obj;

    private com.vmware.vim.sms.DynamicProperty[] propSet;
    ...
    public ObjectContent(
           ...
           com.vmware.vim.sms.DynamicProperty[] propSet,
     ...
     * @return propSet
     */
    public com.vmware.vim.sms.DynamicProperty[] getPropSet() {
        return propSet;
    }
     ...
     * @param propSet
     */
    public void setPropSet(com.vmware.vim.sms.DynamicProperty[] propSet) {
        this.propSet = propSet;
    }

    public com.vmware.vim.sms.DynamicProperty getPropSet(int i) {
        return this.propSet[i];
    }

    public void setPropSet(int i, com.vmware.vim.sms.DynamicProperty _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ObjectContent"));
