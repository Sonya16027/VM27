...
public class ObjectContent extends com.vmware.vim.sms.DynamicData implements
	...
	public ObjectContent(java.lang.String dynamicType,
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:sm1", "propSet"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:sm1",
				"DynamicProperty"));
