...
public class PhysicalNicHintInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public PhysicalNicHintInfo(
           ...
           com.vmware.vim.PhysicalNicIpHint[] subnet,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "PhysicalNicHintInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "subnet"));
