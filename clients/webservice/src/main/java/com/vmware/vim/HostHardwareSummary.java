...
public class HostHardwareSummary extends com.vmware.vim.DynamicData implements
	...
	public HostHardwareSummary(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty,
			java.lang.String vendor, java.lang.String model,
			java.lang.String uuid, long memorySize, java.lang.String cpuModel,
			int cpuMhz, short numCpuPkgs, short numCpuCores,
			short numCpuThreads, int numNics, int numHBAs) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "cpuMhz"));
		elemField.setXmlType(new javax.xml.namespace.QName(
