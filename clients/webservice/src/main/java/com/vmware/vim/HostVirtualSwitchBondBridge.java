...
public class HostVirtualSwitchBondBridge  extends com.vmware.vim.HostVirtualSwitchBridge  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostVirtualSwitchBondBridge"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "beacon"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostVirtualSwitchBeaconConfig"));
