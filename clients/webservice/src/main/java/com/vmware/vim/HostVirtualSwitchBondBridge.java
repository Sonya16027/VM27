...
public class HostVirtualSwitchBondBridge extends
		com.vmware.vim.HostVirtualSwitchBridge implements java.io.Serializable {
	/**
	 * 
	 */
	...
	private com.vmware.vim.HostVirtualSwitchBeaconConfig beacon;

	public HostVirtualSwitchBondBridge() {
	}

	public HostVirtualSwitchBondBridge(java.lang.String dynamicType,
			com.vmware.vim.DynamicProperty[] dynamicProperty,
			java.lang.String[] nicDevice,
			com.vmware.vim.HostVirtualSwitchBeaconConfig beacon) {
	 ...
	 * @return beacon
	 */
	public com.vmware.vim.HostVirtualSwitchBeaconConfig getBeacon() {
		return beacon;
	}
	 ...
	 * @param beacon
	 */
	public void setBeacon(com.vmware.vim.HostVirtualSwitchBeaconConfig beacon) {
		this.beacon = beacon;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostVirtualSwitchBondBridge)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.nicDevice == null && other.getNicDevice() == null) || (this.nicDevice != null && java.util.Arrays
						.equals(this.nicDevice, other.getNicDevice())))
				&& ((this.beacon == null && other.getBeacon() == null) || (this.beacon != null && this.beacon
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostVirtualSwitchBondBridge.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "beacon"));
