...
public class MonthlyByWeekdayTaskScheduler extends
		com.vmware.vim.MonthlyTaskScheduler implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public MonthlyByWeekdayTaskScheduler(java.lang.String dynamicType,
			...
			com.vmware.vim.WeekOfMonth offset, com.vmware.vim.DayOfWeek weekday) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim2", "offset"));
