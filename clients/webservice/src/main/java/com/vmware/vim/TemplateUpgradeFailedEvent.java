...
public class TemplateUpgradeFailedEvent  extends com.vmware.vim.TemplateUpgradeEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "TemplateUpgradeFailedEvent"));
