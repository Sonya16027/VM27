...
public class HostDiskPartitionBlockRange  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private java.lang.Integer partition;

    private java.lang.String type;

    private com.vmware.vim.HostDiskDimensionsLba start;

    private com.vmware.vim.HostDiskDimensionsLba end;
    ...
    public HostDiskPartitionBlockRange(
           ...
           com.vmware.vim.HostDiskDimensionsLba start,
           com.vmware.vim.HostDiskDimensionsLba end) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return start
     */
    public com.vmware.vim.HostDiskDimensionsLba getStart() {
        return start;
    }
     ...
     * @param start
     */
    public void setStart(com.vmware.vim.HostDiskDimensionsLba start) {
        this.start = start;
    }
     ...
     * @return end
     */
    public com.vmware.vim.HostDiskDimensionsLba getEnd() {
        return end;
    }
     ...
     * @param end
     */
    public void setEnd(com.vmware.vim.HostDiskDimensionsLba end) {
        this.end = end;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostDiskPartitionBlockRange)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostDiskPartitionBlockRange.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskPartitionBlockRange"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "end"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskDimensionsLba"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
