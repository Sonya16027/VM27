...
public class ArrayOfVirtualMachineCpuIdInfoSpec  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineCpuIdInfoSpec(com.vmware.vim.VirtualMachineCpuIdInfoSpec[] virtualMachineCpuIdInfoSpec) {
        this.virtualMachineCpuIdInfoSpec = virtualMachineCpuIdInfoSpec;
    }

    public com.vmware.vim.VirtualMachineCpuIdInfoSpec getVirtualMachineCpuIdInfoSpec(int i) {
        return this.virtualMachineCpuIdInfoSpec[i];
    }

    public void setVirtualMachineCpuIdInfoSpec(int i, com.vmware.vim.VirtualMachineCpuIdInfoSpec _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineCpuIdInfoSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineCpuIdInfoSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineCpuIdInfoSpec"));
