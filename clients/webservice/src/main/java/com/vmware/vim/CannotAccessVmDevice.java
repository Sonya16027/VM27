...
public class CannotAccessVmDevice  extends com.vmware.vim.CannotAccessVmComponent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CannotAccessVmDevice"));
