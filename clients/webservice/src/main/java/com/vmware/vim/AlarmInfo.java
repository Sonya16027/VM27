...
public class AlarmInfo  extends com.vmware.vim.AlarmSpec  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "AlarmInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "creationEventId"));
