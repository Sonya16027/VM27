...
public class LongOption  extends com.vmware.vim.OptionType  implements java.io.Serializable {
    private long min;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "LongOption"));
