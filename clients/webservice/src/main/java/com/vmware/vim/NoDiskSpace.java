...
public class NoDiskSpace  extends com.vmware.vim.FileFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "NoDiskSpace"));
