...
public class CustomizationGuiUnattended  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    public CustomizationGuiUnattended(
           ...
           com.vmware.vim.CustomizationPassword password,
           int timeZone,
           boolean autoLogon,
           int autoLogonCount) {
        super(
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "CustomizationGuiUnattended"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("password");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "password"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "timeZone"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("autoLogon");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "autoLogon"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("autoLogonCount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "autoLogonCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
