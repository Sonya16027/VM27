...
public class DatacenterMismatch  extends com.vmware.vim.MigrationFault  implements java.io.Serializable {
    private com.vmware.vim.DatacenterMismatchArgument[] invalidArgument;

    private com.vmware.vim.ManagedObjectReference expectedDatacenter;
    ...
    public DatacenterMismatch(
           ...
           com.vmware.vim.DatacenterMismatchArgument[] invalidArgument,
           com.vmware.vim.ManagedObjectReference expectedDatacenter) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     */
    public com.vmware.vim.DatacenterMismatchArgument[] getInvalidArgument() {
        return invalidArgument;
    }
     ...
     */
    public void setInvalidArgument(com.vmware.vim.DatacenterMismatchArgument[] invalidArgument) {
        this.invalidArgument = invalidArgument;
    }

    public com.vmware.vim.DatacenterMismatchArgument getInvalidArgument(int i) {
        return this.invalidArgument[i];
    }

    public void setInvalidArgument(int i, com.vmware.vim.DatacenterMismatchArgument _value) {
     ...
     */
    public com.vmware.vim.ManagedObjectReference getExpectedDatacenter() {
        return expectedDatacenter;
    }
     ...
     */
    public void setExpectedDatacenter(com.vmware.vim.ManagedObjectReference expectedDatacenter) {
        this.expectedDatacenter = expectedDatacenter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DatacenterMismatch"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("invalidArgument");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "invalidArgument"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "expectedDatacenter"));
