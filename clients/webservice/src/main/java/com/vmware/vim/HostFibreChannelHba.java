...
public class HostFibreChannelHba  extends com.vmware.vim.HostHostBusAdapter  implements java.io.Serializable {
    private long portWorldWideName;

    private long nodeWorldWideName;

    private com.vmware.vim.FibreChannelPortType portType;
    ...
    public HostFibreChannelHba(
           ...
           com.vmware.vim.FibreChannelPortType portType,
           long speed) {
        super(
            dynamicType,
            dynamicProperty,
     ...
     * @return portType
     */
    public com.vmware.vim.FibreChannelPortType getPortType() {
        return portType;
    }
     ...
     * @param portType
     */
    public void setPortType(com.vmware.vim.FibreChannelPortType portType) {
        this.portType = portType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostFibreChannelHba"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "portType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "FibreChannelPortType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("speed");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "speed"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
