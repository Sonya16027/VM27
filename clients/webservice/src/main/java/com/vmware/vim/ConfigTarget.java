...
public class ConfigTarget  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private int numCpus;
     ...
     * @param datastore
     */
    public void setDatastore(com.vmware.vim.VirtualMachineDatastoreInfo[] datastore) {
        this.datastore = datastore;
    }
    ...
    public void setDatastore(int i, com.vmware.vim.VirtualMachineDatastoreInfo _value) {
    ...
    public void setNetwork(int i, com.vmware.vim.VirtualMachineNetworkInfo _value) {
    ...
    public void setParallel(int i, com.vmware.vim.VirtualMachineParallelInfo _value) {
     ...
     */
    public void setLegacyNetworkInfo(com.vmware.vim.VirtualMachineLegacyNetworkSwitchInfo[] legacyNetworkInfo) {
        this.legacyNetworkInfo = legacyNetworkInfo;
    }

    public com.vmware.vim.VirtualMachineLegacyNetworkSwitchInfo getLegacyNetworkInfo(int i) {
        return this.legacyNetworkInfo[i];
    }

    public void setLegacyNetworkInfo(int i, com.vmware.vim.VirtualMachineLegacyNetworkSwitchInfo _value) {
     ...
     */
    public void setScsiPassthrough(com.vmware.vim.VirtualMachineScsiPassthroughInfo[] scsiPassthrough) {
        this.scsiPassthrough = scsiPassthrough;
    }

    public com.vmware.vim.VirtualMachineScsiPassthroughInfo getScsiPassthrough(int i) {
        return this.scsiPassthrough[i];
    }

    public void setScsiPassthrough(int i, com.vmware.vim.VirtualMachineScsiPassthroughInfo _value) {
     ...
     * @param scsiDisk
     */
    public void setScsiDisk(com.vmware.vim.VirtualMachineScsiDiskDeviceInfo[] scsiDisk) {
        this.scsiDisk = scsiDisk;
    }
    ...
    public void setScsiDisk(int i, com.vmware.vim.VirtualMachineScsiDiskDeviceInfo _value) {
     ...
     * @param ideDisk
     */
    public void setIdeDisk(com.vmware.vim.VirtualMachineIdeDiskDeviceInfo[] ideDisk) {
        this.ideDisk = ideDisk;
    }
    ...
    public void setIdeDisk(int i, com.vmware.vim.VirtualMachineIdeDiskDeviceInfo _value) {
     ...
     * @param resourcePool
     */
    public void setResourcePool(com.vmware.vim.ResourcePoolRuntimeInfo resourcePool) {
        this.resourcePool = resourcePool;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ConfigTarget"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "numCpuCores"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("numNumaNodes");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "numNumaNodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "network"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineNetworkInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "cdRom"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineCdromInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "serial"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "parallel"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineParallelInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "floppy"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineFloppyInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "legacyNetworkInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineLegacyNetworkSwitchInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "scsiPassthrough"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineScsiPassthroughInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "scsiDisk"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineScsiDiskDeviceInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "ideDisk"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineIdeDiskDeviceInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "maxMemMBOptimalPerf"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("resourcePool");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "resourcePool"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "autoVmotion"));
