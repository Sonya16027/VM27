...
public class ArrayOfLicenseFeatureInfo  implements java.io.Serializable {
     ...
     */
    public void setLicenseFeatureInfo(com.vmware.vim.LicenseFeatureInfo[] licenseFeatureInfo) {
        this.licenseFeatureInfo = licenseFeatureInfo;
    }
    ...
    public void setLicenseFeatureInfo(int i, com.vmware.vim.LicenseFeatureInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfLicenseFeatureInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("licenseFeatureInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "LicenseFeatureInfo"));
