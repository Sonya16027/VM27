...
public class HostServicePolicy implements java.io.Serializable {
	...
	public static final HostServicePolicy automatic = new HostServicePolicy(
			_automatic);
	...
	public static HostServicePolicy fromValue(java.lang.String value)
		...
		HostServicePolicy enumeration = (HostServicePolicy) _table_.get(value);
		if (enumeration == null) {
