...
public class VirtualMachineNetworkShaperInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineNetworkShaperInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "peakBps"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "averageBps"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
