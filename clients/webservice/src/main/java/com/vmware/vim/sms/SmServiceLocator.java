...
public class SmServiceLocator extends org.apache.axis.client.Service implements
		com.vmware.vim.sms.SmService {
	...
	public SmServiceLocator(java.lang.String wsdlLoc,
	...
	public com.vmware.vim.sms.SmPortType getsmPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			com.vmware.vim.sms.SmBindingStub _stub = new com.vmware.vim.sms.SmBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (com.vmware.vim.sms.SmPortType.class
					.isAssignableFrom(serviceEndpointInterface)) {
				com.vmware.vim.sms.SmBindingStub _stub = new com.vmware.vim.sms.SmBindingStub(
						new java.net.URL(smPort_address), this);
				_stub.setPortName(getsmPortWSDDServiceName());
				return _stub;
			}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports
					.add(new javax.xml.namespace.QName("urn:sm1Service",
							"smPort"));
		}
