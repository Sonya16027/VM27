...
public class ArrayOfDiagnosticManagerBundleInfo  implements java.io.Serializable {
     ...
     */
    public void setDiagnosticManagerBundleInfo(com.vmware.vim.DiagnosticManagerBundleInfo[] diagnosticManagerBundleInfo) {
        this.diagnosticManagerBundleInfo = diagnosticManagerBundleInfo;
    }

    public com.vmware.vim.DiagnosticManagerBundleInfo getDiagnosticManagerBundleInfo(int i) {
        return this.diagnosticManagerBundleInfo[i];
    }

    public void setDiagnosticManagerBundleInfo(int i, com.vmware.vim.DiagnosticManagerBundleInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfDiagnosticManagerBundleInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("diagnosticManagerBundleInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "DiagnosticManagerBundleInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DiagnosticManagerBundleInfo"));
