...
public class ArrayOfNodeProperty  implements java.io.Serializable {
    ...
    public ArrayOfNodeProperty(
           com.vmware.vim.sms.NodeProperty[] nodeProperty) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfNodeProperty)) return false;
        ...
        _equals = true && 
            ((this.nodeProperty==null && other.getNodeProperty()==null) || 
             (this.nodeProperty!=null &&
              java.util.Arrays.equals(this.nodeProperty, other.getNodeProperty())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getNodeProperty() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getNodeProperty());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getNodeProperty(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfNodeProperty.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sm1", "ArrayOfNodeProperty"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nodeProperty");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sm1", "NodeProperty"));
