...
public class DasHostFailedEvent  extends com.vmware.vim.ClusterEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "DasHostFailedEvent"));
