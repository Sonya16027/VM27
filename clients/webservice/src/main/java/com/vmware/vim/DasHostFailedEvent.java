...
public class DasHostFailedEvent extends com.vmware.vim.ClusterEvent implements
		java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private com.vmware.vim.HostEventArgument failedHost;
	...
	public DasHostFailedEvent(java.lang.String dynamicType,
			...
			com.vmware.vim.HostEventArgument failedHost) {
	 ...
	 * @return failedHost
	 */
	public com.vmware.vim.HostEventArgument getFailedHost() {
		return failedHost;
	}
	 ...
	 * @param failedHost
	 */
	public void setFailedHost(com.vmware.vim.HostEventArgument failedHost) {
		this.failedHost = failedHost;
	}
