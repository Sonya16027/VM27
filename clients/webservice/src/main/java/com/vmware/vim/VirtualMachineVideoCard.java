...
public class VirtualMachineVideoCard  extends com.vmware.vim.VirtualDevice  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineVideoCard"));
