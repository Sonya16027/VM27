...
public class ArrayOfPropertySpec  implements java.io.Serializable {
    ...
    public ArrayOfPropertySpec(
           com.vmware.vim.PropertySpec[] propertySpec) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfPropertySpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertySpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "PropertySpec"));
