...
public class UserLoginSessionEvent  extends com.vmware.vim.SessionEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "UserLoginSessionEvent"));
