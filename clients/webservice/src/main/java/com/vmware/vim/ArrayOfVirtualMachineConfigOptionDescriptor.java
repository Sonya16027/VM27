...
public class ArrayOfVirtualMachineConfigOptionDescriptor  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineConfigOptionDescriptor(com.vmware.vim.VirtualMachineConfigOptionDescriptor[] virtualMachineConfigOptionDescriptor) {
        this.virtualMachineConfigOptionDescriptor = virtualMachineConfigOptionDescriptor;
    }

    public com.vmware.vim.VirtualMachineConfigOptionDescriptor getVirtualMachineConfigOptionDescriptor(int i) {
        return this.virtualMachineConfigOptionDescriptor[i];
    }

    public void setVirtualMachineConfigOptionDescriptor(int i, com.vmware.vim.VirtualMachineConfigOptionDescriptor _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ArrayOfVirtualMachineConfigOptionDescriptor"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineConfigOptionDescriptor");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "VirtualMachineConfigOptionDescriptor"));
