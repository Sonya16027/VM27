...
public class HostDiskMappingInfo  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setPhysicalPartition(com.vmware.vim.HostDiskMappingPartitionInfo physicalPartition) {
        this.physicalPartition = physicalPartition;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskMappingInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "HostDiskMappingPartitionInfo"));
