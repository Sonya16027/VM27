...
public class ObjectContent  extends com.vmware.vim.DynamicData  implements java.io.Serializable {
    private com.vmware.vim.ManagedObjectReference obj;

    private com.vmware.vim.DynamicProperty[] propSet;
    ...
    public ObjectContent(
           ...
           com.vmware.vim.DynamicProperty[] propSet,
     ...
     * @return propSet
     */
    public com.vmware.vim.DynamicProperty[] getPropSet() {
        return propSet;
    }
     ...
     * @param propSet
     */
    public void setPropSet(com.vmware.vim.DynamicProperty[] propSet) {
        this.propSet = propSet;
    }

    public com.vmware.vim.DynamicProperty getPropSet(int i) {
        return this.propSet[i];
    }

    public void setPropSet(int i, com.vmware.vim.DynamicProperty _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", "ObjectContent"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "missingSet"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim2", "MissingProperty"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
