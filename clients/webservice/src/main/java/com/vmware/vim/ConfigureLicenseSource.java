...
public class ConfigureLicenseSource  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigureLicenseSource)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigureLicenseSource.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim2", ">ConfigureLicenseSource"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim2", "licenseSource"));
