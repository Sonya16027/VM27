...
class CredentialStoreObfuscate
{
     ...
     */
    public static char[] obfuscate(String hostname, String username, char[] value) throws IOException {
    ...
    public static char[] deObfuscate(String hostname, String username, char[] value) throws IOException {
    	String key = canonicalize(hostname) + username;
