...
public class CredentialStoreAdmin
{
    private static void showUsage() {
        System.out.println("Usage: CredentialStoreAdmin <command> [-f <filename>]");
    ...
    private static CredentialStore getCredentialStoreObject(boolean flagFilename, File file) throws IOException {
