...
class CredentialStoreImpl
     ...
     */
    public synchronized char[] getPassword(String host, String username) throws IOException
    {
        CredentialStoreStorage store = new CredentialStoreStorage(cachePath, defaultCachePath);
     ...
     *         already exist
     */
    public synchronized boolean addPassword(String host, String username, char[] password)
        throws IOException
    {
        CredentialStoreStorage store = new CredentialStoreStorage(cachePath, defaultCachePath);

        return store.addEntry(host, username, CredentialStoreObfuscate.obfuscate(host, username, password));
    }
     ...
     */
    public synchronized boolean removePassword(String host, String username) throws IOException
    {
        CredentialStoreStorage store = new CredentialStoreStorage(cachePath, defaultCachePath);
