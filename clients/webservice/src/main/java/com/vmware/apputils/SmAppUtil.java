...
public class SmAppUtil extends AppUtil {
   ...
   public static SmAppUtil initialize(String name, OptionSpec[] userOptions, String[] args) throws Exception {
   ...
   public static SmAppUtil initialize(String name, String[] args) throws Exception {
   ...
   public void connect() throws Exception {
      ...
      String cookie = com.vmware.apputils.version.VersionUtil.getCookieString(this);
