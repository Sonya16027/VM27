...
/**
 * Java representation of all the enum types for the properties supported by the
 * QueryList API method.
 */
public class EnumLookup {
	 ...
	 */
	public final HashMap<String, HashMap<String, Boolean>> enumMap = new HashMap<String, HashMap<String, Boolean>>() {
		/**
		 * 
		 */
