...
public class EntityHelper {
   ...
   static {
      ...
      moIdPrefixToEntityTypeMap.put("resgroup", EntityReferenceEntityType.resourcePool);
      ...
      entityTypeToMoIdPrefixMap.put(EntityReferenceEntityType.resourcePool, "resgroup");
      ...
      entityTypeToMORTypeMap.put(EntityReferenceEntityType.resourcePool, "ResourcePool");
    ...
    * @throws ArgumentHandlingException if input mor is invalid
    */
   public static EntityReference parseEntityReference(com.vmware.vim.ManagedObjectReference mor) 
      ...
      if (extractedEntityTypeStr == null) {
          ...
          */
         log.logLine("Invalid MOR - value field is in invalid format: " + mor.get_value());
         throw new ArgumentHandlingException("Invalid MOR - value field is in invalid format");  
      }
      ...
      if (extractedEntityType == null) {
         log.logLine("Invalid MOR - unknown object type : " + mor.get_value());
         throw new ArgumentHandlingException("Invalid MOR - unknown object type");  
      }
    ...
    * @throws ArgumentHandlingException if an invalid entity is specified
    */
   public static  com.vmware.vim.ManagedObjectReference parseMOR(EntityReference entity) 
      throws ArgumentHandlingException {
      ...
      com.vmware.vim.ManagedObjectReference mor = new  com.vmware.vim.ManagedObjectReference(moid);
      mor.setType(morType);
      return mor; 
   }
}
