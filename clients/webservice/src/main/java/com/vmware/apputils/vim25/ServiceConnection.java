...
public class ServiceConnection {
	...
	public static com.vmware.apputils.vim25.ServiceConnection CreateServiceConnection(
			String inst) {
	...
	private void writeData(ManagedObjectReference moref, String fileName)
			throws Exception {
	...
	private ManagedObjectReference readData(String fileName)
