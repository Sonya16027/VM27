...
/**
 * Java representation of the entity relationship specification for the
 * QueryList API method. It provides methods to query which relationship
 * combinations are supported, what properties are returned in each case and the
 * type information for those properties.
 */
public final class Catalog {
	/**
	 * Indicates if any relationship queries are supported for the given entity
	 * type.
	 * 
	 * @param entityType
	 *            type name of the entity.
	 * @returns true if at least one relationship combination is supported for
	 *          the given entity type, false otherwise.
	 */
	 ...
	 * 
	 * @param entityType
	 *            type name of the entity for which the query is needed.
	 * @param relatedEntityType
	 *            type name of the required related entities.
	 * @returns true if the given relationship combination is supported, false
	 *          otherwise.
	 */
	public static boolean isRelation(String entityType, String relatedEntityType) {
		return hasRelation(entityType)
				&& relPropTypeMap.get(entityType.toUpperCase()).get(
						relatedEntityType.toUpperCase()) != null;
	}
	 ...
	 * @returns true if the property name is supported for the given
	 *          relationship combination, false otherwise.
	 */
	public static boolean isProperty(String entityType,
			String relatedEntityType, String propertyName) {
		return isRelation(entityType, relatedEntityType)
				&& relPropTypeMap.get(entityType.toUpperCase()).get(
						relatedEntityType.toUpperCase()).get(
						propertyName.toUpperCase()) != null;
	}
	 ...
	 * @param propertyName
	 *            property name to be checked.
	 * @returns true if the property name is supported for a query on the given
	 *          entity type, false otherwise.
	 */
	public static boolean isProperty(String entityType, String propertyName) {
		return entityPropTypeMap.get(entityType.toUpperCase()).get(
				propertyName.toUpperCase()) != null;
	}
	 ...
	 * @param propertyName
	 *            property name to be checked.
	 * @returns type of the specified property or null if the property is not
	...
	public static PropertyType getPropertyType(String entityType,
		...
		return relPropTypeMap.get(entityType.toUpperCase()).get(
				relatedEntityType.toUpperCase())
	...
	/**
	 * Returns a collection of all properties for a given relationship
	 * combination. Each entry contains the name of a property and its type.
	 * 
	 * @param entityType
	 *            type name of the entity for which the query is needed.
	 * @param relatedEntityType
	 *            type name of the required related entities.
	 * @returns a hash map with the property name as the key and property type
	 *          as the value.
	 */
	public static HashMap<String, PropertyType> getSubCatalog(
			String entityType, String relatedEntityType) {
	...
	/**
	 * Returns a collection of all properties for a query on the given entity
	 * type. Each entry contains the name of a property and its type.
	 * 
	 * @param entityType
	 *            type name of the entity for which the query is needed.
	 * @returns a hash map with the property name as the key and property type
	...
	PropertyType>>> relPropTypeMap = new HashMap<String, HashMap<String, HashMap<String, PropertyType>>>() {
		/**
	 * 
	 */
...

		{
...

				{
					put("DATASTORE", new HashMap<String, PropertyType>() {
...

						{
							...
							put("DATASTORETYPE", new PropertyType(
									"datastoreType"));
							put("ENTITYSTATUS", new PropertyType(
									"datastoreStatus"));
							put("ENTITYMULTIPATHINGSTATUS", new PropertyType(
									"multipathingStatus"));
							...
							put("ENTITYOTHERUSED",
									PropertyType.LongPropertyType);
							put("PERCENTOTHERUSED",
									PropertyType.DoublePropertyType);
					...
					put("SCSIVOLUME", new HashMap<String, PropertyType>() {
...

						{
							...
							put("DEVICETYPE", new PropertyType(
									"scsiVolumeDeviceType"));
							put("ENTITYID", PropertyType.StringPropertyType);
						}
					});
					put("SCSIPATH", new HashMap<String, PropertyType>() {
...

						{
							...
							put("LUNNUM", PropertyType.StringPropertyType);
							put("ADAPTER", PropertyType.StringPropertyType);
							put("ADAPTERTYPE", new PropertyType(
									"scsiAdapterType"));
							...
							put("TARGETISCSINAME",
									PropertyType.StringPropertyType);
							put("TARGETISCSIALIAS",
									PropertyType.StringPropertyType);
							put("STATUS", new PropertyType("scsiPathStatus"));
							put("ACTIVITYSTATE", new PropertyType(
									"scsiPathActivityState"));
							put("PREFERRED", new PropertyType(
									"scsiPathPreferred"));
							put("ENTITYID", PropertyType.StringPropertyType);
						}
					});
			...
			put("DATASTORE",
					new HashMap<String, HashMap<String, PropertyType>>() {
						{
							put("VM", new HashMap<String, PropertyType>() {
								{
									...
									put("RESOURCEPOOL",
											PropertyType.StringPropertyType);
									put("RESOURCEPOOLENTITYID",
											PropertyType.StringPropertyType);
									put("ENTITYMULTIPATHINGSTATUS",
											new PropertyType(
													"multipathingStatus"));
									put("ENTITYUSED",
											PropertyType.LongPropertyType);
							...
							put("VM", new HashMap<String, PropertyType>() {
								{
									...
									put("RESOURCEPOOLENTITYID",
											PropertyType.StringPropertyType);
									put("MULTIPATHINGSTATUS", new PropertyType(
											"multipathingStatus"));
	...
	private static final HashMap<String, /* entity type */
	HashMap<String, /* property name */
	PropertyType>> entityPropTypeMap = new HashMap<String, HashMap<String, PropertyType>>() {
		{
			put("VM", new HashMap<String, PropertyType>() {
				{
					put("NAME", PropertyType.StringPropertyType);
			...
			put("SCSIVOLUME", new HashMap<String, PropertyType>() {
				{
					...
					put("SIZE", PropertyType.LongPropertyType);
					put("VENDOR", PropertyType.StringPropertyType);
					put("DEVICETYPE", new PropertyType("scsiVolumeDeviceType"));
					put("ENTITYID", PropertyType.StringPropertyType);
				}
			});
			put("SCSIPATH", new HashMap<String, PropertyType>() {
