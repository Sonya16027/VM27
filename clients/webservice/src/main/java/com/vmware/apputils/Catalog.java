...
public final class Catalog {
    ...
    * @returns true if at least one relationship combination is supported
    ...
    * @returns true if the property name is supported for the given relationship
    ...
    * @param entityType type name of the entity for which the query is needed.
    * @param propertyName property name to be checked.
    * @returns true if the property name is supported for a query on the given entity type,
    *          false otherwise.
    */
   public static boolean isProperty(String entityType,
                                    String propertyName) {
