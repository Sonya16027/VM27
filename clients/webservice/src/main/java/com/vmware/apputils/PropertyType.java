...
/**
 * Specifies the data type of a property. If the property is an enum, the enum
 * name is also stored.
 */
public class PropertyType {
	 ...
	 */
	public static final PropertyType StringPropertyType = new PropertyType(
			Type.Str);

	/**
	 * Attribute to represent a long type
	 */
	public static final PropertyType LongPropertyType = new PropertyType(
			Type.Long);

	/**
	 * Attribute to represent a double type
	 */
	public static final PropertyType DoublePropertyType = new PropertyType(
			Type.Double);
	...
	/**
	 * Internal constructor. For string and number, use the corresponding final
	 * attributes. For enum, use the enumName constructor
	 */
