...
public class VersionUtil {   
   ...
   private static ArrayList getAPIVersions(String data) {
      ...
      try {
         ...
         NodeList nsNodes = (NodeList) xpath.evaluate(expression, 
                                                      doc, 
         ...
         for(int i=0; i<nsNodes.getLength(); i++) {
            ...
            if(nameNode.getTextContent().equalsIgnoreCase("urn:vim25")) {
               ...
               Node priorVersionsNode = (Node) xpath.evaluate(expression, nsNode, 
                                                              XPathConstants.NODE);               
               expression = "version";
               NodeList priorVersionsNodeList = (NodeList) xpath.evaluate(expression, 
                                                                          priorVersionsNode, 
                                                                          XPathConstants.NODESET);
               ...
               expression = "version";
               Node versionNode = (Node) xpath.evaluate(expression, nsNode, 
                                                     XPathConstants.NODE);
               priorVersions.add(versionNode.getTextContent());
            }          
         }       
   ...
   public static com.vmware.vim25.ManagedObjectReference convertManagedObjectReference(
      ...
      com.vmware.vim25.ManagedObjectReference morr1 
         = new com.vmware.vim25.ManagedObjectReference();      
