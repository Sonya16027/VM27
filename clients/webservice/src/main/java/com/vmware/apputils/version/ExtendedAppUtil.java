...
public class ExtendedAppUtil extends com.vmware.apputils.AppUtil {
   ...
   public void setup(String name) {
      ...
      _connection = com.vmware.apputils.vim25.ServiceConnection.CreateServiceConnection(
                       "ServiceInstance");      
   }
   public void connect(String cookieString) throws Exception {
      ...
      try{
         ...
         log.close();
         throw new com.vmware.apputils.ArgumentHandlingException("Exception running : " 
                                                                + getAppName());  
      }
   }
