 ...
 * un.bat com.vmware.samples.vm.vmlinkedclone
	...
	private void createLinkedClone(String[] args, String cookieString)
		...
		if (vmMOR != null) {
			...
			if (snapMOR != null) {
				...
				try {
					...
					ManagedObjectReference taskMOR = ecb
							.getServiceConnection3().getService().cloneVM_Task(
									vmMOR, parentMOR,
									ecb.getOption("clonename"), cloneSpec);
				...
				System.out.println("Snapshot " + ecb.getOption("snapshotname")
						+ " doesn't exist");
			}
		} else {
