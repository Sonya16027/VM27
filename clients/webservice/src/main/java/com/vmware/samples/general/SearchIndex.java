 ...
 * un.bat com.vmware.samples.general.SearchIndex --url [webserviceurl]
...
public class SearchIndex {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			cb.connect();
			String dcName = cb.getOption("dcName");
			String vmDnsName = cb.getOption("vmDnsName");
			String hostDnsName = cb.getOption("hostDnsName");
			String vmPath = cb.getOption("vmPath");
			String vmIP = cb.getOption("vmIP");
