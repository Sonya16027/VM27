 ...
 * </p>
 * <p>
 * run.bat com.vmware.samples.performance.VITop --url [webservice url]
...
public class VITop {
	...
	private void displayStats() throws Exception {
		...
		ManagedObjectReference hostmor = cb.getServiceUtil().getDecendentMoRef(
				null, "HostSystem", cb.getOption("host"));
		if (hostmor == null) {
	...
	private static String[][] getCounters() throws Exception {
		String cpu = cb.getOption("cpu");
		String mem = cb.getOption("memory");
