...
/**
* This sample displays available performance counters or other metadata
* for an ESX system as specified at the command line. Output is in this 
* general report style:</li>
* <ul>Perfomance Interval:
*    <li>Interval Name </li>
*    <li>Interval Period</li>
*    <li>Interval Length</li></ul>
*    <ul>Performance counters:</ul>
*    <ul>Host perf capabilities:
*    <li>Summary supported</li>
*    <li>Current supported</li>
*    <li>Current refresh rate</li></ul>
*
* <p><b>Parameters:</b></p>
* <ul><li>info  Required. Specify one of [interval|counter|host]
* <li>hostname  Optional. Required when 'info' specified is 'host.' Name of the 
* host system</li></ul>
* 
* <p><b>To display the names and description of all the performance
* counters on a VirtualCenter Server:</b></p>
* <p>run.bat com.vmware.samples.performance Basics --url [webserviceurl]
* --username [username] --password [password] --info[interval | 
* counter | host]  --hostname [name of the host server]
*
* <p><b>To display counter names, sampling period, and length of all intervals
* </b></p>:
* <p>run.bat com.vmware.samples.performance Basics --url [webserviceurl]
* --username [username] --password [password] --info[interval]  
* --hostname [name of the host server]</p>

* <p><b>To display the names and description of all the performance
* counters on the ESX host</b></p>
* run.bat com.vmware.samples.performance Basics --url [webserviceurl]
* --username [username] --password [password] --info[counter]  --hostname [name of the host server]</p>
*
* <p><b>To display the names and description of all the performance
* counters on this host . Also all the metrices available on this host should 
* also be displayed</b>
* <p>run.bat com.vmware.samples.performance Basics --url [webserviceurl]
* --username [username] --password [password] --info[host]  --hostname [name of the host server]</p>
*
*/
...
public class Basics {
   ...
   private void getIntervals(ManagedObjectReference perfMgr,VimPortType service) 
   ...
   private void getQueryAvailable(ManagedObjectReference perfMgr,
      ...
      PerfMetricId[] metricIds 
         = service.queryAvailablePerfMetric(perfMgr, hostmor, start, end, null);
   ...
   private Object[] getProperties(VimPortType service, 
      ...
      ObjectContent[] ocs 
         = service.retrieveProperties(sic.getPropertyCollector(),
