...
public class StatsTable extends JPanel {
   ...
   public void setData(Calendar timeStamp, long overallUsage, String units, Vector data) {
       SimpleDateFormat sdf = new SimpleDateFormat("h:mm:ss a");
       String text = "Overall Usage : " + overallUsage + " " + units + "     "  + sdf.format(timeStamp.getTime());
       label.setText(text);
