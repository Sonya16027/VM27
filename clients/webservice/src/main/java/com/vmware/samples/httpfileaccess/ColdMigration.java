 ...
 * un.bat com.vmware.samples.httpfileaccess.ColMigration --url [webserviceurl] 
...
public class ColdMigration {
	...
	private String getVmName() {
		return cb.getOption("vmname");
	}

	private String getLocalPath() {
		return cb.getOption("localpath");
	}

	private String getDataCenter() {
		return cb.getOption("datacentername");
	}

	private String getDataStore() {
		return cb.getOption("datastorename");
	}
