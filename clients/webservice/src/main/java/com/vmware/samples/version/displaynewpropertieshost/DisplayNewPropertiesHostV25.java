...
public class DisplayNewPropertiesHostV25 {
   public static void displayNewProperties(
      ...
      HostRuntimeInfo runtimeInfo 
         = (HostRuntimeInfo)
         ecb.getServiceUtil3().getDynamicProperty(hmor1,"runtime");
      ...
      HostConfigInfo configInfo 
         = (HostConfigInfo)
         ecb.getServiceUtil3().getDynamicProperty(hmor1,"config");
      ...
      if(flag) {
         ...
         Boolean infoFlag = (Boolean)ecb.getServiceUtil3().getDynamicProperty(
                                                   hmor1,
                                                   "capability.ipmiSupported");
         System.out.println("IPMI Supported :- " + infoFlag);
         infoFlag = (Boolean)ecb.getServiceUtil3().getDynamicProperty(hmor1,
