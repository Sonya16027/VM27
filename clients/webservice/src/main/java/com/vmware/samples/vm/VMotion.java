 ...
 * un.bat com.vmware.samples.version.VMotion --url [webserviceurl]
...
public class VMotion {
	...
	public void migrate_or_relocate_VM() throws Exception {
		...
		String targetHost = cb.getOption("targethost");
		String targetPool = cb.getOption("targetpool");
		String sourceHost = cb.getOption("sourcehost");
		String targetDS = cb.getOption("targetdatastore");
	...
	public void migrateVM(String vmname, String pool, String tHost,
		...
		if (cb.option_is_set("state")) {
			state = cb.getOption("state");
			st = VirtualMachinePowerState.fromString(cb.getOption("state"));
		}
	...
	private boolean customValidation() throws Exception {
		boolean flag = true;
		if (cb.option_is_set("state")) {
			String state = cb.getOption("state");

			if (cb.getOption("state") == null) {
		...
		if (cb.option_is_set("priority")) {
			String prior = cb.getOption("priority");
			if (cb.getOption("priority") == null) {
