...
public class DisplayNewPropertiesVMV25 {
   public static void displayVMProperties(
       ...
       ,ArrayList apiVersions, String [] args, String cookieString) throws Exception {
       ...
       Boolean bootOptionsSupported
          = (Boolean)ecb.getServiceUtil3().getDynamicProperty(vmmor1,
                                             "capability.bootOptionsSupported");
       System.out.println("Boot Options Supported :- " + 
                          bootOptionsSupported);
                                            
       Boolean diskSharesSupported
          = (Boolean)ecb.getServiceUtil3().getDynamicProperty(vmmor1,
                                          "capability.diskSharesSupported");  
       System.out.println("Disk Shares Supported :- " + 
                          diskSharesSupported);
       ...
       if(flag) {
          ...
          VirtualMachineFaultToleranceState faultToleranceState
             ...
             ecb.getServiceUtil3().getDynamicProperty(vmmor1,
