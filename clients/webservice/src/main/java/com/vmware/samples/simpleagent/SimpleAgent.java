 ...
 * demonstrate using the {@link CredentialStore} client API.</p>
 * <p>SimpleAgent accesses the local credential store to obtain a single user
 ...
 * <p>To create user accounts and store them in the local credential store, use 
 * the {@link CredentialStoreAdmin} client utility. </p> 
 * <p>Note that this sample does not use the apputils helper classes to create
 * the connection to the server.</p>  
 * 
 * <p><b>Parameters</b></p>
 * <ul> 
 ...
 * <code> 
 * java com.vmware.samples.simpleagent.SimpleAgent --hostName &lt;target-server&gt; 
 * </code> 
 */
...
public class SimpleAgent {
   ...
   private void connectAndLogin(String hostName) throws Exception {
      ...
      System.out.println("Connected Successfully "+_sic.getAbout().getFullName());
   }
