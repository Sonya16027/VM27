 ...
 * to a new location, in a specified folder. This sample finds both the managed entity
 * and the target folder in the inventory tree before attempting the move. If either of
 * these is not found, an error message displays.</p>
 * In addition to built-in command-line arguments --url, --userName, and --password, 
 * the sample uses two custom parameters to specify the inventory object by name
 * (the managed entity, such as a datacenter or virtual machine) and the target folder. 
 * The custom parameters are:</p>
 * <ul>
 * <li><strong>entityname</strong> Required. Name of the inventory object to be moved. </li> 
 * <li><strong>foldername</strong> Required. Name of the target folder into which the inventory object
 * should be moved.</li></ul>
 * 
 * <p><strong>Usage Examples:</strong></p>
 * <br/>
 * Move a folder named "Production" into the "Global_Operations" folder:<br/>
 * <pre>
 * run.bat com.vmware.samples.general.Move --url http://myVMwareServiceName.com/sdk
 * --username sdkUser --password ****** --entityname Production
 * --foldername Global_Operations</pre>
 *
 * <p>Move a datacenter named "Production_Datacenter" into the "Production" folder:</p>
 * <pre>
 * run.bat com.vmware.samples.general.Move --url http://myVMwareServiceName.com/sdk
 ...
 * <p>Move a datacenter named "Production_Datacenter" into the "Production" folder:</p>
 * <pre>
 * run.bat com.vmware.samples.general.Move --url https://myVMwareServiceName.com/sdk
 * --username sdkUser --password ****** --entityname Production_Datacenter
      ...
      if (foldermor == null) {
         ...
         try {
            ManagedObjectReference taskmor 
                  =  cb.getConnection().getService().moveIntoFolder_Task(foldermor, 
