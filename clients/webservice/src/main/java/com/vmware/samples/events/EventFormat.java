...
public class EventFormat  {
   ...
   private void formatLatestEvent() throws Exception {
      try {
         ...
         ObjectContent[] oc = 
            cb.getServiceUtil().getObjectProperties(
         ...
         ArrayOfEventDescriptionEventDetail arrayEventDetails = 
            (ArrayOfEventDescriptionEventDetail)oc[0].getPropSet(0).getVal();
         ...
         System.out.println("The latestEvent was : " + anEvent.getClass().getName());
         System.out.println(formatEvent(Vm, eventDetail, anEvent));
         System.out.println(formatEvent(Host, eventDetail, anEvent));
         System.out.println(formatEvent(ComputeResource, eventDetail, anEvent));
