...
/**
*
* <p>This sample writes the available counters of a managed entity 
* into the specified file at the specified location. The managed entity here
* can be a host system or a virtual machine or a Resource pool.
* </p>
* 
* <p><b>Parameters:</b></p>
* <ul>
* <li>entitytype  Required. Managed entity [HostSystem|VirtualMachine|ResourcePool]</li>
* <li>entityname  Required. Name of the host system
* <li>filename    Required. Name of the file, including path if other than current
* directory. </li>
* </ul>
* 
* <p><b>To obtain listing of counters available for a host named "myHost.com" and save to 
* a file named "myHostCounters:"</b></p>
* 
* <p>run.bat com.vmware.samples.performance.PrintCounters --url https://myHost.com/sdk
* --username root  --password ******* --entitytype HostSystem --entityname  myHost.com
* --filename myHostCounters</p>
* 
*/
...
public class PrintCounters {
   ...
   private void printElementDescription(PrintWriter out, 
                                       String name, 
   ...
   private Set getPerfIdsAvailable(ManagedObjectReference perfMoRef,
      ...
      if(entityMoRef != null) {
         PerfMetricId[] ids 
            = cb.getConnection().getService().queryAvailablePerfMetric(perfMoRef, 
                                                                       entityMoRef, 
                                                                       null, 
                                                                       null, 
                                                                      new Integer(300));
   ...
   public static void main(String args[]) throws Exception{
      ...
      cb = AppUtil.initialize("PrintCounters",
