...
/**
* SimpleClient connects to the server, logs in, 
* lists the inventory contents (managed entities) at the console, and logs out. 
...
* <p>To display the inventory list, SimpleClient obtains 
* managed object references for inventory objects by creating and using 
* several traversal specifications, to navigate the inventory and
* print the output. Traversal specifications are data objects associated with
* the PropertyCollector managed object type. Using these is considered an 
* advanced topic.</p>
* 
* <p><b>Usage Examples:</b></p>
* <pre>run.bat com.vmware.samples.general.SimpleClient --url https://myVMwareServiceName.com/sdk
* [webserviceurl]
