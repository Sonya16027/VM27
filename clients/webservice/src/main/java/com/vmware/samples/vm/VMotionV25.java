...
public class VMotionV25 {
	...
	private void checkVMotionCompatibility() throws Exception {
		...
		String vmname = ecb.getOption("vmname");
		String sourcehost = ecb.getOption("sourcehost");
		String targethost = ecb.getOption("targethost");
		String targetpool = ecb.getOption("targetpool");
		String dataname = ecb.getOption("targetdatastore");
