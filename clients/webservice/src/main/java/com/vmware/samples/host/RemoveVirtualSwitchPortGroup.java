 ...
 * un.bat com.vmware.samples.host.RemoveVirtualSwitchPortGroup --url [webserviceurl] 
 ...
 * un.bat com.vmware.samples.host.RemoveVirtualSwitchPortGroup --url [webserviceurl] --username [username] --password  &lt;password&gt; 
...
public class RemoveVirtualSwitchPortGroup {
	...
	private void validate() throws Exception {
		...
		portGroupName = cb.getOption("portgroupname");
		try {
