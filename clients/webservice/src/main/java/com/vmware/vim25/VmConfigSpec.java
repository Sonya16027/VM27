...
public class VmConfigSpec extends com.vmware.vim25.DynamicData implements
	...
	public VmConfigSpec(java.lang.String dynamicType,
	 ...
	 */
	public void setOvfEnvironmentTransport(
			java.lang.String[] ovfEnvironmentTransport) {
		this.ovfEnvironmentTransport = ovfEnvironmentTransport;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VmConfigSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.product == null && other.getProduct() == null) || (this.product != null && java.util.Arrays
						.equals(this.product, other.getProduct())))
				&& ((this.property == null && other.getProperty() == null) || (this.property != null && java.util.Arrays
						.equals(this.property, other.getProperty())))
				&& ((this.ipAssignment == null && other.getIpAssignment() == null) || (this.ipAssignment != null && this.ipAssignment
						.equals(other.getIpAssignment())))
				&& ((this.eula == null && other.getEula() == null) || (this.eula != null && java.util.Arrays
						.equals(this.eula, other.getEula())))
				&& ((this.ovfSection == null && other.getOvfSection() == null) || (this.ovfSection != null && java.util.Arrays
						.equals(this.ovfSection, other.getOvfSection())))
				&& ((this.ovfEnvironmentTransport == null && other
						.getOvfEnvironmentTransport() == null) || (this.ovfEnvironmentTransport != null && java.util.Arrays
						.equals(this.ovfEnvironmentTransport, other
								.getOvfEnvironmentTransport())))
				&& ((this.installBootRequired == null && other
						.getInstallBootRequired() == null) || (this.installBootRequired != null && this.installBootRequired
						.equals(other.getInstallBootRequired())))
				&& ((this.installBootStopDelay == null && other
						.getInstallBootStopDelay() == null) || (this.installBootStopDelay != null && this.installBootStopDelay
						.equals(other.getInstallBootStopDelay())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getProduct() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getProduct()); i++) {
		...
		if (getOvfEnvironmentTransport() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getOvfEnvironmentTransport()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getOvfEnvironmentTransport(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
