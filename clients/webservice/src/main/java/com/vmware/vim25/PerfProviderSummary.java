...
public class PerfProviderSummary extends com.vmware.vim25.DynamicData implements
	...
	public PerfProviderSummary(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			com.vmware.vim25.ManagedObjectReference entity,
			boolean currentSupported, boolean summarySupported,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof PerfProviderSummary)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.refreshRate == null && other.getRefreshRate() == null) || (this.refreshRate != null && this.refreshRate
						.equals(other.getRefreshRate())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isCurrentSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isSummarySupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			PerfProviderSummary.class, true);
