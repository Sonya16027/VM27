...
public class EventFilterSpecByEntity  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param recursion
     */
    public void setRecursion(com.vmware.vim25.EventFilterSpecRecursionOption recursion) {
        this.recursion = recursion;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EventFilterSpecByEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EventFilterSpecRecursionOption"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
