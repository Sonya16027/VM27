...
public class ProfileDescriptionSection  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param description
     */
    public void setDescription(com.vmware.vim25.ExtendedElementDescription description) {
        this.description = description;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProfileDescriptionSection)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProfileDescriptionSection.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ProfileDescriptionSection"));
