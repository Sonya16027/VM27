...
public class ServiceConsoleReservationInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public ServiceConsoleReservationInfo(
           ...
           long serviceConsoleReservedCfg,
           long serviceConsoleReserved,
           long unreserved) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    /**
     * Gets the serviceConsoleReservedCfg value for this ServiceConsoleReservationInfo.
     * 
    ...
    /**
     * Sets the serviceConsoleReservedCfg value for this ServiceConsoleReservationInfo.
     * 
    ...
    /**
     * Gets the serviceConsoleReserved value for this ServiceConsoleReservationInfo.
     * 
    ...
    /**
     * Sets the serviceConsoleReserved value for this ServiceConsoleReservationInfo.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ServiceConsoleReservationInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            this.serviceConsoleReservedCfg == other.getServiceConsoleReservedCfg() &&
            this.serviceConsoleReserved == other.getServiceConsoleReserved() &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ServiceConsoleReservationInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ServiceConsoleReservationInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("serviceConsoleReservedCfg");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "serviceConsoleReservedCfg"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("serviceConsoleReserved");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "serviceConsoleReserved"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
