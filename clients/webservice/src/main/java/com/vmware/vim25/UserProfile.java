...
public class UserProfile  extends com.vmware.vim25.ApplyProfile  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "UserProfile"));
