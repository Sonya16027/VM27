...
public class ArrayOfVirtualMachineDatastoreInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineDatastoreInfo getVirtualMachineDatastoreInfo(int i) {
        return this.virtualMachineDatastoreInfo[i];
    }

    public void setVirtualMachineDatastoreInfo(int i, com.vmware.vim25.VirtualMachineDatastoreInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfVirtualMachineDatastoreInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineDatastoreInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineDatastoreInfo"));
