...
public class HostNumericSensorHealthState implements java.io.Serializable {
	...
	public static final HostNumericSensorHealthState unknown = new HostNumericSensorHealthState(
			_unknown);
	public static final HostNumericSensorHealthState green = new HostNumericSensorHealthState(
			_green);
	public static final HostNumericSensorHealthState yellow = new HostNumericSensorHealthState(
			_yellow);
	public static final HostNumericSensorHealthState red = new HostNumericSensorHealthState(
			_red);
	...
	public static HostNumericSensorHealthState fromValue(java.lang.String value)
		...
		HostNumericSensorHealthState enumeration = (HostNumericSensorHealthState) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostNumericSensorHealthState.class);
