...
public class VmwareUplinkPortTeamingPolicy  extends com.vmware.vim25.InheritablePolicy  implements java.io.Serializable {
    ...
    public VmwareUplinkPortTeamingPolicy(
           ...
           boolean inherited,
           com.vmware.vim25.StringPolicy policy,
     ...
     */
    public void setFailureCriteria(com.vmware.vim25.DVSFailureCriteria failureCriteria) {
        this.failureCriteria = failureCriteria;
    }
     ...
     */
    public void setUplinkPortOrder(com.vmware.vim25.VMwareUplinkPortOrderPolicy uplinkPortOrder) {
        this.uplinkPortOrder = uplinkPortOrder;
    }
