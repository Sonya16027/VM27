...
public class PatchMissingDependencies extends
		com.vmware.vim25.PatchNotApplicable implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public PatchMissingDependencies(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			com.vmware.vim25.LocalizedMethodFault faultCause,
			com.vmware.vim25.LocalizableMessage[] faultMessage,
			java.lang.String patchID, java.lang.String[] prerequisitePatch,
			java.lang.String[] prerequisiteLib) {
		super(dynamicType, dynamicProperty, faultCause, faultMessage, patchID);
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof PatchMissingDependencies)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.prerequisiteLib == null && other.getPrerequisiteLib() == null) || (this.prerequisiteLib != null && java.util.Arrays
						.equals(this.prerequisiteLib, other
								.getPrerequisiteLib())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPrerequisiteLib() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPrerequisiteLib()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getPrerequisiteLib(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			PatchMissingDependencies.class, true);
