...
public class MismatchedVMotionNetworkNames  extends com.vmware.vim25.MigrationFault  implements java.io.Serializable {
    ...
    public MismatchedVMotionNetworkNames(
           ...
           java.lang.String sourceNetwork,
           java.lang.String destNetwork) {
        super(
            dynamicType,
            dynamicProperty,
            faultCause,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MismatchedVMotionNetworkNames)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.sourceNetwork==null && other.getSourceNetwork()==null) || 
             (this.sourceNetwork!=null &&
              this.sourceNetwork.equals(other.getSourceNetwork()))) &&
            ((this.destNetwork==null && other.getDestNetwork()==null) || 
             (this.destNetwork!=null &&
              this.destNetwork.equals(other.getDestNetwork())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MismatchedVMotionNetworkNames.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "MismatchedVMotionNetworkNames"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sourceNetwork");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "sourceNetwork"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("destNetwork");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "destNetwork"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
