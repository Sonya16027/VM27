...
public class GuestScreenInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int width;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "GuestScreenInfo"));
