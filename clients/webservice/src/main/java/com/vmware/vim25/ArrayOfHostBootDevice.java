...
public class ArrayOfHostBootDevice  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfHostBootDevice)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.hostBootDevice==null && other.getHostBootDevice()==null) || 
             (this.hostBootDevice!=null &&
              java.util.Arrays.equals(this.hostBootDevice, other.getHostBootDevice())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHostBootDevice() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostBootDevice());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostBootDevice(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfHostBootDevice.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostBootDevice"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostBootDevice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostBootDevice"));
