...
public class ArrayOfOvfFileItem implements java.io.Serializable {
	...
	public ArrayOfOvfFileItem(com.vmware.vim25.OvfFileItem[] ovfFileItem) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfOvfFileItem)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.ovfFileItem == null && other.getOvfFileItem() == null) || (this.ovfFileItem != null && java.util.Arrays
				.equals(this.ovfFileItem, other.getOvfFileItem())));
		__equalsCalc = null;
		return _equals;
	}
