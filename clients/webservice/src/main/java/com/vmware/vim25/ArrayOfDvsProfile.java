...
public class ArrayOfDvsProfile implements java.io.Serializable {
	...
	public ArrayOfDvsProfile(com.vmware.vim25.DvsProfile[] dvsProfile) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDvsProfile)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.dvsProfile == null && other.getDvsProfile() == null) || (this.dvsProfile != null && java.util.Arrays
				.equals(this.dvsProfile, other.getDvsProfile())));
		__equalsCalc = null;
		return _equals;
	}
