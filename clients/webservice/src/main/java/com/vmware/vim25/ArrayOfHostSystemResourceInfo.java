...
public class ArrayOfHostSystemResourceInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostSystemResourceInfo getHostSystemResourceInfo(int i) {
        return this.hostSystemResourceInfo[i];
    }

    public void setHostSystemResourceInfo(int i, com.vmware.vim25.HostSystemResourceInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostSystemResourceInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostSystemResourceInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostSystemResourceInfo"));
