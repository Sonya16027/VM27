...
public class ArrayOfDistributedVirtualSwitchHostMemberPnicSpec implements
	...
	/**
	 * Gets the distributedVirtualSwitchHostMemberPnicSpec value for this
	...
	/**
	 * Sets the distributedVirtualSwitchHostMemberPnicSpec value for this
	 * ArrayOfDistributedVirtualSwitchHostMemberPnicSpec.
	 * 
	 * @param distributedVirtualSwitchHostMemberPnicSpec
	 */
	public void setDistributedVirtualSwitchHostMemberPnicSpec(
			com.vmware.vim25.DistributedVirtualSwitchHostMemberPnicSpec[] distributedVirtualSwitchHostMemberPnicSpec) {
		this.distributedVirtualSwitchHostMemberPnicSpec = distributedVirtualSwitchHostMemberPnicSpec;
	}
	...
	public void setDistributedVirtualSwitchHostMemberPnicSpec(int i,
			com.vmware.vim25.DistributedVirtualSwitchHostMemberPnicSpec _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDistributedVirtualSwitchHostMemberPnicSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.distributedVirtualSwitchHostMemberPnicSpec == null && other
				.getDistributedVirtualSwitchHostMemberPnicSpec() == null) || (this.distributedVirtualSwitchHostMemberPnicSpec != null && java.util.Arrays
				.equals(this.distributedVirtualSwitchHostMemberPnicSpec, other
						.getDistributedVirtualSwitchHostMemberPnicSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getDistributedVirtualSwitchHostMemberPnicSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDistributedVirtualSwitchHostMemberPnicSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDistributedVirtualSwitchHostMemberPnicSpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDistributedVirtualSwitchHostMemberPnicSpec.class, true);
