...
public class ArrayOfVmEventArgument implements java.io.Serializable {
	...
	private com.vmware.vim25.VmEventArgument[] vmEventArgument;

	public ArrayOfVmEventArgument() {
	}

	public ArrayOfVmEventArgument(
			com.vmware.vim25.VmEventArgument[] vmEventArgument) {
	 ...
	 */
	public void setVmEventArgument(
			com.vmware.vim25.VmEventArgument[] vmEventArgument) {
		this.vmEventArgument = vmEventArgument;
	}

	public com.vmware.vim25.VmEventArgument getVmEventArgument(int i) {
		return this.vmEventArgument[i];
	}

	public void setVmEventArgument(int i,
			com.vmware.vim25.VmEventArgument _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVmEventArgument)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.vmEventArgument == null && other
				.getVmEventArgument() == null) || (this.vmEventArgument != null && java.util.Arrays
				.equals(this.vmEventArgument, other.getVmEventArgument())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVmEventArgument() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVmEventArgument()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVmEventArgument(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVmEventArgument.class, true);
