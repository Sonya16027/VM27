...
public class StringOption  extends com.vmware.vim25.OptionType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StringOption)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.validCharacters==null && other.getValidCharacters()==null) || 
             (this.validCharacters!=null &&
              this.validCharacters.equals(other.getValidCharacters())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StringOption.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "StringOption"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "validCharacters"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
