...
public class FirewallProfile  extends com.vmware.vim25.ApplyProfile  implements java.io.Serializable {
    private com.vmware.vim25.FirewallProfileRulesetProfile[] ruleset;
    ...
    public FirewallProfile(
           ...
           com.vmware.vim25.FirewallProfileRulesetProfile[] ruleset) {
        super(
            dynamicType,
            dynamicProperty,
            enabled,
     ...
     * @return ruleset
     */
    public com.vmware.vim25.FirewallProfileRulesetProfile[] getRuleset() {
        return ruleset;
    }
     ...
     * @param ruleset
     */
    public void setRuleset(com.vmware.vim25.FirewallProfileRulesetProfile[] ruleset) {
        this.ruleset = ruleset;
    }

    public com.vmware.vim25.FirewallProfileRulesetProfile getRuleset(int i) {
        return this.ruleset[i];
    }

    public void setRuleset(int i, com.vmware.vim25.FirewallProfileRulesetProfile _value) {
