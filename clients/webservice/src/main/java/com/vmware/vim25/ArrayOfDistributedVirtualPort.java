...
public class ArrayOfDistributedVirtualPort implements java.io.Serializable {
	...
	/**
	 * Gets the distributedVirtualPort value for this
	...
	/**
	 * Sets the distributedVirtualPort value for this
	 * ArrayOfDistributedVirtualPort.
	 * 
	 * @param distributedVirtualPort
	 */
	public void setDistributedVirtualPort(
			com.vmware.vim25.DistributedVirtualPort[] distributedVirtualPort) {
		this.distributedVirtualPort = distributedVirtualPort;
	}
	...
	public void setDistributedVirtualPort(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDistributedVirtualPort)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.distributedVirtualPort == null && other
				.getDistributedVirtualPort() == null) || (this.distributedVirtualPort != null && java.util.Arrays
				.equals(this.distributedVirtualPort, other
	...
	public synchronized int hashCode() {
		...
		if (getDistributedVirtualPort() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDistributedVirtualPort()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDistributedVirtualPort(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDistributedVirtualPort.class, true);
