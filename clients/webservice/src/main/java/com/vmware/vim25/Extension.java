...
public class Extension  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public void setEventList(int i, com.vmware.vim25.ExtensionEventTypeInfo _value) {
    ...
    public void setFaultList(int i, com.vmware.vim25.ExtensionFaultTypeInfo _value) {
     ...
     * @param privilegeList
     */
    public void setPrivilegeList(com.vmware.vim25.ExtensionPrivilegeInfo[] privilegeList) {
        this.privilegeList = privilegeList;
    }
    ...
    public void setPrivilegeList(int i, com.vmware.vim25.ExtensionPrivilegeInfo _value) {
     ...
     * @param resourceList
     */
    public void setResourceList(com.vmware.vim25.ExtensionResourceInfo[] resourceList) {
        this.resourceList = resourceList;
    }
    ...
    public void setResourceList(int i, com.vmware.vim25.ExtensionResourceInfo _value) {
