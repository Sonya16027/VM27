...
public class CustomizationIPSettingsIpV6AddressSpec extends
	...
	public CustomizationIPSettingsIpV6AddressSpec(java.lang.String dynamicType,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CustomizationIPSettingsIpV6AddressSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.ip == null && other.getIp() == null) || (this.ip != null && java.util.Arrays
						.equals(this.ip, other.getIp())))
	...
	public synchronized int hashCode() {
		...
		if (getIp() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getIp()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			CustomizationIPSettingsIpV6AddressSpec.class, true);
