...
public class HostIpmiInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostIpmiInfo(
           ...
           java.lang.String bmcIpAddress,
           java.lang.String bmcMacAddress,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostIpmiInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.bmcIpAddress==null && other.getBmcIpAddress()==null) || 
             (this.bmcIpAddress!=null &&
              this.bmcIpAddress.equals(other.getBmcIpAddress()))) &&
            ((this.bmcMacAddress==null && other.getBmcMacAddress()==null) || 
             (this.bmcMacAddress!=null &&
              this.bmcMacAddress.equals(other.getBmcMacAddress()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostIpmiInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostIpmiInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bmcIpAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "bmcIpAddress"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "bmcMacAddress"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "login"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
