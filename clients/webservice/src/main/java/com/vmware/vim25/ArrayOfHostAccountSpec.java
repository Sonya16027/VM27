...
public class ArrayOfHostAccountSpec implements java.io.Serializable {
	 ...
	 */
	public void setHostAccountSpec(
			com.vmware.vim25.HostAccountSpec[] hostAccountSpec) {
		this.hostAccountSpec = hostAccountSpec;
	}
	...
	public void setHostAccountSpec(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostAccountSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostAccountSpec == null && other
				.getHostAccountSpec() == null) || (this.hostAccountSpec != null && java.util.Arrays
				.equals(this.hostAccountSpec, other.getHostAccountSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostAccountSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostAccountSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostAccountSpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostAccountSpec.class, true);
