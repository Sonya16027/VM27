...
public class HostFirewallRuleProtocol implements java.io.Serializable {
	...
	public static final HostFirewallRuleProtocol tcp = new HostFirewallRuleProtocol(
			_tcp);
	public static final HostFirewallRuleProtocol udp = new HostFirewallRuleProtocol(
			_udp);
	...
	public static HostFirewallRuleProtocol fromValue(java.lang.String value)
		...
		HostFirewallRuleProtocol enumeration = (HostFirewallRuleProtocol) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostFirewallRuleProtocol.class);
