...
public class VirtualDiskSparseVer1BackingOption  extends com.vmware.vim25.VirtualDeviceFileBackingOption  implements java.io.Serializable {
    private com.vmware.vim25.ChoiceOption diskModes;
    ...
    public VirtualDiskSparseVer1BackingOption(
           ...
           com.vmware.vim25.ChoiceOption diskModes,
     ...
     * @return diskModes
     */
    public com.vmware.vim25.ChoiceOption getDiskModes() {
        return diskModes;
    }
     ...
     * @param diskModes
     */
    public void setDiskModes(com.vmware.vim25.ChoiceOption diskModes) {
        this.diskModes = diskModes;
    }
