...
public class ArrayOfVirtualDeviceConfigSpec  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualDeviceConfigSpec getVirtualDeviceConfigSpec(int i) {
        return this.virtualDeviceConfigSpec[i];
    }

    public void setVirtualDeviceConfigSpec(int i, com.vmware.vim25.VirtualDeviceConfigSpec _value) {
