...
public class AlarmTriggeringActionTransitionSpec extends
	...
	public AlarmTriggeringActionTransitionSpec(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			com.vmware.vim25.ManagedEntityStatus startState,
			com.vmware.vim25.ManagedEntityStatus finalState, boolean repeats) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof AlarmTriggeringActionTransitionSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.startState == null && other.getStartState() == null) || (this.startState != null && this.startState
						.equals(other.getStartState())))
				&& ((this.finalState == null && other.getFinalState() == null) || (this.finalState != null && this.finalState
						.equals(other.getFinalState())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			AlarmTriggeringActionTransitionSpec.class, true);
