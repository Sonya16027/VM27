...
public class ArrayOfDiagnosticManagerLogDescriptor  implements java.io.Serializable {
    ...
    public com.vmware.vim25.DiagnosticManagerLogDescriptor getDiagnosticManagerLogDescriptor(int i) {
        return this.diagnosticManagerLogDescriptor[i];
    }

    public void setDiagnosticManagerLogDescriptor(int i, com.vmware.vim25.DiagnosticManagerLogDescriptor _value) {
