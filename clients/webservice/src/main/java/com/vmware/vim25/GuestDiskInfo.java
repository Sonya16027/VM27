...
public class GuestDiskInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GuestDiskInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.diskPath==null && other.getDiskPath()==null) || 
             (this.diskPath!=null &&
              this.diskPath.equals(other.getDiskPath()))) &&
            ((this.capacity==null && other.getCapacity()==null) || 
             (this.capacity!=null &&
              this.capacity.equals(other.getCapacity()))) &&
            ((this.freeSpace==null && other.getFreeSpace()==null) || 
             (this.freeSpace!=null &&
              this.freeSpace.equals(other.getFreeSpace())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GuestDiskInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "GuestDiskInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("diskPath");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "diskPath"));
