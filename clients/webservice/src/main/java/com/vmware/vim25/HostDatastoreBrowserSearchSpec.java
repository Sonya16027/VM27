...
public class HostDatastoreBrowserSearchSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.FileQuery[] query;

    private com.vmware.vim25.FileQueryFlags details;
    ...
    public HostDatastoreBrowserSearchSpec(
           ...
           com.vmware.vim25.FileQuery[] query,
           com.vmware.vim25.FileQueryFlags details,
           java.lang.Boolean searchCaseInsensitive,
           java.lang.String[] matchPattern,
           java.lang.Boolean sortFoldersFirst) {
        super(
            dynamicType,
            dynamicProperty);
        this.query = query;
     ...
     * @return query
     */
    public com.vmware.vim25.FileQuery[] getQuery() {
        return query;
    }
     ...
     * @param query
     */
    public void setQuery(com.vmware.vim25.FileQuery[] query) {
        this.query = query;
    }

    public com.vmware.vim25.FileQuery getQuery(int i) {
        return this.query[i];
    }

    public void setQuery(int i, com.vmware.vim25.FileQuery _value) {
        this.query[i] = _value;
    }
     ...
     * @return details
     */
    public com.vmware.vim25.FileQueryFlags getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(com.vmware.vim25.FileQueryFlags details) {
        this.details = details;
    }


    /**
     * Gets the searchCaseInsensitive value for this HostDatastoreBrowserSearchSpec.
     * 
    ...
    /**
     * Sets the searchCaseInsensitive value for this HostDatastoreBrowserSearchSpec.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostDatastoreBrowserSearchSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.searchCaseInsensitive==null && other.getSearchCaseInsensitive()==null) || 
             (this.searchCaseInsensitive!=null &&
              this.searchCaseInsensitive.equals(other.getSearchCaseInsensitive()))) &&
            ((this.matchPattern==null && other.getMatchPattern()==null) || 
             (this.matchPattern!=null &&
              java.util.Arrays.equals(this.matchPattern, other.getMatchPattern()))) &&
            ((this.sortFoldersFirst==null && other.getSortFoldersFirst()==null) || 
             (this.sortFoldersFirst!=null &&
              this.sortFoldersFirst.equals(other.getSortFoldersFirst())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMatchPattern() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMatchPattern());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMatchPattern(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostDatastoreBrowserSearchSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostDatastoreBrowserSearchSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("query");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "query"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "FileQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "FileQueryFlags"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("searchCaseInsensitive");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "searchCaseInsensitive"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "matchPattern"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "sortFoldersFirst"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
