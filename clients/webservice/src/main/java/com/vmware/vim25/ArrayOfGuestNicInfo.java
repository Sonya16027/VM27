...
public class ArrayOfGuestNicInfo  implements java.io.Serializable {
    ...
    public ArrayOfGuestNicInfo(
           com.vmware.vim25.GuestNicInfo[] guestNicInfo) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfGuestNicInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("guestNicInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "GuestNicInfo"));
