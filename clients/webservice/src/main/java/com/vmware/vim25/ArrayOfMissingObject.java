...
public class ArrayOfMissingObject  implements java.io.Serializable {
    ...
    public ArrayOfMissingObject(
           com.vmware.vim25.MissingObject[] missingObject) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfMissingObject"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("missingObject");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "MissingObject"));
