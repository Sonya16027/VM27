...
public class ArrayOfProductComponentInfo implements java.io.Serializable {
	 ...
	 */
	public void setProductComponentInfo(
			com.vmware.vim25.ProductComponentInfo[] productComponentInfo) {
		this.productComponentInfo = productComponentInfo;
	}
	...
	public void setProductComponentInfo(int i,
			com.vmware.vim25.ProductComponentInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfProductComponentInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.productComponentInfo == null && other
				.getProductComponentInfo() == null) || (this.productComponentInfo != null && java.util.Arrays
				.equals(this.productComponentInfo, other
						.getProductComponentInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getProductComponentInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getProductComponentInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getProductComponentInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfProductComponentInfo.class, true);
