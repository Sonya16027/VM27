...
public class ArrayOfProfileExpressionMetadata implements java.io.Serializable {
	...
	/**
	 * Gets the profileExpressionMetadata value for this
	...
	/**
	 * Sets the profileExpressionMetadata value for this
	 * ArrayOfProfileExpressionMetadata.
	 * 
	 * @param profileExpressionMetadata
	 */
	public void setProfileExpressionMetadata(
			com.vmware.vim25.ProfileExpressionMetadata[] profileExpressionMetadata) {
		this.profileExpressionMetadata = profileExpressionMetadata;
	}
	...
	public void setProfileExpressionMetadata(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfProfileExpressionMetadata)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.profileExpressionMetadata == null && other
				.getProfileExpressionMetadata() == null) || (this.profileExpressionMetadata != null && java.util.Arrays
				.equals(this.profileExpressionMetadata, other
						.getProfileExpressionMetadata())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getProfileExpressionMetadata() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getProfileExpressionMetadata()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getProfileExpressionMetadata(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfProfileExpressionMetadata.class, true);
