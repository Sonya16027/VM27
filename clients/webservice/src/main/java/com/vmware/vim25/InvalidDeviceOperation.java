...
public class InvalidDeviceOperation  extends com.vmware.vim25.InvalidDeviceSpec  implements java.io.Serializable {
     ...
     * @param badFileOp
     */
    public void setBadFileOp(com.vmware.vim25.VirtualDeviceConfigSpecFileOperation badFileOp) {
        this.badFileOp = badFileOp;
    }
