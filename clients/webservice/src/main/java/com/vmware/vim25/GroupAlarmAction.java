...
public class GroupAlarmAction  extends com.vmware.vim25.AlarmAction  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "GroupAlarmAction"));
