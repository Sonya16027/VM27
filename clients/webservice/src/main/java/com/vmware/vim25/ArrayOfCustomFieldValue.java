...
public class ArrayOfCustomFieldValue  implements java.io.Serializable {
    ...
    public void setCustomFieldValue(int i, com.vmware.vim25.CustomFieldValue _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfCustomFieldValue"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("customFieldValue");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "CustomFieldValue"));
