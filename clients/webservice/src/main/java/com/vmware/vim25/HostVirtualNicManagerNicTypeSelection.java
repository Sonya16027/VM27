...
public class HostVirtualNicManagerNicTypeSelection  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostVirtualNicManagerNicTypeSelection)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.nicType==null && other.getNicType()==null) || 
             (this.nicType!=null &&
              java.util.Arrays.equals(this.nicType, other.getNicType())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getNicType() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getNicType());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getNicType(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostVirtualNicManagerNicTypeSelection.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostVirtualNicManagerNicTypeSelection"));
