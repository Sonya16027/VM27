...
public class VirtualVmxnet2Option  extends com.vmware.vim25.VirtualVmxnetOption  implements java.io.Serializable {
    public VirtualVmxnet2Option() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualVmxnet2Option)) return false;
        VirtualVmxnet2Option other = (VirtualVmxnet2Option) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualVmxnet2Option.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualVmxnet2Option"));
    }
