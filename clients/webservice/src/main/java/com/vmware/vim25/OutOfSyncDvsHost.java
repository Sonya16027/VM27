...
public class OutOfSyncDvsHost  extends com.vmware.vim25.DvsEvent  implements java.io.Serializable {
     ...
     * @param hostOutOfSync
     */
    public void setHostOutOfSync(com.vmware.vim25.DvsOutOfSyncHostArgument[] hostOutOfSync) {
        this.hostOutOfSync = hostOutOfSync;
    }
    ...
    public void setHostOutOfSync(int i, com.vmware.vim25.DvsOutOfSyncHostArgument _value) {
