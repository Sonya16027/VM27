...
public class ArrayOfProfilePolicy  implements java.io.Serializable {
    ...
    public ArrayOfProfilePolicy(
           com.vmware.vim25.ProfilePolicy[] profilePolicy) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfProfilePolicy)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.profilePolicy==null && other.getProfilePolicy()==null) || 
             (this.profilePolicy!=null &&
              java.util.Arrays.equals(this.profilePolicy, other.getProfilePolicy())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getProfilePolicy() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getProfilePolicy());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getProfilePolicy(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfProfilePolicy.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfProfilePolicy"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("profilePolicy");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ProfilePolicy"));
