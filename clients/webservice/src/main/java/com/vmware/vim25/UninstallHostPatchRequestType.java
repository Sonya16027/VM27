...
public class UninstallHostPatchRequestType implements java.io.Serializable {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof UninstallHostPatchRequestType)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.bulletinIds == null && other.getBulletinIds() == null) || (this.bulletinIds != null && java.util.Arrays
						.equals(this.bulletinIds, other.getBulletinIds())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			UninstallHostPatchRequestType.class, true);
