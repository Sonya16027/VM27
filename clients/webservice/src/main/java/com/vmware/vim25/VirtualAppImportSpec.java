...
public class VirtualAppImportSpec extends com.vmware.vim25.ImportSpec implements
	...
	public VirtualAppImportSpec(java.lang.String dynamicType,
		...
		super(dynamicType, dynamicProperty, entityConfig);
		this.name = name;
	 ...
	 */
	public void setResourcePoolSpec(
			com.vmware.vim25.ResourceConfigSpec resourcePoolSpec) {
		this.resourcePoolSpec = resourcePoolSpec;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VirtualAppImportSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.vAppConfigSpec == null && other.getVAppConfigSpec() == null) || (this.vAppConfigSpec != null && this.vAppConfigSpec
						.equals(other.getVAppConfigSpec())))
				&& ((this.resourcePoolSpec == null && other
						.getResourcePoolSpec() == null) || (this.resourcePoolSpec != null && this.resourcePoolSpec
						.equals(other.getResourcePoolSpec())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualAppImportSpec.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "child"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
				"ImportSpec"));
