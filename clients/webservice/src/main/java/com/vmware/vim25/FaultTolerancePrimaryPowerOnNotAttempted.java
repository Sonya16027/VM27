...
public class FaultTolerancePrimaryPowerOnNotAttempted extends
	...
	/**
	 * Gets the secondaryVm value for this
	...
	/**
	 * Sets the secondaryVm value for this
	 * FaultTolerancePrimaryPowerOnNotAttempted.
	 * 
	 * @param secondaryVm
	 */
	public void setSecondaryVm(
			com.vmware.vim25.ManagedObjectReference secondaryVm) {
		this.secondaryVm = secondaryVm;
	}

	/**
	 * Gets the primaryVm value for this
	 * FaultTolerancePrimaryPowerOnNotAttempted.
	 * 
	 * @return primaryVm
	 */
	...
	/**
	 * Sets the primaryVm value for this
	 * FaultTolerancePrimaryPowerOnNotAttempted.
	 * 
	 * @param primaryVm
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FaultTolerancePrimaryPowerOnNotAttempted)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.secondaryVm == null && other.getSecondaryVm() == null) || (this.secondaryVm != null && this.secondaryVm
						.equals(other.getSecondaryVm())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FaultTolerancePrimaryPowerOnNotAttempted.class, true);
