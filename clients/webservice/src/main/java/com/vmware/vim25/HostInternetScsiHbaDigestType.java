...
public class HostInternetScsiHbaDigestType implements java.io.Serializable {
	...
	public static final HostInternetScsiHbaDigestType digestProhibited = new HostInternetScsiHbaDigestType(
			_digestProhibited);
	public static final HostInternetScsiHbaDigestType digestDiscouraged = new HostInternetScsiHbaDigestType(
			_digestDiscouraged);
	public static final HostInternetScsiHbaDigestType digestPreferred = new HostInternetScsiHbaDigestType(
			_digestPreferred);
	public static final HostInternetScsiHbaDigestType digestRequired = new HostInternetScsiHbaDigestType(
			_digestRequired);
	...
	public static HostInternetScsiHbaDigestType fromValue(java.lang.String value)
		...
		HostInternetScsiHbaDigestType enumeration = (HostInternetScsiHbaDigestType) _table_
				.get(value);
		if (enumeration == null) {
	...
	public static HostInternetScsiHbaDigestType fromString(
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostInternetScsiHbaDigestType.class);
