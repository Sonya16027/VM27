...
public class HostPosixAccountSpec  extends com.vmware.vim25.HostAccountSpec  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostPosixAccountSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.posixId==null && other.getPosixId()==null) || 
             (this.posixId!=null &&
              this.posixId.equals(other.getPosixId()))) &&
            ((this.shellAccess==null && other.getShellAccess()==null) || 
             (this.shellAccess!=null &&
              this.shellAccess.equals(other.getShellAccess())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostPosixAccountSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostPosixAccountSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("posixId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "posixId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "shellAccess"));
