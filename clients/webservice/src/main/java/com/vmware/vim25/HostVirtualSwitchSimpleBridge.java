...
public class HostVirtualSwitchSimpleBridge  extends com.vmware.vim25.HostVirtualSwitchBridge  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostVirtualSwitchSimpleBridge"));
