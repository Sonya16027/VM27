...
public class HostFibreChannelTargetTransport  extends com.vmware.vim25.HostTargetTransport  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostFibreChannelTargetTransport"));
