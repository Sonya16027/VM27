...
public class ArrayOfHostDiskPartitionInfo  implements java.io.Serializable {
    private com.vmware.vim25.HostDiskPartitionInfo[] hostDiskPartitionInfo;

    public ArrayOfHostDiskPartitionInfo() {
    }

    public ArrayOfHostDiskPartitionInfo(
           com.vmware.vim25.HostDiskPartitionInfo[] hostDiskPartitionInfo) {
    ...
    public com.vmware.vim25.HostDiskPartitionInfo getHostDiskPartitionInfo(int i) {
        return this.hostDiskPartitionInfo[i];
    }

    public void setHostDiskPartitionInfo(int i, com.vmware.vim25.HostDiskPartitionInfo _value) {
