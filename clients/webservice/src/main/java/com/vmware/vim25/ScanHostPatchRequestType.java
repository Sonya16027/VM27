...
public class ScanHostPatchRequestType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ScanHostPatchRequestType)) return false;
        ...
        _equals = true && 
            ...
            ((this.updateID==null && other.getUpdateID()==null) || 
             (this.updateID!=null &&
              java.util.Arrays.equals(this.updateID, other.getUpdateID())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getUpdateID() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getUpdateID());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getUpdateID(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ScanHostPatchRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ScanHostPatchRequestType"));
