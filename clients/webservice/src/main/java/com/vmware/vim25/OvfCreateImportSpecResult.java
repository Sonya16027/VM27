...
public class OvfCreateImportSpecResult  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OvfCreateImportSpecResult)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.importSpec==null && other.getImportSpec()==null) || 
             (this.importSpec!=null &&
              this.importSpec.equals(other.getImportSpec()))) &&
            ((this.fileItem==null && other.getFileItem()==null) || 
             (this.fileItem!=null &&
              java.util.Arrays.equals(this.fileItem, other.getFileItem()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getFileItem() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getFileItem());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getFileItem(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OvfCreateImportSpecResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "OvfCreateImportSpecResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "fileItem"));
