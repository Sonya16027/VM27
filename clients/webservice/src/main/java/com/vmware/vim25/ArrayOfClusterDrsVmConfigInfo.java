...
public class ArrayOfClusterDrsVmConfigInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.ClusterDrsVmConfigInfo getClusterDrsVmConfigInfo(int i) {
        return this.clusterDrsVmConfigInfo[i];
    }

    public void setClusterDrsVmConfigInfo(int i, com.vmware.vim25.ClusterDrsVmConfigInfo _value) {
