...
public class HostDiskDimensionsLba extends com.vmware.vim25.DynamicData
	...
	public HostDiskDimensionsLba(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty, int blockSize,
			long block) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "block"));
		elemField.setXmlType(new javax.xml.namespace.QName(
