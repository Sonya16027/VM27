...
public class VirtualMachineHtSharing implements java.io.Serializable {
	...
	public static final VirtualMachineHtSharing any = new VirtualMachineHtSharing(
			_any);
	public static final VirtualMachineHtSharing none = new VirtualMachineHtSharing(
			_none);
	public static final VirtualMachineHtSharing internal = new VirtualMachineHtSharing(
			_internal);
	...
	public static VirtualMachineHtSharing fromValue(java.lang.String value)
		...
		VirtualMachineHtSharing enumeration = (VirtualMachineHtSharing) _table_
				.get(value);
		if (enumeration == null) {
