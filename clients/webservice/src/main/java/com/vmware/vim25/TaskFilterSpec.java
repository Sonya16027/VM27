...
public class TaskFilterSpec extends com.vmware.vim25.DynamicData implements
	...
	public TaskFilterSpec(java.lang.String dynamicType,
			...
			int[] eventChainId, java.lang.String[] tag,
			java.lang.String[] parentTaskKey, java.lang.String[] rootTaskKey) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof TaskFilterSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.eventChainId == null && other.getEventChainId() == null) || (this.eventChainId != null && java.util.Arrays
						.equals(this.eventChainId, other.getEventChainId())))
				&& ((this.tag == null && other.getTag() == null) || (this.tag != null && java.util.Arrays
						.equals(this.tag, other.getTag())))
				&& ((this.parentTaskKey == null && other.getParentTaskKey() == null) || (this.parentTaskKey != null && java.util.Arrays
						.equals(this.parentTaskKey, other.getParentTaskKey())))
				&& ((this.rootTaskKey == null && other.getRootTaskKey() == null) || (this.rootTaskKey != null && java.util.Arrays
						.equals(this.rootTaskKey, other.getRootTaskKey())));
		__equalsCalc = null;
		return _equals;
	}
