...
public class VirtualMachineTargetInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualMachineTargetInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.configurationTag==null && other.getConfigurationTag()==null) || 
             (this.configurationTag!=null &&
              java.util.Arrays.equals(this.configurationTag, other.getConfigurationTag())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getConfigurationTag() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getConfigurationTag());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getConfigurationTag(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualMachineTargetInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineTargetInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "configurationTag"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
