...
public class ConfigTarget extends com.vmware.vim25.DynamicData implements
	...
	public void setDatastore(int i,
			com.vmware.vim25.VirtualMachineDatastoreInfo _value) {
	...
	public void setNetwork(int i,
			com.vmware.vim25.VirtualMachineNetworkInfo _value) {
	...
	public void setSerial(int i,
			com.vmware.vim25.VirtualMachineSerialInfo _value) {
	...
	public void setParallel(int i,
			com.vmware.vim25.VirtualMachineParallelInfo _value) {
	...
	public void setFloppy(int i,
			com.vmware.vim25.VirtualMachineFloppyInfo _value) {
	...
	public void setLegacyNetworkInfo(int i,
			com.vmware.vim25.VirtualMachineLegacyNetworkSwitchInfo _value) {
	...
	public void setScsiDisk(int i,
			com.vmware.vim25.VirtualMachineScsiDiskDeviceInfo _value) {
	...
	public void setPciPassthrough(int i,
			com.vmware.vim25.VirtualMachinePciPassthroughInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.sound == null && other.getSound() == null) || (this.sound != null && java.util.Arrays
						.equals(this.sound, other.getSound())))
				&& ((this.usb == null && other.getUsb() == null) || (this.usb != null && java.util.Arrays
						.equals(this.usb, other.getUsb())))
				...
				&& ((this.pciPassthrough == null && other.getPciPassthrough() == null) || (this.pciPassthrough != null && java.util.Arrays
						.equals(this.pciPassthrough, other.getPciPassthrough())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getSound() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getSound()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getSound(),
						i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
		...
		if (getUsb() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getUsb()); i++) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "cdRom"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "sound"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
