...
public class VirtualSCSISharing implements java.io.Serializable {
    ...
    public static final VirtualSCSISharing noSharing = new VirtualSCSISharing(_noSharing);
    public static final VirtualSCSISharing virtualSharing = new VirtualSCSISharing(_virtualSharing);
    public static final VirtualSCSISharing physicalSharing = new VirtualSCSISharing(_physicalSharing);
    public java.lang.String getValue() { return _value_;}
    public static VirtualSCSISharing fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        VirtualSCSISharing enumeration = (VirtualSCSISharing)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualSCSISharing.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualSCSISharing"));
    }
    /**
