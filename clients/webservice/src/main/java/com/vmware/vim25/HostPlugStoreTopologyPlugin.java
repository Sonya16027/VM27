...
public class HostPlugStoreTopologyPlugin  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostPlugStoreTopologyPlugin)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.claimedPath==null && other.getClaimedPath()==null) || 
             (this.claimedPath!=null &&
              java.util.Arrays.equals(this.claimedPath, other.getClaimedPath())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getClaimedPath() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getClaimedPath());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getClaimedPath(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostPlugStoreTopologyPlugin.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostPlugStoreTopologyPlugin"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "claimedPath"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
