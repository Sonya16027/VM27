...
public class VirtualMachineFileLayoutSnapshotLayout  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the snapshotFile value for this VirtualMachineFileLayoutSnapshotLayout.
     * 
     * @return snapshotFile
     */
    ...
    /**
     * Sets the snapshotFile value for this VirtualMachineFileLayoutSnapshotLayout.
     * 
     * @param snapshotFile
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualMachineFileLayoutSnapshotLayout)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.snapshotFile==null && other.getSnapshotFile()==null) || 
             (this.snapshotFile!=null &&
              java.util.Arrays.equals(this.snapshotFile, other.getSnapshotFile())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSnapshotFile() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSnapshotFile());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSnapshotFile(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualMachineFileLayoutSnapshotLayout.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineFileLayoutSnapshotLayout"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "snapshotFile"));
