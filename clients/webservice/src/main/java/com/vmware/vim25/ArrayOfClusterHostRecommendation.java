...
public class ArrayOfClusterHostRecommendation  implements java.io.Serializable {
    ...
    public com.vmware.vim25.ClusterHostRecommendation getClusterHostRecommendation(int i) {
        return this.clusterHostRecommendation[i];
    }

    public void setClusterHostRecommendation(int i, com.vmware.vim25.ClusterHostRecommendation _value) {
