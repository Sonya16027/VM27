...
public class VAppOvfSectionSpec  extends com.vmware.vim25.ArrayUpdateSpec  implements java.io.Serializable {
    ...
    public VAppOvfSectionSpec(
           ...
           com.vmware.vim25.VAppOvfSectionInfo info) {
        super(
            dynamicType,
            dynamicProperty,
            operation,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VAppOvfSectionSpec)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VAppOvfSectionSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VAppOvfSectionSpec"));
