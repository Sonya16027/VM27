...
public class ArrayOfCheckResult  implements java.io.Serializable {
    ...
    public ArrayOfCheckResult(
           com.vmware.vim25.CheckResult[] checkResult) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfCheckResult)) return false;
        ...
        _equals = true && 
            ((this.checkResult==null && other.getCheckResult()==null) || 
             (this.checkResult!=null &&
              java.util.Arrays.equals(this.checkResult, other.getCheckResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCheckResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCheckResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCheckResult(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfCheckResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfCheckResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("checkResult");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "CheckResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CheckResult"));
