...
public class ExpandVmfsDatastoreRequestType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExpandVmfsDatastoreRequestType)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExpandVmfsDatastoreRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ExpandVmfsDatastoreRequestType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmfsDatastoreExpandSpec"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
