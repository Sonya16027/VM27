...
public class ArrayOfHostDiskPartitionAttributes  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostDiskPartitionAttributes getHostDiskPartitionAttributes(int i) {
        return this.hostDiskPartitionAttributes[i];
    }

    public void setHostDiskPartitionAttributes(int i, com.vmware.vim25.HostDiskPartitionAttributes _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostDiskPartitionAttributes"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostDiskPartitionAttributes");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostDiskPartitionAttributes"));
