...
public class ArrayOfManagedObjectReference  implements java.io.Serializable {
    ...
    public com.vmware.vim25.ManagedObjectReference getManagedObjectReference(int i) {
        return this.managedObjectReference[i];
    }

    public void setManagedObjectReference(int i, com.vmware.vim25.ManagedObjectReference _value) {
