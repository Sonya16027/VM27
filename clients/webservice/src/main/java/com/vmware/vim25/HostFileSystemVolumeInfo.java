...
public class HostFileSystemVolumeInfo extends com.vmware.vim25.DynamicData
	...
	private com.vmware.vim25.HostFileSystemMountInfo[] mountInfo;
	...
	public HostFileSystemVolumeInfo(java.lang.String dynamicType,
			...
			com.vmware.vim25.HostFileSystemMountInfo[] mountInfo) {
	 ...
	 * @return mountInfo
	 */
	public com.vmware.vim25.HostFileSystemMountInfo[] getMountInfo() {
		return mountInfo;
	}
	...
	public com.vmware.vim25.HostFileSystemMountInfo getMountInfo(int i) {
		return this.mountInfo[i];
	}

	public void setMountInfo(int i,
			com.vmware.vim25.HostFileSystemMountInfo _value) {
