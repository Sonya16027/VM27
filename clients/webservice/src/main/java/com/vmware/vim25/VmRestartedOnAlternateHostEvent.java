...
public class VmRestartedOnAlternateHostEvent  extends com.vmware.vim25.VmPoweredOnEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmRestartedOnAlternateHostEvent"));
