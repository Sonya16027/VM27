...
public class ArrayOfPhysicalNicNameHint  implements java.io.Serializable {
    ...
    public void setPhysicalNicNameHint(int i, com.vmware.vim25.PhysicalNicNameHint _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfPhysicalNicNameHint"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("physicalNicNameHint");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "PhysicalNicNameHint"));
