...
public class ArrayOfUserGroupProfile implements java.io.Serializable {
	 ...
	 */
	public void setUserGroupProfile(
			com.vmware.vim25.UserGroupProfile[] userGroupProfile) {
		this.userGroupProfile = userGroupProfile;
	}
	...
	public void setUserGroupProfile(int i,
			com.vmware.vim25.UserGroupProfile _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfUserGroupProfile)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.userGroupProfile == null && other
				.getUserGroupProfile() == null) || (this.userGroupProfile != null && java.util.Arrays
				.equals(this.userGroupProfile, other.getUserGroupProfile())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getUserGroupProfile() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getUserGroupProfile()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getUserGroupProfile(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfUserGroupProfile.class, true);
