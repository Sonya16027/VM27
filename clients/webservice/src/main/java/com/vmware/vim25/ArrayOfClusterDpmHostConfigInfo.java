...
public class ArrayOfClusterDpmHostConfigInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.ClusterDpmHostConfigInfo getClusterDpmHostConfigInfo(int i) {
        return this.clusterDpmHostConfigInfo[i];
    }

    public void setClusterDpmHostConfigInfo(int i, com.vmware.vim25.ClusterDpmHostConfigInfo _value) {
