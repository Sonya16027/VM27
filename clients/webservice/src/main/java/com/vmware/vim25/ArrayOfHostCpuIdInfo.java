...
public class ArrayOfHostCpuIdInfo  implements java.io.Serializable {
    ...
    public ArrayOfHostCpuIdInfo(
           com.vmware.vim25.HostCpuIdInfo[] hostCpuIdInfo) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostCpuIdInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostCpuIdInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostCpuIdInfo"));
