...
public class ArrayOfLicenseManagerLicenseInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.LicenseManagerLicenseInfo getLicenseManagerLicenseInfo(int i) {
        return this.licenseManagerLicenseInfo[i];
    }

    public void setLicenseManagerLicenseInfo(int i, com.vmware.vim25.LicenseManagerLicenseInfo _value) {
