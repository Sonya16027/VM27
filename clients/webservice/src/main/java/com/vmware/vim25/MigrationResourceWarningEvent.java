...
public class MigrationResourceWarningEvent  extends com.vmware.vim25.MigrationEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "MigrationResourceWarningEvent"));
