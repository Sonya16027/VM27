...
public class ArrayOfHostPciPassthruInfo implements java.io.Serializable {
	 ...
	 */
	public void setHostPciPassthruInfo(
			com.vmware.vim25.HostPciPassthruInfo[] hostPciPassthruInfo) {
		this.hostPciPassthruInfo = hostPciPassthruInfo;
	}
	...
	public void setHostPciPassthruInfo(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostPciPassthruInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostPciPassthruInfo == null && other
				.getHostPciPassthruInfo() == null) || (this.hostPciPassthruInfo != null && java.util.Arrays
				.equals(this.hostPciPassthruInfo, other
						.getHostPciPassthruInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostPciPassthruInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostPciPassthruInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostPciPassthruInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostPciPassthruInfo.class, true);
