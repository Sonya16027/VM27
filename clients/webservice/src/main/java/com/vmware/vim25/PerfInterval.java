...
public class PerfInterval  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int key;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PerfInterval"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "samplingPeriod"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
