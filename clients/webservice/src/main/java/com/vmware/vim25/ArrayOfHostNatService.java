...
public class ArrayOfHostNatService  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfHostNatService)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.hostNatService==null && other.getHostNatService()==null) || 
             (this.hostNatService!=null &&
              java.util.Arrays.equals(this.hostNatService, other.getHostNatService())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHostNatService() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostNatService());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostNatService(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfHostNatService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostNatService"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostNatService");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostNatService"));
