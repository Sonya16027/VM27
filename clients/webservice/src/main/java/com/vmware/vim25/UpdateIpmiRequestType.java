...
public class UpdateIpmiRequestType implements java.io.Serializable {
	...
	public UpdateIpmiRequestType(com.vmware.vim25.ManagedObjectReference _this,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof UpdateIpmiRequestType)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.ipmiInfo == null && other.getIpmiInfo() == null) || (this.ipmiInfo != null && this.ipmiInfo
						.equals(other.getIpmiInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			UpdateIpmiRequestType.class, true);
