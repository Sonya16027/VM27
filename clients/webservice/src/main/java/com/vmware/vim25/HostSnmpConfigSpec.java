...
public class HostSnmpConfigSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param trapTargets
     */
    public void setTrapTargets(com.vmware.vim25.HostSnmpDestination[] trapTargets) {
        this.trapTargets = trapTargets;
    }
    ...
    public void setTrapTargets(int i, com.vmware.vim25.HostSnmpDestination _value) {
        this.trapTargets[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostSnmpConfigSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.readOnlyCommunities==null && other.getReadOnlyCommunities()==null) || 
             (this.readOnlyCommunities!=null &&
              java.util.Arrays.equals(this.readOnlyCommunities, other.getReadOnlyCommunities()))) &&
            ((this.trapTargets==null && other.getTrapTargets()==null) || 
             (this.trapTargets!=null &&
              java.util.Arrays.equals(this.trapTargets, other.getTrapTargets())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getReadOnlyCommunities() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getReadOnlyCommunities());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getReadOnlyCommunities(), i);
                if (obj != null &&
        ...
        if (getTrapTargets() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getTrapTargets());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getTrapTargets(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostSnmpConfigSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostSnmpConfigSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "readOnlyCommunities"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "trapTargets"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostSnmpDestination"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
