...
public class MemorySizeNotSupported  extends com.vmware.vim25.VirtualHardwareCompatibilityIssue  implements java.io.Serializable {
    ...
    /**
     * Gets the memorySizeMB value for this MemorySizeNotSupported.
     * 
     * @return memorySizeMB
     */
    ...
    /**
     * Sets the memorySizeMB value for this MemorySizeNotSupported.
     * 
     * @param memorySizeMB
     */
    ...
    /**
     * Gets the minMemorySizeMB value for this MemorySizeNotSupported.
     * 
    ...
    /**
     * Sets the minMemorySizeMB value for this MemorySizeNotSupported.
     * 
    ...
    /**
     * Gets the maxMemorySizeMB value for this MemorySizeNotSupported.
     * 
    ...
    /**
     * Sets the maxMemorySizeMB value for this MemorySizeNotSupported.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MemorySizeNotSupported)) return false;
        MemorySizeNotSupported other = (MemorySizeNotSupported) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MemorySizeNotSupported.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "MemorySizeNotSupported"));
