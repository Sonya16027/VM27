...
public class AddStandaloneHostRequestType implements java.io.Serializable {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof AddStandaloneHostRequestType)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.compResSpec == null && other.getCompResSpec() == null) || (this.compResSpec != null && this.compResSpec
						.equals(other.getCompResSpec())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			AddStandaloneHostRequestType.class, true);
