...
public class ArrayOfHostSnmpDestination  implements java.io.Serializable {
    ...
    public void setHostSnmpDestination(int i, com.vmware.vim25.HostSnmpDestination _value) {
        this.hostSnmpDestination[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfHostSnmpDestination)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.hostSnmpDestination==null && other.getHostSnmpDestination()==null) || 
             (this.hostSnmpDestination!=null &&
              java.util.Arrays.equals(this.hostSnmpDestination, other.getHostSnmpDestination())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHostSnmpDestination() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostSnmpDestination());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostSnmpDestination(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfHostSnmpDestination.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostSnmpDestination"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostSnmpDestination");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostSnmpDestination"));
