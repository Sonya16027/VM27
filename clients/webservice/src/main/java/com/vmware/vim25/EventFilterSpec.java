...
public class EventFilterSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.eventTypeId==null && other.getEventTypeId()==null) || 
             (this.eventTypeId!=null &&
              java.util.Arrays.equals(this.eventTypeId, other.getEventTypeId())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getEventTypeId() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getEventTypeId());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getEventTypeId(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EventFilterSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entity");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "entity"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EventFilterSpecByEntity"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EventFilterSpecByTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EventFilterSpecByUsername"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "disableFullMessage"));
