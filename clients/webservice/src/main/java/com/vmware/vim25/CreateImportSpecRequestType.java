...
public class CreateImportSpecRequestType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateImportSpecRequestType)) return false;
        ...
        _equals = true && 
            ...
            ((this.cisp==null && other.getCisp()==null) || 
             (this.cisp!=null &&
              this.cisp.equals(other.getCisp())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateImportSpecRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CreateImportSpecRequestType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "cisp"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "OvfCreateImportSpecParams"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
