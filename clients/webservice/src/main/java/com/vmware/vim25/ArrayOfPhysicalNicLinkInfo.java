/**
 * ArrayOfPhysicalNicLinkInfo.java
 *
...
public class ArrayOfPhysicalNicLinkInfo  implements java.io.Serializable {
    private com.vmware.vim25.PhysicalNicLinkInfo[] physicalNicLinkInfo;

    public ArrayOfPhysicalNicLinkInfo() {
    }

    public ArrayOfPhysicalNicLinkInfo(
           com.vmware.vim25.PhysicalNicLinkInfo[] physicalNicLinkInfo) {
    ...
    public com.vmware.vim25.PhysicalNicLinkInfo getPhysicalNicLinkInfo(int i) {
        return this.physicalNicLinkInfo[i];
    }

    public void setPhysicalNicLinkInfo(int i, com.vmware.vim25.PhysicalNicLinkInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfPhysicalNicLinkInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("physicalNicLinkInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "PhysicalNicLinkInfo"));
