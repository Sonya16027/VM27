...
public class LicenseUsageInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.LicenseSource source;

    private boolean sourceAvailable;

    private com.vmware.vim25.LicenseReservationInfo[] reservationInfo;

    private com.vmware.vim25.LicenseFeatureInfo[] featureInfo;
    ...
    public LicenseUsageInfo(
           ...
           com.vmware.vim25.LicenseReservationInfo[] reservationInfo,
           com.vmware.vim25.LicenseFeatureInfo[] featureInfo) {
        super(
            dynamicType,
            dynamicProperty);
        this.source = source;
     ...
     */
    public com.vmware.vim25.LicenseReservationInfo[] getReservationInfo() {
        return reservationInfo;
    }
     ...
     */
    public void setReservationInfo(com.vmware.vim25.LicenseReservationInfo[] reservationInfo) {
        this.reservationInfo = reservationInfo;
    }

    public com.vmware.vim25.LicenseReservationInfo getReservationInfo(int i) {
        return this.reservationInfo[i];
    }

    public void setReservationInfo(int i, com.vmware.vim25.LicenseReservationInfo _value) {
     ...
     * @return featureInfo
     */
    public com.vmware.vim25.LicenseFeatureInfo[] getFeatureInfo() {
        return featureInfo;
    }
     ...
     * @param featureInfo
     */
    public void setFeatureInfo(com.vmware.vim25.LicenseFeatureInfo[] featureInfo) {
        this.featureInfo = featureInfo;
    }

    public com.vmware.vim25.LicenseFeatureInfo getFeatureInfo(int i) {
        return this.featureInfo[i];
    }

    public void setFeatureInfo(int i, com.vmware.vim25.LicenseFeatureInfo _value) {
