...
public class ArrayOfHostNumaNode  implements java.io.Serializable {
    ...
    public ArrayOfHostNumaNode(
           com.vmware.vim25.HostNumaNode[] hostNumaNode) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostNumaNode"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostNumaNode");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostNumaNode"));
