...
public class HostListSummaryQuickStats extends com.vmware.vim25.DynamicData
	...
	public HostListSummaryQuickStats(java.lang.String dynamicType,
	 ...
	 */
	public void setDistributedCpuFairness(
			java.lang.Integer distributedCpuFairness) {
		this.distributedCpuFairness = distributedCpuFairness;
	}

	/**
	 * Gets the distributedMemoryFairness value for this
	...
	/**
	 * Sets the distributedMemoryFairness value for this
	 * HostListSummaryQuickStats.
	 * 
	 * @param distributedMemoryFairness
	 */
	public void setDistributedMemoryFairness(
			java.lang.Integer distributedMemoryFairness) {
		this.distributedMemoryFairness = distributedMemoryFairness;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.overallMemoryUsage == null && other
						.getOverallMemoryUsage() == null) || (this.overallMemoryUsage != null && this.overallMemoryUsage
						.equals(other.getOverallMemoryUsage())))
				&& ((this.distributedCpuFairness == null && other
						.getDistributedCpuFairness() == null) || (this.distributedCpuFairness != null && this.distributedCpuFairness
						.equals(other.getDistributedCpuFairness())))
				&& ((this.distributedMemoryFairness == null && other
						.getDistributedMemoryFairness() == null) || (this.distributedMemoryFairness != null && this.distributedMemoryFairness
						.equals(other.getDistributedMemoryFairness())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostListSummaryQuickStats.class, true);
