...
public class HostInternetScsiHbaDigestCapabilities extends
	...
	public HostInternetScsiHbaDigestCapabilities(java.lang.String dynamicType,
	...
	/**
	 * Gets the headerDigestSettable value for this
	...
	/**
	 * Sets the headerDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	...
	/**
	 * Gets the dataDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	...
	/**
	 * Sets the dataDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	...
	/**
	 * Gets the targetHeaderDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	...
	/**
	 * Sets the targetHeaderDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	 * @param targetHeaderDigestSettable
	 */
	public void setTargetHeaderDigestSettable(
			java.lang.Boolean targetHeaderDigestSettable) {
		this.targetHeaderDigestSettable = targetHeaderDigestSettable;
	}

	/**
	 * Gets the targetDataDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	...
	/**
	 * Sets the targetDataDigestSettable value for this
	 * HostInternetScsiHbaDigestCapabilities.
	 * 
	 * @param targetDataDigestSettable
	 */
	public void setTargetDataDigestSettable(
			java.lang.Boolean targetDataDigestSettable) {
		this.targetDataDigestSettable = targetDataDigestSettable;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostInternetScsiHbaDigestCapabilities)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.headerDigestSettable == null && other
						.getHeaderDigestSettable() == null) || (this.headerDigestSettable != null && this.headerDigestSettable
						.equals(other.getHeaderDigestSettable())))
				&& ((this.dataDigestSettable == null && other
						.getDataDigestSettable() == null) || (this.dataDigestSettable != null && this.dataDigestSettable
						.equals(other.getDataDigestSettable())))
				&& ((this.targetHeaderDigestSettable == null && other
						.getTargetHeaderDigestSettable() == null) || (this.targetHeaderDigestSettable != null && this.targetHeaderDigestSettable
						.equals(other.getTargetHeaderDigestSettable())))
				&& ((this.targetDataDigestSettable == null && other
						.getTargetDataDigestSettable() == null) || (this.targetDataDigestSettable != null && this.targetDataDigestSettable
						.equals(other.getTargetDataDigestSettable())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostInternetScsiHbaDigestCapabilities.class, true);
