...
public class HostNumericSensorType implements java.io.Serializable {
	...
	public static final HostNumericSensorType fan = new HostNumericSensorType(
			_fan);
	public static final HostNumericSensorType power = new HostNumericSensorType(
			_power);
	public static final HostNumericSensorType temperature = new HostNumericSensorType(
			_temperature);
	public static final HostNumericSensorType voltage = new HostNumericSensorType(
			_voltage);
	public static final HostNumericSensorType other = new HostNumericSensorType(
			_other);
	...
	public static HostNumericSensorType fromValue(java.lang.String value)
		...
		HostNumericSensorType enumeration = (HostNumericSensorType) _table_
				.get(value);
		if (enumeration == null) {
