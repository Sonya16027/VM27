...
public class OvfCreateImportSpecParams extends
		com.vmware.vim25.OvfManagerCommonParams implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public OvfCreateImportSpecParams(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String locale, java.lang.String deploymentOption,
			com.vmware.vim25.KeyValue[] msgBundle, java.lang.String entityName,
			com.vmware.vim25.ManagedObjectReference hostSystem,
			com.vmware.vim25.OvfNetworkMapping[] networkMapping,
			java.lang.String ipAllocationPolicy, java.lang.String ipProtocol,
			com.vmware.vim25.KeyValue[] propertyMapping) {
		super(dynamicType, dynamicProperty, locale, deploymentOption, msgBundle);
	...
	public void setNetworkMapping(int i,
			com.vmware.vim25.OvfNetworkMapping _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.hostSystem == null && other.getHostSystem() == null) || (this.hostSystem != null && this.hostSystem
						.equals(other.getHostSystem())))
				&& ((this.networkMapping == null && other.getNetworkMapping() == null) || (this.networkMapping != null && java.util.Arrays
						.equals(this.networkMapping, other.getNetworkMapping())))
				&& ((this.ipAllocationPolicy == null && other
						.getIpAllocationPolicy() == null) || (this.ipAllocationPolicy != null && this.ipAllocationPolicy
						.equals(other.getIpAllocationPolicy())))
				&& ((this.ipProtocol == null && other.getIpProtocol() == null) || (this.ipProtocol != null && this.ipProtocol
						.equals(other.getIpProtocol())))
				&& ((this.propertyMapping == null && other.getPropertyMapping() == null) || (this.propertyMapping != null && java.util.Arrays
						.equals(this.propertyMapping, other
								.getPropertyMapping())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPropertyMapping() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPropertyMapping()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			OvfCreateImportSpecParams.class, true);
