...
public class VmDiskFileQueryFlags extends com.vmware.vim25.DynamicData
	...
	public VmDiskFileQueryFlags(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			boolean diskType, boolean capacityKb, boolean hardwareVersion,
			java.lang.Boolean controllerType, java.lang.Boolean diskExtents,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VmDiskFileQueryFlags)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.diskExtents == null && other.getDiskExtents() == null) || (this.diskExtents != null && this.diskExtents
						.equals(other.getDiskExtents())))
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isHardwareVersion() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VmDiskFileQueryFlags.class, true);
