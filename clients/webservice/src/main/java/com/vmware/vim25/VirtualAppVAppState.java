...
public class VirtualAppVAppState implements java.io.Serializable {
	...
	public static final VirtualAppVAppState started = new VirtualAppVAppState(
			_started);
	public static final VirtualAppVAppState stopped = new VirtualAppVAppState(
			_stopped);
	public static final VirtualAppVAppState starting = new VirtualAppVAppState(
			_starting);
	public static final VirtualAppVAppState stopping = new VirtualAppVAppState(
			_stopping);
	...
	public static VirtualAppVAppState fromValue(java.lang.String value)
		...
		VirtualAppVAppState enumeration = (VirtualAppVAppState) _table_
				.get(value);
		if (enumeration == null) {
