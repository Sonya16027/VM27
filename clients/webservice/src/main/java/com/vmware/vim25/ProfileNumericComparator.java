...
public class ProfileNumericComparator implements java.io.Serializable {
	...
	public static final ProfileNumericComparator lessThan = new ProfileNumericComparator(
			_lessThan);
	public static final ProfileNumericComparator lessThanEqual = new ProfileNumericComparator(
			_lessThanEqual);
	public static final ProfileNumericComparator equal = new ProfileNumericComparator(
			_equal);
	public static final ProfileNumericComparator notEqual = new ProfileNumericComparator(
			_notEqual);
	public static final ProfileNumericComparator greaterThanEqual = new ProfileNumericComparator(
			_greaterThanEqual);
	public static final ProfileNumericComparator greaterThan = new ProfileNumericComparator(
			_greaterThan);
	...
	public static ProfileNumericComparator fromValue(java.lang.String value)
		...
		ProfileNumericComparator enumeration = (ProfileNumericComparator) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ProfileNumericComparator.class);
