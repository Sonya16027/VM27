...
public class HostMultipathInfoLogicalUnit extends com.vmware.vim25.DynamicData
	...
	private com.vmware.vim25.HostMultipathInfoPath[] path;

	private com.vmware.vim25.HostMultipathInfoLogicalUnitPolicy policy;

	private com.vmware.vim25.HostMultipathInfoLogicalUnitStorageArrayTypePolicy storageArrayTypePolicy;
	...
	public HostMultipathInfoLogicalUnit(
			...
			com.vmware.vim25.HostMultipathInfoPath[] path,
			com.vmware.vim25.HostMultipathInfoLogicalUnitPolicy policy,
			com.vmware.vim25.HostMultipathInfoLogicalUnitStorageArrayTypePolicy storageArrayTypePolicy) {
	 ...
	 * @return path
	 */
	public com.vmware.vim25.HostMultipathInfoPath[] getPath() {
		return path;
	}
	 ...
	 * @param path
	 */
	public void setPath(com.vmware.vim25.HostMultipathInfoPath[] path) {
		this.path = path;
	}

	public com.vmware.vim25.HostMultipathInfoPath getPath(int i) {
		return this.path[i];
	}

	public void setPath(int i, com.vmware.vim25.HostMultipathInfoPath _value) {
		this.path[i] = _value;
	}
	...
	/**
	 * Gets the storageArrayTypePolicy value for this
	 * HostMultipathInfoLogicalUnit.
	 * 
	 * @return storageArrayTypePolicy
	 */
	public com.vmware.vim25.HostMultipathInfoLogicalUnitStorageArrayTypePolicy getStorageArrayTypePolicy() {
		return storageArrayTypePolicy;
	}

	/**
	 * Sets the storageArrayTypePolicy value for this
	 * HostMultipathInfoLogicalUnit.
	 * 
	 * @param storageArrayTypePolicy
	 */
	public void setStorageArrayTypePolicy(
			com.vmware.vim25.HostMultipathInfoLogicalUnitStorageArrayTypePolicy storageArrayTypePolicy) {
		this.storageArrayTypePolicy = storageArrayTypePolicy;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostMultipathInfoLogicalUnit)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.id == null && other.getId() == null) || (this.id != null && this.id
						.equals(other.getId())))
				&& ((this.lun == null && other.getLun() == null) || (this.lun != null && this.lun
						.equals(other.getLun())))
				...
				&& ((this.storageArrayTypePolicy == null && other
						.getStorageArrayTypePolicy() == null) || (this.storageArrayTypePolicy != null && this.storageArrayTypePolicy
						.equals(other.getStorageArrayTypePolicy())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostMultipathInfoLogicalUnit.class, true);
