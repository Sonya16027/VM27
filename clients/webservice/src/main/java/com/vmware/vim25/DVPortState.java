...
public class DVPortState extends com.vmware.vim25.DynamicData implements
	 ...
	 */
	public void setVendorSpecificState(
			com.vmware.vim25.DistributedVirtualSwitchKeyedOpaqueBlob[] vendorSpecificState) {
		this.vendorSpecificState = vendorSpecificState;
	}
	...
	public void setVendorSpecificState(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.runtimeInfo == null && other.getRuntimeInfo() == null) || (this.runtimeInfo != null && this.runtimeInfo
						.equals(other.getRuntimeInfo())))
				&& ((this.stats == null && other.getStats() == null) || (this.stats != null && this.stats
						.equals(other.getStats())))
				&& ((this.vendorSpecificState == null && other
						.getVendorSpecificState() == null) || (this.vendorSpecificState != null && java.util.Arrays
						.equals(this.vendorSpecificState, other
	...
	public synchronized int hashCode() {
		...
		if (getVendorSpecificState() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVendorSpecificState()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVendorSpecificState(), i);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "stats"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
