...
public class ArrayOfTypeDescription implements java.io.Serializable {
	...
	private com.vmware.vim25.TypeDescription[] typeDescription;

	public ArrayOfTypeDescription() {
	}

	public ArrayOfTypeDescription(
			com.vmware.vim25.TypeDescription[] typeDescription) {
	...
	public com.vmware.vim25.TypeDescription getTypeDescription(int i) {
		return this.typeDescription[i];
	}

	public void setTypeDescription(int i,
			com.vmware.vim25.TypeDescription _value) {
