...
public class ManagedEntityStatus implements java.io.Serializable {
    ...
    public static final ManagedEntityStatus gray = new ManagedEntityStatus(_gray);
    public static final ManagedEntityStatus green = new ManagedEntityStatus(_green);
    public static final ManagedEntityStatus yellow = new ManagedEntityStatus(_yellow);
    ...
    public static ManagedEntityStatus fromValue(java.lang.String value)
        ...
        ManagedEntityStatus enumeration = (ManagedEntityStatus)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ManagedEntityStatus.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ManagedEntityStatus"));
    }
    /**
