...
public class UpgradePolicy implements java.io.Serializable {
    ...
    public static final UpgradePolicy upgradeAtPowerCycle = new UpgradePolicy(_upgradeAtPowerCycle);
    public java.lang.String getValue() { return _value_;}
    public static UpgradePolicy fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        UpgradePolicy enumeration = (UpgradePolicy)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpgradePolicy.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "UpgradePolicy"));
    }
    /**
