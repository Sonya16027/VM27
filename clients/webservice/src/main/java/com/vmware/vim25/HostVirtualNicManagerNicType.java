...
public class HostVirtualNicManagerNicType implements java.io.Serializable {
	...
	public static final HostVirtualNicManagerNicType vmotion = new HostVirtualNicManagerNicType(
			_vmotion);
	public static final HostVirtualNicManagerNicType faultToleranceLogging = new HostVirtualNicManagerNicType(
			_faultToleranceLogging);
	public static final HostVirtualNicManagerNicType management = new HostVirtualNicManagerNicType(
			_management);
	...
	public static HostVirtualNicManagerNicType fromValue(java.lang.String value)
		...
		HostVirtualNicManagerNicType enumeration = (HostVirtualNicManagerNicType) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostVirtualNicManagerNicType.class);
