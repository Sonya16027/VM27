...
public class HostIpRouteConfigSpec extends com.vmware.vim25.HostIpRouteConfig
	...
	public HostIpRouteConfigSpec(
		...
		super(dynamicType, dynamicProperty, defaultGateway, gatewayDevice,
				ipV6DefaultGateway, ipV6GatewayDevice);
	 ...
	 */
	public void setGatewayDeviceConnection(
			com.vmware.vim25.HostVirtualNicConnection gatewayDeviceConnection) {
		this.gatewayDeviceConnection = gatewayDeviceConnection;
	}

	/**
	 * Gets the ipV6GatewayDeviceConnection value for this
	...
	/**
	 * Sets the ipV6GatewayDeviceConnection value for this
	 * HostIpRouteConfigSpec.
	 * 
	 * @param ipV6GatewayDeviceConnection
	 */
	public void setIpV6GatewayDeviceConnection(
			com.vmware.vim25.HostVirtualNicConnection ipV6GatewayDeviceConnection) {
		this.ipV6GatewayDeviceConnection = ipV6GatewayDeviceConnection;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.gatewayDeviceConnection == null && other
						.getGatewayDeviceConnection() == null) || (this.gatewayDeviceConnection != null && this.gatewayDeviceConnection
						.equals(other.getGatewayDeviceConnection())))
				&& ((this.ipV6GatewayDeviceConnection == null && other
						.getIpV6GatewayDeviceConnection() == null) || (this.ipV6GatewayDeviceConnection != null && this.ipV6GatewayDeviceConnection
						.equals(other.getIpV6GatewayDeviceConnection())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostIpRouteConfigSpec.class, true);
