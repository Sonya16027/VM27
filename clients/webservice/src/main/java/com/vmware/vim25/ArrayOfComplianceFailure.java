...
public class ArrayOfComplianceFailure implements java.io.Serializable {
	 ...
	 */
	public void setComplianceFailure(
			com.vmware.vim25.ComplianceFailure[] complianceFailure) {
		this.complianceFailure = complianceFailure;
	}
	...
	public void setComplianceFailure(int i,
			com.vmware.vim25.ComplianceFailure _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfComplianceFailure)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.complianceFailure == null && other
				.getComplianceFailure() == null) || (this.complianceFailure != null && java.util.Arrays
				.equals(this.complianceFailure, other.getComplianceFailure())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getComplianceFailure() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getComplianceFailure()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getComplianceFailure(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfComplianceFailure.class, true);
