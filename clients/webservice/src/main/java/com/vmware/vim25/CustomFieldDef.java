...
public class CustomFieldDef  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int key;
     ...
     */
    public void setFieldDefPrivileges(com.vmware.vim25.PrivilegePolicyDef fieldDefPrivileges) {
        this.fieldDefPrivileges = fieldDefPrivileges;
    }
     ...
     */
    public void setFieldInstancePrivileges(com.vmware.vim25.PrivilegePolicyDef fieldInstancePrivileges) {
        this.fieldInstancePrivileges = fieldInstancePrivileges;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomFieldDef)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.managedObjectType==null && other.getManagedObjectType()==null) || 
             (this.managedObjectType!=null &&
              this.managedObjectType.equals(other.getManagedObjectType()))) &&
            ((this.fieldDefPrivileges==null && other.getFieldDefPrivileges()==null) || 
             (this.fieldDefPrivileges!=null &&
              this.fieldDefPrivileges.equals(other.getFieldDefPrivileges()))) &&
            ((this.fieldInstancePrivileges==null && other.getFieldInstancePrivileges()==null) || 
             (this.fieldInstancePrivileges!=null &&
              this.fieldInstancePrivileges.equals(other.getFieldInstancePrivileges())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomFieldDef.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CustomFieldDef"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "managedObjectType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "fieldDefPrivileges"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "fieldInstancePrivileges"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PrivilegePolicyDef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
