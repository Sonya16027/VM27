...
public class DVSSummary  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param hostMember
     */
    public void setHostMember(com.vmware.vim25.ManagedObjectReference[] hostMember) {
        this.hostMember = hostMember;
    }
    ...
    public void setHostMember(int i, com.vmware.vim25.ManagedObjectReference _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DVSSummary)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.hostMember==null && other.getHostMember()==null) || 
             (this.hostMember!=null &&
              java.util.Arrays.equals(this.hostMember, other.getHostMember()))) &&
            ...
            ((this.portgroupName==null && other.getPortgroupName()==null) || 
             (this.portgroupName!=null &&
              java.util.Arrays.equals(this.portgroupName, other.getPortgroupName()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getHostMember() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostMember());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostMember(), i);
                if (obj != null &&
        ...
        if (getPortgroupName() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPortgroupName());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPortgroupName(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DVSSummary.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DVSSummary"));
