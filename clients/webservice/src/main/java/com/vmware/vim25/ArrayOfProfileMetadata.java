...
public class ArrayOfProfileMetadata implements java.io.Serializable {
	...
	public void setProfileMetadata(int i,
			com.vmware.vim25.ProfileMetadata _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfProfileMetadata)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.profileMetadata == null && other
				.getProfileMetadata() == null) || (this.profileMetadata != null && java.util.Arrays
				.equals(this.profileMetadata, other.getProfileMetadata())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getProfileMetadata() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getProfileMetadata()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getProfileMetadata(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfProfileMetadata.class, true);
