...
public class ArrayOfHostVirtualSwitchConfig  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostVirtualSwitchConfig getHostVirtualSwitchConfig(int i) {
        return this.hostVirtualSwitchConfig[i];
    }

    public void setHostVirtualSwitchConfig(int i, com.vmware.vim25.HostVirtualSwitchConfig _value) {
