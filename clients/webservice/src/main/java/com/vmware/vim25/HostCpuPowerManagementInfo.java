...
public class HostCpuPowerManagementInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostCpuPowerManagementInfo(
           ...
           java.lang.String hardwareSupport) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostCpuPowerManagementInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.currentPolicy==null && other.getCurrentPolicy()==null) || 
             (this.currentPolicy!=null &&
              this.currentPolicy.equals(other.getCurrentPolicy()))) &&
            ((this.hardwareSupport==null && other.getHardwareSupport()==null) || 
             (this.hardwareSupport!=null &&
              this.hardwareSupport.equals(other.getHardwareSupport())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostCpuPowerManagementInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostCpuPowerManagementInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("currentPolicy");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "currentPolicy"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "hardwareSupport"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
