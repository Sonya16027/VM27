...
public class HostHardwareElementStatus implements java.io.Serializable {
	...
	public static final HostHardwareElementStatus Unknown = new HostHardwareElementStatus(
			_Unknown);
	public static final HostHardwareElementStatus Green = new HostHardwareElementStatus(
			_Green);
	public static final HostHardwareElementStatus Yellow = new HostHardwareElementStatus(
			_Yellow);
	public static final HostHardwareElementStatus Red = new HostHardwareElementStatus(
			_Red);
	...
	public static HostHardwareElementStatus fromValue(java.lang.String value)
		...
		HostHardwareElementStatus enumeration = (HostHardwareElementStatus) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostHardwareElementStatus.class);
