...
public class ArrayOfVMwareDVSPvlanConfigSpec implements java.io.Serializable {
	...
	/**
	 * Gets the VMwareDVSPvlanConfigSpec value for this
	...
	/**
	 * Sets the VMwareDVSPvlanConfigSpec value for this
	 * ArrayOfVMwareDVSPvlanConfigSpec.
	 * 
	 * @param VMwareDVSPvlanConfigSpec
	 */
	public void setVMwareDVSPvlanConfigSpec(
			com.vmware.vim25.VMwareDVSPvlanConfigSpec[] VMwareDVSPvlanConfigSpec) {
		this.VMwareDVSPvlanConfigSpec = VMwareDVSPvlanConfigSpec;
	}
	...
	public void setVMwareDVSPvlanConfigSpec(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVMwareDVSPvlanConfigSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.VMwareDVSPvlanConfigSpec == null && other
				.getVMwareDVSPvlanConfigSpec() == null) || (this.VMwareDVSPvlanConfigSpec != null && java.util.Arrays
				.equals(this.VMwareDVSPvlanConfigSpec, other
						.getVMwareDVSPvlanConfigSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVMwareDVSPvlanConfigSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVMwareDVSPvlanConfigSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVMwareDVSPvlanConfigSpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVMwareDVSPvlanConfigSpec.class, true);
