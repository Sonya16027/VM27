...
public class AlarmDescription  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param stateOperator
     */
    public void setStateOperator(com.vmware.vim25.ElementDescription[] stateOperator) {
        this.stateOperator = stateOperator;
    }
    ...
    public void setStateOperator(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     */
    public void setMetricOperator(com.vmware.vim25.ElementDescription[] metricOperator) {
        this.metricOperator = metricOperator;
    }
    ...
    public void setMetricOperator(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     */
    public void setHostSystemConnectionState(com.vmware.vim25.ElementDescription[] hostSystemConnectionState) {
        this.hostSystemConnectionState = hostSystemConnectionState;
    }

    public com.vmware.vim25.ElementDescription getHostSystemConnectionState(int i) {
        return this.hostSystemConnectionState[i];
    }

    public void setHostSystemConnectionState(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     */
    public void setVirtualMachinePowerState(com.vmware.vim25.ElementDescription[] virtualMachinePowerState) {
        this.virtualMachinePowerState = virtualMachinePowerState;
    }
    ...
    public void setVirtualMachinePowerState(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     */
    public void setDatastoreConnectionState(com.vmware.vim25.ElementDescription[] datastoreConnectionState) {
        this.datastoreConnectionState = datastoreConnectionState;
    }
    ...
    public void setDatastoreConnectionState(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     */
    public void setHostSystemPowerState(com.vmware.vim25.ElementDescription[] hostSystemPowerState) {
        this.hostSystemPowerState = hostSystemPowerState;
    }
    ...
    public void setHostSystemPowerState(int i, com.vmware.vim25.ElementDescription _value) {
        this.hostSystemPowerState[i] = _value;
    }


    /**
     * Gets the virtualMachineGuestHeartbeatStatus value for this AlarmDescription.
     * 
    ...
    /**
     * Sets the virtualMachineGuestHeartbeatStatus value for this AlarmDescription.
     * 
     * @param virtualMachineGuestHeartbeatStatus
     */
    public void setVirtualMachineGuestHeartbeatStatus(com.vmware.vim25.ElementDescription[] virtualMachineGuestHeartbeatStatus) {
        this.virtualMachineGuestHeartbeatStatus = virtualMachineGuestHeartbeatStatus;
    }

    public com.vmware.vim25.ElementDescription getVirtualMachineGuestHeartbeatStatus(int i) {
        return this.virtualMachineGuestHeartbeatStatus[i];
    }

    public void setVirtualMachineGuestHeartbeatStatus(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     * @param entityStatus
     */
    public void setEntityStatus(com.vmware.vim25.ElementDescription[] entityStatus) {
        this.entityStatus = entityStatus;
    }
    ...
    public void setEntityStatus(int i, com.vmware.vim25.ElementDescription _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.datastoreConnectionState==null && other.getDatastoreConnectionState()==null) || 
             (this.datastoreConnectionState!=null &&
              java.util.Arrays.equals(this.datastoreConnectionState, other.getDatastoreConnectionState()))) &&
            ((this.hostSystemPowerState==null && other.getHostSystemPowerState()==null) || 
             (this.hostSystemPowerState!=null &&
              java.util.Arrays.equals(this.hostSystemPowerState, other.getHostSystemPowerState()))) &&
            ((this.virtualMachineGuestHeartbeatStatus==null && other.getVirtualMachineGuestHeartbeatStatus()==null) || 
             (this.virtualMachineGuestHeartbeatStatus!=null &&
              java.util.Arrays.equals(this.virtualMachineGuestHeartbeatStatus, other.getVirtualMachineGuestHeartbeatStatus()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getDatastoreConnectionState() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDatastoreConnectionState());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDatastoreConnectionState(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getHostSystemPowerState() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostSystemPowerState());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostSystemPowerState(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getVirtualMachineGuestHeartbeatStatus() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getVirtualMachineGuestHeartbeatStatus());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getVirtualMachineGuestHeartbeatStatus(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AlarmDescription"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("expr");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "expr"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "stateOperator"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "metricOperator"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "hostSystemConnectionState"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "virtualMachinePowerState"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "datastoreConnectionState"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "hostSystemPowerState"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "virtualMachineGuestHeartbeatStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "entityStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ElementDescription"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
