...
public class HostInternetScsiHbaIPCapabilities extends
	...
	public HostInternetScsiHbaIPCapabilities(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			boolean addressSettable, boolean ipConfigurationMethodSettable,
			boolean subnetMaskSettable, boolean defaultGatewaySettable,
	...
	/**
	 * Gets the addressSettable value for this
	...
	/**
	 * Sets the addressSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Gets the ipConfigurationMethodSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the ipConfigurationMethodSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	 * @param ipConfigurationMethodSettable
	 */
	public void setIpConfigurationMethodSettable(
			boolean ipConfigurationMethodSettable) {
		this.ipConfigurationMethodSettable = ipConfigurationMethodSettable;
	}

	/**
	 * Gets the subnetMaskSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the subnetMaskSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Gets the defaultGatewaySettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the defaultGatewaySettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Gets the primaryDnsServerAddressSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the primaryDnsServerAddressSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	 * @param primaryDnsServerAddressSettable
	 */
	public void setPrimaryDnsServerAddressSettable(
			boolean primaryDnsServerAddressSettable) {
		this.primaryDnsServerAddressSettable = primaryDnsServerAddressSettable;
	}

	/**
	 * Gets the alternateDnsServerAddressSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the alternateDnsServerAddressSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	 * @param alternateDnsServerAddressSettable
	 */
	public void setAlternateDnsServerAddressSettable(
			boolean alternateDnsServerAddressSettable) {
		this.alternateDnsServerAddressSettable = alternateDnsServerAddressSettable;
	}
	...
	/**
	 * Gets the arpRedirectSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the arpRedirectSettable value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Gets the hostNameAsTargetAddress value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	...
	/**
	 * Sets the hostNameAsTargetAddress value for this
	 * HostInternetScsiHbaIPCapabilities.
	 * 
	 * @param hostNameAsTargetAddress
	 */
	public void setHostNameAsTargetAddress(
			java.lang.Boolean hostNameAsTargetAddress) {
		this.hostNameAsTargetAddress = hostNameAsTargetAddress;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostInternetScsiHbaIPCapabilities)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& this.ipConfigurationMethodSettable == other
						.isIpConfigurationMethodSettable()
				&& this.subnetMaskSettable == other.isSubnetMaskSettable()
				&& this.defaultGatewaySettable == other
						.isDefaultGatewaySettable()
				&& this.primaryDnsServerAddressSettable == other
						.isPrimaryDnsServerAddressSettable()
				&& this.alternateDnsServerAddressSettable == other
						.isAlternateDnsServerAddressSettable()
				&& ((this.ipv6Supported == null && other.getIpv6Supported() == null) || (this.ipv6Supported != null && this.ipv6Supported
						.equals(other.getIpv6Supported())))
				&& ((this.arpRedirectSettable == null && other
						.getArpRedirectSettable() == null) || (this.arpRedirectSettable != null && this.arpRedirectSettable
						.equals(other.getArpRedirectSettable())))
				&& ((this.mtuSettable == null && other.getMtuSettable() == null) || (this.mtuSettable != null && this.mtuSettable
						.equals(other.getMtuSettable())))
				&& ((this.hostNameAsTargetAddress == null && other
						.getHostNameAsTargetAddress() == null) || (this.hostNameAsTargetAddress != null && this.hostNameAsTargetAddress
						.equals(other.getHostNameAsTargetAddress())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isAddressSettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isIpConfigurationMethodSettable() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isSubnetMaskSettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isDefaultGatewaySettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isPrimaryDnsServerAddressSettable() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isAlternateDnsServerAddressSettable() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostInternetScsiHbaIPCapabilities.class, true);
