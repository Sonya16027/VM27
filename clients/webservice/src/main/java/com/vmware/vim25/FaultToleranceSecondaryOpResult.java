...
public class FaultToleranceSecondaryOpResult  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param powerOnResult
     */
    public void setPowerOnResult(com.vmware.vim25.ClusterPowerOnVmResult powerOnResult) {
        this.powerOnResult = powerOnResult;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FaultToleranceSecondaryOpResult)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.powerOnResult==null && other.getPowerOnResult()==null) || 
             (this.powerOnResult!=null &&
              this.powerOnResult.equals(other.getPowerOnResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isPowerOnAttempted() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FaultToleranceSecondaryOpResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "FaultToleranceSecondaryOpResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "powerOnAttempted"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("powerOnResult");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "powerOnResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ClusterPowerOnVmResult"));
