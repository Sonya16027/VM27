...
public class HostFirewallRule  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int port;
     ...
     * @param direction
     */
    public void setDirection(com.vmware.vim25.HostFirewallRuleDirection direction) {
        this.direction = direction;
    }
