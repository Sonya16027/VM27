...
public class HostDiskPartitionSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param partition
     */
    public void setPartition(com.vmware.vim25.HostDiskPartitionAttributes[] partition) {
        this.partition = partition;
    }
    ...
    public void setPartition(int i, com.vmware.vim25.HostDiskPartitionAttributes _value) {
