...
public class ArrayOfLicenseReservationInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.LicenseReservationInfo getLicenseReservationInfo(int i) {
        return this.licenseReservationInfo[i];
    }

    public void setLicenseReservationInfo(int i, com.vmware.vim25.LicenseReservationInfo _value) {
