...
public class PromoteDisksRequestType implements java.io.Serializable {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof PromoteDisksRequestType)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.disks == null && other.getDisks() == null) || (this.disks != null && java.util.Arrays
						.equals(this.disks, other.getDisks())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getDisks() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getDisks()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getDisks(),
						i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			PromoteDisksRequestType.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "disks"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
				"VirtualDisk"));
