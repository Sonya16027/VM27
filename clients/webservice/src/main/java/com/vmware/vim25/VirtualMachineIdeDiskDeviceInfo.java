...
public class VirtualMachineIdeDiskDeviceInfo  extends com.vmware.vim25.VirtualMachineDiskDeviceInfo  implements java.io.Serializable {
    private com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo[] partitionTable;
    ...
    public VirtualMachineIdeDiskDeviceInfo(
           ...
           com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo[] partitionTable) {
        super(
            dynamicType,
            dynamicProperty,
            name,
     ...
     */
    public com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo[] getPartitionTable() {
        return partitionTable;
    }
     ...
     */
    public void setPartitionTable(com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo[] partitionTable) {
        this.partitionTable = partitionTable;
    }

    public com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo getPartitionTable(int i) {
        return this.partitionTable[i];
    }

    public void setPartitionTable(int i, com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo _value) {
