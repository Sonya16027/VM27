...
public class ArrayOfDvsOutOfSyncHostArgument implements java.io.Serializable {
	...
	/**
	 * Gets the dvsOutOfSyncHostArgument value for this
	...
	/**
	 * Sets the dvsOutOfSyncHostArgument value for this
	 * ArrayOfDvsOutOfSyncHostArgument.
	 * 
	 * @param dvsOutOfSyncHostArgument
	 */
	public void setDvsOutOfSyncHostArgument(
			com.vmware.vim25.DvsOutOfSyncHostArgument[] dvsOutOfSyncHostArgument) {
		this.dvsOutOfSyncHostArgument = dvsOutOfSyncHostArgument;
	}
	...
	public void setDvsOutOfSyncHostArgument(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDvsOutOfSyncHostArgument)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.dvsOutOfSyncHostArgument == null && other
				.getDvsOutOfSyncHostArgument() == null) || (this.dvsOutOfSyncHostArgument != null && java.util.Arrays
				.equals(this.dvsOutOfSyncHostArgument, other
						.getDvsOutOfSyncHostArgument())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getDvsOutOfSyncHostArgument() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDvsOutOfSyncHostArgument()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDvsOutOfSyncHostArgument(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDvsOutOfSyncHostArgument.class, true);
