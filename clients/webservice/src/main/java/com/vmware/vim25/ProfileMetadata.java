...
public class ProfileMetadata extends com.vmware.vim25.DynamicData implements
	...
	private com.vmware.vim25.ExtendedDescription description;

	public ProfileMetadata() {
	}

	public ProfileMetadata(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String key,
			com.vmware.vim25.ExtendedDescription description) {
	 ...
	 * @return description
	 */
	public com.vmware.vim25.ExtendedDescription getDescription() {
		return description;
	}
	 ...
	 * @param description
	 */
	public void setDescription(com.vmware.vim25.ExtendedDescription description) {
		this.description = description;
	}
