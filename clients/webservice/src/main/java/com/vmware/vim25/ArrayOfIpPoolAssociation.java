...
public class ArrayOfIpPoolAssociation  implements java.io.Serializable {
    ...
    public void setIpPoolAssociation(int i, com.vmware.vim25.IpPoolAssociation _value) {
        this.ipPoolAssociation[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfIpPoolAssociation)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.ipPoolAssociation==null && other.getIpPoolAssociation()==null) || 
             (this.ipPoolAssociation!=null &&
              java.util.Arrays.equals(this.ipPoolAssociation, other.getIpPoolAssociation())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getIpPoolAssociation() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getIpPoolAssociation());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getIpPoolAssociation(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfIpPoolAssociation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfIpPoolAssociation"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ipPoolAssociation");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "IpPoolAssociation"));
