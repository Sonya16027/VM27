...
public class VirtualPCIControllerOption extends
	...
	public VirtualPCIControllerOption(java.lang.String dynamicType,
	 ...
	 */
	public void setNumSCSIControllers(
			com.vmware.vim25.IntOption numSCSIControllers) {
		this.numSCSIControllers = numSCSIControllers;
	}
	...
	/**
	 * Gets the numPCIPassthroughDevices value for this
	...
	/**
	 * Sets the numPCIPassthroughDevices value for this
	 * VirtualPCIControllerOption.
	 * 
	 * @param numPCIPassthroughDevices
	 */
	public void setNumPCIPassthroughDevices(
			com.vmware.vim25.IntOption numPCIPassthroughDevices) {
		this.numPCIPassthroughDevices = numPCIPassthroughDevices;
	}
	 ...
	 */
	public void setNumSasSCSIControllers(
			com.vmware.vim25.IntOption numSasSCSIControllers) {
		this.numSasSCSIControllers = numSasSCSIControllers;
	}

	/**
	 * Gets the numVmxnet3EthernetCards value for this
	 * VirtualPCIControllerOption.
	 * 
	...
	/**
	 * Sets the numVmxnet3EthernetCards value for this
	 * VirtualPCIControllerOption.
	 * 
	 * @param numVmxnet3EthernetCards
	 */
	public void setNumVmxnet3EthernetCards(
			com.vmware.vim25.IntOption numVmxnet3EthernetCards) {
		this.numVmxnet3EthernetCards = numVmxnet3EthernetCards;
	}

	/**
	 * Gets the numParaVirtualSCSIControllers value for this
	 * VirtualPCIControllerOption.
	 * 
	...
	/**
	 * Sets the numParaVirtualSCSIControllers value for this
	 * VirtualPCIControllerOption.
	 * 
	 * @param numParaVirtualSCSIControllers
	 */
	public void setNumParaVirtualSCSIControllers(
			com.vmware.vim25.IntOption numParaVirtualSCSIControllers) {
		this.numParaVirtualSCSIControllers = numParaVirtualSCSIControllers;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VirtualPCIControllerOption)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.numSCSIControllers == null && other
						.getNumSCSIControllers() == null) || (this.numSCSIControllers != null && this.numSCSIControllers
						.equals(other.getNumSCSIControllers())))
				&& ((this.numEthernetCards == null && other
						.getNumEthernetCards() == null) || (this.numEthernetCards != null && this.numEthernetCards
						.equals(other.getNumEthernetCards())))
				&& ((this.numVideoCards == null && other.getNumVideoCards() == null) || (this.numVideoCards != null && this.numVideoCards
						.equals(other.getNumVideoCards())))
				&& ((this.numSoundCards == null && other.getNumSoundCards() == null) || (this.numSoundCards != null && this.numSoundCards
						.equals(other.getNumSoundCards())))
				&& ((this.numVmiRoms == null && other.getNumVmiRoms() == null) || (this.numVmiRoms != null && this.numVmiRoms
						.equals(other.getNumVmiRoms())))
				&& ((this.numVmciDevices == null && other.getNumVmciDevices() == null) || (this.numVmciDevices != null && this.numVmciDevices
						.equals(other.getNumVmciDevices())))
				&& ((this.numPCIPassthroughDevices == null && other
						.getNumPCIPassthroughDevices() == null) || (this.numPCIPassthroughDevices != null && this.numPCIPassthroughDevices
						.equals(other.getNumPCIPassthroughDevices())))
				&& ((this.numSasSCSIControllers == null && other
						.getNumSasSCSIControllers() == null) || (this.numSasSCSIControllers != null && this.numSasSCSIControllers
						.equals(other.getNumSasSCSIControllers())))
				&& ((this.numVmxnet3EthernetCards == null && other
						.getNumVmxnet3EthernetCards() == null) || (this.numVmxnet3EthernetCards != null && this.numVmxnet3EthernetCards
						.equals(other.getNumVmxnet3EthernetCards())))
				&& ((this.numParaVirtualSCSIControllers == null && other
						.getNumParaVirtualSCSIControllers() == null) || (this.numParaVirtualSCSIControllers != null && this.numParaVirtualSCSIControllers
						.equals(other.getNumParaVirtualSCSIControllers())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualPCIControllerOption.class, true);
