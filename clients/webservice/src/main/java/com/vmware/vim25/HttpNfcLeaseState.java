...
public class HttpNfcLeaseState implements java.io.Serializable {
	...
	public static final HttpNfcLeaseState initializing = new HttpNfcLeaseState(
			_initializing);
	...
	public static HttpNfcLeaseState fromValue(java.lang.String value)
		...
		HttpNfcLeaseState enumeration = (HttpNfcLeaseState) _table_.get(value);
		if (enumeration == null) {
