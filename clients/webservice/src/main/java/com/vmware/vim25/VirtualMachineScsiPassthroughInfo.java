...
public class VirtualMachineScsiPassthroughInfo  extends com.vmware.vim25.VirtualMachineTargetInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the physicalUnitNumber value for this VirtualMachineScsiPassthroughInfo.
     * 
    ...
    /**
     * Sets the physicalUnitNumber value for this VirtualMachineScsiPassthroughInfo.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualMachineScsiPassthroughInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.scsiClass==null && other.getScsiClass()==null) || 
             (this.scsiClass!=null &&
              this.scsiClass.equals(other.getScsiClass()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualMachineScsiPassthroughInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineScsiPassthroughInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("scsiClass");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "scsiClass"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "physicalUnitNumber"));
