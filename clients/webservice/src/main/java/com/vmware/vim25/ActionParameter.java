...
public class ActionParameter implements java.io.Serializable {
    ...
    public static final ActionParameter targetName = new ActionParameter(_targetName);
    public static final ActionParameter alarmName = new ActionParameter(_alarmName);
    public static final ActionParameter oldStatus = new ActionParameter(_oldStatus);
    public static final ActionParameter newStatus = new ActionParameter(_newStatus);
    public static final ActionParameter triggeringSummary = new ActionParameter(_triggeringSummary);
    public static final ActionParameter declaringSummary = new ActionParameter(_declaringSummary);
    public static final ActionParameter eventDescription = new ActionParameter(_eventDescription);
    ...
    public static ActionParameter fromValue(java.lang.String value)
        ...
        ActionParameter enumeration = (ActionParameter)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ActionParameter.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ActionParameter"));
    }
    /**
