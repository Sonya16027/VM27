...
public class VmFailedMigrateEvent  extends com.vmware.vim25.VmEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmFailedMigrateEvent"));
