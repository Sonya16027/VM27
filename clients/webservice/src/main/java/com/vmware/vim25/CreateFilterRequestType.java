...
public class CreateFilterRequestType  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CreateFilterRequestType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "partialUpdates"));
