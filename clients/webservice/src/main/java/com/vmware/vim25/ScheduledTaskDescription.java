...
public class ScheduledTaskDescription  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.TypeDescription[] action;

    private com.vmware.vim25.ScheduledTaskDetail[] schedulerInfo;

    private com.vmware.vim25.ElementDescription[] state;

    private com.vmware.vim25.ElementDescription[] dayOfWeek;

    private com.vmware.vim25.ElementDescription[] weekOfMonth;
    ...
    public ScheduledTaskDescription(
           ...
           com.vmware.vim25.ScheduledTaskDetail[] schedulerInfo,
           com.vmware.vim25.ElementDescription[] state,
           com.vmware.vim25.ElementDescription[] dayOfWeek,
           com.vmware.vim25.ElementDescription[] weekOfMonth) {
        super(
            dynamicType,
            dynamicProperty);
        this.action = action;
     ...
     */
    public com.vmware.vim25.ScheduledTaskDetail[] getSchedulerInfo() {
        return schedulerInfo;
    }
     ...
     * @param schedulerInfo
     */
    public void setSchedulerInfo(com.vmware.vim25.ScheduledTaskDetail[] schedulerInfo) {
        this.schedulerInfo = schedulerInfo;
    }

    public com.vmware.vim25.ScheduledTaskDetail getSchedulerInfo(int i) {
        return this.schedulerInfo[i];
    }

    public void setSchedulerInfo(int i, com.vmware.vim25.ScheduledTaskDetail _value) {
     ...
     * @return dayOfWeek
     */
    public com.vmware.vim25.ElementDescription[] getDayOfWeek() {
        return dayOfWeek;
    }
     ...
     * @param dayOfWeek
     */
    public void setDayOfWeek(com.vmware.vim25.ElementDescription[] dayOfWeek) {
        this.dayOfWeek = dayOfWeek;
    }

    public com.vmware.vim25.ElementDescription getDayOfWeek(int i) {
        return this.dayOfWeek[i];
    }

    public void setDayOfWeek(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     * @return weekOfMonth
     */
    public com.vmware.vim25.ElementDescription[] getWeekOfMonth() {
        return weekOfMonth;
    }
     ...
     * @param weekOfMonth
     */
    public void setWeekOfMonth(com.vmware.vim25.ElementDescription[] weekOfMonth) {
        this.weekOfMonth = weekOfMonth;
    }

    public com.vmware.vim25.ElementDescription getWeekOfMonth(int i) {
        return this.weekOfMonth[i];
    }

    public void setWeekOfMonth(int i, com.vmware.vim25.ElementDescription _value) {
