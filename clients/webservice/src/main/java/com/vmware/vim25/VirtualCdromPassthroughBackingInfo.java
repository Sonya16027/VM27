...
public class VirtualCdromPassthroughBackingInfo  extends com.vmware.vim25.VirtualDeviceDeviceBackingInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualCdromPassthroughBackingInfo"));
