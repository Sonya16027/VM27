...
public class LicenseExpiredEvent  extends com.vmware.vim25.Event  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "LicenseExpiredEvent"));
