...
public class ClusterConfigSpecEx extends
		com.vmware.vim25.ComputeResourceConfigSpec implements
	...
	public ClusterConfigSpecEx(java.lang.String dynamicType,
	 ...
	 */
	public void setDpmHostConfigSpec(
			com.vmware.vim25.ClusterDpmHostConfigSpec[] dpmHostConfigSpec) {
		this.dpmHostConfigSpec = dpmHostConfigSpec;
	}
	...
	public void setDpmHostConfigSpec(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClusterConfigSpecEx)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.dpmConfig == null && other.getDpmConfig() == null) || (this.dpmConfig != null && this.dpmConfig
						.equals(other.getDpmConfig())))
				&& ((this.dpmHostConfigSpec == null && other
						.getDpmHostConfigSpec() == null) || (this.dpmHostConfigSpec != null && java.util.Arrays
						.equals(this.dpmHostConfigSpec, other
	...
	public synchronized int hashCode() {
		...
		if (getDpmHostConfigSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDpmHostConfigSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDpmHostConfigSpec(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClusterConfigSpecEx.class, true);
