...
public class ArrayOfExtensionResourceInfo implements java.io.Serializable {
	...
	/**
	 * Gets the extensionResourceInfo value for this
	...
	/**
	 * Sets the extensionResourceInfo value for this
	 * ArrayOfExtensionResourceInfo.
	 * 
	 * @param extensionResourceInfo
	 */
	public void setExtensionResourceInfo(
			com.vmware.vim25.ExtensionResourceInfo[] extensionResourceInfo) {
		this.extensionResourceInfo = extensionResourceInfo;
	}
	...
	public void setExtensionResourceInfo(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfExtensionResourceInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.extensionResourceInfo == null && other
				.getExtensionResourceInfo() == null) || (this.extensionResourceInfo != null && java.util.Arrays
				.equals(this.extensionResourceInfo, other
						.getExtensionResourceInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getExtensionResourceInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getExtensionResourceInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getExtensionResourceInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfExtensionResourceInfo.class, true);
