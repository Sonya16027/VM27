...
public class MethodFault  extends org.apache.axis.AxisFault  implements java.io.Serializable {
     ...
     * @param faultMessage
     */
    public void setFaultMessage(com.vmware.vim25.LocalizableMessage[] faultMessage) {
        this.faultMessage = faultMessage;
    }
    ...
    public void setFaultMessage(int i, com.vmware.vim25.LocalizableMessage _value) {
