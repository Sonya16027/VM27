...
public class VirtualMachineFileLayoutExDiskLayout  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int key;
     ...
     * @param chain
     */
    public void setChain(com.vmware.vim25.VirtualMachineFileLayoutExDiskUnit[] chain) {
        this.chain = chain;
    }
    ...
    public void setChain(int i, com.vmware.vim25.VirtualMachineFileLayoutExDiskUnit _value) {
        this.chain[i] = _value;
    }
