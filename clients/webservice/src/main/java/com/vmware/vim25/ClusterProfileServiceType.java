...
public class ClusterProfileServiceType implements java.io.Serializable {
	...
	public static final ClusterProfileServiceType DRS = new ClusterProfileServiceType(
			_DRS);
	public static final ClusterProfileServiceType HA = new ClusterProfileServiceType(
			_HA);
	public static final ClusterProfileServiceType DPM = new ClusterProfileServiceType(
			_DPM);
	public static final ClusterProfileServiceType FT = new ClusterProfileServiceType(
			_FT);
	...
	public static ClusterProfileServiceType fromValue(java.lang.String value)
		...
		ClusterProfileServiceType enumeration = (ClusterProfileServiceType) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClusterProfileServiceType.class);
