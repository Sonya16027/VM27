...
public class AgentInstallFailedReason implements java.io.Serializable {
    ...
    public static AgentInstallFailedReason fromValue(java.lang.String value)
        ...
        AgentInstallFailedReason enumeration = (AgentInstallFailedReason)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AgentInstallFailedReason.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AgentInstallFailedReason"));
    }
    /**
