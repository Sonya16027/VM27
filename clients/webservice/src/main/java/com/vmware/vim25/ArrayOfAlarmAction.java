...
public class ArrayOfAlarmAction  implements java.io.Serializable {
    ...
    public ArrayOfAlarmAction(
           com.vmware.vim25.AlarmAction[] alarmAction) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfAlarmAction"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("alarmAction");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "AlarmAction"));
