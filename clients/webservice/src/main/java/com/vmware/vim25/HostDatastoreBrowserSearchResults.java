...
public class HostDatastoreBrowserSearchResults  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostDatastoreBrowserSearchResults(
           ...
           com.vmware.vim25.FileInfo[] file) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostDatastoreBrowserSearchResults"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "folderPath"));
