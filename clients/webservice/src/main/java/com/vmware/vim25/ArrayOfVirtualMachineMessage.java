...
public class ArrayOfVirtualMachineMessage implements java.io.Serializable {
	...
	/**
	 * Gets the virtualMachineMessage value for this
	...
	/**
	 * Sets the virtualMachineMessage value for this
	 * ArrayOfVirtualMachineMessage.
	 * 
	 * @param virtualMachineMessage
	 */
	public void setVirtualMachineMessage(
			com.vmware.vim25.VirtualMachineMessage[] virtualMachineMessage) {
		this.virtualMachineMessage = virtualMachineMessage;
	}
	...
	public void setVirtualMachineMessage(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVirtualMachineMessage)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.virtualMachineMessage == null && other
				.getVirtualMachineMessage() == null) || (this.virtualMachineMessage != null && java.util.Arrays
				.equals(this.virtualMachineMessage, other
						.getVirtualMachineMessage())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVirtualMachineMessage() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVirtualMachineMessage()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVirtualMachineMessage(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVirtualMachineMessage.class, true);
