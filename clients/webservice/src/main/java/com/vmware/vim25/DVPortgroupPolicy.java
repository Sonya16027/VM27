...
public class DVPortgroupPolicy extends com.vmware.vim25.DynamicData implements
	...
	public DVPortgroupPolicy(java.lang.String dynamicType,
	 ...
	 */
	public void setVendorConfigOverrideAllowed(
	 ...
	 */
	public void setPortConfigResetAtDisconnect(
			boolean portConfigResetAtDisconnect) {
		this.portConfigResetAtDisconnect = portConfigResetAtDisconnect;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DVPortgroupPolicy)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& this.shapingOverrideAllowed == other
						.isShapingOverrideAllowed()
				&& this.vendorConfigOverrideAllowed == other
						.isVendorConfigOverrideAllowed()
				&& this.livePortMovingAllowed == other
						.isLivePortMovingAllowed()
				&& this.portConfigResetAtDisconnect == other
						.isPortConfigResetAtDisconnect();
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isBlockOverrideAllowed() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isShapingOverrideAllowed() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isVendorConfigOverrideAllowed() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isLivePortMovingAllowed() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isPortConfigResetAtDisconnect() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
