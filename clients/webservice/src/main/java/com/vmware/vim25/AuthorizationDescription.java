...
public class AuthorizationDescription  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.ElementDescription[] privilege;

    private com.vmware.vim25.ElementDescription[] privilegeGroup;
    ...
    public AuthorizationDescription(
           ...
           com.vmware.vim25.ElementDescription[] privilege,
           com.vmware.vim25.ElementDescription[] privilegeGroup) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return privilege
     */
    public com.vmware.vim25.ElementDescription[] getPrivilege() {
        return privilege;
    }
     ...
     * @param privilege
     */
    public void setPrivilege(com.vmware.vim25.ElementDescription[] privilege) {
        this.privilege = privilege;
    }

    public com.vmware.vim25.ElementDescription getPrivilege(int i) {
        return this.privilege[i];
    }

    public void setPrivilege(int i, com.vmware.vim25.ElementDescription _value) {
     ...
     */
    public com.vmware.vim25.ElementDescription[] getPrivilegeGroup() {
        return privilegeGroup;
    }
     ...
     */
    public void setPrivilegeGroup(com.vmware.vim25.ElementDescription[] privilegeGroup) {
        this.privilegeGroup = privilegeGroup;
    }

    public com.vmware.vim25.ElementDescription getPrivilegeGroup(int i) {
        return this.privilegeGroup[i];
    }

    public void setPrivilegeGroup(int i, com.vmware.vim25.ElementDescription _value) {
