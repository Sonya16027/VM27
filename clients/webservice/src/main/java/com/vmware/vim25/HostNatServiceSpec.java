...
public class HostNatServiceSpec extends com.vmware.vim25.DynamicData implements
	...
	public HostNatServiceSpec(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String virtualSwitch, boolean activeFtp,
			boolean allowAnyOui, boolean configPort,
			java.lang.String ipGatewayAddress, int udpTimeout,
	...
	public void setPortForward(int i,
			com.vmware.vim25.HostNatServicePortForwardSpec _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.ipGatewayAddress == null && other
						.getIpGatewayAddress() == null) || (this.ipGatewayAddress != null && this.ipGatewayAddress
						.equals(other.getIpGatewayAddress())))
				&& this.udpTimeout == other.getUdpTimeout()
				&& ((this.portForward == null && other.getPortForward() == null) || (this.portForward != null && java.util.Arrays
						.equals(this.portForward, other.getPortForward())))
				&& ((this.nameService == null && other.getNameService() == null) || (this.nameService != null && this.nameService
						.equals(other.getNameService())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isAllowAnyOui() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
