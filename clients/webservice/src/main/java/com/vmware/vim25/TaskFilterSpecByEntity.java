...
public class TaskFilterSpecByEntity  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param recursion
     */
    public void setRecursion(com.vmware.vim25.TaskFilterSpecRecursionOption recursion) {
        this.recursion = recursion;
    }
