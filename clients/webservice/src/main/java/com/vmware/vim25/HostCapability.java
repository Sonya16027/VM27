...
public class HostCapability extends com.vmware.vim25.DynamicData implements
	...
	public HostCapability(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			boolean recursiveResourcePoolsSupported,
			boolean cpuMemoryResourceConfigurationSupported,
			boolean rebootSupported, boolean shutdownSupported,
			boolean vmotionSupported, boolean standbySupported,
			java.lang.Boolean ipmiSupported, java.lang.Integer maxSupportedVMs,
			java.lang.Integer maxRunningVMs,
			java.lang.Integer maxSupportedVcpus,
			boolean datastorePrincipalSupported, boolean sanSupported,
			boolean nfsSupported, boolean iscsiSupported,
			boolean vlanTaggingSupported, boolean nicTeamingSupported,
			boolean highGuestMemSupported, boolean maintenanceModeSupported,
			boolean suspendedRelocateSupported,
			boolean restrictedSnapshotRelocateSupported,
			boolean perVmSwapFiles, boolean localSwapDatastoreSupported,
			boolean unsharedSwapVMotionSupported,
			boolean backgroundSnapshotsSupported,
			boolean preAssignedPCIUnitNumbersSupported,
			boolean screenshotSupported, boolean scaledScreenshotSupported,
	 ...
	 */
	public void setRecursiveResourcePoolsSupported(
			boolean recursiveResourcePoolsSupported) {
		this.recursiveResourcePoolsSupported = recursiveResourcePoolsSupported;
	}

	/**
	 * Gets the cpuMemoryResourceConfigurationSupported value for this
	 * HostCapability.
	 * 
	...
	/**
	 * Sets the cpuMemoryResourceConfigurationSupported value for this
	 * HostCapability.
	 * 
	 * @param cpuMemoryResourceConfigurationSupported
	 */
	public void setCpuMemoryResourceConfigurationSupported(
			boolean cpuMemoryResourceConfigurationSupported) {
		this.cpuMemoryResourceConfigurationSupported = cpuMemoryResourceConfigurationSupported;
	}
	 ...
	 */
	public void setDatastorePrincipalSupported(
	...
	/**
	 * Gets the restrictedSnapshotRelocateSupported value for this
	 * HostCapability.
	 * 
	...
	/**
	 * Sets the restrictedSnapshotRelocateSupported value for this
	 * HostCapability.
	 * 
	 * @param restrictedSnapshotRelocateSupported
	 */
	public void setRestrictedSnapshotRelocateSupported(
			boolean restrictedSnapshotRelocateSupported) {
		this.restrictedSnapshotRelocateSupported = restrictedSnapshotRelocateSupported;
	}
	 ...
	 */
	public void setLocalSwapDatastoreSupported(
	 ...
	 */
	public void setUnsharedSwapVMotionSupported(
			boolean unsharedSwapVMotionSupported) {
		this.unsharedSwapVMotionSupported = unsharedSwapVMotionSupported;
	}
	 ...
	 */
	public void setBackgroundSnapshotsSupported(
			boolean backgroundSnapshotsSupported) {
		this.backgroundSnapshotsSupported = backgroundSnapshotsSupported;
	}

	/**
	 * Gets the preAssignedPCIUnitNumbersSupported value for this
	 * HostCapability.
	 * 
	...
	/**
	 * Sets the preAssignedPCIUnitNumbersSupported value for this
	 * HostCapability.
	 * 
	 * @param preAssignedPCIUnitNumbersSupported
	 */
	public void setPreAssignedPCIUnitNumbersSupported(
			boolean preAssignedPCIUnitNumbersSupported) {
		this.preAssignedPCIUnitNumbersSupported = preAssignedPCIUnitNumbersSupported;
	}
	 ...
	 */
	public void setStorageVMotionSupported(
			java.lang.Boolean storageVMotionSupported) {
		this.storageVMotionSupported = storageVMotionSupported;
	}

	/**
	 * Gets the vmotionWithStorageVMotionSupported value for this
	 * HostCapability.
	 * 
	...
	/**
	 * Sets the vmotionWithStorageVMotionSupported value for this
	 * HostCapability.
	 * 
	 * @param vmotionWithStorageVMotionSupported
	 */
	public void setVmotionWithStorageVMotionSupported(
			java.lang.Boolean vmotionWithStorageVMotionSupported) {
		this.vmotionWithStorageVMotionSupported = vmotionWithStorageVMotionSupported;
	}
	 ...
	 */
	public void setReplayUnsupportedReason(
			java.lang.String replayUnsupportedReason) {
		this.replayUnsupportedReason = replayUnsupportedReason;
	}
	 ...
	 */
	public void setLoginBySSLThumbprintSupported(
			java.lang.Boolean loginBySSLThumbprintSupported) {
		this.loginBySSLThumbprintSupported = loginBySSLThumbprintSupported;
	}
	 ...
	 */
	public void setCloneFromSnapshotSupported(
			java.lang.Boolean cloneFromSnapshotSupported) {
		this.cloneFromSnapshotSupported = cloneFromSnapshotSupported;
	}
	 ...
	 */
	public void setDeltaDiskBackingsSupported(
			java.lang.Boolean deltaDiskBackingsSupported) {
		this.deltaDiskBackingsSupported = deltaDiskBackingsSupported;
	}

	/**
	 * Gets the perVMNetworkTrafficShapingSupported value for this
	 * HostCapability.
	 * 
	...
	/**
	 * Sets the perVMNetworkTrafficShapingSupported value for this
	 * HostCapability.
	 * 
	 * @param perVMNetworkTrafficShapingSupported
	 */
	public void setPerVMNetworkTrafficShapingSupported(
			java.lang.Boolean perVMNetworkTrafficShapingSupported) {
		this.perVMNetworkTrafficShapingSupported = perVMNetworkTrafficShapingSupported;
	}
	 ...
	 */
	public void setSupportedCpuFeature(
			com.vmware.vim25.HostCpuIdInfo[] supportedCpuFeature) {
		this.supportedCpuFeature = supportedCpuFeature;
	}
	...
	public void setSupportedCpuFeature(int i,
			com.vmware.vim25.HostCpuIdInfo _value) {
	 ...
	 */
	public void setVirtualExecUsageSupported(
			java.lang.Boolean virtualExecUsageSupported) {
		this.virtualExecUsageSupported = virtualExecUsageSupported;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& this.recursiveResourcePoolsSupported == other
						.isRecursiveResourcePoolsSupported()
				&& this.cpuMemoryResourceConfigurationSupported == other
				...
				&& ((this.ipmiSupported == null && other.getIpmiSupported() == null) || (this.ipmiSupported != null && this.ipmiSupported
						.equals(other.getIpmiSupported())))
				&& ((this.maxSupportedVMs == null && other.getMaxSupportedVMs() == null) || (this.maxSupportedVMs != null && this.maxSupportedVMs
						.equals(other.getMaxSupportedVMs())))
				&& ((this.maxRunningVMs == null && other.getMaxRunningVMs() == null) || (this.maxRunningVMs != null && this.maxRunningVMs
						.equals(other.getMaxRunningVMs())))
				&& ((this.maxSupportedVcpus == null && other
						.getMaxSupportedVcpus() == null) || (this.maxSupportedVcpus != null && this.maxSupportedVcpus
						.equals(other.getMaxSupportedVcpus())))
				&& this.datastorePrincipalSupported == other
				...
				&& this.highGuestMemSupported == other
						.isHighGuestMemSupported()
				&& this.maintenanceModeSupported == other
						.isMaintenanceModeSupported()
				&& this.suspendedRelocateSupported == other
						.isSuspendedRelocateSupported()
				&& this.restrictedSnapshotRelocateSupported == other
						.isRestrictedSnapshotRelocateSupported()
				&& this.perVmSwapFiles == other.isPerVmSwapFiles()
				&& this.localSwapDatastoreSupported == other
						.isLocalSwapDatastoreSupported()
				&& this.unsharedSwapVMotionSupported == other
						.isUnsharedSwapVMotionSupported()
				&& this.backgroundSnapshotsSupported == other
						.isBackgroundSnapshotsSupported()
				&& this.preAssignedPCIUnitNumbersSupported == other
						.isPreAssignedPCIUnitNumbersSupported()
				&& this.screenshotSupported == other.isScreenshotSupported()
				&& this.scaledScreenshotSupported == other
						.isScaledScreenshotSupported()
				&& ((this.storageVMotionSupported == null && other
						.getStorageVMotionSupported() == null) || (this.storageVMotionSupported != null && this.storageVMotionSupported
						.equals(other.getStorageVMotionSupported())))
				&& ((this.vmotionWithStorageVMotionSupported == null && other
						.getVmotionWithStorageVMotionSupported() == null) || (this.vmotionWithStorageVMotionSupported != null && this.vmotionWithStorageVMotionSupported
						.equals(other.getVmotionWithStorageVMotionSupported())))
				&& ((this.recordReplaySupported == null && other
						.getRecordReplaySupported() == null) || (this.recordReplaySupported != null && this.recordReplaySupported
						.equals(other.getRecordReplaySupported())))
				&& ((this.ftSupported == null && other.getFtSupported() == null) || (this.ftSupported != null && this.ftSupported
						.equals(other.getFtSupported())))
				&& ((this.replayUnsupportedReason == null && other
						.getReplayUnsupportedReason() == null) || (this.replayUnsupportedReason != null && this.replayUnsupportedReason
						.equals(other.getReplayUnsupportedReason())))
				&& ((this.loginBySSLThumbprintSupported == null && other
						.getLoginBySSLThumbprintSupported() == null) || (this.loginBySSLThumbprintSupported != null && this.loginBySSLThumbprintSupported
						.equals(other.getLoginBySSLThumbprintSupported())))
				&& ((this.cloneFromSnapshotSupported == null && other
						.getCloneFromSnapshotSupported() == null) || (this.cloneFromSnapshotSupported != null && this.cloneFromSnapshotSupported
						.equals(other.getCloneFromSnapshotSupported())))
				&& ((this.deltaDiskBackingsSupported == null && other
						.getDeltaDiskBackingsSupported() == null) || (this.deltaDiskBackingsSupported != null && this.deltaDiskBackingsSupported
						.equals(other.getDeltaDiskBackingsSupported())))
				&& ((this.perVMNetworkTrafficShapingSupported == null && other
						.getPerVMNetworkTrafficShapingSupported() == null) || (this.perVMNetworkTrafficShapingSupported != null && this.perVMNetworkTrafficShapingSupported
						.equals(other.getPerVMNetworkTrafficShapingSupported())))
				&& ((this.tpmSupported == null && other.getTpmSupported() == null) || (this.tpmSupported != null && this.tpmSupported
						.equals(other.getTpmSupported())))
				&& ((this.supportedCpuFeature == null && other
						.getSupportedCpuFeature() == null) || (this.supportedCpuFeature != null && java.util.Arrays
						.equals(this.supportedCpuFeature, other
								.getSupportedCpuFeature())))
				&& ((this.virtualExecUsageSupported == null && other
						.getVirtualExecUsageSupported() == null) || (this.virtualExecUsageSupported != null && this.virtualExecUsageSupported
						.equals(other.getVirtualExecUsageSupported())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isRecursiveResourcePoolsSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isCpuMemoryResourceConfigurationSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isRebootSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isShutdownSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isVmotionSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isStandbySupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		...
		_hashCode += (isDatastorePrincipalSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isSanSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isNfsSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isIscsiSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isVlanTaggingSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isNicTeamingSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isHighGuestMemSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isMaintenanceModeSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isSuspendedRelocateSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isRestrictedSnapshotRelocateSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isPerVmSwapFiles() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isLocalSwapDatastoreSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isUnsharedSwapVMotionSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isBackgroundSnapshotsSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isPreAssignedPCIUnitNumbersSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isScreenshotSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isScaledScreenshotSupported() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		...
		if (getSupportedCpuFeature() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getSupportedCpuFeature()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getSupportedCpuFeature(), i);
