...
public class HostInternetScsiHba  extends com.vmware.vim25.HostHostBusAdapter  implements java.io.Serializable {
     ...
     */
    public void setDiscoveryCapabilities(com.vmware.vim25.HostInternetScsiHbaDiscoveryCapabilities discoveryCapabilities) {
        this.discoveryCapabilities = discoveryCapabilities;
    }
     ...
     */
    public void setDiscoveryProperties(com.vmware.vim25.HostInternetScsiHbaDiscoveryProperties discoveryProperties) {
        this.discoveryProperties = discoveryProperties;
    }
     ...
     */
    public void setAuthenticationCapabilities(com.vmware.vim25.HostInternetScsiHbaAuthenticationCapabilities authenticationCapabilities) {
        this.authenticationCapabilities = authenticationCapabilities;
    }
     ...
     */
    public void setAuthenticationProperties(com.vmware.vim25.HostInternetScsiHbaAuthenticationProperties authenticationProperties) {
        this.authenticationProperties = authenticationProperties;
    }
     ...
     */
    public void setDigestCapabilities(com.vmware.vim25.HostInternetScsiHbaDigestCapabilities digestCapabilities) {
        this.digestCapabilities = digestCapabilities;
    }
     ...
     */
    public void setDigestProperties(com.vmware.vim25.HostInternetScsiHbaDigestProperties digestProperties) {
        this.digestProperties = digestProperties;
    }
     ...
     */
    public void setIpCapabilities(com.vmware.vim25.HostInternetScsiHbaIPCapabilities ipCapabilities) {
        this.ipCapabilities = ipCapabilities;
    }
     ...
     * @param ipProperties
     */
    public void setIpProperties(com.vmware.vim25.HostInternetScsiHbaIPProperties ipProperties) {
        this.ipProperties = ipProperties;
    }
     ...
     */
    public void setSupportedAdvancedOptions(com.vmware.vim25.OptionDef[] supportedAdvancedOptions) {
        this.supportedAdvancedOptions = supportedAdvancedOptions;
    }
    ...
    public void setSupportedAdvancedOptions(int i, com.vmware.vim25.OptionDef _value) {
     ...
     */
    public void setAdvancedOptions(com.vmware.vim25.HostInternetScsiHbaParamValue[] advancedOptions) {
        this.advancedOptions = advancedOptions;
    }

    public com.vmware.vim25.HostInternetScsiHbaParamValue getAdvancedOptions(int i) {
        return this.advancedOptions[i];
    }

    public void setAdvancedOptions(int i, com.vmware.vim25.HostInternetScsiHbaParamValue _value) {
     ...
     */
    public void setConfiguredSendTarget(com.vmware.vim25.HostInternetScsiHbaSendTarget[] configuredSendTarget) {
        this.configuredSendTarget = configuredSendTarget;
    }

    public com.vmware.vim25.HostInternetScsiHbaSendTarget getConfiguredSendTarget(int i) {
        return this.configuredSendTarget[i];
    }

    public void setConfiguredSendTarget(int i, com.vmware.vim25.HostInternetScsiHbaSendTarget _value) {
     ...
     */
    public void setConfiguredStaticTarget(com.vmware.vim25.HostInternetScsiHbaStaticTarget[] configuredStaticTarget) {
        this.configuredStaticTarget = configuredStaticTarget;
    }

    public com.vmware.vim25.HostInternetScsiHbaStaticTarget getConfiguredStaticTarget(int i) {
        return this.configuredStaticTarget[i];
    }

    public void setConfiguredStaticTarget(int i, com.vmware.vim25.HostInternetScsiHbaStaticTarget _value) {
