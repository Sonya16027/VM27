...
public class ArrayOfPerfQuerySpec  implements java.io.Serializable {
    ...
    public ArrayOfPerfQuerySpec(
           com.vmware.vim25.PerfQuerySpec[] perfQuerySpec) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfPerfQuerySpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("perfQuerySpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "PerfQuerySpec"));
