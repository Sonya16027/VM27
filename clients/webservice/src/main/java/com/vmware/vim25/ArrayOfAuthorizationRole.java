...
public class ArrayOfAuthorizationRole implements java.io.Serializable {
	 ...
	 */
	public void setAuthorizationRole(
			com.vmware.vim25.AuthorizationRole[] authorizationRole) {
		this.authorizationRole = authorizationRole;
	}
	...
	public void setAuthorizationRole(int i,
			com.vmware.vim25.AuthorizationRole _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfAuthorizationRole)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.authorizationRole == null && other
				.getAuthorizationRole() == null) || (this.authorizationRole != null && java.util.Arrays
				.equals(this.authorizationRole, other.getAuthorizationRole())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getAuthorizationRole() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getAuthorizationRole()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getAuthorizationRole(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfAuthorizationRole.class, true);
