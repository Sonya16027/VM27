...
public class ArrayOfFileQuery  implements java.io.Serializable {
    ...
    public ArrayOfFileQuery(
           com.vmware.vim25.FileQuery[] fileQuery) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfFileQuery"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fileQuery");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "FileQuery"));
