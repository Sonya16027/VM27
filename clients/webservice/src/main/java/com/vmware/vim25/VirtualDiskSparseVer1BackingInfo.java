...
public class VirtualDiskSparseVer1BackingInfo  extends com.vmware.vim25.VirtualDeviceFileBackingInfo  implements java.io.Serializable {
     ...
     * @param parent
     */
    public void setParent(com.vmware.vim25.VirtualDiskSparseVer1BackingInfo parent) {
        this.parent = parent;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualDiskSparseVer1BackingInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualDiskSparseVer1BackingInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
