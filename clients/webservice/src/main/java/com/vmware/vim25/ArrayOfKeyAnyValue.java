...
public class ArrayOfKeyAnyValue  implements java.io.Serializable {
    ...
    public ArrayOfKeyAnyValue(
           com.vmware.vim25.KeyAnyValue[] keyAnyValue) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfKeyAnyValue)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.keyAnyValue==null && other.getKeyAnyValue()==null) || 
             (this.keyAnyValue!=null &&
              java.util.Arrays.equals(this.keyAnyValue, other.getKeyAnyValue())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getKeyAnyValue() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getKeyAnyValue());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getKeyAnyValue(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfKeyAnyValue.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfKeyAnyValue"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("keyAnyValue");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "KeyAnyValue"));
