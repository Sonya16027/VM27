...
public class ProfilePolicyMetadata  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setPossibleOption(com.vmware.vim25.ProfilePolicyOptionMetadata[] possibleOption) {
        this.possibleOption = possibleOption;
    }
    ...
    public void setPossibleOption(int i, com.vmware.vim25.ProfilePolicyOptionMetadata _value) {
        this.possibleOption[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProfilePolicyMetadata)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.possibleOption==null && other.getPossibleOption()==null) || 
             (this.possibleOption!=null &&
              java.util.Arrays.equals(this.possibleOption, other.getPossibleOption())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPossibleOption() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPossibleOption());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPossibleOption(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProfilePolicyMetadata.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ProfilePolicyMetadata"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "possibleOption"));
