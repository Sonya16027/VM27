...
public class HostConfigSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param nasDatastore
     */
    public void setNasDatastore(com.vmware.vim25.HostNasVolumeConfig[] nasDatastore) {
        this.nasDatastore = nasDatastore;
    }
    ...
    public void setNasDatastore(int i, com.vmware.vim25.HostNasVolumeConfig _value) {
     ...
     */
    public void setNicTypeSelection(com.vmware.vim25.HostVirtualNicManagerNicTypeSelection[] nicTypeSelection) {
        this.nicTypeSelection = nicTypeSelection;
    }

    public com.vmware.vim25.HostVirtualNicManagerNicTypeSelection getNicTypeSelection(int i) {
        return this.nicTypeSelection[i];
    }

    public void setNicTypeSelection(int i, com.vmware.vim25.HostVirtualNicManagerNicTypeSelection _value) {
     ...
     */
    public void setUsergroupAccount(com.vmware.vim25.HostAccountSpec[] usergroupAccount) {
        this.usergroupAccount = usergroupAccount;
    }
    ...
    public void setUsergroupAccount(int i, com.vmware.vim25.HostAccountSpec _value) {
