...
public class ArrayOfHostNatServiceConfig  implements java.io.Serializable {
    ...
    public void setHostNatServiceConfig(int i, com.vmware.vim25.HostNatServiceConfig _value) {
        this.hostNatServiceConfig[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfHostNatServiceConfig)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.hostNatServiceConfig==null && other.getHostNatServiceConfig()==null) || 
             (this.hostNatServiceConfig!=null &&
              java.util.Arrays.equals(this.hostNatServiceConfig, other.getHostNatServiceConfig())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHostNatServiceConfig() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostNatServiceConfig());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostNatServiceConfig(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfHostNatServiceConfig.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostNatServiceConfig"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostNatServiceConfig");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostNatServiceConfig"));
