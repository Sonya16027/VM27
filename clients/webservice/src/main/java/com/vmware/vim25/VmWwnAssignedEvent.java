...
public class VmWwnAssignedEvent extends com.vmware.vim25.VmEvent implements
	...
	public VmWwnAssignedEvent(java.lang.String dynamicType,
			...
			boolean template, long[] nodeWwns, long[] portWwns) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VmWwnAssignedEvent)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.nodeWwns == null && other.getNodeWwns() == null) || (this.nodeWwns != null && java.util.Arrays
						.equals(this.nodeWwns, other.getNodeWwns())))
				&& ((this.portWwns == null && other.getPortWwns() == null) || (this.portWwns != null && java.util.Arrays
						.equals(this.portWwns, other.getPortWwns())));
		__equalsCalc = null;
		return _equals;
	}
