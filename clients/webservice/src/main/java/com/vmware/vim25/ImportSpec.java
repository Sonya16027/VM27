...
public class ImportSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImportSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.entityConfig==null && other.getEntityConfig()==null) || 
             (this.entityConfig!=null &&
              this.entityConfig.equals(other.getEntityConfig())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImportSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ImportSpec"));
