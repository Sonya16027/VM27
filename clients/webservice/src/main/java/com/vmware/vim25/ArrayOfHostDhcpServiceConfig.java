...
public class ArrayOfHostDhcpServiceConfig implements java.io.Serializable {
	...
	/**
	 * Gets the hostDhcpServiceConfig value for this
	...
	/**
	 * Sets the hostDhcpServiceConfig value for this
	 * ArrayOfHostDhcpServiceConfig.
	 * 
	 * @param hostDhcpServiceConfig
	 */
	public void setHostDhcpServiceConfig(
			com.vmware.vim25.HostDhcpServiceConfig[] hostDhcpServiceConfig) {
		this.hostDhcpServiceConfig = hostDhcpServiceConfig;
	}
	...
	public void setHostDhcpServiceConfig(int i,
			com.vmware.vim25.HostDhcpServiceConfig _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostDhcpServiceConfig)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostDhcpServiceConfig == null && other
				.getHostDhcpServiceConfig() == null) || (this.hostDhcpServiceConfig != null && java.util.Arrays
				.equals(this.hostDhcpServiceConfig, other
						.getHostDhcpServiceConfig())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostDhcpServiceConfig() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostDhcpServiceConfig()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostDhcpServiceConfig(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostDhcpServiceConfig.class, true);
