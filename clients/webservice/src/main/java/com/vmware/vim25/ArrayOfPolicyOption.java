...
public class ArrayOfPolicyOption  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfPolicyOption)) return false;
        ...
        _equals = true && 
            ((this.policyOption==null && other.getPolicyOption()==null) || 
             (this.policyOption!=null &&
              java.util.Arrays.equals(this.policyOption, other.getPolicyOption())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPolicyOption() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPolicyOption());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPolicyOption(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfPolicyOption.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfPolicyOption"));
