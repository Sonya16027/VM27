...
public class VirtualDevice  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int key;
     ...
     * @param connectable
     */
    public void setConnectable(com.vmware.vim25.VirtualDeviceConnectInfo connectable) {
        this.connectable = connectable;
    }
