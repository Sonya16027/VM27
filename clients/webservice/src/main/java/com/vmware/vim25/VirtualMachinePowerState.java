...
public class VirtualMachinePowerState implements java.io.Serializable {
	...
	public static final VirtualMachinePowerState poweredOff = new VirtualMachinePowerState(
			_poweredOff);
	public static final VirtualMachinePowerState poweredOn = new VirtualMachinePowerState(
			_poweredOn);
	public static final VirtualMachinePowerState suspended = new VirtualMachinePowerState(
			_suspended);
	...
	public static VirtualMachinePowerState fromValue(java.lang.String value)
		...
		VirtualMachinePowerState enumeration = (VirtualMachinePowerState) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualMachinePowerState.class);
