...
public class ArrayOfVirtualMachineConfigOptionDescriptor  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineConfigOptionDescriptor getVirtualMachineConfigOptionDescriptor(int i) {
        return this.virtualMachineConfigOptionDescriptor[i];
    }

    public void setVirtualMachineConfigOptionDescriptor(int i, com.vmware.vim25.VirtualMachineConfigOptionDescriptor _value) {
