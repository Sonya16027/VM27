...
public class ExportVAppResponse  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference returnval;

    public ExportVAppResponse() {
    }
    ...
    /**
     * Gets the returnval value for this ExportVAppResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this ExportVAppResponse.
     * 
     * @param returnval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExportVAppResponse)) return false;
        ExportVAppResponse other = (ExportVAppResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExportVAppResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", ">ExportVAppResponse"));
