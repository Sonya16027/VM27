...
public class ArrayOfVirtualMachineRelocateSpecDiskLocator  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineRelocateSpecDiskLocator getVirtualMachineRelocateSpecDiskLocator(int i) {
        return this.virtualMachineRelocateSpecDiskLocator[i];
    }

    public void setVirtualMachineRelocateSpecDiskLocator(int i, com.vmware.vim25.VirtualMachineRelocateSpecDiskLocator _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfVirtualMachineRelocateSpecDiskLocator"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineRelocateSpecDiskLocator");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineRelocateSpecDiskLocator"));
