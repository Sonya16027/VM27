...
public class UpdateInternetScsiAuthenticationPropertiesRequestType  implements java.io.Serializable {
    ...
    /**
     * Gets the _this value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the iScsiHbaDevice value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
    ...
    /**
     * Sets the iScsiHbaDevice value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
    ...
    /**
     * Gets the authenticationProperties value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
    ...
    /**
     * Sets the authenticationProperties value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
    ...
    /**
     * Gets the targetSet value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
     * @return targetSet
     */
    ...
    /**
     * Sets the targetSet value for this UpdateInternetScsiAuthenticationPropertiesRequestType.
     * 
     * @param targetSet
     */
    public void setTargetSet(com.vmware.vim25.HostInternetScsiHbaTargetSet targetSet) {
        this.targetSet = targetSet;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateInternetScsiAuthenticationPropertiesRequestType)) return false;
        ...
        _equals = true && 
            ...
            ((this.targetSet==null && other.getTargetSet()==null) || 
             (this.targetSet!=null &&
              this.targetSet.equals(other.getTargetSet())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateInternetScsiAuthenticationPropertiesRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "UpdateInternetScsiAuthenticationPropertiesRequestType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "iScsiHbaDevice"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "targetSet"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostInternetScsiHbaTargetSet"));
