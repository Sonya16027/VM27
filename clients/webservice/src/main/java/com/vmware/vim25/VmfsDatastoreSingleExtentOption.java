...
public class VmfsDatastoreSingleExtentOption  extends com.vmware.vim25.VmfsDatastoreBaseOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmfsDatastoreSingleExtentOption"));
