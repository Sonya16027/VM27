...
public class ArrayOfHostPortGroupProfile implements java.io.Serializable {
	 ...
	 */
	public void setHostPortGroupProfile(
			com.vmware.vim25.HostPortGroupProfile[] hostPortGroupProfile) {
		this.hostPortGroupProfile = hostPortGroupProfile;
	}
	...
	public void setHostPortGroupProfile(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostPortGroupProfile)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostPortGroupProfile == null && other
				.getHostPortGroupProfile() == null) || (this.hostPortGroupProfile != null && java.util.Arrays
				.equals(this.hostPortGroupProfile, other
						.getHostPortGroupProfile())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostPortGroupProfile() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostPortGroupProfile()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostPortGroupProfile(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostPortGroupProfile.class, true);
