...
public class VmfsDatastoreCreateSpec extends com.vmware.vim25.VmfsDatastoreSpec
	...
	private com.vmware.vim25.HostVmfsSpec vmfs;
	...
	public VmfsDatastoreCreateSpec(java.lang.String dynamicType,
			...
			com.vmware.vim25.HostVmfsSpec vmfs,
	 ...
	 * @return vmfs
	 */
	public com.vmware.vim25.HostVmfsSpec getVmfs() {
		return vmfs;
	}
	 ...
	 * @param vmfs
	 */
	public void setVmfs(com.vmware.vim25.HostVmfsSpec vmfs) {
		this.vmfs = vmfs;
	}
