...
public class PropertySpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PropertySpec)) return false;
    ...
    public synchronized int hashCode() {
        ...
        if (getPathSet() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPathSet());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPathSet(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PropertySpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PropertySpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "all"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "pathSet"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
