...
public class ArrayOfVirtualMachineFileLayoutSnapshotLayout  implements java.io.Serializable {
     ...
     */
    public void setVirtualMachineFileLayoutSnapshotLayout(com.vmware.vim25.VirtualMachineFileLayoutSnapshotLayout[] virtualMachineFileLayoutSnapshotLayout) {
        this.virtualMachineFileLayoutSnapshotLayout = virtualMachineFileLayoutSnapshotLayout;
    }

    public com.vmware.vim25.VirtualMachineFileLayoutSnapshotLayout getVirtualMachineFileLayoutSnapshotLayout(int i) {
        return this.virtualMachineFileLayoutSnapshotLayout[i];
    }

    public void setVirtualMachineFileLayoutSnapshotLayout(int i, com.vmware.vim25.VirtualMachineFileLayoutSnapshotLayout _value) {
