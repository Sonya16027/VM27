...
public class VmConfigFileQueryFlags extends com.vmware.vim25.DynamicData
	...
	public VmConfigFileQueryFlags(java.lang.String dynamicType,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VmConfigFileQueryFlags)) {
			return false;
		}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isConfigVersion() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VmConfigFileQueryFlags.class, true);
