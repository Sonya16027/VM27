...
public class AutoStartPowerInfo extends com.vmware.vim25.DynamicData implements
	...
	public AutoStartPowerInfo(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			com.vmware.vim25.ManagedObjectReference key, int startOrder,
			int startDelay,
			com.vmware.vim25.AutoStartWaitHeartbeatSetting waitForHeartbeat,
			java.lang.String startAction, int stopDelay,
	 ...
	 */
	public void setWaitForHeartbeat(
			com.vmware.vim25.AutoStartWaitHeartbeatSetting waitForHeartbeat) {
		this.waitForHeartbeat = waitForHeartbeat;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof AutoStartPowerInfo)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.waitForHeartbeat == null && other
						.getWaitForHeartbeat() == null) || (this.waitForHeartbeat != null && this.waitForHeartbeat
						.equals(other.getWaitForHeartbeat())))
