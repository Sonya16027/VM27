...
public class AutoStartPowerInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.vim25.AutoStartWaitHeartbeatSetting waitForHeartbeat;
    ...
    public AutoStartPowerInfo(
           ...
           int startOrder,
           int startDelay,
           com.vmware.vim25.AutoStartWaitHeartbeatSetting waitForHeartbeat,
     ...
     */
    public com.vmware.vim25.AutoStartWaitHeartbeatSetting getWaitForHeartbeat() {
        return waitForHeartbeat;
    }
     ...
     */
    public void setWaitForHeartbeat(com.vmware.vim25.AutoStartWaitHeartbeatSetting waitForHeartbeat) {
        this.waitForHeartbeat = waitForHeartbeat;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AutoStartPowerInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AutoStartWaitHeartbeatSetting"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
