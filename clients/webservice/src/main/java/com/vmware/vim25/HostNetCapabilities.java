...
public class HostNetCapabilities extends com.vmware.vim25.DynamicData implements
	...
	public HostNetCapabilities(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			boolean canSetPhysicalNicLinkSpeed, boolean supportsNicTeaming,
			java.lang.String[] nicTeamingPolicy, boolean supportsVlan,
			boolean usesServiceConsoleNic, boolean supportsNetworkHints,
			java.lang.Integer maxPortGroupsPerVswitch,
			boolean vswitchConfigSupported, boolean vnicConfigSupported,
			boolean ipRouteConfigSupported, boolean dnsConfigSupported,
			boolean dhcpOnVnicSupported, java.lang.Boolean ipV6Supported) {
	 ...
	 */
	public void setMaxPortGroupsPerVswitch(
			java.lang.Integer maxPortGroupsPerVswitch) {
		this.maxPortGroupsPerVswitch = maxPortGroupsPerVswitch;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostNetCapabilities)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& this.canSetPhysicalNicLinkSpeed == other
						.isCanSetPhysicalNicLinkSpeed()
				&& this.supportsNicTeaming == other.isSupportsNicTeaming()
				&& ((this.nicTeamingPolicy == null && other
						.getNicTeamingPolicy() == null) || (this.nicTeamingPolicy != null && java.util.Arrays
						.equals(this.nicTeamingPolicy, other
								.getNicTeamingPolicy())))
				&& this.supportsVlan == other.isSupportsVlan()
				&& this.usesServiceConsoleNic == other
						.isUsesServiceConsoleNic()
				&& this.supportsNetworkHints == other.isSupportsNetworkHints()
				&& ((this.maxPortGroupsPerVswitch == null && other
						.getMaxPortGroupsPerVswitch() == null) || (this.maxPortGroupsPerVswitch != null && this.maxPortGroupsPerVswitch
						.equals(other.getMaxPortGroupsPerVswitch())))
				&& this.vswitchConfigSupported == other
						.isVswitchConfigSupported()
				&& this.vnicConfigSupported == other.isVnicConfigSupported()
				&& this.ipRouteConfigSupported == other
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isCanSetPhysicalNicLinkSpeed() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isSupportsNicTeaming() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		if (getNicTeamingPolicy() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getNicTeamingPolicy()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getNicTeamingPolicy(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		}
		_hashCode += (isSupportsVlan() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isUsesServiceConsoleNic() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isSupportsNetworkHints() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		if (getMaxPortGroupsPerVswitch() != null) {
			_hashCode += getMaxPortGroupsPerVswitch().hashCode();
		}
		_hashCode += (isVswitchConfigSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isVnicConfigSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isIpRouteConfigSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isDnsConfigSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isDhcpOnVnicSupported() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostNetCapabilities.class, true);
