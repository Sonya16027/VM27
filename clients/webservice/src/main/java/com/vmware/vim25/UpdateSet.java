...
public class UpdateSet  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private java.lang.String version;

    private com.vmware.vim25.PropertyFilterUpdate[] filterSet;
    ...
    public UpdateSet(
           ...
           com.vmware.vim25.PropertyFilterUpdate[] filterSet) {
        super(
            dynamicType,
            dynamicProperty);
     ...
     * @return filterSet
     */
    public com.vmware.vim25.PropertyFilterUpdate[] getFilterSet() {
        return filterSet;
    }
     ...
     * @param filterSet
     */
    public void setFilterSet(com.vmware.vim25.PropertyFilterUpdate[] filterSet) {
        this.filterSet = filterSet;
    }

    public com.vmware.vim25.PropertyFilterUpdate getFilterSet(int i) {
        return this.filterSet[i];
    }

    public void setFilterSet(int i, com.vmware.vim25.PropertyFilterUpdate _value) {
