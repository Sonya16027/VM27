...
public class ArrayOfVirtualDevice  implements java.io.Serializable {
    ...
    public ArrayOfVirtualDevice(
           com.vmware.vim25.VirtualDevice[] virtualDevice) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfVirtualDevice"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualDevice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "VirtualDevice"));
