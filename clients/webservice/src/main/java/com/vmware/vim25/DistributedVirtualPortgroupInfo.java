...
public class DistributedVirtualPortgroupInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public DistributedVirtualPortgroupInfo(
           ...
           java.lang.String portgroupType,
           boolean uplinkPortgroup,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DistributedVirtualPortgroupInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.portgroupType==null && other.getPortgroupType()==null) || 
             (this.portgroupType!=null &&
              this.portgroupType.equals(other.getPortgroupType()))) &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isUplinkPortgroup() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DistributedVirtualPortgroupInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DistributedVirtualPortgroupInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "portgroupType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
