...
public class HostHardwareStatusInfo extends com.vmware.vim25.DynamicData
	...
	public HostHardwareStatusInfo(java.lang.String dynamicType,
	 ...
	 */
	public void setMemoryStatusInfo(
			com.vmware.vim25.HostHardwareElementInfo[] memoryStatusInfo) {
		this.memoryStatusInfo = memoryStatusInfo;
	}
	...
	public void setMemoryStatusInfo(int i,
	...
	public void setCpuStatusInfo(int i,
			com.vmware.vim25.HostHardwareElementInfo _value) {
	 ...
	 */
	public void setStorageStatusInfo(
			com.vmware.vim25.HostStorageElementInfo[] storageStatusInfo) {
		this.storageStatusInfo = storageStatusInfo;
	}
	...
	public void setStorageStatusInfo(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostHardwareStatusInfo)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.memoryStatusInfo == null && other
						.getMemoryStatusInfo() == null) || (this.memoryStatusInfo != null && java.util.Arrays
						.equals(this.memoryStatusInfo, other
								.getMemoryStatusInfo())))
				&& ((this.cpuStatusInfo == null && other.getCpuStatusInfo() == null) || (this.cpuStatusInfo != null && java.util.Arrays
						.equals(this.cpuStatusInfo, other.getCpuStatusInfo())))
				&& ((this.storageStatusInfo == null && other
						.getStorageStatusInfo() == null) || (this.storageStatusInfo != null && java.util.Arrays
						.equals(this.storageStatusInfo, other
	...
	public synchronized int hashCode() {
		...
		if (getMemoryStatusInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getMemoryStatusInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getMemoryStatusInfo(), i);
		...
		if (getStorageStatusInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getStorageStatusInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getStorageStatusInfo(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostHardwareStatusInfo.class, true);
