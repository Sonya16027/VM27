...
public class ArrayOfPnicUplinkProfile implements java.io.Serializable {
	 ...
	 */
	public void setPnicUplinkProfile(
			com.vmware.vim25.PnicUplinkProfile[] pnicUplinkProfile) {
		this.pnicUplinkProfile = pnicUplinkProfile;
	}
	...
	public void setPnicUplinkProfile(int i,
			com.vmware.vim25.PnicUplinkProfile _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfPnicUplinkProfile)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.pnicUplinkProfile == null && other
				.getPnicUplinkProfile() == null) || (this.pnicUplinkProfile != null && java.util.Arrays
				.equals(this.pnicUplinkProfile, other.getPnicUplinkProfile())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPnicUplinkProfile() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPnicUplinkProfile()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getPnicUplinkProfile(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfPnicUplinkProfile.class, true);
