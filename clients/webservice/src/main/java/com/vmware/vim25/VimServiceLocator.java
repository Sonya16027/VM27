...
public class VimServiceLocator extends org.apache.axis.client.Service implements com.vmware.vim25.VimService {
    ...
    public VimServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public com.vmware.vim25.VimPortType getVimPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.vmware.vim25.VimPortType getVimPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vmware.vim25.VimBindingStub _stub = new com.vmware.vim25.VimBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vmware.vim25.VimPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vmware.vim25.VimBindingStub _stub = new com.vmware.vim25.VimBindingStub(new java.net.URL(VimPort_address), this);
                _stub.setPortName(getVimPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:vim25Service", "VimPort"));
        }
