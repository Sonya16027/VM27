...
public class ArrayOfHostTpmDigestInfo  implements java.io.Serializable {
    ...
    public void setHostTpmDigestInfo(int i, com.vmware.vim25.HostTpmDigestInfo _value) {
        this.hostTpmDigestInfo[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfHostTpmDigestInfo)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.hostTpmDigestInfo==null && other.getHostTpmDigestInfo()==null) || 
             (this.hostTpmDigestInfo!=null &&
              java.util.Arrays.equals(this.hostTpmDigestInfo, other.getHostTpmDigestInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHostTpmDigestInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostTpmDigestInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostTpmDigestInfo(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfHostTpmDigestInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostTpmDigestInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostTpmDigestInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostTpmDigestInfo"));
