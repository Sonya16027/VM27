...
public class ClusterPowerOnVmResult extends com.vmware.vim25.DynamicData
	...
	public ClusterPowerOnVmResult(java.lang.String dynamicType,
	...
	public void setAttempted(int i,
			com.vmware.vim25.ClusterAttemptedVmInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.attempted == null && other.getAttempted() == null) || (this.attempted != null && java.util.Arrays
						.equals(this.attempted, other.getAttempted())))
				&& ((this.notAttempted == null && other.getNotAttempted() == null) || (this.notAttempted != null && java.util.Arrays
						.equals(this.notAttempted, other.getNotAttempted())))
				&& ((this.recommendations == null && other.getRecommendations() == null) || (this.recommendations != null && java.util.Arrays
						.equals(this.recommendations, other
								.getRecommendations())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getRecommendations() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getRecommendations()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClusterPowerOnVmResult.class, true);
