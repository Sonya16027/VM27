...
public class HostSslThumbprintInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostSslThumbprintInfo(
           ...
           java.lang.String[] sslThumbprints) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostSslThumbprintInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.sslThumbprints==null && other.getSslThumbprints()==null) || 
             (this.sslThumbprints!=null &&
              java.util.Arrays.equals(this.sslThumbprints, other.getSslThumbprints())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSslThumbprints() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSslThumbprints());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSslThumbprints(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostSslThumbprintInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostSslThumbprintInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "sslThumbprints"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
