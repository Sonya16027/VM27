...
public class ArrayOfHostIpRouteEntry implements java.io.Serializable {
	 ...
	 */
	public void setHostIpRouteEntry(
			com.vmware.vim25.HostIpRouteEntry[] hostIpRouteEntry) {
		this.hostIpRouteEntry = hostIpRouteEntry;
	}
	...
	public void setHostIpRouteEntry(int i,
			com.vmware.vim25.HostIpRouteEntry _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostIpRouteEntry)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostIpRouteEntry == null && other
				.getHostIpRouteEntry() == null) || (this.hostIpRouteEntry != null && java.util.Arrays
				.equals(this.hostIpRouteEntry, other.getHostIpRouteEntry())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostIpRouteEntry() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostIpRouteEntry()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostIpRouteEntry(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostIpRouteEntry.class, true);
