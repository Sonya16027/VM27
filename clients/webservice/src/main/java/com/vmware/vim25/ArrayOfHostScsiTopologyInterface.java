...
public class ArrayOfHostScsiTopologyInterface  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostScsiTopologyInterface getHostScsiTopologyInterface(int i) {
        return this.hostScsiTopologyInterface[i];
    }

    public void setHostScsiTopologyInterface(int i, com.vmware.vim25.HostScsiTopologyInterface _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostScsiTopologyInterface"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostScsiTopologyInterface");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostScsiTopologyInterface"));
