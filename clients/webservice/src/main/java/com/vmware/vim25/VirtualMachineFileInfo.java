...
public class VirtualMachineFileInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public VirtualMachineFileInfo(
           ...
           java.lang.String suspendDirectory,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualMachineFileInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.snapshotDirectory==null && other.getSnapshotDirectory()==null) || 
             (this.snapshotDirectory!=null &&
              this.snapshotDirectory.equals(other.getSnapshotDirectory()))) &&
            ((this.suspendDirectory==null && other.getSuspendDirectory()==null) || 
             (this.suspendDirectory!=null &&
              this.suspendDirectory.equals(other.getSuspendDirectory()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualMachineFileInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineFileInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "snapshotDirectory"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "suspendDirectory"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "logDirectory"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
