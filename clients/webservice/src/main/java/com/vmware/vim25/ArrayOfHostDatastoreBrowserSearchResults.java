...
public class ArrayOfHostDatastoreBrowserSearchResults  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostDatastoreBrowserSearchResults getHostDatastoreBrowserSearchResults(int i) {
        return this.hostDatastoreBrowserSearchResults[i];
    }

    public void setHostDatastoreBrowserSearchResults(int i, com.vmware.vim25.HostDatastoreBrowserSearchResults _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostDatastoreBrowserSearchResults"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostDatastoreBrowserSearchResults");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostDatastoreBrowserSearchResults"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostDatastoreBrowserSearchResults"));
