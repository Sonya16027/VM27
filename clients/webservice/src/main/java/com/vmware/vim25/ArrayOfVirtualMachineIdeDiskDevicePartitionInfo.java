...
public class ArrayOfVirtualMachineIdeDiskDevicePartitionInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo getVirtualMachineIdeDiskDevicePartitionInfo(int i) {
        return this.virtualMachineIdeDiskDevicePartitionInfo[i];
    }

    public void setVirtualMachineIdeDiskDevicePartitionInfo(int i, com.vmware.vim25.VirtualMachineIdeDiskDevicePartitionInfo _value) {
