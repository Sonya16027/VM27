...
public class ArrayOfVAppProductSpec  implements java.io.Serializable {
    ...
    public void setVAppProductSpec(int i, com.vmware.vim25.VAppProductSpec _value) {
        this.VAppProductSpec[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfVAppProductSpec)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.VAppProductSpec==null && other.getVAppProductSpec()==null) || 
             (this.VAppProductSpec!=null &&
              java.util.Arrays.equals(this.VAppProductSpec, other.getVAppProductSpec())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getVAppProductSpec() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getVAppProductSpec());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getVAppProductSpec(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfVAppProductSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfVAppProductSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("VAppProductSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "VAppProductSpec"));
