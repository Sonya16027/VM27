...
public class QueryPerfRequestType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryPerfRequestType)) return false;
        ...
        _equals = true && 
            ...
            ((this.querySpec==null && other.getQuerySpec()==null) || 
             (this.querySpec!=null &&
              java.util.Arrays.equals(this.querySpec, other.getQuerySpec())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getQuerySpec() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getQuerySpec());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getQuerySpec(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryPerfRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "QueryPerfRequestType"));
