...
public class HostNatServiceNameServiceSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostNatServiceNameServiceSpec(
           ...
           boolean dnsAutoDetect,
           java.lang.String dnsPolicy,
           int dnsRetries,
           int dnsTimeout,
           java.lang.String[] dnsNameServer,
           int nbdsTimeout,
           int nbnsRetries,
           int nbnsTimeout) {
        super(
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostNatServiceNameServiceSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.dnsPolicy==null && other.getDnsPolicy()==null) || 
             (this.dnsPolicy!=null &&
              this.dnsPolicy.equals(other.getDnsPolicy()))) &&
            this.dnsRetries == other.getDnsRetries() &&
            this.dnsTimeout == other.getDnsTimeout() &&
            ((this.dnsNameServer==null && other.getDnsNameServer()==null) || 
             (this.dnsNameServer!=null &&
              java.util.Arrays.equals(this.dnsNameServer, other.getDnsNameServer()))) &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isDnsAutoDetect() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        ...
        if (getDnsNameServer() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDnsNameServer());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDnsNameServer(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostNatServiceNameServiceSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostNatServiceNameServiceSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnsAutoDetect");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dnsAutoDetect"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnsPolicy");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dnsPolicy"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnsRetries");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dnsRetries"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnsTimeout");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dnsTimeout"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnsNameServer");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dnsNameServer"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "nbdsTimeout"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nbnsRetries");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "nbnsRetries"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nbnsTimeout");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "nbnsTimeout"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
