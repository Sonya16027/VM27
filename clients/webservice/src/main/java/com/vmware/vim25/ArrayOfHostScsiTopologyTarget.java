...
public class ArrayOfHostScsiTopologyTarget  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostScsiTopologyTarget getHostScsiTopologyTarget(int i) {
        return this.hostScsiTopologyTarget[i];
    }

    public void setHostScsiTopologyTarget(int i, com.vmware.vim25.HostScsiTopologyTarget _value) {
