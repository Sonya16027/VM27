...
public class ArrayOfElementDescription implements java.io.Serializable {
	...
	private com.vmware.vim25.ElementDescription[] elementDescription;

	public ArrayOfElementDescription() {
	}

	public ArrayOfElementDescription(
			com.vmware.vim25.ElementDescription[] elementDescription) {
	...
	public com.vmware.vim25.ElementDescription getElementDescription(int i) {
