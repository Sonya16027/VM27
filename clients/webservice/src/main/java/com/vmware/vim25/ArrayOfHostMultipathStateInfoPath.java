...
public class ArrayOfHostMultipathStateInfoPath implements java.io.Serializable {
	...
	/**
	 * Gets the hostMultipathStateInfoPath value for this
	...
	/**
	 * Sets the hostMultipathStateInfoPath value for this
	 * ArrayOfHostMultipathStateInfoPath.
	 * 
	 * @param hostMultipathStateInfoPath
	 */
	public void setHostMultipathStateInfoPath(
			com.vmware.vim25.HostMultipathStateInfoPath[] hostMultipathStateInfoPath) {
		this.hostMultipathStateInfoPath = hostMultipathStateInfoPath;
	}
	...
	public void setHostMultipathStateInfoPath(int i,
			com.vmware.vim25.HostMultipathStateInfoPath _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostMultipathStateInfoPath)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostMultipathStateInfoPath == null && other
				.getHostMultipathStateInfoPath() == null) || (this.hostMultipathStateInfoPath != null && java.util.Arrays
				.equals(this.hostMultipathStateInfoPath, other
						.getHostMultipathStateInfoPath())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostMultipathStateInfoPath() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostMultipathStateInfoPath()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostMultipathStateInfoPath(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostMultipathStateInfoPath.class, true);
