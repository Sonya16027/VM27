...
public class VmFaultToleranceInvalidFileBacking  extends com.vmware.vim25.VmFaultToleranceIssue  implements java.io.Serializable {
    ...
    /**
     * Gets the backingFilename value for this VmFaultToleranceInvalidFileBacking.
     * 
    ...
    /**
     * Sets the backingFilename value for this VmFaultToleranceInvalidFileBacking.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VmFaultToleranceInvalidFileBacking)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.backingType==null && other.getBackingType()==null) || 
             (this.backingType!=null &&
              this.backingType.equals(other.getBackingType()))) &&
            ((this.backingFilename==null && other.getBackingFilename()==null) || 
             (this.backingFilename!=null &&
              this.backingFilename.equals(other.getBackingFilename())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VmFaultToleranceInvalidFileBacking.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmFaultToleranceInvalidFileBacking"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("backingType");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "backingType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "backingFilename"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
