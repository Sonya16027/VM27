...
public class VirtualDiskFlatVer2BackingOption extends
	...
	public VirtualDiskFlatVer2BackingOption(java.lang.String dynamicType,
			...
			com.vmware.vim25.BoolOption writeThrough, boolean growable,
			boolean hotGrowable, boolean uuid,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VirtualDiskFlatVer2BackingOption)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.eagerlyScrub == null && other.getEagerlyScrub() == null) || (this.eagerlyScrub != null && this.eagerlyScrub
						.equals(other.getEagerlyScrub())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isHotGrowable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualDiskFlatVer2BackingOption.class, true);
