...
public class SystemError  extends com.vmware.vim25.RuntimeFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "SystemError"));
