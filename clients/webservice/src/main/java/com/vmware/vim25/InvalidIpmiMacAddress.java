...
public class InvalidIpmiMacAddress  extends com.vmware.vim25.VimFault  implements java.io.Serializable {
     ...
     */
    public void setUserProvidedMacAddress(java.lang.String userProvidedMacAddress) {
        this.userProvidedMacAddress = userProvidedMacAddress;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidIpmiMacAddress)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.userProvidedMacAddress==null && other.getUserProvidedMacAddress()==null) || 
             (this.userProvidedMacAddress!=null &&
              this.userProvidedMacAddress.equals(other.getUserProvidedMacAddress()))) &&
            ((this.observedMacAddress==null && other.getObservedMacAddress()==null) || 
             (this.observedMacAddress!=null &&
              this.observedMacAddress.equals(other.getObservedMacAddress())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InvalidIpmiMacAddress.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "InvalidIpmiMacAddress"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userProvidedMacAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "userProvidedMacAddress"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("observedMacAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "observedMacAddress"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
