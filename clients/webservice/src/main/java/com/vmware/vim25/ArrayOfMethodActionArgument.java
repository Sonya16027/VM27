...
public class ArrayOfMethodActionArgument  implements java.io.Serializable {
    ...
    public void setMethodActionArgument(int i, com.vmware.vim25.MethodActionArgument _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfMethodActionArgument"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("methodActionArgument");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "MethodActionArgument"));
