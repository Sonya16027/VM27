...
public class ArrayOfMethodActionArgument implements java.io.Serializable {
	...
	private com.vmware.vim25.MethodActionArgument[] methodActionArgument;

	public ArrayOfMethodActionArgument() {
	}

	public ArrayOfMethodActionArgument(
			com.vmware.vim25.MethodActionArgument[] methodActionArgument) {
	 ...
	 */
	public void setMethodActionArgument(
			com.vmware.vim25.MethodActionArgument[] methodActionArgument) {
		this.methodActionArgument = methodActionArgument;
	}

	public com.vmware.vim25.MethodActionArgument getMethodActionArgument(int i) {
		return this.methodActionArgument[i];
	}

	public void setMethodActionArgument(int i,
			com.vmware.vim25.MethodActionArgument _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfMethodActionArgument)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.methodActionArgument == null && other
				.getMethodActionArgument() == null) || (this.methodActionArgument != null && java.util.Arrays
				.equals(this.methodActionArgument, other
						.getMethodActionArgument())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getMethodActionArgument() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getMethodActionArgument()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getMethodActionArgument(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfMethodActionArgument.class, true);
