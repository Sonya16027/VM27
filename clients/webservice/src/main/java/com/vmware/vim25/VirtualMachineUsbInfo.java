...
public class VirtualMachineUsbInfo extends
	...
	public VirtualMachineUsbInfo(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String name, java.lang.String[] configurationTag,
			java.lang.String description, int vendor, int product,
			java.lang.String physicalPath, java.lang.String[] family,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.physicalPath == null && other.getPhysicalPath() == null) || (this.physicalPath != null && this.physicalPath
						.equals(other.getPhysicalPath())))
				&& ((this.family == null && other.getFamily() == null) || (this.family != null && java.util.Arrays
						.equals(this.family, other.getFamily())))
				&& ((this.speed == null && other.getSpeed() == null) || (this.speed != null && java.util.Arrays
						.equals(this.speed, other.getSpeed())))
	...
	public synchronized int hashCode() {
		...
		if (getFamily() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getFamily()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getFamily(),
						i);
		...
		if (getSpeed() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getSpeed()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getSpeed(),
						i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualMachineUsbInfo.class, true);
