...
public class CustomizationLicenseFilePrintData  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param autoMode
     */
    public void setAutoMode(com.vmware.vim25.CustomizationLicenseDataMode autoMode) {
        this.autoMode = autoMode;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CustomizationLicenseFilePrintData"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("autoMode");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "autoMode"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CustomizationLicenseDataMode"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("autoUsers");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "autoUsers"));
