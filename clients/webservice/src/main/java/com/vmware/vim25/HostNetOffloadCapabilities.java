...
public class HostNetOffloadCapabilities  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostNetOffloadCapabilities(
           ...
           java.lang.Boolean csumOffload,
           java.lang.Boolean tcpSegmentation,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostNetOffloadCapabilities)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.csumOffload==null && other.getCsumOffload()==null) || 
             (this.csumOffload!=null &&
              this.csumOffload.equals(other.getCsumOffload()))) &&
            ((this.tcpSegmentation==null && other.getTcpSegmentation()==null) || 
             (this.tcpSegmentation!=null &&
              this.tcpSegmentation.equals(other.getTcpSegmentation()))) &&
            ((this.zeroCopyXmit==null && other.getZeroCopyXmit()==null) || 
             (this.zeroCopyXmit!=null &&
              this.zeroCopyXmit.equals(other.getZeroCopyXmit())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostNetOffloadCapabilities.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostNetOffloadCapabilities"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("csumOffload");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "csumOffload"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "tcpSegmentation"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "zeroCopyXmit"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
