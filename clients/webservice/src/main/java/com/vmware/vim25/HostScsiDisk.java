...
public class HostScsiDisk extends com.vmware.vim25.ScsiLun implements
	...
	public HostScsiDisk(java.lang.String dynamicType,
		...
		super(dynamicType, dynamicProperty, deviceName, deviceType, key, uuid,
				descriptor, canonicalName, displayName, lunType, vendor, model,
				revision, scsiLevel, serialNumber, durableName, alternateName,
				standardInquiry, queueDepth, operationalState, capabilities);
