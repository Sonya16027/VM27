...
public class DatastoreRemovedOnHostEvent  extends com.vmware.vim25.HostEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DatastoreRemovedOnHostEvent"));
