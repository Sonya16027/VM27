...
public class FaultToleranceConfigInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int role;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FaultToleranceConfigInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.instanceUuids==null && other.getInstanceUuids()==null) || 
             (this.instanceUuids!=null &&
              java.util.Arrays.equals(this.instanceUuids, other.getInstanceUuids()))) &&
            ((this.configPaths==null && other.getConfigPaths()==null) || 
             (this.configPaths!=null &&
              java.util.Arrays.equals(this.configPaths, other.getConfigPaths())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getInstanceUuids() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getInstanceUuids());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getInstanceUuids(), i);
                if (obj != null &&
        ...
        if (getConfigPaths() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getConfigPaths());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getConfigPaths(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FaultToleranceConfigInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "FaultToleranceConfigInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "instanceUuids"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "configPaths"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
