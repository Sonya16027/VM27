...
public class ArrayOfScsiLunDescriptor  implements java.io.Serializable {
    ...
    public void setScsiLunDescriptor(int i, com.vmware.vim25.ScsiLunDescriptor _value) {
        this.scsiLunDescriptor[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfScsiLunDescriptor)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.scsiLunDescriptor==null && other.getScsiLunDescriptor()==null) || 
             (this.scsiLunDescriptor!=null &&
              java.util.Arrays.equals(this.scsiLunDescriptor, other.getScsiLunDescriptor())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getScsiLunDescriptor() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getScsiLunDescriptor());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getScsiLunDescriptor(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfScsiLunDescriptor.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfScsiLunDescriptor"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("scsiLunDescriptor");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ScsiLunDescriptor"));
