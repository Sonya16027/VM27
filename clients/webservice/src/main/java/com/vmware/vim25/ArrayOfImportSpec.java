...
public class ArrayOfImportSpec implements java.io.Serializable {
	...
	public ArrayOfImportSpec(com.vmware.vim25.ImportSpec[] importSpec) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfImportSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.importSpec == null && other.getImportSpec() == null) || (this.importSpec != null && java.util.Arrays
				.equals(this.importSpec, other.getImportSpec())));
		__equalsCalc = null;
		return _equals;
	}
