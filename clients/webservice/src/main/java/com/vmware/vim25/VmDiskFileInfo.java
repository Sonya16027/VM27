...
public class VmDiskFileInfo  extends com.vmware.vim25.FileInfo  implements java.io.Serializable {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.diskExtents==null && other.getDiskExtents()==null) || 
             (this.diskExtents!=null &&
              java.util.Arrays.equals(this.diskExtents, other.getDiskExtents()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getDiskExtents() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDiskExtents());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDiskExtents(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmDiskFileInfo"));
