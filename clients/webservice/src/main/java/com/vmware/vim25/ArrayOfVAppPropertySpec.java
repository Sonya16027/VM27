...
public class ArrayOfVAppPropertySpec implements java.io.Serializable {
	 ...
	 */
	public void setVAppPropertySpec(
			com.vmware.vim25.VAppPropertySpec[] VAppPropertySpec) {
		this.VAppPropertySpec = VAppPropertySpec;
	}
	...
	public void setVAppPropertySpec(int i,
			com.vmware.vim25.VAppPropertySpec _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVAppPropertySpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.VAppPropertySpec == null && other
				.getVAppPropertySpec() == null) || (this.VAppPropertySpec != null && java.util.Arrays
				.equals(this.VAppPropertySpec, other.getVAppPropertySpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVAppPropertySpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVAppPropertySpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVAppPropertySpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVAppPropertySpec.class, true);
