...
public class ArrayOfIpPool implements java.io.Serializable {
	...
	public ArrayOfIpPool(com.vmware.vim25.IpPool[] ipPool) {
		this.ipPool = ipPool;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfIpPool)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.ipPool == null && other.getIpPool() == null) || (this.ipPool != null && java.util.Arrays
				.equals(this.ipPool, other.getIpPool())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (getIpPool() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getIpPool()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getIpPool(),
						i);
