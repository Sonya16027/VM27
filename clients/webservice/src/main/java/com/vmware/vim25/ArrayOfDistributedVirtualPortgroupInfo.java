...
public class ArrayOfDistributedVirtualPortgroupInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.DistributedVirtualPortgroupInfo getDistributedVirtualPortgroupInfo(int i) {
        return this.distributedVirtualPortgroupInfo[i];
    }

    public void setDistributedVirtualPortgroupInfo(int i, com.vmware.vim25.DistributedVirtualPortgroupInfo _value) {
