...
public class ArrayOfVirtualMachineScsiDiskDeviceInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineScsiDiskDeviceInfo getVirtualMachineScsiDiskDeviceInfo(int i) {
        return this.virtualMachineScsiDiskDeviceInfo[i];
    }

    public void setVirtualMachineScsiDiskDeviceInfo(int i, com.vmware.vim25.VirtualMachineScsiDiskDeviceInfo _value) {
