...
public class HostRuntimeInfo extends com.vmware.vim25.DynamicData implements
	 ...
	 */
	public void setHealthSystemRuntime(
			com.vmware.vim25.HealthSystemRuntime healthSystemRuntime) {
		this.healthSystemRuntime = healthSystemRuntime;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostRuntimeInfo)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.healthSystemRuntime == null && other
						.getHealthSystemRuntime() == null) || (this.healthSystemRuntime != null && this.healthSystemRuntime
						.equals(other.getHealthSystemRuntime())))
				&& ((this.tpmPcrValues == null && other.getTpmPcrValues() == null) || (this.tpmPcrValues != null && java.util.Arrays
						.equals(this.tpmPcrValues, other.getTpmPcrValues())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isInMaintenanceMode() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		if (getBootTime() != null) {
