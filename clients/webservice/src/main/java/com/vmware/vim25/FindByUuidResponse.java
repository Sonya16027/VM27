...
public class FindByUuidResponse  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference returnval;

    public FindByUuidResponse() {
    }
    ...
    /**
     * Gets the returnval value for this FindByUuidResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this FindByUuidResponse.
     * 
     * @param returnval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindByUuidResponse)) return false;
        FindByUuidResponse other = (FindByUuidResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindByUuidResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", ">FindByUuidResponse"));
