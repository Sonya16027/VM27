...
public class DvsProfile extends com.vmware.vim25.ApplyProfile implements
	...
	public DvsProfile(java.lang.String dynamicType,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.uplink == null && other.getUplink() == null) || (this.uplink != null && java.util.Arrays
						.equals(this.uplink, other.getUplink())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getUplink() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getUplink()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getUplink(),
						i);
