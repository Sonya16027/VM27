...
public class ArrayOfClusterRuleSpec  implements java.io.Serializable {
    ...
    public void setClusterRuleSpec(int i, com.vmware.vim25.ClusterRuleSpec _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfClusterRuleSpec"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("clusterRuleSpec");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ClusterRuleSpec"));
