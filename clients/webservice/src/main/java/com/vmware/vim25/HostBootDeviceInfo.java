...
public class HostBootDeviceInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostBootDeviceInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.bootDevices==null && other.getBootDevices()==null) || 
             (this.bootDevices!=null &&
              java.util.Arrays.equals(this.bootDevices, other.getBootDevices()))) &&
            ((this.currentBootDeviceKey==null && other.getCurrentBootDeviceKey()==null) || 
             (this.currentBootDeviceKey!=null &&
              this.currentBootDeviceKey.equals(other.getCurrentBootDeviceKey())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getBootDevices() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBootDevices());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getBootDevices(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostBootDeviceInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostBootDeviceInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bootDevices");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "bootDevices"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostBootDevice"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "currentBootDeviceKey"));
