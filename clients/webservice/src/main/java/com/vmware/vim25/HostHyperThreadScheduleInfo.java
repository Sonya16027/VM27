...
public class HostHyperThreadScheduleInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostHyperThreadScheduleInfo"));
