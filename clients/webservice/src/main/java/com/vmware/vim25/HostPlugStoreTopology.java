...
public class HostPlugStoreTopology  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param adapter
     */
    public void setAdapter(com.vmware.vim25.HostPlugStoreTopologyAdapter[] adapter) {
        this.adapter = adapter;
    }
    ...
    public void setAdapter(int i, com.vmware.vim25.HostPlugStoreTopologyAdapter _value) {
    ...
    public void setTarget(int i, com.vmware.vim25.HostPlugStoreTopologyTarget _value) {
    ...
    public void setDevice(int i, com.vmware.vim25.HostPlugStoreTopologyDevice _value) {
    ...
    public void setPlugin(int i, com.vmware.vim25.HostPlugStoreTopologyPlugin _value) {
