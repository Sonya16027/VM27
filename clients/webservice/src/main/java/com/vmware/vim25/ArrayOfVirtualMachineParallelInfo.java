...
public class ArrayOfVirtualMachineParallelInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineParallelInfo getVirtualMachineParallelInfo(int i) {
        return this.virtualMachineParallelInfo[i];
    }

    public void setVirtualMachineParallelInfo(int i, com.vmware.vim25.VirtualMachineParallelInfo _value) {
