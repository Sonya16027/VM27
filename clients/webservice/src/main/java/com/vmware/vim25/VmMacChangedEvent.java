...
public class VmMacChangedEvent  extends com.vmware.vim25.VmEvent  implements java.io.Serializable {
    ...
    public VmMacChangedEvent(
           ...
           java.lang.String oldMac,
           java.lang.String newMac) {
        super(
            dynamicType,
            dynamicProperty,
            key,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VmMacChangedEvent)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.oldMac==null && other.getOldMac()==null) || 
             (this.oldMac!=null &&
              this.oldMac.equals(other.getOldMac()))) &&
            ((this.newMac==null && other.getNewMac()==null) || 
             (this.newMac!=null &&
              this.newMac.equals(other.getNewMac())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VmMacChangedEvent.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmMacChangedEvent"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "oldMac"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("newMac");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "newMac"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
