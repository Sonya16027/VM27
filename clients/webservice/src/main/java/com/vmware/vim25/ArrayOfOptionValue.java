...
public class ArrayOfOptionValue  implements java.io.Serializable {
    ...
    public ArrayOfOptionValue(
           com.vmware.vim25.OptionValue[] optionValue) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfOptionValue"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("optionValue");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "OptionValue"));
