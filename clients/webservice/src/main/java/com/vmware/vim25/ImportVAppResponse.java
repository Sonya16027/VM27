...
public class ImportVAppResponse  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference returnval;

    public ImportVAppResponse() {
    }
    ...
    /**
     * Gets the returnval value for this ImportVAppResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this ImportVAppResponse.
     * 
     * @param returnval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImportVAppResponse)) return false;
        ImportVAppResponse other = (ImportVAppResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImportVAppResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", ">ImportVAppResponse"));
