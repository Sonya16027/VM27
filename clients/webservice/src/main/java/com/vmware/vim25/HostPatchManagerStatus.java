...
public class HostPatchManagerStatus  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostPatchManagerStatus(
           ...
           boolean vmOffRequired,
           java.lang.String[] supersededPatchIds) {
        super(
            dynamicType,
            dynamicProperty);
        this.id = id;
     ...
     */
    public void setPrerequisitePatch(com.vmware.vim25.HostPatchManagerStatusPrerequisitePatch[] prerequisitePatch) {
        this.prerequisitePatch = prerequisitePatch;
    }

    public com.vmware.vim25.HostPatchManagerStatusPrerequisitePatch getPrerequisitePatch(int i) {
        return this.prerequisitePatch[i];
    }

    public void setPrerequisitePatch(int i, com.vmware.vim25.HostPatchManagerStatusPrerequisitePatch _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostPatchManagerStatus)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.integrity==null && other.getIntegrity()==null) || 
             (this.integrity!=null &&
              this.integrity.equals(other.getIntegrity()))) &&
            this.installed == other.isInstalled() &&
            ((this.installState==null && other.getInstallState()==null) || 
             (this.installState!=null &&
              java.util.Arrays.equals(this.installState, other.getInstallState()))) &&
            ...
            ((this.supersededPatchIds==null && other.getSupersededPatchIds()==null) || 
             (this.supersededPatchIds!=null &&
              java.util.Arrays.equals(this.supersededPatchIds, other.getSupersededPatchIds())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getInstallState() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getInstallState());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getInstallState(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        _hashCode += (isRestartRequired() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        _hashCode += (isReconnectRequired() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        _hashCode += (isVmOffRequired() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        if (getSupersededPatchIds() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSupersededPatchIds());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSupersededPatchIds(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostPatchManagerStatus.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostPatchManagerStatus"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "applicable"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "integrity"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "installed"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("installState");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "installState"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostPatchManagerStatusPrerequisitePatch"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "restartRequired"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reconnectRequired");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "reconnectRequired"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("vmOffRequired");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "vmOffRequired"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("supersededPatchIds");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "supersededPatchIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
