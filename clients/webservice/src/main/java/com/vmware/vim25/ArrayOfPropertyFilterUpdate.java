...
public class ArrayOfPropertyFilterUpdate  implements java.io.Serializable {
    ...
    public void setPropertyFilterUpdate(int i, com.vmware.vim25.PropertyFilterUpdate _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfPropertyFilterUpdate"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("propertyFilterUpdate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "PropertyFilterUpdate"));
