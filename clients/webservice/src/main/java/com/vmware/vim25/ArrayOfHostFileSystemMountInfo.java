...
public class ArrayOfHostFileSystemMountInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.HostFileSystemMountInfo getHostFileSystemMountInfo(int i) {
        return this.hostFileSystemMountInfo[i];
    }

    public void setHostFileSystemMountInfo(int i, com.vmware.vim25.HostFileSystemMountInfo _value) {
