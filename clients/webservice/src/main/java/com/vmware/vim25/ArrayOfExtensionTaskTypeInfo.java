...
public class ArrayOfExtensionTaskTypeInfo implements java.io.Serializable {
	...
	/**
	 * Gets the extensionTaskTypeInfo value for this
	...
	/**
	 * Sets the extensionTaskTypeInfo value for this
	 * ArrayOfExtensionTaskTypeInfo.
	 * 
	 * @param extensionTaskTypeInfo
	 */
	public void setExtensionTaskTypeInfo(
			com.vmware.vim25.ExtensionTaskTypeInfo[] extensionTaskTypeInfo) {
		this.extensionTaskTypeInfo = extensionTaskTypeInfo;
	}
	...
	public void setExtensionTaskTypeInfo(int i,
			com.vmware.vim25.ExtensionTaskTypeInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfExtensionTaskTypeInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.extensionTaskTypeInfo == null && other
				.getExtensionTaskTypeInfo() == null) || (this.extensionTaskTypeInfo != null && java.util.Arrays
				.equals(this.extensionTaskTypeInfo, other
						.getExtensionTaskTypeInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getExtensionTaskTypeInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getExtensionTaskTypeInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getExtensionTaskTypeInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfExtensionTaskTypeInfo.class, true);
