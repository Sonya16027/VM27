...
public class ArrayOfFirewallProfileRulesetProfile implements
	...
	/**
	 * Gets the firewallProfileRulesetProfile value for this
	...
	/**
	 * Sets the firewallProfileRulesetProfile value for this
	 * ArrayOfFirewallProfileRulesetProfile.
	 * 
	 * @param firewallProfileRulesetProfile
	 */
	public void setFirewallProfileRulesetProfile(
			com.vmware.vim25.FirewallProfileRulesetProfile[] firewallProfileRulesetProfile) {
		this.firewallProfileRulesetProfile = firewallProfileRulesetProfile;
	}
	...
	public void setFirewallProfileRulesetProfile(int i,
			com.vmware.vim25.FirewallProfileRulesetProfile _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfFirewallProfileRulesetProfile)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.firewallProfileRulesetProfile == null && other
				.getFirewallProfileRulesetProfile() == null) || (this.firewallProfileRulesetProfile != null && java.util.Arrays
				.equals(this.firewallProfileRulesetProfile, other
						.getFirewallProfileRulesetProfile())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getFirewallProfileRulesetProfile() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getFirewallProfileRulesetProfile()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getFirewallProfileRulesetProfile(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfFirewallProfileRulesetProfile.class, true);
