...
public class HostMultipathStateInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public void setPath(int i, com.vmware.vim25.HostMultipathStateInfoPath _value) {
        this.path[i] = _value;
    }
