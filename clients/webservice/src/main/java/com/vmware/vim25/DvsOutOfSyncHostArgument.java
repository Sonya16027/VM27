...
public class DvsOutOfSyncHostArgument extends com.vmware.vim25.DynamicData
	...
	public DvsOutOfSyncHostArgument(java.lang.String dynamicType,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DvsOutOfSyncHostArgument)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.outOfSyncHost == null && other.getOutOfSyncHost() == null) || (this.outOfSyncHost != null && this.outOfSyncHost
						.equals(other.getOutOfSyncHost())))
				&& ((this.configParamters == null && other.getConfigParamters() == null) || (this.configParamters != null && java.util.Arrays
						.equals(this.configParamters, other
								.getConfigParamters())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getConfigParamters() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getConfigParamters()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getConfigParamters(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			DvsOutOfSyncHostArgument.class, true);
