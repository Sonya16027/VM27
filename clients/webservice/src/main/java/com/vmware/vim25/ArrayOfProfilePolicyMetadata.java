...
public class ArrayOfProfilePolicyMetadata implements java.io.Serializable {
	...
	/**
	 * Gets the profilePolicyMetadata value for this
	...
	/**
	 * Sets the profilePolicyMetadata value for this
	 * ArrayOfProfilePolicyMetadata.
	 * 
	 * @param profilePolicyMetadata
	 */
	public void setProfilePolicyMetadata(
			com.vmware.vim25.ProfilePolicyMetadata[] profilePolicyMetadata) {
		this.profilePolicyMetadata = profilePolicyMetadata;
	}
	...
	public void setProfilePolicyMetadata(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfProfilePolicyMetadata)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.profilePolicyMetadata == null && other
				.getProfilePolicyMetadata() == null) || (this.profilePolicyMetadata != null && java.util.Arrays
				.equals(this.profilePolicyMetadata, other
						.getProfilePolicyMetadata())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getProfilePolicyMetadata() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getProfilePolicyMetadata()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getProfilePolicyMetadata(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfProfilePolicyMetadata.class, true);
