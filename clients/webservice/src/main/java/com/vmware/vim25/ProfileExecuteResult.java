...
public class ProfileExecuteResult extends com.vmware.vim25.DynamicData
	...
	public void setRequireInput(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ProfileExecuteResult)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.inapplicablePath == null && other
						.getInapplicablePath() == null) || (this.inapplicablePath != null && java.util.Arrays
						.equals(this.inapplicablePath, other
								.getInapplicablePath())))
				&& ((this.requireInput == null && other.getRequireInput() == null) || (this.requireInput != null && java.util.Arrays
						.equals(this.requireInput, other.getRequireInput())))
	...
	public synchronized int hashCode() {
		...
		if (getInapplicablePath() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getInapplicablePath()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getInapplicablePath(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ProfileExecuteResult.class, true);
