...
public class HostNumaInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private java.lang.String type;

    private int numNodes;

    private com.vmware.vim25.HostNumaNode[] numaNode;
    ...
    public HostNumaInfo(
           ...
           int numNodes,
           com.vmware.vim25.HostNumaNode[] numaNode) {
        super(
            dynamicType,
            dynamicProperty);
        this.type = type;
     ...
     * @return numaNode
     */
    public com.vmware.vim25.HostNumaNode[] getNumaNode() {
        return numaNode;
    }
     ...
     * @param numaNode
     */
    public void setNumaNode(com.vmware.vim25.HostNumaNode[] numaNode) {
        this.numaNode = numaNode;
    }

    public com.vmware.vim25.HostNumaNode getNumaNode(int i) {
        return this.numaNode[i];
    }

    public void setNumaNode(int i, com.vmware.vim25.HostNumaNode _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostNumaInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "numNodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("numaNode");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "numaNode"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostNumaNode"));
