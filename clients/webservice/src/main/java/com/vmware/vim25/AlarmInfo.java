...
public class AlarmInfo extends com.vmware.vim25.AlarmSpec implements
	...
	public AlarmInfo(java.lang.String dynamicType,
			...
			com.vmware.vim25.AlarmSetting setting, java.lang.String key,
		...
		super(dynamicType, dynamicProperty, name, description, enabled,
				expression, action, actionFrequency, setting);
		this.key = key;
		this.alarm = alarm;
		this.entity = entity;
