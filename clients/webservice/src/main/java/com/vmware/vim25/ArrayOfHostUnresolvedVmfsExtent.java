...
public class ArrayOfHostUnresolvedVmfsExtent implements java.io.Serializable {
	...
	/**
	 * Gets the hostUnresolvedVmfsExtent value for this
	...
	/**
	 * Sets the hostUnresolvedVmfsExtent value for this
	 * ArrayOfHostUnresolvedVmfsExtent.
	 * 
	 * @param hostUnresolvedVmfsExtent
	 */
	public void setHostUnresolvedVmfsExtent(
			com.vmware.vim25.HostUnresolvedVmfsExtent[] hostUnresolvedVmfsExtent) {
		this.hostUnresolvedVmfsExtent = hostUnresolvedVmfsExtent;
	}
	...
	public void setHostUnresolvedVmfsExtent(int i,
			com.vmware.vim25.HostUnresolvedVmfsExtent _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostUnresolvedVmfsExtent)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostUnresolvedVmfsExtent == null && other
				.getHostUnresolvedVmfsExtent() == null) || (this.hostUnresolvedVmfsExtent != null && java.util.Arrays
				.equals(this.hostUnresolvedVmfsExtent, other
						.getHostUnresolvedVmfsExtent())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostUnresolvedVmfsExtent() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostUnresolvedVmfsExtent()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostUnresolvedVmfsExtent(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostUnresolvedVmfsExtent.class, true);
