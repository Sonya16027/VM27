...
public class DistributedVirtualSwitchPortConnectee  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the connectedEntity value for this DistributedVirtualSwitchPortConnectee.
     * 
    ...
    /**
     * Sets the connectedEntity value for this DistributedVirtualSwitchPortConnectee.
     * 
     * @param connectedEntity
     */
    public void setConnectedEntity(com.vmware.vim25.ManagedObjectReference connectedEntity) {
        this.connectedEntity = connectedEntity;
    }
    ...
    /**
     * Gets the addressHint value for this DistributedVirtualSwitchPortConnectee.
     * 
     * @return addressHint
     */
    ...
    /**
     * Sets the addressHint value for this DistributedVirtualSwitchPortConnectee.
     * 
     * @param addressHint
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DistributedVirtualSwitchPortConnectee)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.connectedEntity==null && other.getConnectedEntity()==null) || 
             (this.connectedEntity!=null &&
              this.connectedEntity.equals(other.getConnectedEntity()))) &&
            ((this.nicKey==null && other.getNicKey()==null) || 
             (this.nicKey!=null &&
              this.nicKey.equals(other.getNicKey()))) &&
            ((this.type==null && other.getType()==null) || 
             (this.type!=null &&
              this.type.equals(other.getType()))) &&
            ((this.addressHint==null && other.getAddressHint()==null) || 
             (this.addressHint!=null &&
              this.addressHint.equals(other.getAddressHint())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DistributedVirtualSwitchPortConnectee.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DistributedVirtualSwitchPortConnectee"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("connectedEntity");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "connectedEntity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "nicKey"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "addressHint"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
