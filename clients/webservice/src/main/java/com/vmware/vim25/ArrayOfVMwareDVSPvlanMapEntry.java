...
public class ArrayOfVMwareDVSPvlanMapEntry implements java.io.Serializable {
	...
	/**
	 * Gets the VMwareDVSPvlanMapEntry value for this
	...
	/**
	 * Sets the VMwareDVSPvlanMapEntry value for this
	 * ArrayOfVMwareDVSPvlanMapEntry.
	 * 
	 * @param VMwareDVSPvlanMapEntry
	 */
	public void setVMwareDVSPvlanMapEntry(
			com.vmware.vim25.VMwareDVSPvlanMapEntry[] VMwareDVSPvlanMapEntry) {
		this.VMwareDVSPvlanMapEntry = VMwareDVSPvlanMapEntry;
	}
	...
	public void setVMwareDVSPvlanMapEntry(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVMwareDVSPvlanMapEntry)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.VMwareDVSPvlanMapEntry == null && other
				.getVMwareDVSPvlanMapEntry() == null) || (this.VMwareDVSPvlanMapEntry != null && java.util.Arrays
				.equals(this.VMwareDVSPvlanMapEntry, other
						.getVMwareDVSPvlanMapEntry())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVMwareDVSPvlanMapEntry() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVMwareDVSPvlanMapEntry()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVMwareDVSPvlanMapEntry(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVMwareDVSPvlanMapEntry.class, true);
