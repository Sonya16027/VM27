...
public class PropertyFilterUpdate  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference filter;

    private com.vmware.vim25.ObjectUpdate[] objectSet;

    private com.vmware.vim25.MissingObject[] missingSet;
    ...
    public PropertyFilterUpdate(
           ...
           com.vmware.vim25.ManagedObjectReference filter,
           com.vmware.vim25.ObjectUpdate[] objectSet,
           com.vmware.vim25.MissingObject[] missingSet) {
        super(
            dynamicType,
            dynamicProperty);
        this.filter = filter;
     ...
     * @return filter
     */
    public com.vmware.vim25.ManagedObjectReference getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.vmware.vim25.ManagedObjectReference filter) {
        this.filter = filter;
    }
     ...
     * @return objectSet
     */
    public com.vmware.vim25.ObjectUpdate[] getObjectSet() {
        return objectSet;
    }
     ...
     * @param objectSet
     */
    public void setObjectSet(com.vmware.vim25.ObjectUpdate[] objectSet) {
        this.objectSet = objectSet;
    }

    public com.vmware.vim25.ObjectUpdate getObjectSet(int i) {
        return this.objectSet[i];
    }

    public void setObjectSet(int i, com.vmware.vim25.ObjectUpdate _value) {
     ...
     * @return missingSet
     */
    public com.vmware.vim25.MissingObject[] getMissingSet() {
        return missingSet;
    }
     ...
     * @param missingSet
     */
    public void setMissingSet(com.vmware.vim25.MissingObject[] missingSet) {
        this.missingSet = missingSet;
    }

    public com.vmware.vim25.MissingObject getMissingSet(int i) {
        return this.missingSet[i];
    }

    public void setMissingSet(int i, com.vmware.vim25.MissingObject _value) {
