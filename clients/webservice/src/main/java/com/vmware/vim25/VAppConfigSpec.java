...
public class VAppConfigSpec extends com.vmware.vim25.VmConfigSpec implements
	...
	public VAppConfigSpec(java.lang.String dynamicType,
		...
		super(dynamicType, dynamicProperty, product, property, ipAssignment,
				eula, ovfSection, ovfEnvironmentTransport, installBootRequired,
	...
	/**
	 * Gets the entityConfig value for this VAppConfigSpec.
	 * 
	 * @return entityConfig
	 */
	...
	/**
	 * Sets the entityConfig value for this VAppConfigSpec.
	 * 
	 * @param entityConfig
	 */
	...
	public void setEntityConfig(int i,
			com.vmware.vim25.VAppEntityConfigInfo _value) {
		this.entityConfig[i] = _value;
	}

	/**
	 * Gets the annotation value for this VAppConfigSpec.
	 * 
	 * @return annotation
	 */
	...
	/**
	 * Sets the annotation value for this VAppConfigSpec.
	 * 
	 * @param annotation
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VAppConfigSpec)) {
			return false;
		}
		VAppConfigSpec other = (VAppConfigSpec) obj;
		if (obj == null) {
			return false;
		}
		if (this == obj) {
		...
		_equals = super.equals(obj)
				&& ((this.entityConfig == null && other.getEntityConfig() == null) || (this.entityConfig != null && java.util.Arrays
						.equals(this.entityConfig, other.getEntityConfig())))
