...
public class ArrayOfVAppCloneSpecNetworkMappingPair  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VAppCloneSpecNetworkMappingPair getVAppCloneSpecNetworkMappingPair(int i) {
        return this.VAppCloneSpecNetworkMappingPair[i];
    }

    public void setVAppCloneSpecNetworkMappingPair(int i, com.vmware.vim25.VAppCloneSpecNetworkMappingPair _value) {
