...
public class LicenseManagerState implements java.io.Serializable {
	...
	public static final LicenseManagerState initializing = new LicenseManagerState(
			_initializing);
	public static final LicenseManagerState normal = new LicenseManagerState(
			_normal);
	public static final LicenseManagerState marginal = new LicenseManagerState(
			_marginal);
	public static final LicenseManagerState fault = new LicenseManagerState(
			_fault);
	...
	public static LicenseManagerState fromValue(java.lang.String value)
		...
		LicenseManagerState enumeration = (LicenseManagerState) _table_
				.get(value);
		if (enumeration == null) {
