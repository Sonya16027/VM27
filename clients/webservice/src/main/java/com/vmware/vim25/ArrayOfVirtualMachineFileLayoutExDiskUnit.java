...
public class ArrayOfVirtualMachineFileLayoutExDiskUnit  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineFileLayoutExDiskUnit getVirtualMachineFileLayoutExDiskUnit(int i) {
        return this.virtualMachineFileLayoutExDiskUnit[i];
    }

    public void setVirtualMachineFileLayoutExDiskUnit(int i, com.vmware.vim25.VirtualMachineFileLayoutExDiskUnit _value) {
