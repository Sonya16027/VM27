...
public class ArrayOfClusterDrsMigration  implements java.io.Serializable {
    ...
    public void setClusterDrsMigration(int i, com.vmware.vim25.ClusterDrsMigration _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfClusterDrsMigration"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("clusterDrsMigration");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ClusterDrsMigration"));
