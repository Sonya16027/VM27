...
public class MetricAlarmExpression  extends com.vmware.vim25.AlarmExpression  implements java.io.Serializable {
    ...
    public MetricAlarmExpression(
           ...
           com.vmware.vim25.PerfMetricId metric,
           java.lang.Integer yellow,
           java.lang.Integer yellowInterval,
           java.lang.Integer red,
           java.lang.Integer redInterval) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MetricAlarmExpression)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.yellow==null && other.getYellow()==null) || 
             (this.yellow!=null &&
              this.yellow.equals(other.getYellow()))) &&
            ((this.yellowInterval==null && other.getYellowInterval()==null) || 
             (this.yellowInterval!=null &&
              this.yellowInterval.equals(other.getYellowInterval()))) &&
            ((this.red==null && other.getRed()==null) || 
             (this.red!=null &&
              this.red.equals(other.getRed()))) &&
            ((this.redInterval==null && other.getRedInterval()==null) || 
             (this.redInterval!=null &&
              this.redInterval.equals(other.getRedInterval())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MetricAlarmExpression.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "MetricAlarmExpression"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("operator");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "operator"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "MetricAlarmOperator"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "metric"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PerfMetricId"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("yellow");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "yellow"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "yellowInterval"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "redInterval"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
