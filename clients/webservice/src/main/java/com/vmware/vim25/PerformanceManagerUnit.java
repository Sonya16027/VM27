...
public class PerformanceManagerUnit implements java.io.Serializable {
	...
	public static final PerformanceManagerUnit percent = new PerformanceManagerUnit(
			_percent);
	public static final PerformanceManagerUnit kiloBytes = new PerformanceManagerUnit(
			_kiloBytes);
	public static final PerformanceManagerUnit megaBytes = new PerformanceManagerUnit(
			_megaBytes);
	public static final PerformanceManagerUnit megaHertz = new PerformanceManagerUnit(
			_megaHertz);
	public static final PerformanceManagerUnit number = new PerformanceManagerUnit(
			_number);
	public static final PerformanceManagerUnit microsecond = new PerformanceManagerUnit(
			_microsecond);
	public static final PerformanceManagerUnit millisecond = new PerformanceManagerUnit(
			_millisecond);
	public static final PerformanceManagerUnit second = new PerformanceManagerUnit(
			_second);
	public static final PerformanceManagerUnit kiloBytesPerSecond = new PerformanceManagerUnit(
			_kiloBytesPerSecond);
	public static final PerformanceManagerUnit megaBytesPerSecond = new PerformanceManagerUnit(
			_megaBytesPerSecond);
	...
	public static PerformanceManagerUnit fromValue(java.lang.String value)
		...
		PerformanceManagerUnit enumeration = (PerformanceManagerUnit) _table_
				.get(value);
		if (enumeration == null) {
