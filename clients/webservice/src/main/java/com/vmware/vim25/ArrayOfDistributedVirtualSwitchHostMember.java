...
public class ArrayOfDistributedVirtualSwitchHostMember implements
	...
	/**
	 * Gets the distributedVirtualSwitchHostMember value for this
	...
	/**
	 * Sets the distributedVirtualSwitchHostMember value for this
	 * ArrayOfDistributedVirtualSwitchHostMember.
	 * 
	 * @param distributedVirtualSwitchHostMember
	 */
	public void setDistributedVirtualSwitchHostMember(
			com.vmware.vim25.DistributedVirtualSwitchHostMember[] distributedVirtualSwitchHostMember) {
		this.distributedVirtualSwitchHostMember = distributedVirtualSwitchHostMember;
	}
	...
	public void setDistributedVirtualSwitchHostMember(int i,
			com.vmware.vim25.DistributedVirtualSwitchHostMember _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDistributedVirtualSwitchHostMember)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.distributedVirtualSwitchHostMember == null && other
				.getDistributedVirtualSwitchHostMember() == null) || (this.distributedVirtualSwitchHostMember != null && java.util.Arrays
				.equals(this.distributedVirtualSwitchHostMember, other
						.getDistributedVirtualSwitchHostMember())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getDistributedVirtualSwitchHostMember() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDistributedVirtualSwitchHostMember()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDistributedVirtualSwitchHostMember(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDistributedVirtualSwitchHostMember.class, true);
