...
public class VirtualVmxnetOption  extends com.vmware.vim25.VirtualEthernetCardOption  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualVmxnetOption"));
    }
