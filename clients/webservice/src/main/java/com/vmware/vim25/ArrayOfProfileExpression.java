...
public class ArrayOfProfileExpression  implements java.io.Serializable {
    ...
    public void setProfileExpression(int i, com.vmware.vim25.ProfileExpression _value) {
        this.profileExpression[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfProfileExpression)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.profileExpression==null && other.getProfileExpression()==null) || 
             (this.profileExpression!=null &&
              java.util.Arrays.equals(this.profileExpression, other.getProfileExpression())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getProfileExpression() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getProfileExpression());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getProfileExpression(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfProfileExpression.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfProfileExpression"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("profileExpression");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ProfileExpression"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ProfileExpression"));
