...
public class ServiceContent extends com.vmware.vim25.DynamicData implements
	 ...
	 */
	public void setVirtualDiskManager(
			com.vmware.vim25.ManagedObjectReference virtualDiskManager) {
		this.virtualDiskManager = virtualDiskManager;
	}
	 ...
	 */
	public void setVmProvisioningChecker(
			com.vmware.vim25.ManagedObjectReference vmProvisioningChecker) {
		this.vmProvisioningChecker = vmProvisioningChecker;
	}
	 ...
	 */
	public void setVmCompatibilityChecker(
			com.vmware.vim25.ManagedObjectReference vmCompatibilityChecker) {
		this.vmCompatibilityChecker = vmCompatibilityChecker;
	}
	 ...
	 */
	public void setDvSwitchManager(
			com.vmware.vim25.ManagedObjectReference dvSwitchManager) {
		this.dvSwitchManager = dvSwitchManager;
	}
	 ...
	 */
	public void setHostProfileManager(
			com.vmware.vim25.ManagedObjectReference hostProfileManager) {
		this.hostProfileManager = hostProfileManager;
	}
	 ...
	 */
	public void setClusterProfileManager(
			com.vmware.vim25.ManagedObjectReference clusterProfileManager) {
		this.clusterProfileManager = clusterProfileManager;
	}
	 ...
	 */
	public void setComplianceManager(
			com.vmware.vim25.ManagedObjectReference complianceManager) {
		this.complianceManager = complianceManager;
	}
	 ...
	 */
	public void setLocalizationManager(
			com.vmware.vim25.ManagedObjectReference localizationManager) {
		this.localizationManager = localizationManager;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.viewManager == null && other.getViewManager() == null) || (this.viewManager != null && this.viewManager
						.equals(other.getViewManager())))
				...
				&& ((this.extensionManager == null && other
						.getExtensionManager() == null) || (this.extensionManager != null && this.extensionManager
						.equals(other.getExtensionManager())))
				...
				&& ((this.fileManager == null && other.getFileManager() == null) || (this.fileManager != null && this.fileManager
						.equals(other.getFileManager())))
				&& ((this.virtualDiskManager == null && other
						.getVirtualDiskManager() == null) || (this.virtualDiskManager != null && this.virtualDiskManager
						.equals(other.getVirtualDiskManager())))
				&& ((this.virtualizationManager == null && other
						.getVirtualizationManager() == null) || (this.virtualizationManager != null && this.virtualizationManager
						.equals(other.getVirtualizationManager())))
				&& ((this.snmpSystem == null && other.getSnmpSystem() == null) || (this.snmpSystem != null && this.snmpSystem
						.equals(other.getSnmpSystem())))
				&& ((this.vmProvisioningChecker == null && other
						.getVmProvisioningChecker() == null) || (this.vmProvisioningChecker != null && this.vmProvisioningChecker
						.equals(other.getVmProvisioningChecker())))
				&& ((this.vmCompatibilityChecker == null && other
						.getVmCompatibilityChecker() == null) || (this.vmCompatibilityChecker != null && this.vmCompatibilityChecker
						.equals(other.getVmCompatibilityChecker())))
				&& ((this.ovfManager == null && other.getOvfManager() == null) || (this.ovfManager != null && this.ovfManager
						.equals(other.getOvfManager())))
				&& ((this.ipPoolManager == null && other.getIpPoolManager() == null) || (this.ipPoolManager != null && this.ipPoolManager
						.equals(other.getIpPoolManager())))
				&& ((this.dvSwitchManager == null && other.getDvSwitchManager() == null) || (this.dvSwitchManager != null && this.dvSwitchManager
						.equals(other.getDvSwitchManager())))
				&& ((this.hostProfileManager == null && other
						.getHostProfileManager() == null) || (this.hostProfileManager != null && this.hostProfileManager
						.equals(other.getHostProfileManager())))
				&& ((this.clusterProfileManager == null && other
						.getClusterProfileManager() == null) || (this.clusterProfileManager != null && this.clusterProfileManager
						.equals(other.getClusterProfileManager())))
				&& ((this.complianceManager == null && other
						.getComplianceManager() == null) || (this.complianceManager != null && this.complianceManager
						.equals(other.getComplianceManager())))
				&& ((this.localizationManager == null && other
						.getLocalizationManager() == null) || (this.localizationManager != null && this.localizationManager
						.equals(other.getLocalizationManager())));
		__equalsCalc = null;
		return _equals;
	}
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "about"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
				"AboutInfo"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
