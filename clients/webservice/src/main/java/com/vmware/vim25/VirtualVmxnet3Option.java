...
public class VirtualVmxnet3Option  extends com.vmware.vim25.VirtualVmxnetOption  implements java.io.Serializable {
    public VirtualVmxnet3Option() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualVmxnet3Option)) return false;
        VirtualVmxnet3Option other = (VirtualVmxnet3Option) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualVmxnet3Option.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualVmxnet3Option"));
    }
