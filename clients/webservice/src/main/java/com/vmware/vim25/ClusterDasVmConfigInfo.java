...
public class ClusterDasVmConfigInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     */
    public void setRestartPriority(com.vmware.vim25.DasVmPriority restartPriority) {
        this.restartPriority = restartPriority;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.dasSettings==null && other.getDasSettings()==null) || 
             (this.dasSettings!=null &&
              this.dasSettings.equals(other.getDasSettings())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ClusterDasVmConfigInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DasVmPriority"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("powerOffOnIsolation");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "powerOffOnIsolation"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dasSettings"));
