...
public class ScsiLunType implements java.io.Serializable {
	...
	public static final ScsiLunType opticalDevice = new ScsiLunType(
			_opticalDevice);
	public static final ScsiLunType mediaChanger = new ScsiLunType(
			_mediaChanger);
	public static final ScsiLunType communications = new ScsiLunType(
			_communications);
	public static final ScsiLunType storageArrayController = new ScsiLunType(
			_storageArrayController);
	...
	public static ScsiLunType fromValue(java.lang.String value)
		...
		ScsiLunType enumeration = (ScsiLunType) _table_.get(value);
		if (enumeration == null) {
