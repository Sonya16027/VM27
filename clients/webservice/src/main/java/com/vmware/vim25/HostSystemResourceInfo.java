...
public class HostSystemResourceInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private com.vmware.vim25.ResourceConfigSpec config;

    private com.vmware.vim25.HostSystemResourceInfo[] child;
    ...
    public HostSystemResourceInfo(
           ...
           com.vmware.vim25.HostSystemResourceInfo[] child) {
        super(
            dynamicType,
            dynamicProperty);
        this.key = key;
     ...
     * @return child
     */
    public com.vmware.vim25.HostSystemResourceInfo[] getChild() {
        return child;
    }
     ...
     * @param child
     */
    public void setChild(com.vmware.vim25.HostSystemResourceInfo[] child) {
        this.child = child;
    }

    public com.vmware.vim25.HostSystemResourceInfo getChild(int i) {
        return this.child[i];
    }

    public void setChild(int i, com.vmware.vim25.HostSystemResourceInfo _value) {
        this.child[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostSystemResourceInfo)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostSystemResourceInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostSystemResourceInfo"));
