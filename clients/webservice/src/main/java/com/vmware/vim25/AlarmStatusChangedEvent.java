...
public class AlarmStatusChangedEvent  extends com.vmware.vim25.AlarmEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AlarmStatusChangedEvent"));
