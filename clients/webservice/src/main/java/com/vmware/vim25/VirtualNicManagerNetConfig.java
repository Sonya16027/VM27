...
public class VirtualNicManagerNetConfig  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualNicManagerNetConfig)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.selectedVnic==null && other.getSelectedVnic()==null) || 
             (this.selectedVnic!=null &&
              java.util.Arrays.equals(this.selectedVnic, other.getSelectedVnic())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isMultiSelectAllowed() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        ...
        if (getSelectedVnic() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSelectedVnic());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSelectedVnic(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualNicManagerNetConfig.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualNicManagerNetConfig"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "multiSelectAllowed"));
