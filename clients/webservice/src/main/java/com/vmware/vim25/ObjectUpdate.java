...
public class ObjectUpdate extends com.vmware.vim25.DynamicData implements
	...
	private com.vmware.vim25.ObjectUpdateKind kind;

	private com.vmware.vim25.ManagedObjectReference obj;

	private com.vmware.vim25.PropertyChange[] changeSet;
	...
	public ObjectUpdate(java.lang.String dynamicType,
			...
			com.vmware.vim25.ObjectUpdateKind kind,
			com.vmware.vim25.ManagedObjectReference obj,
			com.vmware.vim25.PropertyChange[] changeSet,
	 ...
	 * @return kind
	 */
	public com.vmware.vim25.ObjectUpdateKind getKind() {
		return kind;
	}
	 ...
	 * @param kind
	 */
	public void setKind(com.vmware.vim25.ObjectUpdateKind kind) {
		this.kind = kind;
	}
	 ...
	 * @return changeSet
	 */
	public com.vmware.vim25.PropertyChange[] getChangeSet() {
		return changeSet;
	}
	 ...
	 * @param changeSet
	 */
	public void setChangeSet(com.vmware.vim25.PropertyChange[] changeSet) {
		this.changeSet = changeSet;
	}

	public com.vmware.vim25.PropertyChange getChangeSet(int i) {
		return this.changeSet[i];
	}

	public void setChangeSet(int i, com.vmware.vim25.PropertyChange _value) {
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "kind"));
