...
public class ArrayOfEventAlarmExpressionComparison implements
	...
	/**
	 * Gets the eventAlarmExpressionComparison value for this
	...
	/**
	 * Sets the eventAlarmExpressionComparison value for this
	 * ArrayOfEventAlarmExpressionComparison.
	 * 
	 * @param eventAlarmExpressionComparison
	 */
	public void setEventAlarmExpressionComparison(
			com.vmware.vim25.EventAlarmExpressionComparison[] eventAlarmExpressionComparison) {
		this.eventAlarmExpressionComparison = eventAlarmExpressionComparison;
	}
	...
	public void setEventAlarmExpressionComparison(int i,
			com.vmware.vim25.EventAlarmExpressionComparison _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfEventAlarmExpressionComparison)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.eventAlarmExpressionComparison == null && other
				.getEventAlarmExpressionComparison() == null) || (this.eventAlarmExpressionComparison != null && java.util.Arrays
				.equals(this.eventAlarmExpressionComparison, other
						.getEventAlarmExpressionComparison())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getEventAlarmExpressionComparison() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getEventAlarmExpressionComparison()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getEventAlarmExpressionComparison(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfEventAlarmExpressionComparison.class, true);
