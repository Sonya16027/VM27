...
public class HostLocalFileSystemVolumeSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostLocalFileSystemVolumeSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "localPath"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
