...
public class VirtualMachineConfigSpec extends com.vmware.vim25.DynamicData
	...
	public VirtualMachineConfigSpec(
			...
			java.lang.Integer numCPUs, java.lang.Long memoryMB,
	...
	public void setDeviceChange(int i,
			com.vmware.vim25.VirtualDeviceConfigSpec _value) {
	...
	public void setCpuFeatureMask(int i,
			com.vmware.vim25.VirtualMachineCpuIdInfoSpec _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.npivNodeWorldWideName == null && other
						.getNpivNodeWorldWideName() == null) || (this.npivNodeWorldWideName != null && java.util.Arrays
						.equals(this.npivNodeWorldWideName, other
								.getNpivNodeWorldWideName())))
				&& ((this.npivPortWorldWideName == null && other
						.getNpivPortWorldWideName() == null) || (this.npivPortWorldWideName != null && java.util.Arrays
						.equals(this.npivPortWorldWideName, other
								.getNpivPortWorldWideName())))
				&& ((this.npivWorldWideNameType == null && other
						.getNpivWorldWideNameType() == null) || (this.npivWorldWideNameType != null && this.npivWorldWideNameType
						.equals(other.getNpivWorldWideNameType())))
				&& ((this.npivDesiredNodeWwns == null && other
						.getNpivDesiredNodeWwns() == null) || (this.npivDesiredNodeWwns != null && this.npivDesiredNodeWwns
						.equals(other.getNpivDesiredNodeWwns())))
				&& ((this.npivDesiredPortWwns == null && other
						.getNpivDesiredPortWwns() == null) || (this.npivDesiredPortWwns != null && this.npivDesiredPortWwns
						.equals(other.getNpivDesiredPortWwns())))
				&& ((this.npivTemporaryDisabled == null && other
						.getNpivTemporaryDisabled() == null) || (this.npivTemporaryDisabled != null && this.npivTemporaryDisabled
						.equals(other.getNpivTemporaryDisabled())))
				&& ((this.npivOnNonRdmDisks == null && other
						.getNpivOnNonRdmDisks() == null) || (this.npivOnNonRdmDisks != null && this.npivOnNonRdmDisks
						.equals(other.getNpivOnNonRdmDisks())))
				&& ((this.npivWorldWideNameOp == null && other
						.getNpivWorldWideNameOp() == null) || (this.npivWorldWideNameOp != null && this.npivWorldWideNameOp
						.equals(other.getNpivWorldWideNameOp())))
				...
				&& ((this.alternateGuestName == null && other
						.getAlternateGuestName() == null) || (this.alternateGuestName != null && this.alternateGuestName
						.equals(other.getAlternateGuestName())))
				...
				&& ((this.powerOpInfo == null && other.getPowerOpInfo() == null) || (this.powerOpInfo != null && this.powerOpInfo
						.equals(other.getPowerOpInfo())))
				&& ((this.numCPUs == null && other.getNumCPUs() == null) || (this.numCPUs != null && this.numCPUs
						.equals(other.getNumCPUs())))
				&& ((this.memoryMB == null && other.getMemoryMB() == null) || (this.memoryMB != null && this.memoryMB
						.equals(other.getMemoryMB())))
				&& ((this.memoryHotAddEnabled == null && other
						.getMemoryHotAddEnabled() == null) || (this.memoryHotAddEnabled != null && this.memoryHotAddEnabled
						.equals(other.getMemoryHotAddEnabled())))
				&& ((this.cpuHotAddEnabled == null && other
						.getCpuHotAddEnabled() == null) || (this.cpuHotAddEnabled != null && this.cpuHotAddEnabled
						.equals(other.getCpuHotAddEnabled())))
				&& ((this.cpuHotRemoveEnabled == null && other
						.getCpuHotRemoveEnabled() == null) || (this.cpuHotRemoveEnabled != null && this.cpuHotRemoveEnabled
						.equals(other.getCpuHotRemoveEnabled())))
				&& ((this.deviceChange == null && other.getDeviceChange() == null) || (this.deviceChange != null && java.util.Arrays
						.equals(this.deviceChange, other.getDeviceChange())))
				...
				&& ((this.swapPlacement == null && other.getSwapPlacement() == null) || (this.swapPlacement != null && this.swapPlacement
						.equals(other.getSwapPlacement())))
				&& ((this.bootOptions == null && other.getBootOptions() == null) || (this.bootOptions != null && this.bootOptions
						.equals(other.getBootOptions())))
				&& ((this.vAppConfig == null && other.getVAppConfig() == null) || (this.vAppConfig != null && this.vAppConfig
						.equals(other.getVAppConfig())))
				&& ((this.ftInfo == null && other.getFtInfo() == null) || (this.ftInfo != null && this.ftInfo
						.equals(other.getFtInfo())))
				&& ((this.vAppConfigRemoved == null && other
						.getVAppConfigRemoved() == null) || (this.vAppConfigRemoved != null && this.vAppConfigRemoved
						.equals(other.getVAppConfigRemoved())))
				&& ((this.vAssertsEnabled == null && other.getVAssertsEnabled() == null) || (this.vAssertsEnabled != null && this.vAssertsEnabled
						.equals(other.getVAssertsEnabled())))
				&& ((this.changeTrackingEnabled == null && other
						.getChangeTrackingEnabled() == null) || (this.changeTrackingEnabled != null && this.changeTrackingEnabled
						.equals(other.getChangeTrackingEnabled())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getNpivNodeWorldWideName() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getNpivNodeWorldWideName()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getNpivNodeWorldWideName(), i);
		...
		if (getNpivPortWorldWideName() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getNpivPortWorldWideName()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getNpivPortWorldWideName(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualMachineConfigSpec.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "files"));
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "tools"));
		elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25",
				"ToolsConfigInfo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
