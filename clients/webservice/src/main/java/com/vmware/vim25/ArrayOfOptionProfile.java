...
public class ArrayOfOptionProfile  implements java.io.Serializable {
    ...
    public ArrayOfOptionProfile(
           com.vmware.vim25.OptionProfile[] optionProfile) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfOptionProfile)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.optionProfile==null && other.getOptionProfile()==null) || 
             (this.optionProfile!=null &&
              java.util.Arrays.equals(this.optionProfile, other.getOptionProfile())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getOptionProfile() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getOptionProfile());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getOptionProfile(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfOptionProfile.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfOptionProfile"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("optionProfile");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "OptionProfile"));
