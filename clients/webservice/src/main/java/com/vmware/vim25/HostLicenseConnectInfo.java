...
public class HostLicenseConnectInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param evaluation
     */
    public void setEvaluation(com.vmware.vim25.LicenseManagerEvaluationInfo evaluation) {
        this.evaluation = evaluation;
    }
