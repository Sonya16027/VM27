...
public class VmFaultToleranceStateChangedEvent extends com.vmware.vim25.VmEvent
	...
	public VmFaultToleranceStateChangedEvent(java.lang.String dynamicType,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VmFaultToleranceStateChangedEvent)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.oldState == null && other.getOldState() == null) || (this.oldState != null && this.oldState
						.equals(other.getOldState())))
				&& ((this.newState == null && other.getNewState() == null) || (this.newState != null && this.newState
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VmFaultToleranceStateChangedEvent.class, true);
