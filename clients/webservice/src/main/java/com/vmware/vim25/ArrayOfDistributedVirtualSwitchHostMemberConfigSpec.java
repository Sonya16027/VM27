...
public class ArrayOfDistributedVirtualSwitchHostMemberConfigSpec implements
	...
	/**
	 * Gets the distributedVirtualSwitchHostMemberConfigSpec value for this
	...
	/**
	 * Sets the distributedVirtualSwitchHostMemberConfigSpec value for this
	 * ArrayOfDistributedVirtualSwitchHostMemberConfigSpec.
	 * 
	 * @param distributedVirtualSwitchHostMemberConfigSpec
	 */
	public void setDistributedVirtualSwitchHostMemberConfigSpec(
			com.vmware.vim25.DistributedVirtualSwitchHostMemberConfigSpec[] distributedVirtualSwitchHostMemberConfigSpec) {
		this.distributedVirtualSwitchHostMemberConfigSpec = distributedVirtualSwitchHostMemberConfigSpec;
	}
	...
	public void setDistributedVirtualSwitchHostMemberConfigSpec(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDistributedVirtualSwitchHostMemberConfigSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.distributedVirtualSwitchHostMemberConfigSpec == null && other
				.getDistributedVirtualSwitchHostMemberConfigSpec() == null) || (this.distributedVirtualSwitchHostMemberConfigSpec != null && java.util.Arrays
				.equals(this.distributedVirtualSwitchHostMemberConfigSpec,
						other.getDistributedVirtualSwitchHostMemberConfigSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getDistributedVirtualSwitchHostMemberConfigSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDistributedVirtualSwitchHostMemberConfigSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDistributedVirtualSwitchHostMemberConfigSpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDistributedVirtualSwitchHostMemberConfigSpec.class, true);
