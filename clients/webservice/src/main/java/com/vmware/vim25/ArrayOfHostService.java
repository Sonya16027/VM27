...
public class ArrayOfHostService implements java.io.Serializable {
	...
	private com.vmware.vim25.HostService[] hostService;

	public ArrayOfHostService() {
	}

	public ArrayOfHostService(com.vmware.vim25.HostService[] hostService) {
	...
	public com.vmware.vim25.HostService getHostService(int i) {
		return this.hostService[i];
	}

	public void setHostService(int i, com.vmware.vim25.HostService _value) {
