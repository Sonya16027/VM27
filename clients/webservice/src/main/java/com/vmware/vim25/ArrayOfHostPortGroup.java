...
public class ArrayOfHostPortGroup implements java.io.Serializable {
	...
	private com.vmware.vim25.HostPortGroup[] hostPortGroup;

	public ArrayOfHostPortGroup() {
	}

	public ArrayOfHostPortGroup(com.vmware.vim25.HostPortGroup[] hostPortGroup) {
	...
	public com.vmware.vim25.HostPortGroup getHostPortGroup(int i) {
		return this.hostPortGroup[i];
	}

	public void setHostPortGroup(int i, com.vmware.vim25.HostPortGroup _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostPortGroup)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostPortGroup == null && other
				.getHostPortGroup() == null) || (this.hostPortGroup != null && java.util.Arrays
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostPortGroup.class, true);
