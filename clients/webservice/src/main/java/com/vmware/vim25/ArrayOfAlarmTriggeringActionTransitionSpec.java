...
public class ArrayOfAlarmTriggeringActionTransitionSpec implements
	...
	/**
	 * Gets the alarmTriggeringActionTransitionSpec value for this
	...
	/**
	 * Sets the alarmTriggeringActionTransitionSpec value for this
	 * ArrayOfAlarmTriggeringActionTransitionSpec.
	 * 
	 * @param alarmTriggeringActionTransitionSpec
	 */
	public void setAlarmTriggeringActionTransitionSpec(
			com.vmware.vim25.AlarmTriggeringActionTransitionSpec[] alarmTriggeringActionTransitionSpec) {
		this.alarmTriggeringActionTransitionSpec = alarmTriggeringActionTransitionSpec;
	}
	...
	public void setAlarmTriggeringActionTransitionSpec(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfAlarmTriggeringActionTransitionSpec)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.alarmTriggeringActionTransitionSpec == null && other
				.getAlarmTriggeringActionTransitionSpec() == null) || (this.alarmTriggeringActionTransitionSpec != null && java.util.Arrays
				.equals(this.alarmTriggeringActionTransitionSpec, other
						.getAlarmTriggeringActionTransitionSpec())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getAlarmTriggeringActionTransitionSpec() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getAlarmTriggeringActionTransitionSpec()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getAlarmTriggeringActionTransitionSpec(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfAlarmTriggeringActionTransitionSpec.class, true);
