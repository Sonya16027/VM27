...
public class HostDhcpServiceSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostDhcpServiceSpec(
           ...
           int defaultLeaseDuration,
           java.lang.String leaseBeginIp,
           java.lang.String leaseEndIp,
           int maxLeaseDuration,
           boolean unlimitedLease,
           java.lang.String ipSubnetAddr,
           java.lang.String ipSubnetMask) {
        super(
            dynamicType,
            dynamicProperty);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostDhcpServiceSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.leaseBeginIp==null && other.getLeaseBeginIp()==null) || 
             (this.leaseBeginIp!=null &&
              this.leaseBeginIp.equals(other.getLeaseBeginIp()))) &&
            ((this.leaseEndIp==null && other.getLeaseEndIp()==null) || 
             (this.leaseEndIp!=null &&
              this.leaseEndIp.equals(other.getLeaseEndIp()))) &&
            this.maxLeaseDuration == other.getMaxLeaseDuration() &&
            this.unlimitedLease == other.isUnlimitedLease() &&
            ((this.ipSubnetAddr==null && other.getIpSubnetAddr()==null) || 
             (this.ipSubnetAddr!=null &&
              this.ipSubnetAddr.equals(other.getIpSubnetAddr()))) &&
            ((this.ipSubnetMask==null && other.getIpSubnetMask()==null) || 
             (this.ipSubnetMask!=null &&
              this.ipSubnetMask.equals(other.getIpSubnetMask())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isUnlimitedLease() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostDhcpServiceSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostDhcpServiceSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "defaultLeaseDuration"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("leaseBeginIp");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "leaseBeginIp"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("leaseEndIp");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "leaseEndIp"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("maxLeaseDuration");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "maxLeaseDuration"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("unlimitedLease");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "unlimitedLease"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ipSubnetAddr");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ipSubnetAddr"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ipSubnetMask");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ipSubnetMask"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
