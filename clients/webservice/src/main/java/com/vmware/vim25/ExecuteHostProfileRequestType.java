...
public class ExecuteHostProfileRequestType  implements java.io.Serializable {
     ...
     * @param deferredParam
     */
    public void setDeferredParam(com.vmware.vim25.ProfileDeferredPolicyOptionParameter[] deferredParam) {
        this.deferredParam = deferredParam;
    }

    public com.vmware.vim25.ProfileDeferredPolicyOptionParameter getDeferredParam(int i) {
        return this.deferredParam[i];
    }

    public void setDeferredParam(int i, com.vmware.vim25.ProfileDeferredPolicyOptionParameter _value) {
        this.deferredParam[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExecuteHostProfileRequestType)) return false;
        ...
        _equals = true && 
            ...
            ((this.deferredParam==null && other.getDeferredParam()==null) || 
             (this.deferredParam!=null &&
              java.util.Arrays.equals(this.deferredParam, other.getDeferredParam())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDeferredParam() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDeferredParam());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDeferredParam(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExecuteHostProfileRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ExecuteHostProfileRequestType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "deferredParam"));
