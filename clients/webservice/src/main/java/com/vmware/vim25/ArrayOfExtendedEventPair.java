...
public class ArrayOfExtendedEventPair  implements java.io.Serializable {
    ...
    public void setExtendedEventPair(int i, com.vmware.vim25.ExtendedEventPair _value) {
        this.extendedEventPair[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfExtendedEventPair)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.extendedEventPair==null && other.getExtendedEventPair()==null) || 
             (this.extendedEventPair!=null &&
              java.util.Arrays.equals(this.extendedEventPair, other.getExtendedEventPair())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getExtendedEventPair() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getExtendedEventPair());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getExtendedEventPair(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfExtendedEventPair.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfExtendedEventPair"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("extendedEventPair");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ExtendedEventPair"));
