...
public class LicenseAssignmentFailedReason implements java.io.Serializable {
	...
	public static final LicenseAssignmentFailedReason keyEntityMismatch = new LicenseAssignmentFailedReason(
			_keyEntityMismatch);
	public static final LicenseAssignmentFailedReason downgradeDisallowed = new LicenseAssignmentFailedReason(
			_downgradeDisallowed);
	public static final LicenseAssignmentFailedReason inventoryNotManageableByVirtualCenter = new LicenseAssignmentFailedReason(
			_inventoryNotManageableByVirtualCenter);
	public static final LicenseAssignmentFailedReason hostsUnmanageableByVirtualCenterWithoutLicenseServer = new LicenseAssignmentFailedReason(
			_hostsUnmanageableByVirtualCenterWithoutLicenseServer);
	...
	public static LicenseAssignmentFailedReason fromValue(java.lang.String value)
		...
		LicenseAssignmentFailedReason enumeration = (LicenseAssignmentFailedReason) _table_
				.get(value);
		if (enumeration == null) {
	...
	public static LicenseAssignmentFailedReason fromString(
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			LicenseAssignmentFailedReason.class);
