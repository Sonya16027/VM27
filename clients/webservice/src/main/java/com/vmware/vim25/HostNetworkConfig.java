...
public class HostNetworkConfig  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public void setVswitch(int i, com.vmware.vim25.HostVirtualSwitchConfig _value) {
     ...
     * @param proxySwitch
     */
    public void setProxySwitch(com.vmware.vim25.HostProxySwitchConfig[] proxySwitch) {
        this.proxySwitch = proxySwitch;
    }
    ...
    public void setProxySwitch(int i, com.vmware.vim25.HostProxySwitchConfig _value) {
     ...
     * @param consoleVnic
     */
    public void setConsoleVnic(com.vmware.vim25.HostVirtualNicConfig[] consoleVnic) {
        this.consoleVnic = consoleVnic;
    }
    ...
    public void setConsoleVnic(int i, com.vmware.vim25.HostVirtualNicConfig _value) {
     ...
     * @param ipRouteConfig
     */
    public void setIpRouteConfig(com.vmware.vim25.HostIpRouteConfig ipRouteConfig) {
        this.ipRouteConfig = ipRouteConfig;
    }
     ...
     */
    public void setConsoleIpRouteConfig(com.vmware.vim25.HostIpRouteConfig consoleIpRouteConfig) {
        this.consoleIpRouteConfig = consoleIpRouteConfig;
    }
     ...
     */
    public void setRouteTableConfig(com.vmware.vim25.HostIpRouteTableConfig routeTableConfig) {
        this.routeTableConfig = routeTableConfig;
    }
