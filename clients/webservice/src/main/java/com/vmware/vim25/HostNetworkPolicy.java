...
public class HostNetworkPolicy  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param offloadPolicy
     */
    public void setOffloadPolicy(com.vmware.vim25.HostNetOffloadCapabilities offloadPolicy) {
        this.offloadPolicy = offloadPolicy;
    }
     ...
     * @param shapingPolicy
     */
    public void setShapingPolicy(com.vmware.vim25.HostNetworkTrafficShapingPolicy shapingPolicy) {
        this.shapingPolicy = shapingPolicy;
    }
