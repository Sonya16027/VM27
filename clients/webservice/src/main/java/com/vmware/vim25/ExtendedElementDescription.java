...
public class ExtendedElementDescription  extends com.vmware.vim25.ElementDescription  implements java.io.Serializable {
    ...
    /**
     * Gets the messageCatalogKeyPrefix value for this ExtendedElementDescription.
     * 
    ...
    /**
     * Sets the messageCatalogKeyPrefix value for this ExtendedElementDescription.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExtendedElementDescription)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExtendedElementDescription.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ExtendedElementDescription"));
