...
public class LicenseManagerLicenseKey implements java.io.Serializable {
	...
	public static final LicenseManagerLicenseKey vc = new LicenseManagerLicenseKey(
			_vc);
	public static final LicenseManagerLicenseKey vcExpress = new LicenseManagerLicenseKey(
			_vcExpress);
	...
	public static final LicenseManagerLicenseKey gsxHost = new LicenseManagerLicenseKey(
			_gsxHost);
	public static final LicenseManagerLicenseKey serverHost = new LicenseManagerLicenseKey(
			_serverHost);
	public static final LicenseManagerLicenseKey drsPower = new LicenseManagerLicenseKey(
			_drsPower);
