...
public class ArrayOfStaticRouteProfile  implements java.io.Serializable {
    ...
    public void setStaticRouteProfile(int i, com.vmware.vim25.StaticRouteProfile _value) {
        this.staticRouteProfile[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfStaticRouteProfile)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.staticRouteProfile==null && other.getStaticRouteProfile()==null) || 
             (this.staticRouteProfile!=null &&
              java.util.Arrays.equals(this.staticRouteProfile, other.getStaticRouteProfile())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getStaticRouteProfile() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getStaticRouteProfile());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getStaticRouteProfile(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfStaticRouteProfile.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfStaticRouteProfile"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("staticRouteProfile");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "StaticRouteProfile"));
