/**
 * QueryCompatibleHostForNewDvsRequestType.java
 *
...
public class QueryCompatibleHostForNewDvsRequestType  implements java.io.Serializable {
    ...
    public QueryCompatibleHostForNewDvsRequestType() {
    }
    ...
    /**
     * Gets the _this value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @return _this
     */
    ...
    /**
     * Sets the _this value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @param _this
     */
    ...
    /**
     * Gets the container value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @return container
     */
    ...
    /**
     * Sets the container value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @param container
     */
    ...
    /**
     * Gets the recursive value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @return recursive
     */
    ...
    /**
     * Sets the recursive value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @param recursive
     */
    ...
    /**
     * Gets the switchProductSpec value for this QueryCompatibleHostForNewDvsRequestType.
     * 
    ...
    /**
     * Sets the switchProductSpec value for this QueryCompatibleHostForNewDvsRequestType.
     * 
     * @param switchProductSpec
     */
    public void setSwitchProductSpec(com.vmware.vim25.DistributedVirtualSwitchProductSpec switchProductSpec) {
        this.switchProductSpec = switchProductSpec;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryCompatibleHostForNewDvsRequestType)) return false;
        QueryCompatibleHostForNewDvsRequestType other = (QueryCompatibleHostForNewDvsRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryCompatibleHostForNewDvsRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "QueryCompatibleHostForNewDvsRequestType"));
