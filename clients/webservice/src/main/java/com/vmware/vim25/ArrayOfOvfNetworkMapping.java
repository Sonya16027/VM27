...
public class ArrayOfOvfNetworkMapping implements java.io.Serializable {
	 ...
	 */
	public void setOvfNetworkMapping(
			com.vmware.vim25.OvfNetworkMapping[] ovfNetworkMapping) {
		this.ovfNetworkMapping = ovfNetworkMapping;
	}
	...
	public void setOvfNetworkMapping(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfOvfNetworkMapping)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.ovfNetworkMapping == null && other
				.getOvfNetworkMapping() == null) || (this.ovfNetworkMapping != null && java.util.Arrays
				.equals(this.ovfNetworkMapping, other.getOvfNetworkMapping())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getOvfNetworkMapping() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getOvfNetworkMapping()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getOvfNetworkMapping(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfOvfNetworkMapping.class, true);
