...
public class PhysicalNicConfig  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public PhysicalNicConfig(
           ...
           com.vmware.vim25.PhysicalNicSpec spec) {
        super(
            dynamicType,
            dynamicProperty);
        this.device = device;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PhysicalNicConfig)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PhysicalNicConfig.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PhysicalNicConfig"));
