...
public class InstallHostPatchRequestType implements java.io.Serializable {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof InstallHostPatchRequestType)) {
			return false;
		}
		...
		_equals = true
				...
				&& ((this.updateID == null && other.getUpdateID() == null) || (this.updateID != null && this.updateID
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			InstallHostPatchRequestType.class, true);
