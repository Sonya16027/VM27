...
public class HostStorageElementInfo extends
		com.vmware.vim25.HostHardwareElementInfo implements
	...
	public HostStorageElementInfo(java.lang.String dynamicType,
		...
		super(dynamicType, dynamicProperty, name, status);
	 ...
	 */
	public void setOperationalInfo(
			com.vmware.vim25.HostStorageOperationalInfo[] operationalInfo) {
		this.operationalInfo = operationalInfo;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostStorageElementInfo)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.operationalInfo == null && other.getOperationalInfo() == null) || (this.operationalInfo != null && java.util.Arrays
						.equals(this.operationalInfo, other
								.getOperationalInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getOperationalInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getOperationalInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getOperationalInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostStorageElementInfo.class, true);
