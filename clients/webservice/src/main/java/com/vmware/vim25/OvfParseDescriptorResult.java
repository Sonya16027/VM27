...
public class OvfParseDescriptorResult extends com.vmware.vim25.DynamicData
	...
	public OvfParseDescriptorResult(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String[] eula, com.vmware.vim25.OvfNetworkInfo[] network,
			...
			java.lang.String defaultEntityName, boolean virtualApp,
	 ...
	 */
	public void setApproximateDownloadSize(
			java.lang.Long approximateDownloadSize) {
		this.approximateDownloadSize = approximateDownloadSize;
	}

	/**
	 * Gets the approximateFlatDeploymentSize value for this
	...
	/**
	 * Sets the approximateFlatDeploymentSize value for this
	 * OvfParseDescriptorResult.
	 * 
	 * @param approximateFlatDeploymentSize
	 */
	public void setApproximateFlatDeploymentSize(
			java.lang.Long approximateFlatDeploymentSize) {
		this.approximateFlatDeploymentSize = approximateFlatDeploymentSize;
	}

	/**
	 * Gets the approximateSparseDeploymentSize value for this
	 * OvfParseDescriptorResult.
	 * 
	...
	/**
	 * Sets the approximateSparseDeploymentSize value for this
	 * OvfParseDescriptorResult.
	 * 
	 * @param approximateSparseDeploymentSize
	 */
	public void setApproximateSparseDeploymentSize(
			java.lang.Long approximateSparseDeploymentSize) {
		this.approximateSparseDeploymentSize = approximateSparseDeploymentSize;
	}
	 ...
	 */
	public void setDeploymentOption(
			com.vmware.vim25.OvfDeploymentOption[] deploymentOption) {
		this.deploymentOption = deploymentOption;
	}
	...
	public void setDeploymentOption(int i,
			com.vmware.vim25.OvfDeploymentOption _value) {
	 ...
	 */
	public void setDefaultDeploymentOption(
			java.lang.String defaultDeploymentOption) {
		this.defaultDeploymentOption = defaultDeploymentOption;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.eula == null && other.getEula() == null) || (this.eula != null && java.util.Arrays
						.equals(this.eula, other.getEula())))
				&& ((this.network == null && other.getNetwork() == null) || (this.network != null && java.util.Arrays
						.equals(this.network, other.getNetwork())))
				&& ((this.ipAllocationScheme == null && other
						.getIpAllocationScheme() == null) || (this.ipAllocationScheme != null && java.util.Arrays
						.equals(this.ipAllocationScheme, other
								.getIpAllocationScheme())))
				&& ((this.ipProtocols == null && other.getIpProtocols() == null) || (this.ipProtocols != null && java.util.Arrays
						.equals(this.ipProtocols, other.getIpProtocols())))
				&& ((this.property == null && other.getProperty() == null) || (this.property != null && java.util.Arrays
						.equals(this.property, other.getProperty())))
				...
				&& ((this.approximateDownloadSize == null && other
						.getApproximateDownloadSize() == null) || (this.approximateDownloadSize != null && this.approximateDownloadSize
						.equals(other.getApproximateDownloadSize())))
				&& ((this.approximateFlatDeploymentSize == null && other
						.getApproximateFlatDeploymentSize() == null) || (this.approximateFlatDeploymentSize != null && this.approximateFlatDeploymentSize
						.equals(other.getApproximateFlatDeploymentSize())))
				&& ((this.approximateSparseDeploymentSize == null && other
						.getApproximateSparseDeploymentSize() == null) || (this.approximateSparseDeploymentSize != null && this.approximateSparseDeploymentSize
						.equals(other.getApproximateSparseDeploymentSize())))
				&& ((this.defaultEntityName == null && other
						.getDefaultEntityName() == null) || (this.defaultEntityName != null && this.defaultEntityName
						.equals(other.getDefaultEntityName())))
				&& this.virtualApp == other.isVirtualApp()
				&& ((this.deploymentOption == null && other
						.getDeploymentOption() == null) || (this.deploymentOption != null && java.util.Arrays
						.equals(this.deploymentOption, other
								.getDeploymentOption())))
				&& ((this.defaultDeploymentOption == null && other
						.getDefaultDeploymentOption() == null) || (this.defaultDeploymentOption != null && this.defaultDeploymentOption
						.equals(other.getDefaultDeploymentOption())))
	...
	public synchronized int hashCode() {
		...
		if (getEula() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getEula()); i++) {
		...
		if (getIpAllocationScheme() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getIpAllocationScheme()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getIpAllocationScheme(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (getDeploymentOption() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDeploymentOption()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDeploymentOption(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			OvfParseDescriptorResult.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "eula"));
