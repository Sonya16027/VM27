...
public class NumericRange  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private int start;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NumericRange.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "NumericRange"));
