...
public class FileQueryFlags extends com.vmware.vim25.DynamicData implements
	...
	public FileQueryFlags(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			boolean fileType, boolean fileSize, boolean modification,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FileQueryFlags)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.fileOwner == null && other.getFileOwner() == null) || (this.fileOwner != null && this.fileOwner
						.equals(other.getFileOwner())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isModification() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
