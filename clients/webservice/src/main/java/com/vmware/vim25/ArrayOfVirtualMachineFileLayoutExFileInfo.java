...
public class ArrayOfVirtualMachineFileLayoutExFileInfo implements
	...
	/**
	 * Gets the virtualMachineFileLayoutExFileInfo value for this
	...
	/**
	 * Sets the virtualMachineFileLayoutExFileInfo value for this
	 * ArrayOfVirtualMachineFileLayoutExFileInfo.
	 * 
	 * @param virtualMachineFileLayoutExFileInfo
	 */
	public void setVirtualMachineFileLayoutExFileInfo(
			com.vmware.vim25.VirtualMachineFileLayoutExFileInfo[] virtualMachineFileLayoutExFileInfo) {
		this.virtualMachineFileLayoutExFileInfo = virtualMachineFileLayoutExFileInfo;
	}
	...
	public void setVirtualMachineFileLayoutExFileInfo(int i,
			com.vmware.vim25.VirtualMachineFileLayoutExFileInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVirtualMachineFileLayoutExFileInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.virtualMachineFileLayoutExFileInfo == null && other
				.getVirtualMachineFileLayoutExFileInfo() == null) || (this.virtualMachineFileLayoutExFileInfo != null && java.util.Arrays
				.equals(this.virtualMachineFileLayoutExFileInfo, other
						.getVirtualMachineFileLayoutExFileInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVirtualMachineFileLayoutExFileInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVirtualMachineFileLayoutExFileInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVirtualMachineFileLayoutExFileInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVirtualMachineFileLayoutExFileInfo.class, true);
