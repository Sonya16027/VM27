...
public class CustomizationGuiUnattended  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.CustomizationPassword password;
    ...
    public CustomizationGuiUnattended(
           ...
           com.vmware.vim25.CustomizationPassword password,
           int timeZone,
           boolean autoLogon,
           int autoLogonCount) {
        super(
     ...
     * @return password
     */
    public com.vmware.vim25.CustomizationPassword getPassword() {
        return password;
    }
     ...
     * @param password
     */
    public void setPassword(com.vmware.vim25.CustomizationPassword password) {
        this.password = password;
    }
