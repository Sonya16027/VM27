...
public class NetworkProfile  extends com.vmware.vim25.ApplyProfile  implements java.io.Serializable {
     ...
     * @param hostPortGroup
     */
    public void setHostPortGroup(com.vmware.vim25.HostPortGroupProfile[] hostPortGroup) {
        this.hostPortGroup = hostPortGroup;
    }
    ...
    public void setHostPortGroup(int i, com.vmware.vim25.HostPortGroupProfile _value) {
     ...
     */
    public void setServiceConsolePortGroup(com.vmware.vim25.ServiceConsolePortGroupProfile[] serviceConsolePortGroup) {
        this.serviceConsolePortGroup = serviceConsolePortGroup;
    }

    public com.vmware.vim25.ServiceConsolePortGroupProfile getServiceConsolePortGroup(int i) {
        return this.serviceConsolePortGroup[i];
    }

    public void setServiceConsolePortGroup(int i, com.vmware.vim25.ServiceConsolePortGroupProfile _value) {
     ...
     * @param dnsConfig
     */
    public void setDnsConfig(com.vmware.vim25.NetworkProfileDnsConfigProfile dnsConfig) {
        this.dnsConfig = dnsConfig;
    }
     ...
     */
    public void setConsoleIpRouteConfig(com.vmware.vim25.IpRouteProfile consoleIpRouteConfig) {
        this.consoleIpRouteConfig = consoleIpRouteConfig;
    }
     ...
     */
    public void setDvsServiceConsoleNic(com.vmware.vim25.DvsServiceConsoleVNicProfile[] dvsServiceConsoleNic) {
        this.dvsServiceConsoleNic = dvsServiceConsoleNic;
    }

    public com.vmware.vim25.DvsServiceConsoleVNicProfile getDvsServiceConsoleNic(int i) {
        return this.dvsServiceConsoleNic[i];
    }

    public void setDvsServiceConsoleNic(int i, com.vmware.vim25.DvsServiceConsoleVNicProfile _value) {
