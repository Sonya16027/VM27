...
public class HostNumaNode extends com.vmware.vim25.DynamicData implements
	...
	public HostNumaNode(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty, byte typeId,
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "cpuID"));
		elemField.setXmlType(new javax.xml.namespace.QName(
