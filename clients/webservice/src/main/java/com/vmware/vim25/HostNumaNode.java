...
public class HostNumaNode  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private byte typeId;
    ...
    public HostNumaNode(
           ...
           byte typeId,
           short[] cpuID,
           long memoryRangeBegin,
           long memoryRangeLength) {
        super(
            dynamicType,
            dynamicProperty);
        this.typeId = typeId;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostNumaNode)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.cpuID==null && other.getCpuID()==null) || 
             (this.cpuID!=null &&
              java.util.Arrays.equals(this.cpuID, other.getCpuID()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCpuID() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCpuID());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCpuID(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostNumaNode.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostNumaNode"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("typeId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "typeId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "byte"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cpuID");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "cpuID"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "memoryRangeBegin"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("memoryRangeLength");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "memoryRangeLength"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
