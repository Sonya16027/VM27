...
public class ArrayOfVirtualMachinePciPassthroughInfo implements
	...
	/**
	 * Gets the virtualMachinePciPassthroughInfo value for this
	...
	/**
	 * Sets the virtualMachinePciPassthroughInfo value for this
	 * ArrayOfVirtualMachinePciPassthroughInfo.
	 * 
	 * @param virtualMachinePciPassthroughInfo
	 */
	public void setVirtualMachinePciPassthroughInfo(
			com.vmware.vim25.VirtualMachinePciPassthroughInfo[] virtualMachinePciPassthroughInfo) {
		this.virtualMachinePciPassthroughInfo = virtualMachinePciPassthroughInfo;
	}
	...
	public void setVirtualMachinePciPassthroughInfo(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVirtualMachinePciPassthroughInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.virtualMachinePciPassthroughInfo == null && other
				.getVirtualMachinePciPassthroughInfo() == null) || (this.virtualMachinePciPassthroughInfo != null && java.util.Arrays
				.equals(this.virtualMachinePciPassthroughInfo, other
						.getVirtualMachinePciPassthroughInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVirtualMachinePciPassthroughInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVirtualMachinePciPassthroughInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVirtualMachinePciPassthroughInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVirtualMachinePciPassthroughInfo.class, true);
