...
public class ExportVmResponse  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference returnval;

    public ExportVmResponse() {
    }
    ...
    /**
     * Gets the returnval value for this ExportVmResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this ExportVmResponse.
     * 
     * @param returnval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExportVmResponse)) return false;
        ExportVmResponse other = (ExportVmResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExportVmResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", ">ExportVmResponse"));
