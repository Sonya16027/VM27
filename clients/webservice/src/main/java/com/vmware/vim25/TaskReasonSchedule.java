...
public class TaskReasonSchedule  extends com.vmware.vim25.TaskReason  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "TaskReasonSchedule"));
