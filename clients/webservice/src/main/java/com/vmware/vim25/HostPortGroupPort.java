...
public class HostPortGroupPort extends com.vmware.vim25.DynamicData implements
	...
	public HostPortGroupPort(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String key, java.lang.String[] mac, java.lang.String type) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostPortGroupPort)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.key == null && other.getKey() == null) || (this.key != null && this.key
						.equals(other.getKey())))
				&& ((this.mac == null && other.getMac() == null) || (this.mac != null && java.util.Arrays
						.equals(this.mac, other.getMac())))
	...
	public synchronized int hashCode() {
		...
		if (getMac() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getMac()); i++) {
