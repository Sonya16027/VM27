...
public class VirtualDiskMode implements java.io.Serializable {
    ...
    public static final VirtualDiskMode persistent = new VirtualDiskMode(_persistent);
    public static final VirtualDiskMode nonpersistent = new VirtualDiskMode(_nonpersistent);
    public static final VirtualDiskMode undoable = new VirtualDiskMode(_undoable);
    public static final VirtualDiskMode independent_persistent = new VirtualDiskMode(_independent_persistent);
    public static final VirtualDiskMode independent_nonpersistent = new VirtualDiskMode(_independent_nonpersistent);
    ...
    public static VirtualDiskMode fromValue(java.lang.String value)
        ...
        VirtualDiskMode enumeration = (VirtualDiskMode)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualDiskMode.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualDiskMode"));
    }
    /**
