...
public class VmWwnConflict  extends com.vmware.vim25.InvalidVmConfig  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VmWwnConflict)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.wwn==null && other.getWwn()==null) || 
             (this.wwn!=null &&
              this.wwn.equals(other.getWwn())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VmWwnConflict.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VmWwnConflict"));
