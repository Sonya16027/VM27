...
public class VirtualMachineStorageInfo extends com.vmware.vim25.DynamicData
	 ...
	 */
	public void setPerDatastoreUsage(
			com.vmware.vim25.VirtualMachineUsageOnDatastore[] perDatastoreUsage) {
		this.perDatastoreUsage = perDatastoreUsage;
	}
	...
	public void setPerDatastoreUsage(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VirtualMachineStorageInfo)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.perDatastoreUsage == null && other
						.getPerDatastoreUsage() == null) || (this.perDatastoreUsage != null && java.util.Arrays
						.equals(this.perDatastoreUsage, other
	...
	public synchronized int hashCode() {
		...
		if (getPerDatastoreUsage() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getPerDatastoreUsage()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getPerDatastoreUsage(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualMachineStorageInfo.class, true);
