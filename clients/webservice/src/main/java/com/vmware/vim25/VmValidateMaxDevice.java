...
public class VmValidateMaxDevice extends com.vmware.vim25.VimFault implements
	...
	public VmValidateMaxDevice(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			com.vmware.vim25.LocalizedMethodFault faultCause,
			com.vmware.vim25.LocalizableMessage[] faultMessage,
			java.lang.String device, int max, int count) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VmValidateMaxDevice)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& this.max == other.getMax() && this.count == other.getCount();
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VmValidateMaxDevice.class, true);
