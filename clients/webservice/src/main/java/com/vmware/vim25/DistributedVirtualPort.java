...
public class DistributedVirtualPort extends com.vmware.vim25.DynamicData
	...
	public DistributedVirtualPort(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String key, com.vmware.vim25.DVPortConfigInfo config,
			java.lang.String dvsUuid, java.lang.String portgroupKey,
			com.vmware.vim25.ManagedObjectReference proxyHost,
			com.vmware.vim25.DistributedVirtualSwitchPortConnectee connectee,
			boolean conflict, java.lang.String conflictPortKey,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DistributedVirtualPort)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.dvsUuid == null && other.getDvsUuid() == null) || (this.dvsUuid != null && this.dvsUuid
						.equals(other.getDvsUuid())))
				&& ((this.portgroupKey == null && other.getPortgroupKey() == null) || (this.portgroupKey != null && this.portgroupKey
						.equals(other.getPortgroupKey())))
				&& ((this.proxyHost == null && other.getProxyHost() == null) || (this.proxyHost != null && this.proxyHost
						.equals(other.getProxyHost())))
				&& ((this.connectee == null && other.getConnectee() == null) || (this.connectee != null && this.connectee
						.equals(other.getConnectee())))
				&& this.conflict == other.isConflict()
				&& ((this.conflictPortKey == null && other.getConflictPortKey() == null) || (this.conflictPortKey != null && this.conflictPortKey
						.equals(other.getConflictPortKey())))
				...
				&& ((this.lastStatusChange == null && other
						.getLastStatusChange() == null) || (this.lastStatusChange != null && this.lastStatusChange
						.equals(other.getLastStatusChange())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			DistributedVirtualPort.class, true);
