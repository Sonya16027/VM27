...
public class ArrayOfClusterDrsRecommendation  implements java.io.Serializable {
    ...
    public com.vmware.vim25.ClusterDrsRecommendation getClusterDrsRecommendation(int i) {
        return this.clusterDrsRecommendation[i];
    }

    public void setClusterDrsRecommendation(int i, com.vmware.vim25.ClusterDrsRecommendation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfClusterDrsRecommendation"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("clusterDrsRecommendation");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ClusterDrsRecommendation"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ClusterDrsRecommendation"));
