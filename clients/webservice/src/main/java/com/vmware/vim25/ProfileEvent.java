...
public class ProfileEvent  extends com.vmware.vim25.Event  implements java.io.Serializable {
    ...
    /**
     * Gets the profile value for this ProfileEvent.
     * 
     * @return profile
     */
    ...
    /**
     * Sets the profile value for this ProfileEvent.
     * 
     * @param profile
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ProfileEvent"));
