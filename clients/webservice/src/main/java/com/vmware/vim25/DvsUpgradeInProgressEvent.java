/**
 * DvsUpgradeInProgressEvent.java
 *
...
public class DvsUpgradeInProgressEvent  extends com.vmware.vim25.DvsEvent  implements java.io.Serializable {
    private com.vmware.vim25.DistributedVirtualSwitchProductSpec productInfo;

    public DvsUpgradeInProgressEvent() {
    }
    ...
    /**
     * Gets the productInfo value for this DvsUpgradeInProgressEvent.
     * 
     * @return productInfo
     */
    ...
    /**
     * Sets the productInfo value for this DvsUpgradeInProgressEvent.
     * 
     * @param productInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DvsUpgradeInProgressEvent)) return false;
        DvsUpgradeInProgressEvent other = (DvsUpgradeInProgressEvent) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DvsUpgradeInProgressEvent.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DvsUpgradeInProgressEvent"));
