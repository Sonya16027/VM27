...
public class HostPciPassthruInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostPciPassthruInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.dependentDevice==null && other.getDependentDevice()==null) || 
             (this.dependentDevice!=null &&
              this.dependentDevice.equals(other.getDependentDevice()))) &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isPassthruEnabled() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        _hashCode += (isPassthruCapable() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        _hashCode += (isPassthruActive() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostPciPassthruInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostPciPassthruInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "dependentDevice"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("passthruEnabled");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "passthruEnabled"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("passthruCapable");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "passthruCapable"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("passthruActive");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "passthruActive"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
