...
public class ArrayOfHostFirewallRuleset  implements java.io.Serializable {
    ...
    public void setHostFirewallRuleset(int i, com.vmware.vim25.HostFirewallRuleset _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostFirewallRuleset"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostFirewallRuleset");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostFirewallRuleset"));
