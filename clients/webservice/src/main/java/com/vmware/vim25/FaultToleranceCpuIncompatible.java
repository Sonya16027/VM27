...
public class FaultToleranceCpuIncompatible extends
		com.vmware.vim25.CpuIncompatible implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public FaultToleranceCpuIncompatible(java.lang.String dynamicType,
			...
			com.vmware.vim25.ManagedObjectReference host, boolean model,
			boolean family, boolean stepping) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FaultToleranceCpuIncompatible)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = super.equals(obj) && this.model == other.isModel()
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FaultToleranceCpuIncompatible.class, true);
