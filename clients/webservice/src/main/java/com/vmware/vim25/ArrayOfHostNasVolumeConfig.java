...
public class ArrayOfHostNasVolumeConfig implements java.io.Serializable {
	 ...
	 */
	public void setHostNasVolumeConfig(
			com.vmware.vim25.HostNasVolumeConfig[] hostNasVolumeConfig) {
		this.hostNasVolumeConfig = hostNasVolumeConfig;
	}
	...
	public void setHostNasVolumeConfig(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostNasVolumeConfig)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostNasVolumeConfig == null && other
				.getHostNasVolumeConfig() == null) || (this.hostNasVolumeConfig != null && java.util.Arrays
				.equals(this.hostNasVolumeConfig, other
						.getHostNasVolumeConfig())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostNasVolumeConfig() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostNasVolumeConfig()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostNasVolumeConfig(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostNasVolumeConfig.class, true);
