...
public class HostInternetScsiHbaAuthenticationCapabilities extends
	...
	public HostInternetScsiHbaAuthenticationCapabilities(
			...
			boolean chapAuthSettable, boolean krb5AuthSettable,
			boolean srpAuthSettable, boolean spkmAuthSettable,
	...
	/**
	 * Gets the chapAuthSettable value for this
	...
	/**
	 * Sets the chapAuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Gets the krb5AuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Sets the krb5AuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Gets the srpAuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Sets the srpAuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Gets the spkmAuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Sets the spkmAuthSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Gets the mutualChapSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Sets the mutualChapSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Gets the targetChapSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Sets the targetChapSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Gets the targetMutualChapSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	...
	/**
	 * Sets the targetMutualChapSettable value for this
	 * HostInternetScsiHbaAuthenticationCapabilities.
	 * 
	 * @param targetMutualChapSettable
	 */
	public void setTargetMutualChapSettable(
			java.lang.Boolean targetMutualChapSettable) {
		this.targetMutualChapSettable = targetMutualChapSettable;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostInternetScsiHbaAuthenticationCapabilities)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.mutualChapSettable == null && other
						.getMutualChapSettable() == null) || (this.mutualChapSettable != null && this.mutualChapSettable
						.equals(other.getMutualChapSettable())))
				&& ((this.targetChapSettable == null && other
						.getTargetChapSettable() == null) || (this.targetChapSettable != null && this.targetChapSettable
						.equals(other.getTargetChapSettable())))
				&& ((this.targetMutualChapSettable == null && other
						.getTargetMutualChapSettable() == null) || (this.targetMutualChapSettable != null && this.targetMutualChapSettable
						.equals(other.getTargetMutualChapSettable())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isChapAuthSettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isKrb5AuthSettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isSrpAuthSettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isSpkmAuthSettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostInternetScsiHbaAuthenticationCapabilities.class, true);
