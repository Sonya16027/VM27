...
public class HostLicenseSpec extends com.vmware.vim25.DynamicData implements
	...
	public HostLicenseSpec(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			com.vmware.vim25.LicenseSource source, java.lang.String editionKey,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostLicenseSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.disabledFeatureKey == null && other
						.getDisabledFeatureKey() == null) || (this.disabledFeatureKey != null && java.util.Arrays
						.equals(this.disabledFeatureKey, other
								.getDisabledFeatureKey())))
				&& ((this.enabledFeatureKey == null && other
						.getEnabledFeatureKey() == null) || (this.enabledFeatureKey != null && java.util.Arrays
						.equals(this.enabledFeatureKey, other
	...
	public synchronized int hashCode() {
		...
		if (getDisabledFeatureKey() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDisabledFeatureKey()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDisabledFeatureKey(), i);
		...
		if (getEnabledFeatureKey() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getEnabledFeatureKey()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getEnabledFeatureKey(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
