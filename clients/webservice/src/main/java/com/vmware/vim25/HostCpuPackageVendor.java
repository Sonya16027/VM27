...
public class HostCpuPackageVendor implements java.io.Serializable {
	...
	public static final HostCpuPackageVendor unknown = new HostCpuPackageVendor(
			_unknown);
	public static final HostCpuPackageVendor intel = new HostCpuPackageVendor(
			_intel);
	public static final HostCpuPackageVendor amd = new HostCpuPackageVendor(
			_amd);
	...
	public static HostCpuPackageVendor fromValue(java.lang.String value)
		...
		HostCpuPackageVendor enumeration = (HostCpuPackageVendor) _table_
				.get(value);
		if (enumeration == null) {
