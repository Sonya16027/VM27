...
public class HostPatchManagerPatchManagerOperationSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the userName value for this HostPatchManagerPatchManagerOperationSpec.
     * 
     * @return userName
     */
    ...
    /**
     * Sets the userName value for this HostPatchManagerPatchManagerOperationSpec.
     * 
     * @param userName
     */
    ...
    /**
     * Gets the password value for this HostPatchManagerPatchManagerOperationSpec.
     * 
     * @return password
     */
    ...
    /**
     * Sets the password value for this HostPatchManagerPatchManagerOperationSpec.
     * 
     * @param password
     */
    ...
    /**
     * Gets the cmdOption value for this HostPatchManagerPatchManagerOperationSpec.
     * 
     * @return cmdOption
     */
    ...
    /**
     * Sets the cmdOption value for this HostPatchManagerPatchManagerOperationSpec.
     * 
     * @param cmdOption
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostPatchManagerPatchManagerOperationSpec)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.cmdOption==null && other.getCmdOption()==null) || 
             (this.cmdOption!=null &&
              this.cmdOption.equals(other.getCmdOption())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostPatchManagerPatchManagerOperationSpec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostPatchManagerPatchManagerOperationSpec"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "cmdOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
