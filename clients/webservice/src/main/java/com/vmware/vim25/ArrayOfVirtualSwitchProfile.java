...
public class ArrayOfVirtualSwitchProfile implements java.io.Serializable {
	 ...
	 */
	public void setVirtualSwitchProfile(
			com.vmware.vim25.VirtualSwitchProfile[] virtualSwitchProfile) {
		this.virtualSwitchProfile = virtualSwitchProfile;
	}
	...
	public void setVirtualSwitchProfile(int i,
			com.vmware.vim25.VirtualSwitchProfile _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVirtualSwitchProfile)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.virtualSwitchProfile == null && other
				.getVirtualSwitchProfile() == null) || (this.virtualSwitchProfile != null && java.util.Arrays
				.equals(this.virtualSwitchProfile, other
						.getVirtualSwitchProfile())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVirtualSwitchProfile() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVirtualSwitchProfile()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVirtualSwitchProfile(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVirtualSwitchProfile.class, true);
