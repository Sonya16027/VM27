...
public class HostInternetScsiHbaDiscoveryCapabilities extends
	...
	public HostInternetScsiHbaDiscoveryCapabilities(
			...
			boolean iSnsDiscoverySettable, boolean slpDiscoverySettable,
	...
	/**
	 * Gets the iSnsDiscoverySettable value for this
	...
	/**
	 * Sets the iSnsDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	...
	/**
	 * Gets the slpDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	...
	/**
	 * Sets the slpDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	...
	/**
	 * Gets the staticTargetDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	...
	/**
	 * Sets the staticTargetDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	 * @param staticTargetDiscoverySettable
	 */
	public void setStaticTargetDiscoverySettable(
			boolean staticTargetDiscoverySettable) {
		this.staticTargetDiscoverySettable = staticTargetDiscoverySettable;
	}

	/**
	 * Gets the sendTargetsDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	...
	/**
	 * Sets the sendTargetsDiscoverySettable value for this
	 * HostInternetScsiHbaDiscoveryCapabilities.
	 * 
	 * @param sendTargetsDiscoverySettable
	 */
	public void setSendTargetsDiscoverySettable(
			boolean sendTargetsDiscoverySettable) {
		this.sendTargetsDiscoverySettable = sendTargetsDiscoverySettable;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostInternetScsiHbaDiscoveryCapabilities)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& this.iSnsDiscoverySettable == other
						.isISnsDiscoverySettable()
				&& this.slpDiscoverySettable == other.isSlpDiscoverySettable()
				&& this.staticTargetDiscoverySettable == other
						.isStaticTargetDiscoverySettable()
				&& this.sendTargetsDiscoverySettable == other
	...
	public synchronized int hashCode() {
		...
		_hashCode += (isISnsDiscoverySettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isSlpDiscoverySettable() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isStaticTargetDiscoverySettable() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isSendTargetsDiscoverySettable() ? Boolean.TRUE
				: Boolean.FALSE).hashCode();
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostInternetScsiHbaDiscoveryCapabilities.class, true);
