...
public class FloatOption  extends com.vmware.vim25.OptionType  implements java.io.Serializable {
    private float min;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "FloatOption"));
