...
public class PropertyChangeOp implements java.io.Serializable {
	...
	public static final PropertyChangeOp indirectRemove = new PropertyChangeOp(
			_indirectRemove);
	...
	public static PropertyChangeOp fromValue(java.lang.String value)
		...
		PropertyChangeOp enumeration = (PropertyChangeOp) _table_.get(value);
		if (enumeration == null) {
