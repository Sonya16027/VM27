...
public class HostUnresolvedVmfsResolutionSpec extends
	...
	public HostUnresolvedVmfsResolutionSpec(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String[] extentDevicePath, java.lang.String uuidResolution) {
	...
	/**
	 * Gets the extentDevicePath value for this
	...
	/**
	 * Sets the extentDevicePath value for this
	 * HostUnresolvedVmfsResolutionSpec.
	 * 
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof HostUnresolvedVmfsResolutionSpec)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.extentDevicePath == null && other
						.getExtentDevicePath() == null) || (this.extentDevicePath != null && java.util.Arrays
						.equals(this.extentDevicePath, other
								.getExtentDevicePath())))
				&& ((this.uuidResolution == null && other.getUuidResolution() == null) || (this.uuidResolution != null && this.uuidResolution
						.equals(other.getUuidResolution())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getExtentDevicePath() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getExtentDevicePath()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getExtentDevicePath(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			HostUnresolvedVmfsResolutionSpec.class, true);
