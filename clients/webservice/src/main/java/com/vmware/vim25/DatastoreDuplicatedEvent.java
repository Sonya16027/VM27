...
public class DatastoreDuplicatedEvent  extends com.vmware.vim25.DatastoreEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DatastoreDuplicatedEvent"));
    }
