...
public class VAppIPAssignmentInfo extends com.vmware.vim25.DynamicData
	...
	public VAppIPAssignmentInfo(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty,
			java.lang.String[] supportedAllocationScheme,
			java.lang.String ipAllocationPolicy,
			java.lang.String[] supportedIpProtocol, java.lang.String ipProtocol) {
	 ...
	 */
	public void setSupportedAllocationScheme(
			java.lang.String[] supportedAllocationScheme) {
		this.supportedAllocationScheme = supportedAllocationScheme;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof VAppIPAssignmentInfo)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.supportedAllocationScheme == null && other
						.getSupportedAllocationScheme() == null) || (this.supportedAllocationScheme != null && java.util.Arrays
						.equals(this.supportedAllocationScheme, other
				...
				&& ((this.supportedIpProtocol == null && other
						.getSupportedIpProtocol() == null) || (this.supportedIpProtocol != null && java.util.Arrays
						.equals(this.supportedIpProtocol, other
	...
	public synchronized int hashCode() {
		...
		if (getSupportedAllocationScheme() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getSupportedAllocationScheme()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getSupportedAllocationScheme(), i);
		...
		if (getSupportedIpProtocol() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getSupportedIpProtocol()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getSupportedIpProtocol(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VAppIPAssignmentInfo.class, true);
