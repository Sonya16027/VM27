...
public class ArrayOfExtensionServerInfo implements java.io.Serializable {
	...
	private com.vmware.vim25.ExtensionServerInfo[] extensionServerInfo;

	public ArrayOfExtensionServerInfo() {
	}

	public ArrayOfExtensionServerInfo(
			com.vmware.vim25.ExtensionServerInfo[] extensionServerInfo) {
	 ...
	 */
	public void setExtensionServerInfo(
			com.vmware.vim25.ExtensionServerInfo[] extensionServerInfo) {
		this.extensionServerInfo = extensionServerInfo;
	}

	public com.vmware.vim25.ExtensionServerInfo getExtensionServerInfo(int i) {
		return this.extensionServerInfo[i];
	}

	public void setExtensionServerInfo(int i,
			com.vmware.vim25.ExtensionServerInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfExtensionServerInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.extensionServerInfo == null && other
				.getExtensionServerInfo() == null) || (this.extensionServerInfo != null && java.util.Arrays
				.equals(this.extensionServerInfo, other
						.getExtensionServerInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getExtensionServerInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getExtensionServerInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getExtensionServerInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfExtensionServerInfo.class, true);
