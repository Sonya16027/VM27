...
public class CheckTestType implements java.io.Serializable {
    ...
    public static final CheckTestType sourceTests = new CheckTestType(_sourceTests);
    public static final CheckTestType hostTests = new CheckTestType(_hostTests);
    public static final CheckTestType resourcePoolTests = new CheckTestType(_resourcePoolTests);
    public static final CheckTestType datastoreTests = new CheckTestType(_datastoreTests);
    public java.lang.String getValue() { return _value_;}
    public static CheckTestType fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        CheckTestType enumeration = (CheckTestType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CheckTestType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "CheckTestType"));
    }
    /**
