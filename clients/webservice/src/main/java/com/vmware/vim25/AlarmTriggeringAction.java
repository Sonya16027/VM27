...
public class AlarmTriggeringAction  extends com.vmware.vim25.AlarmAction  implements java.io.Serializable {
     ...
     */
    public void setTransitionSpecs(com.vmware.vim25.AlarmTriggeringActionTransitionSpec[] transitionSpecs) {
        this.transitionSpecs = transitionSpecs;
    }

    public com.vmware.vim25.AlarmTriggeringActionTransitionSpec getTransitionSpecs(int i) {
        return this.transitionSpecs[i];
    }

    public void setTransitionSpecs(int i, com.vmware.vim25.AlarmTriggeringActionTransitionSpec _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.transitionSpecs==null && other.getTransitionSpecs()==null) || 
             (this.transitionSpecs!=null &&
              java.util.Arrays.equals(this.transitionSpecs, other.getTransitionSpecs()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getTransitionSpecs() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getTransitionSpecs());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getTransitionSpecs(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AlarmTriggeringAction"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("action");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "action"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "Action"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("transitionSpecs");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "transitionSpecs"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "green2yellow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("yellow2Red");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "yellow2red"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("red2Yellow");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "red2yellow"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("yellow2Green");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "yellow2green"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
