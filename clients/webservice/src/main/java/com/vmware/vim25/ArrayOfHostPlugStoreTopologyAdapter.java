...
public class ArrayOfHostPlugStoreTopologyAdapter implements
	...
	/**
	 * Gets the hostPlugStoreTopologyAdapter value for this
	...
	/**
	 * Sets the hostPlugStoreTopologyAdapter value for this
	 * ArrayOfHostPlugStoreTopologyAdapter.
	 * 
	 * @param hostPlugStoreTopologyAdapter
	 */
	public void setHostPlugStoreTopologyAdapter(
			com.vmware.vim25.HostPlugStoreTopologyAdapter[] hostPlugStoreTopologyAdapter) {
		this.hostPlugStoreTopologyAdapter = hostPlugStoreTopologyAdapter;
	}
	...
	public void setHostPlugStoreTopologyAdapter(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostPlugStoreTopologyAdapter)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostPlugStoreTopologyAdapter == null && other
				.getHostPlugStoreTopologyAdapter() == null) || (this.hostPlugStoreTopologyAdapter != null && java.util.Arrays
				.equals(this.hostPlugStoreTopologyAdapter, other
						.getHostPlugStoreTopologyAdapter())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostPlugStoreTopologyAdapter() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostPlugStoreTopologyAdapter()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostPlugStoreTopologyAdapter(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostPlugStoreTopologyAdapter.class, true);
