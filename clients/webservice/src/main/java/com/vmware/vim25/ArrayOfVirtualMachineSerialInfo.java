...
public class ArrayOfVirtualMachineSerialInfo  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineSerialInfo getVirtualMachineSerialInfo(int i) {
        return this.virtualMachineSerialInfo[i];
    }

    public void setVirtualMachineSerialInfo(int i, com.vmware.vim25.VirtualMachineSerialInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfVirtualMachineSerialInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("virtualMachineSerialInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineSerialInfo"));
