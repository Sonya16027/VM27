...
public class VirtualControllerOption  extends com.vmware.vim25.VirtualDeviceOption  implements java.io.Serializable {
    private com.vmware.vim25.IntOption devices;
     ...
     * @return devices
     */
    public com.vmware.vim25.IntOption getDevices() {
        return devices;
    }
     ...
     * @param devices
     */
    public void setDevices(com.vmware.vim25.IntOption devices) {
        this.devices = devices;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VirtualControllerOption)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.supportedDevice==null && other.getSupportedDevice()==null) || 
             (this.supportedDevice!=null &&
              java.util.Arrays.equals(this.supportedDevice, other.getSupportedDevice())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSupportedDevice() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSupportedDevice());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSupportedDevice(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VirtualControllerOption.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualControllerOption"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("devices");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "devices"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "supportedDevice"));
