...
public class VirtualDiskType implements java.io.Serializable {
	...
	public static final VirtualDiskType preallocated = new VirtualDiskType(
			_preallocated);
	...
	public static final VirtualDiskType sparse2Gb = new VirtualDiskType(
			_sparse2Gb);
	public static final VirtualDiskType thick2Gb = new VirtualDiskType(
			_thick2Gb);
	public static final VirtualDiskType eagerZeroedThick = new VirtualDiskType(
			_eagerZeroedThick);
	public static final VirtualDiskType sparseMonolithic = new VirtualDiskType(
			_sparseMonolithic);
	public static final VirtualDiskType flatMonolithic = new VirtualDiskType(
			_flatMonolithic);
	...
	public static VirtualDiskType fromValue(java.lang.String value)
		...
		VirtualDiskType enumeration = (VirtualDiskType) _table_.get(value);
		if (enumeration == null) {
