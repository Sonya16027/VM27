...
public class ScheduledTaskEmailCompletedEvent  extends com.vmware.vim25.ScheduledTaskEvent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ScheduledTaskEmailCompletedEvent"));
