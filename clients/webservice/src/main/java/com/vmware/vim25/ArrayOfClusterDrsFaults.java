...
public class ArrayOfClusterDrsFaults implements java.io.Serializable {
	 ...
	 */
	public void setClusterDrsFaults(
			com.vmware.vim25.ClusterDrsFaults[] clusterDrsFaults) {
		this.clusterDrsFaults = clusterDrsFaults;
	}
	...
	public void setClusterDrsFaults(int i,
			com.vmware.vim25.ClusterDrsFaults _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfClusterDrsFaults)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.clusterDrsFaults == null && other
				.getClusterDrsFaults() == null) || (this.clusterDrsFaults != null && java.util.Arrays
				.equals(this.clusterDrsFaults, other.getClusterDrsFaults())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getClusterDrsFaults() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getClusterDrsFaults()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getClusterDrsFaults(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfClusterDrsFaults.class, true);
