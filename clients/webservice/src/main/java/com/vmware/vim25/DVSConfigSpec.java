...
public class DVSConfigSpec  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
     ...
     * @param host
     */
    public void setHost(com.vmware.vim25.DistributedVirtualSwitchHostMemberConfigSpec[] host) {
        this.host = host;
    }

    public com.vmware.vim25.DistributedVirtualSwitchHostMemberConfigSpec getHost(int i) {
        return this.host[i];
    }

    public void setHost(int i, com.vmware.vim25.DistributedVirtualSwitchHostMemberConfigSpec _value) {
        this.host[i] = _value;
    }
