...
public class HostDatastoreNameConflictConnectInfo  extends com.vmware.vim25.HostDatastoreConnectInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostDatastoreNameConflictConnectInfo"));
