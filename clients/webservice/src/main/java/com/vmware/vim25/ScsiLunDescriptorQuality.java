...
public class ScsiLunDescriptorQuality implements java.io.Serializable {
	...
	public static final ScsiLunDescriptorQuality highQuality = new ScsiLunDescriptorQuality(
			_highQuality);
	public static final ScsiLunDescriptorQuality mediumQuality = new ScsiLunDescriptorQuality(
			_mediumQuality);
	public static final ScsiLunDescriptorQuality lowQuality = new ScsiLunDescriptorQuality(
			_lowQuality);
	public static final ScsiLunDescriptorQuality unknownQuality = new ScsiLunDescriptorQuality(
			_unknownQuality);
	...
	public static ScsiLunDescriptorQuality fromValue(java.lang.String value)
		...
		ScsiLunDescriptorQuality enumeration = (ScsiLunDescriptorQuality) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ScsiLunDescriptorQuality.class);
