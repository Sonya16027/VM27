...
public class ArrayOfHostServiceConfig implements java.io.Serializable {
	 ...
	 */
	public void setHostServiceConfig(
			com.vmware.vim25.HostServiceConfig[] hostServiceConfig) {
		this.hostServiceConfig = hostServiceConfig;
	}
	...
	public void setHostServiceConfig(int i,
			com.vmware.vim25.HostServiceConfig _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfHostServiceConfig)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.hostServiceConfig == null && other
				.getHostServiceConfig() == null) || (this.hostServiceConfig != null && java.util.Arrays
				.equals(this.hostServiceConfig, other.getHostServiceConfig())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getHostServiceConfig() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getHostServiceConfig()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getHostServiceConfig(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfHostServiceConfig.class, true);
