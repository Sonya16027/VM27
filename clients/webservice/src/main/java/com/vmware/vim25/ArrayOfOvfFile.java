...
public class ArrayOfOvfFile  implements java.io.Serializable {
    ...
    public ArrayOfOvfFile(
           com.vmware.vim25.OvfFile[] ovfFile) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfOvfFile)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.ovfFile==null && other.getOvfFile()==null) || 
             (this.ovfFile!=null &&
              java.util.Arrays.equals(this.ovfFile, other.getOvfFile())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getOvfFile() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getOvfFile());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getOvfFile(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfOvfFile.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfOvfFile"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ovfFile");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "OvfFile"));
