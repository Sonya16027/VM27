...
public class ArrayOfVAppProductInfo implements java.io.Serializable {
	...
	private com.vmware.vim25.VAppProductInfo[] VAppProductInfo;

	public ArrayOfVAppProductInfo() {
	}

	public ArrayOfVAppProductInfo(
			com.vmware.vim25.VAppProductInfo[] VAppProductInfo) {
	 ...
	 */
	public void setVAppProductInfo(
			com.vmware.vim25.VAppProductInfo[] VAppProductInfo) {
		this.VAppProductInfo = VAppProductInfo;
	}

	public com.vmware.vim25.VAppProductInfo getVAppProductInfo(int i) {
		return this.VAppProductInfo[i];
	}

	public void setVAppProductInfo(int i,
			com.vmware.vim25.VAppProductInfo _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVAppProductInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.VAppProductInfo == null && other
				.getVAppProductInfo() == null) || (this.VAppProductInfo != null && java.util.Arrays
				.equals(this.VAppProductInfo, other.getVAppProductInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVAppProductInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVAppProductInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVAppProductInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVAppProductInfo.class, true);
