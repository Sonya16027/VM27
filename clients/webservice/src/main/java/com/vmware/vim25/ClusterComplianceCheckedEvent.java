...
public class ClusterComplianceCheckedEvent  extends com.vmware.vim25.ClusterEvent  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClusterComplianceCheckedEvent)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClusterComplianceCheckedEvent.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ClusterComplianceCheckedEvent"));
