...
public class ArrayOfVirtualMachineCpuIdInfoSpec  implements java.io.Serializable {
    ...
    public com.vmware.vim25.VirtualMachineCpuIdInfoSpec getVirtualMachineCpuIdInfoSpec(int i) {
        return this.virtualMachineCpuIdInfoSpec[i];
    }

    public void setVirtualMachineCpuIdInfoSpec(int i, com.vmware.vim25.VirtualMachineCpuIdInfoSpec _value) {
