...
public class CreateTaskResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the returnval value for this CreateTaskResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this CreateTaskResponse.
     * 
     * @param returnval
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", ">CreateTaskResponse"));
