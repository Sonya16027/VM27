...
public class ClusterDrsVmConfigInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference key;

    private java.lang.Boolean enabled;

    private com.vmware.vim25.DrsBehavior behavior;
    ...
    public ClusterDrsVmConfigInfo(
           ...
           com.vmware.vim25.DrsBehavior behavior) {
        super(
            dynamicType,
            dynamicProperty);
        this.key = key;
     ...
     * @return behavior
     */
    public com.vmware.vim25.DrsBehavior getBehavior() {
        return behavior;
    }
     ...
     * @param behavior
     */
    public void setBehavior(com.vmware.vim25.DrsBehavior behavior) {
        this.behavior = behavior;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ClusterDrsVmConfigInfo"));
