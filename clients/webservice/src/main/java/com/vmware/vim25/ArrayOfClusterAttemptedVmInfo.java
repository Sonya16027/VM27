...
public class ArrayOfClusterAttemptedVmInfo implements java.io.Serializable {
	...
	/**
	 * Gets the clusterAttemptedVmInfo value for this
	...
	/**
	 * Sets the clusterAttemptedVmInfo value for this
	 * ArrayOfClusterAttemptedVmInfo.
	 * 
	 * @param clusterAttemptedVmInfo
	 */
	public void setClusterAttemptedVmInfo(
			com.vmware.vim25.ClusterAttemptedVmInfo[] clusterAttemptedVmInfo) {
		this.clusterAttemptedVmInfo = clusterAttemptedVmInfo;
	}
	...
	public void setClusterAttemptedVmInfo(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfClusterAttemptedVmInfo)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.clusterAttemptedVmInfo == null && other
				.getClusterAttemptedVmInfo() == null) || (this.clusterAttemptedVmInfo != null && java.util.Arrays
				.equals(this.clusterAttemptedVmInfo, other
						.getClusterAttemptedVmInfo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getClusterAttemptedVmInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getClusterAttemptedVmInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getClusterAttemptedVmInfo(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfClusterAttemptedVmInfo.class, true);
