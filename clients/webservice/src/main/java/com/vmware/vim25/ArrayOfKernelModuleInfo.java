...
public class ArrayOfKernelModuleInfo  implements java.io.Serializable {
    ...
    public void setKernelModuleInfo(int i, com.vmware.vim25.KernelModuleInfo _value) {
        this.kernelModuleInfo[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfKernelModuleInfo)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.kernelModuleInfo==null && other.getKernelModuleInfo()==null) || 
             (this.kernelModuleInfo!=null &&
              java.util.Arrays.equals(this.kernelModuleInfo, other.getKernelModuleInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getKernelModuleInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getKernelModuleInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getKernelModuleInfo(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfKernelModuleInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfKernelModuleInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("kernelModuleInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "KernelModuleInfo"));
