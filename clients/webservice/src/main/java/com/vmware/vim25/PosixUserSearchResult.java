...
public class PosixUserSearchResult  extends com.vmware.vim25.UserSearchResult  implements java.io.Serializable {
    private int id;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PosixUserSearchResult)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PosixUserSearchResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PosixUserSearchResult"));
