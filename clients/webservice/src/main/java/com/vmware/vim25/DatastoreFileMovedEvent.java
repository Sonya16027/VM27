...
public class DatastoreFileMovedEvent  extends com.vmware.vim25.DatastoreFileEvent  implements java.io.Serializable {
    private com.vmware.vim25.DatastoreEventArgument sourceDatastore;

    private java.lang.String sourceFile;

    public DatastoreFileMovedEvent() {
    }
    ...
    /**
     * Gets the sourceDatastore value for this DatastoreFileMovedEvent.
     * 
    ...
    /**
     * Sets the sourceDatastore value for this DatastoreFileMovedEvent.
     * 
     * @param sourceDatastore
     */
    public void setSourceDatastore(com.vmware.vim25.DatastoreEventArgument sourceDatastore) {
        this.sourceDatastore = sourceDatastore;
    }


    /**
     * Gets the sourceFile value for this DatastoreFileMovedEvent.
     * 
     * @return sourceFile
     */
    ...
    /**
     * Sets the sourceFile value for this DatastoreFileMovedEvent.
     * 
     * @param sourceFile
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DatastoreFileMovedEvent)) return false;
        DatastoreFileMovedEvent other = (DatastoreFileMovedEvent) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DatastoreFileMovedEvent.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DatastoreFileMovedEvent"));
