...
public class HostDiskMappingOption  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    private com.vmware.vim25.HostDiskMappingPartitionOption[] physicalPartition;
    ...
    public HostDiskMappingOption(
           ...
           com.vmware.vim25.HostDiskMappingPartitionOption[] physicalPartition,
     ...
     */
    public com.vmware.vim25.HostDiskMappingPartitionOption[] getPhysicalPartition() {
        return physicalPartition;
    }
     ...
     */
    public void setPhysicalPartition(com.vmware.vim25.HostDiskMappingPartitionOption[] physicalPartition) {
        this.physicalPartition = physicalPartition;
    }

    public com.vmware.vim25.HostDiskMappingPartitionOption getPhysicalPartition(int i) {
        return this.physicalPartition[i];
    }

    public void setPhysicalPartition(int i, com.vmware.vim25.HostDiskMappingPartitionOption _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostDiskMappingOption"));
