...
public class VirtualMachineUsbInfoSpeed implements java.io.Serializable {
	...
	public static final VirtualMachineUsbInfoSpeed low = new VirtualMachineUsbInfoSpeed(
			_low);
	public static final VirtualMachineUsbInfoSpeed full = new VirtualMachineUsbInfoSpeed(
			_full);
	public static final VirtualMachineUsbInfoSpeed high = new VirtualMachineUsbInfoSpeed(
			_high);
	public static final VirtualMachineUsbInfoSpeed unknownSpeed = new VirtualMachineUsbInfoSpeed(
			_unknownSpeed);
	...
	public static VirtualMachineUsbInfoSpeed fromValue(java.lang.String value)
		...
		VirtualMachineUsbInfoSpeed enumeration = (VirtualMachineUsbInfoSpeed) _table_
				.get(value);
		if (enumeration == null) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			VirtualMachineUsbInfoSpeed.class);
