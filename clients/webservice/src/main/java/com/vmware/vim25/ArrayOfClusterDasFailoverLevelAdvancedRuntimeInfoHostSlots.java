...
public class ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots
	...
	/**
	 * Gets the clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots value for
	 * this ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots.
	 * 
	...
	/**
	 * Sets the clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots value for
	 * this ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots.
	 * 
	 * @param clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots
	 */
	public void setClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots(
			com.vmware.vim25.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots[] clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots) {
		this.clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots = clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots == null && other
				.getClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots() == null) || (this.clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots != null && java.util.Arrays
				.equals(
						this.clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots,
						other
								.getClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots.class,
			true);
	...
	static {
		...
		elemField
				.setFieldName("clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots");
