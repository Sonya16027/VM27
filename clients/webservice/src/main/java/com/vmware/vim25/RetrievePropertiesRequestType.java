...
public class RetrievePropertiesRequestType  implements java.io.Serializable {
    ...
    private com.vmware.vim25.PropertyFilterSpec[] specSet;
     ...
     * @return specSet
     */
    public com.vmware.vim25.PropertyFilterSpec[] getSpecSet() {
        return specSet;
    }
     ...
     * @param specSet
     */
    public void setSpecSet(com.vmware.vim25.PropertyFilterSpec[] specSet) {
        this.specSet = specSet;
    }

    public com.vmware.vim25.PropertyFilterSpec getSpecSet(int i) {
        return this.specSet[i];
    }

    public void setSpecSet(int i, com.vmware.vim25.PropertyFilterSpec _value) {
        this.specSet[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievePropertiesRequestType)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievePropertiesRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "RetrievePropertiesRequestType"));
