...
public class ArrayOfLocalizationManagerMessageCatalog implements
	...
	/**
	 * Gets the localizationManagerMessageCatalog value for this
	...
	/**
	 * Sets the localizationManagerMessageCatalog value for this
	 * ArrayOfLocalizationManagerMessageCatalog.
	 * 
	 * @param localizationManagerMessageCatalog
	 */
	public void setLocalizationManagerMessageCatalog(
			com.vmware.vim25.LocalizationManagerMessageCatalog[] localizationManagerMessageCatalog) {
		this.localizationManagerMessageCatalog = localizationManagerMessageCatalog;
	}
	...
	public void setLocalizationManagerMessageCatalog(int i,
			com.vmware.vim25.LocalizationManagerMessageCatalog _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfLocalizationManagerMessageCatalog)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.localizationManagerMessageCatalog == null && other
				.getLocalizationManagerMessageCatalog() == null) || (this.localizationManagerMessageCatalog != null && java.util.Arrays
				.equals(this.localizationManagerMessageCatalog, other
						.getLocalizationManagerMessageCatalog())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getLocalizationManagerMessageCatalog() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getLocalizationManagerMessageCatalog()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getLocalizationManagerMessageCatalog(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfLocalizationManagerMessageCatalog.class, true);
