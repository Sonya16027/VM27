...
public class ArrayOfDiskChangeExtent implements java.io.Serializable {
	 ...
	 */
	public void setDiskChangeExtent(
			com.vmware.vim25.DiskChangeExtent[] diskChangeExtent) {
		this.diskChangeExtent = diskChangeExtent;
	}
	...
	public void setDiskChangeExtent(int i,
			com.vmware.vim25.DiskChangeExtent _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfDiskChangeExtent)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.diskChangeExtent == null && other
				.getDiskChangeExtent() == null) || (this.diskChangeExtent != null && java.util.Arrays
				.equals(this.diskChangeExtent, other.getDiskChangeExtent())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getDiskChangeExtent() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getDiskChangeExtent()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getDiskChangeExtent(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfDiskChangeExtent.class, true);
