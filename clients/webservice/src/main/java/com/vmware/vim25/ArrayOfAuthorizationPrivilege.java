...
public class ArrayOfAuthorizationPrivilege  implements java.io.Serializable {
    ...
    public com.vmware.vim25.AuthorizationPrivilege getAuthorizationPrivilege(int i) {
        return this.authorizationPrivilege[i];
    }

    public void setAuthorizationPrivilege(int i, com.vmware.vim25.AuthorizationPrivilege _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfAuthorizationPrivilege"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("authorizationPrivilege");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "AuthorizationPrivilege"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "AuthorizationPrivilege"));
