...
public class ClusterHostPowerAction extends com.vmware.vim25.ClusterAction
	...
	public ClusterHostPowerAction(java.lang.String dynamicType,
			...
			java.lang.Integer cpuCapacityMHz, java.lang.Integer memCapacityMB) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClusterHostPowerAction)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.operationType == null && other.getOperationType() == null) || (this.operationType != null && this.operationType
						.equals(other.getOperationType())))
				&& ((this.powerConsumptionWatt == null && other
						.getPowerConsumptionWatt() == null) || (this.powerConsumptionWatt != null && this.powerConsumptionWatt
						.equals(other.getPowerConsumptionWatt())))
				&& ((this.cpuCapacityMHz == null && other.getCpuCapacityMHz() == null) || (this.cpuCapacityMHz != null && this.cpuCapacityMHz
						.equals(other.getCpuCapacityMHz())))
				&& ((this.memCapacityMB == null && other.getMemCapacityMB() == null) || (this.memCapacityMB != null && this.memCapacityMB
						.equals(other.getMemCapacityMB())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClusterHostPowerAction.class, true);
