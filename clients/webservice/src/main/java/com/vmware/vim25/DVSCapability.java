...
public class DVSCapability extends com.vmware.vim25.DynamicData implements
	 ...
	 */
	public void setDvPortGroupOperationSupported(
			java.lang.Boolean dvPortGroupOperationSupported) {
		this.dvPortGroupOperationSupported = dvPortGroupOperationSupported;
	}
	 ...
	 */
	public void setDvPortOperationSupported(
			java.lang.Boolean dvPortOperationSupported) {
		this.dvPortOperationSupported = dvPortOperationSupported;
	}
	 ...
	 */
	public void setCompatibleHostComponentProductInfo(
			com.vmware.vim25.DistributedVirtualSwitchHostProductSpec[] compatibleHostComponentProductInfo) {
		this.compatibleHostComponentProductInfo = compatibleHostComponentProductInfo;
	}
	...
	public void setCompatibleHostComponentProductInfo(int i,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DVSCapability)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				&& ((this.dvsOperationSupported == null && other
						.getDvsOperationSupported() == null) || (this.dvsOperationSupported != null && this.dvsOperationSupported
						.equals(other.getDvsOperationSupported())))
				&& ((this.dvPortGroupOperationSupported == null && other
						.getDvPortGroupOperationSupported() == null) || (this.dvPortGroupOperationSupported != null && this.dvPortGroupOperationSupported
						.equals(other.getDvPortGroupOperationSupported())))
				&& ((this.dvPortOperationSupported == null && other
						.getDvPortOperationSupported() == null) || (this.dvPortOperationSupported != null && this.dvPortOperationSupported
						.equals(other.getDvPortOperationSupported())))
				&& ((this.compatibleHostComponentProductInfo == null && other
						.getCompatibleHostComponentProductInfo() == null) || (this.compatibleHostComponentProductInfo != null && java.util.Arrays
						.equals(this.compatibleHostComponentProductInfo, other
	...
	public synchronized int hashCode() {
		...
		if (getCompatibleHostComponentProductInfo() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getCompatibleHostComponentProductInfo()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getCompatibleHostComponentProductInfo(), i);
