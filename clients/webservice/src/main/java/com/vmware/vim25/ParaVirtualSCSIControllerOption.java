/**
 * ParaVirtualSCSIControllerOption.java
 *
...
public class ParaVirtualSCSIControllerOption extends
		com.vmware.vim25.VirtualSCSIControllerOption implements
	...
	public ParaVirtualSCSIControllerOption() {
	}

	public ParaVirtualSCSIControllerOption(java.lang.String dynamicType,
			...
			int defaultSharedIndex, com.vmware.vim25.BoolOption hotAddRemove,
		...
		super(dynamicType, dynamicProperty, type, connectOption,
				...
				numSCSIDisks, numSCSICdroms, numSCSIPassthrough, sharing,
				defaultSharedIndex, hotAddRemove, scsiCtlrUnitNumber);
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ParaVirtualSCSIControllerOption)) {
			return false;
		}
		ParaVirtualSCSIControllerOption other = (ParaVirtualSCSIControllerOption) obj;
		if (obj == null) {
			return false;
		}
		if (this == obj) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ParaVirtualSCSIControllerOption.class, true);
