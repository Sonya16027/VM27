...
public class ResourcePoolMovedEvent  extends com.vmware.vim25.ResourcePoolEvent  implements java.io.Serializable {
     ...
     * @param oldParent
     */
    public void setOldParent(com.vmware.vim25.ResourcePoolEventArgument oldParent) {
        this.oldParent = oldParent;
    }
     ...
     * @param newParent
     */
    public void setNewParent(com.vmware.vim25.ResourcePoolEventArgument newParent) {
        this.newParent = newParent;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ResourcePoolMovedEvent"));
