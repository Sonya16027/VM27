...
public class ToolsConfigInfo  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public ToolsConfigInfo(
           ...
           java.lang.Integer toolsVersion,
           java.lang.Boolean afterPowerOn,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ToolsConfigInfo)) return false;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.afterPowerOn==null && other.getAfterPowerOn()==null) || 
             (this.afterPowerOn!=null &&
              this.afterPowerOn.equals(other.getAfterPowerOn()))) &&
            ((this.afterResume==null && other.getAfterResume()==null) || 
             (this.afterResume!=null &&
              this.afterResume.equals(other.getAfterResume()))) &&
            ((this.beforeGuestStandby==null && other.getBeforeGuestStandby()==null) || 
             (this.beforeGuestStandby!=null &&
              this.beforeGuestStandby.equals(other.getBeforeGuestStandby()))) &&
            ((this.beforeGuestShutdown==null && other.getBeforeGuestShutdown()==null) || 
             (this.beforeGuestShutdown!=null &&
              this.beforeGuestShutdown.equals(other.getBeforeGuestShutdown()))) &&
            ((this.beforeGuestReboot==null && other.getBeforeGuestReboot()==null) || 
             (this.beforeGuestReboot!=null &&
              this.beforeGuestReboot.equals(other.getBeforeGuestReboot()))) &&
            ((this.toolsUpgradePolicy==null && other.getToolsUpgradePolicy()==null) || 
             (this.toolsUpgradePolicy!=null &&
              this.toolsUpgradePolicy.equals(other.getToolsUpgradePolicy()))) &&
            ((this.pendingCustomization==null && other.getPendingCustomization()==null) || 
             (this.pendingCustomization!=null &&
              this.pendingCustomization.equals(other.getPendingCustomization()))) &&
            ((this.syncTimeWithHost==null && other.getSyncTimeWithHost()==null) || 
             (this.syncTimeWithHost!=null &&
              this.syncTimeWithHost.equals(other.getSyncTimeWithHost())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ToolsConfigInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ToolsConfigInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "afterPowerOn"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "afterResume"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "beforeGuestStandby"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "beforeGuestShutdown"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "beforeGuestReboot"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "toolsUpgradePolicy"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "pendingCustomization"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "syncTimeWithHost"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
