...
public class VMwareUplinkPortOrderPolicy  extends com.vmware.vim25.InheritablePolicy  implements java.io.Serializable {
    ...
    public VMwareUplinkPortOrderPolicy(
           ...
           boolean inherited,
           java.lang.String[] activeUplinkPort,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VMwareUplinkPortOrderPolicy)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.activeUplinkPort==null && other.getActiveUplinkPort()==null) || 
             (this.activeUplinkPort!=null &&
              java.util.Arrays.equals(this.activeUplinkPort, other.getActiveUplinkPort()))) &&
            ((this.standbyUplinkPort==null && other.getStandbyUplinkPort()==null) || 
             (this.standbyUplinkPort!=null &&
              java.util.Arrays.equals(this.standbyUplinkPort, other.getStandbyUplinkPort())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getActiveUplinkPort() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getActiveUplinkPort());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getActiveUplinkPort(), i);
                if (obj != null &&
        ...
        if (getStandbyUplinkPort() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getStandbyUplinkPort());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getStandbyUplinkPort(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VMwareUplinkPortOrderPolicy.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VMwareUplinkPortOrderPolicy"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("activeUplinkPort");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "activeUplinkPort"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "standbyUplinkPort"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
