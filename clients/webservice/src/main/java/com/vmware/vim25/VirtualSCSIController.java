...
public class VirtualSCSIController  extends com.vmware.vim25.VirtualController  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualSCSIController"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "sharedBus"));
