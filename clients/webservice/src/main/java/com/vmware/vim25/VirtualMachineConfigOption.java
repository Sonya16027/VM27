...
public class VirtualMachineConfigOption  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public void setGuestOSDescriptor(int i, com.vmware.vim25.GuestOsDescriptor _value) {
     ...
     */
    public void setHardwareOptions(com.vmware.vim25.VirtualHardwareOption hardwareOptions) {
        this.hardwareOptions = hardwareOptions;
    }
     ...
     * @param capabilities
     */
    public void setCapabilities(com.vmware.vim25.VirtualMachineCapability capabilities) {
        this.capabilities = capabilities;
    }
    ...
    /**
     * Gets the supportedOvfEnvironmentTransport value for this VirtualMachineConfigOption.
     * 
    ...
    /**
     * Sets the supportedOvfEnvironmentTransport value for this VirtualMachineConfigOption.
     * 
     * @param supportedOvfEnvironmentTransport
     */
    public void setSupportedOvfEnvironmentTransport(java.lang.String[] supportedOvfEnvironmentTransport) {
        this.supportedOvfEnvironmentTransport = supportedOvfEnvironmentTransport;
    }
    ...
    public void setSupportedOvfEnvironmentTransport(int i, java.lang.String _value) {
        this.supportedOvfEnvironmentTransport[i] = _value;
    }


    /**
     * Gets the supportedOvfInstallTransport value for this VirtualMachineConfigOption.
     * 
    ...
    /**
     * Sets the supportedOvfInstallTransport value for this VirtualMachineConfigOption.
     * 
     * @param supportedOvfInstallTransport
     */
    public void setSupportedOvfInstallTransport(java.lang.String[] supportedOvfInstallTransport) {
        this.supportedOvfInstallTransport = supportedOvfInstallTransport;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.supportedMonitorType==null && other.getSupportedMonitorType()==null) || 
             (this.supportedMonitorType!=null &&
              java.util.Arrays.equals(this.supportedMonitorType, other.getSupportedMonitorType()))) &&
            ((this.supportedOvfEnvironmentTransport==null && other.getSupportedOvfEnvironmentTransport()==null) || 
             (this.supportedOvfEnvironmentTransport!=null &&
              java.util.Arrays.equals(this.supportedOvfEnvironmentTransport, other.getSupportedOvfEnvironmentTransport()))) &&
            ((this.supportedOvfInstallTransport==null && other.getSupportedOvfInstallTransport()==null) || 
             (this.supportedOvfInstallTransport!=null &&
              java.util.Arrays.equals(this.supportedOvfInstallTransport, other.getSupportedOvfInstallTransport())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSupportedMonitorType() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSupportedMonitorType());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSupportedMonitorType(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getSupportedOvfEnvironmentTransport() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSupportedOvfEnvironmentTransport());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSupportedOvfEnvironmentTransport(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getSupportedOvfInstallTransport() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSupportedOvfInstallTransport());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSupportedOvfInstallTransport(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineConfigOption"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "guestOSDescriptor"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "GuestOsDescriptor"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("guestOSDefaultIndex");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "guestOSDefaultIndex"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hardwareOptions");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "hardwareOptions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualHardwareOption"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("capabilities");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "capabilities"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "VirtualMachineCapability"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("datastore");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "datastore"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DatastoreOption"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("defaultDevice");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "defaultDevice"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "supportedMonitorType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "supportedOvfEnvironmentTransport"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "supportedOvfInstallTransport"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
