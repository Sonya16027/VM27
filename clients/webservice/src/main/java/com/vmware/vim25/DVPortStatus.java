...
public class DVPortStatus extends com.vmware.vim25.DynamicData implements
	...
	public DVPortStatus(java.lang.String dynamicType,
			com.vmware.vim25.DynamicProperty[] dynamicProperty, boolean linkUp,
			boolean blocked, com.vmware.vim25.NumericRange[] vlanIds,
			java.lang.Boolean trunkingMode, java.lang.Integer mtu,
			java.lang.String linkPeer, java.lang.String macAddress) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.vlanIds == null && other.getVlanIds() == null) || (this.vlanIds != null && java.util.Arrays
						.equals(this.vlanIds, other.getVlanIds())))
				&& ((this.trunkingMode == null && other.getTrunkingMode() == null) || (this.trunkingMode != null && this.trunkingMode
						.equals(other.getTrunkingMode())))
				&& ((this.mtu == null && other.getMtu() == null) || (this.mtu != null && this.mtu
						.equals(other.getMtu())))
				&& ((this.linkPeer == null && other.getLinkPeer() == null) || (this.linkPeer != null && this.linkPeer
						.equals(other.getLinkPeer())))
	...
	public synchronized int hashCode() {
		...
		if (getVlanIds() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getVlanIds()); i++) {
