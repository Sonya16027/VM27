...
public class ArrayOfHostPortGroupPort  implements java.io.Serializable {
    private com.vmware.vim25.HostPortGroupPort[] hostPortGroupPort;

    public ArrayOfHostPortGroupPort() {
    }

    public ArrayOfHostPortGroupPort(
           com.vmware.vim25.HostPortGroupPort[] hostPortGroupPort) {
    ...
    public com.vmware.vim25.HostPortGroupPort getHostPortGroupPort(int i) {
        return this.hostPortGroupPort[i];
    }

    public void setHostPortGroupPort(int i, com.vmware.vim25.HostPortGroupPort _value) {
