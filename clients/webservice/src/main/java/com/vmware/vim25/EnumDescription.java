...
public class EnumDescription  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public EnumDescription(
           ...
           com.vmware.vim25.ElementDescription[] tags) {
        super(
            dynamicType,
            dynamicProperty);
        this.key = key;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EnumDescription)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EnumDescription.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "EnumDescription"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "tags"));
