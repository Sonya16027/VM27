...
public class ArrayOfProfileDeferredPolicyOptionParameter  implements java.io.Serializable {
    ...
    public com.vmware.vim25.ProfileDeferredPolicyOptionParameter getProfileDeferredPolicyOptionParameter(int i) {
        return this.profileDeferredPolicyOptionParameter[i];
    }

    public void setProfileDeferredPolicyOptionParameter(int i, com.vmware.vim25.ProfileDeferredPolicyOptionParameter _value) {
