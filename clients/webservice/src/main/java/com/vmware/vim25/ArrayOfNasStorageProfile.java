...
public class ArrayOfNasStorageProfile  implements java.io.Serializable {
    ...
    public void setNasStorageProfile(int i, com.vmware.vim25.NasStorageProfile _value) {
        this.nasStorageProfile[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfNasStorageProfile)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.nasStorageProfile==null && other.getNasStorageProfile()==null) || 
             (this.nasStorageProfile!=null &&
              java.util.Arrays.equals(this.nasStorageProfile, other.getNasStorageProfile())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getNasStorageProfile() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getNasStorageProfile());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getNasStorageProfile(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfNasStorageProfile.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfNasStorageProfile"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nasStorageProfile");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "NasStorageProfile"));
