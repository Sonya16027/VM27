...
public class ArrayOfMultipleCertificatesVerifyFaultThumbprintData implements
	...
	/**
	 * Gets the multipleCertificatesVerifyFaultThumbprintData value for this
	...
	/**
	 * Sets the multipleCertificatesVerifyFaultThumbprintData value for this
	 * ArrayOfMultipleCertificatesVerifyFaultThumbprintData.
	 * 
	 * @param multipleCertificatesVerifyFaultThumbprintData
	 */
	public void setMultipleCertificatesVerifyFaultThumbprintData(
			com.vmware.vim25.MultipleCertificatesVerifyFaultThumbprintData[] multipleCertificatesVerifyFaultThumbprintData) {
		this.multipleCertificatesVerifyFaultThumbprintData = multipleCertificatesVerifyFaultThumbprintData;
	}
	...
	public void setMultipleCertificatesVerifyFaultThumbprintData(
			int i,
			com.vmware.vim25.MultipleCertificatesVerifyFaultThumbprintData _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfMultipleCertificatesVerifyFaultThumbprintData)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.multipleCertificatesVerifyFaultThumbprintData == null && other
				.getMultipleCertificatesVerifyFaultThumbprintData() == null) || (this.multipleCertificatesVerifyFaultThumbprintData != null && java.util.Arrays
				.equals(
						this.multipleCertificatesVerifyFaultThumbprintData,
						other
								.getMultipleCertificatesVerifyFaultThumbprintData())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getMultipleCertificatesVerifyFaultThumbprintData() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getMultipleCertificatesVerifyFaultThumbprintData()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getMultipleCertificatesVerifyFaultThumbprintData(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfMultipleCertificatesVerifyFaultThumbprintData.class, true);
