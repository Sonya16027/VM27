...
public class HostSnmpSystemAgentLimits  extends com.vmware.vim25.DynamicData  implements java.io.Serializable {
    ...
    public HostSnmpSystemAgentLimits(
           ...
           int maxReadOnlyCommunities,
           int maxTrapDestinations,
           int maxCommunityLength,
           int maxBufferSize,
     ...
     * @param capability
     */
    public void setCapability(com.vmware.vim25.HostSnmpAgentCapability capability) {
        this.capability = capability;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HostSnmpSystemAgentLimits)) return false;
        ...
        _equals = super.equals(obj) && 
            this.maxReadOnlyCommunities == other.getMaxReadOnlyCommunities() &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HostSnmpSystemAgentLimits.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostSnmpSystemAgentLimits"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("maxReadOnlyCommunities");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "maxReadOnlyCommunities"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("maxTrapDestinations");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "maxTrapDestinations"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("maxCommunityLength");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "maxCommunityLength"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("maxBufferSize");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "maxBufferSize"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "HostSnmpAgentCapability"));
