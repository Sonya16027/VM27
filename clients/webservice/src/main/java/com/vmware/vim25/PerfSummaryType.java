...
public class PerfSummaryType implements java.io.Serializable {
    ...
    public static final PerfSummaryType summation = new PerfSummaryType(_summation);
    ...
    public static PerfSummaryType fromValue(java.lang.String value)
        ...
        PerfSummaryType enumeration = (PerfSummaryType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PerfSummaryType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "PerfSummaryType"));
    }
    /**
