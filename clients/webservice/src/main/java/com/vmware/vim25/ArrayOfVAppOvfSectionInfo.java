...
public class ArrayOfVAppOvfSectionInfo  implements java.io.Serializable {
    ...
    public void setVAppOvfSectionInfo(int i, com.vmware.vim25.VAppOvfSectionInfo _value) {
        this.VAppOvfSectionInfo[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfVAppOvfSectionInfo)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.VAppOvfSectionInfo==null && other.getVAppOvfSectionInfo()==null) || 
             (this.VAppOvfSectionInfo!=null &&
              java.util.Arrays.equals(this.VAppOvfSectionInfo, other.getVAppOvfSectionInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getVAppOvfSectionInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getVAppOvfSectionInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getVAppOvfSectionInfo(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfVAppOvfSectionInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfVAppOvfSectionInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("VAppOvfSectionInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "VAppOvfSectionInfo"));
