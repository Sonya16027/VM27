...
public class ArrayOfHostDhcpService  implements java.io.Serializable {
    ...
    public void setHostDhcpService(int i, com.vmware.vim25.HostDhcpService _value) {
        this.hostDhcpService[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfHostDhcpService)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.hostDhcpService==null && other.getHostDhcpService()==null) || 
             (this.hostDhcpService!=null &&
              java.util.Arrays.equals(this.hostDhcpService, other.getHostDhcpService())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getHostDhcpService() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostDhcpService());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostDhcpService(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfHostDhcpService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "ArrayOfHostDhcpService"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("hostDhcpService");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "HostDhcpService"));
