...
public class CpuIncompatible81EDX extends com.vmware.vim25.CpuIncompatible
	...
	public CpuIncompatible81EDX(java.lang.String dynamicType,
			...
			com.vmware.vim25.ManagedObjectReference host, boolean nx,
			boolean ffxsr, boolean rdtscp, boolean lm, boolean other,
			boolean otherOnly) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CpuIncompatible81EDX)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = super.equals(obj) && this.nx == other.isNx()
				&& this.ffxsr == other.isFfxsr()
				&& this.rdtscp == other.isRdtscp() && this.lm == other.isLm()
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			CpuIncompatible81EDX.class, true);
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("urn:vim25", "ffxsr"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "boolean"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
