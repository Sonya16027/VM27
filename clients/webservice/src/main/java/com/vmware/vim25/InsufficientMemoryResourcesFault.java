...
public class InsufficientMemoryResourcesFault  extends com.vmware.vim25.InsufficientResourcesFault  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InsufficientMemoryResourcesFault)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InsufficientMemoryResourcesFault.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "InsufficientMemoryResourcesFault"));
