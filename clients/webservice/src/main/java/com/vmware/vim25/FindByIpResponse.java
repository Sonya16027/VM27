...
public class FindByIpResponse  implements java.io.Serializable {
    private com.vmware.vim25.ManagedObjectReference returnval;

    public FindByIpResponse() {
    }
    ...
    /**
     * Gets the returnval value for this FindByIpResponse.
     * 
     * @return returnval
     */
    ...
    /**
     * Sets the returnval value for this FindByIpResponse.
     * 
     * @param returnval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindByIpResponse)) return false;
        FindByIpResponse other = (FindByIpResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindByIpResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", ">FindByIpResponse"));
