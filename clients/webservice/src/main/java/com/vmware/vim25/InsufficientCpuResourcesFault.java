...
public class InsufficientCpuResourcesFault  extends com.vmware.vim25.InsufficientResourcesFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:vim25", "InsufficientCpuResourcesFault"));
