...
public class ArrayOfVnicPortArgument implements java.io.Serializable {
	 ...
	 */
	public void setVnicPortArgument(
			com.vmware.vim25.VnicPortArgument[] vnicPortArgument) {
		this.vnicPortArgument = vnicPortArgument;
	}
	...
	public void setVnicPortArgument(int i,
			com.vmware.vim25.VnicPortArgument _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ArrayOfVnicPortArgument)) {
			return false;
		}
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.vnicPortArgument == null && other
				.getVnicPortArgument() == null) || (this.vnicPortArgument != null && java.util.Arrays
				.equals(this.vnicPortArgument, other.getVnicPortArgument())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getVnicPortArgument() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getVnicPortArgument()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getVnicPortArgument(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ArrayOfVnicPortArgument.class, true);
